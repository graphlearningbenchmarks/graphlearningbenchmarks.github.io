...
short_description: US Congress bill co-sponsorship hypergraph node classification
  (2 classes).
description: '**2-class node classification** US Congress bill co-sponsorship hypergraph
...
detailed_description:
  task: US Congress bill co-sponsorship hypergraph node classification (2 classes).
    The primary catalog metric is Accuracy.
  data: US Congress bill co-sponsorship hypergraph node classification (2 classes).
