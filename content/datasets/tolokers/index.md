...
short_description: Yandex Toloka worker network binary node classification from the
  heterophilic benchmark.
description: '**Binary node classification** Yandex Toloka worker network binary node
...
detailed_description:
  task: Yandex Toloka worker network binary node classification from the heterophilic
    benchmark. The primary catalog metric is ROC-AUC.
  data: Yandex Toloka worker network binary node classification from the heterophilic
    benchmark. The cataloged artifact reports 1 graphs, 2 target classes or tasks.
...
- title: PyTorch Geometric Tolokers loader documentation
