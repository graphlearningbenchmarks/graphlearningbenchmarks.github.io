...
short_description: Circular skip link graphs — tests graph isomorphism discrimination
  (10 classes).
description: '**10-class graph classification** Circular skip link graphs — tests
  graph isomorphism discrimination (10 classes). Uses the benchmark-provided synthetic
  or superpixel node/edge features. Evaluated by Accuracy.'
detailed_description:
  task: Circular skip link graphs — tests graph isomorphism discrimination (10 classes).
    The primary catalog metric is Accuracy.
  data: Circular skip link graphs — tests graph isomorphism discrimination (10 classes).
...
- title: PyTorch Geometric CSL loader documentation
