...
short_description: Binary classification — blood-brain barrier permeability of molecules.
description: '**Binary graph classification** Binary classification — blood-brain
  barrier permeability of molecules. SMILES and labels are fixed; molecular graph
  featurization is implementation-defined. Missing labels are not negatives; report
  split and featurizer. Evaluated by ROC-AUC.'
detailed_description:
  task: Binary classification — blood-brain barrier permeability of molecules. The
    primary catalog metric is ROC-AUC.
  data: Binary classification — blood-brain barrier permeability of molecules.
...
- title: PyTorch Geometric BBBP loader documentation
...
best_model:
  ...
  metric: ROC-AUC
  arxiv_id: '2602.05567'
  paper_title: 'MAGPrompt: Message-Adaptive Graph Prompt Tuning for Graph Neural Networks'
papers:
- arxiv_id: '2605.06462'
