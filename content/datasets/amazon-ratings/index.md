...
short_description: Amazon product co-purchase node classification (5 rating classes)
  from the heterophilic benchmark.
description: '**5-class node classification** Amazon product co-purchase node classification
  (5 rating classes) from the heterophilic benchmark. Uses the corrected benchmark
  features and ten official splits. Evaluated by Accuracy.'
detailed_description:
  task: Amazon product co-purchase node classification (5 rating classes) from the
    heterophilic benchmark. The primary catalog metric is Accuracy.
  data: Amazon product co-purchase node classification (5 rating classes) from the
...
- title: PyTorch Geometric Amazon-ratings loader documentation
