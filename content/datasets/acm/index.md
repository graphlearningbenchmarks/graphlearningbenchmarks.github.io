...
short_description: Heterogeneous ACM academic graph — classify paper nodes (3 areas).
description: '**3-class node classification** Heterogeneous ACM academic graph — classify
  paper nodes (3 areas). Uses typed nodes, typed relations, and available type-specific
  features. Evaluated by Micro-F1.'
detailed_description:
  task: Heterogeneous ACM academic graph — classify paper nodes (3 areas). The primary
    catalog metric is Micro-F1.
  data: Heterogeneous ACM academic graph — classify paper nodes (3 areas). The cataloged
...
- title: PyTorch Geometric ACM loader documentation
