...
stats:
  ...
  extra_stats:
    ...
    node_feature_dim: 0
    size_regimes: 'small: 50,000 graphs, 241.0 nodes, 9,016.1 edges; large: 50,000
      graphs, 1,027.8 nodes, 102,644.8 edges'
    statistic_notes: GraphBench Table 2 reports separate small and large RB graph
      populations.
result_count: 5
best_model:
