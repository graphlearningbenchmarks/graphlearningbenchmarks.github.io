...
short_description: Predict an accessibility class for every intersection on the Shanghai
  road graph.
description: '**Node classification** on the Shanghai road graph, predicting an accessibility
...
detailed_description:
  task: Shanghai road-network node classification from the City-Networks benchmark.
    Labels are derived from long-range accessibility statistics on the city graph.
    The primary catalog metric is Accuracy.
  data: Shanghai road-network node classification from the City-Networks benchmark.
    Labels are derived from long-range accessibility statistics on the city graph.
...
- title: PyTorch Geometric Shanghai loader documentation
...
stats:
  ...
  extra_stats:
    ...
    statistic_notes: 'City-Networks Table 1: largest connected component of the undirected
      Shanghai road graph; counts and topology statistics are rounded.'
    transitivity: 0.04
result_count: 18
best_model:
  model: GAT
  ...
  stats:
    ...
    extra_stats:
      ...
      statistic_notes: 'City-Networks Table 1: largest connected component of the
        undirected Shanghai road graph; counts and topology statistics are rounded.'
      transitivity: 0.04
  metrics:
  - Accuracy
