...
short_description: Graph classification of proteins into enzymes and non-enzymes via
  D&D representation.
description: '**2-class graph classification** Graph classification of proteins into
  enzymes and non-enzymes via D&D representation. Uses the released node/edge labels
  or attributes; several social datasets are featureless. Evaluated by Accuracy.'
detailed_description:
  task: Graph classification of proteins into enzymes and non-enzymes via D&D representation.
    The primary catalog metric is Accuracy.
  data: Graph classification of proteins into enzymes and non-enzymes via D&D representation.
    The cataloged artifact reports 1,178 graphs, 2 target classes or tasks.
...
- title: PyTorch Geometric D&D loader documentation
...
best_model:
  ...
  metric: Accuracy
  arxiv_id: '2309.00738'
  paper_title: Rethinking the Power of Graph Canonization in Graph Representation
...
- slug: 10-fold-cv
  ...
  - model: structure2vec
    ...
    date: Apr 10, 2017
    date_iso: '2017-04-10'
    date_display: Apr 2017
    codebase_url: https://github.com/mys007/ecc
    published_conference: ''
    published_conference_short: ''
    published_conference_slug: ''
    published_venue: ''
  ...
  - model: GL
    ...
    codebase_url: ''
    published_conference: NeurIPS 2016
    published_conference_short: NeurIPS
    published_conference_slug: neurips
    published_venue: NeurIPS 2016
    uses_external_data: false
    is_best: false
    is_std_outlier: false
    metric_values:
  ...
  - model: DGCNN
    ...
    codebase_url: https://github.com/vermaMachineLearning/Graph-Capsule-CNN-Networks
    published_conference: ICML 2018
    published_conference_short: ICML
    published_conference_slug: icml
    published_venue: ICML 2018
    uses_external_data: false
    is_best: false
    is_std_outlier: false
    metric_values:
