...
short_description: Predict each paper’s research topic from bag-of-words features
  and citation links on one citation graph.
description: '**Node classification** on one citation graph, predicting each paper’s
  research topic from bag-of-words features and citation links. Evaluated by Accuracy.'
detailed_description:
  task: Citation network node classification (6 classes). The primary catalog metric
    is Accuracy.
  data: Citation network node classification (6 classes).
...
- title: PyTorch Geometric CiteSeer loader documentation
...
best_model:
  ...
  metric: Accuracy
  arxiv_id: '2412.04064'
  paper_title: Graph Neural Networks Need Cluster-Normalize-Activate Modules
papers:
- arxiv_id: '2606.00757'
...
- slug: planetoid-split
  ...
  notes: Yang et al. 2016 fixed split.
  is_standard: true
  primary_metric: Accuracy
