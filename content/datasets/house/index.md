...
short_description: US House of Representatives voting hypergraph node classification
  (2 classes).
description: '**2-class node classification** US House of Representatives voting hypergraph
  node classification (2 classes). Uses node-hyperedge incidence and the released
  node features. Clique expansion changes the input by discarding hyperedge identity.
  Evaluated by Accuracy.'
detailed_description:
  task: US House of Representatives voting hypergraph node classification (2 classes).
    The primary catalog metric is Accuracy.
  data: US House of Representatives voting hypergraph node classification (2 classes).
