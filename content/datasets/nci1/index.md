...
short_description: Graph classification of chemical compounds screened for anti-cancer
  activity.
description: '**2-class graph classification** Graph classification of chemical compounds
  screened for anti-cancer activity. Uses the released node/edge labels or attributes;
  several social datasets are featureless. Evaluated by Accuracy.'
detailed_description:
  task: Graph classification of chemical compounds screened for anti-cancer activity.
    The primary catalog metric is Accuracy.
  data: Graph classification of chemical compounds screened for anti-cancer activity.
    The cataloged artifact reports 4,110 graphs, 2 target classes or tasks.
...
- title: PyTorch Geometric NCI1 loader documentation
