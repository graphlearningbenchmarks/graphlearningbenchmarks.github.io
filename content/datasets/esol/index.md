...
stats:
  ...
  extra_stats:
    ...
    label_imbalance: not applicable; measured aqueous solubility is a continuous regression
      target
    node_feature_dim: 9
...
- slug: scaffold-split
  ...
  stats:
    ...
    extra_stats:
      edge_feature_dim: 3
      edge_feature_type: categorical RDKit bond features in the PyG loader
      label_imbalance: not applicable; measured aqueous solubility is a continuous
        regression target
      node_feature_dim: 9
      node_feature_type: categorical RDKit atom features in the PyG loader
