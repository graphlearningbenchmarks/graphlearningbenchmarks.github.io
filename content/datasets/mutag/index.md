...
short_description: Graph classification of mutagenic aromatic and heteroaromatic nitro
  compounds (2 classes).
description: '**2-class graph classification** Graph classification of mutagenic aromatic
  and heteroaromatic nitro compounds (2 classes). Uses the released node/edge labels
  or attributes; several social datasets are featureless. Evaluated by Accuracy.'
detailed_description:
  task: Graph classification of mutagenic aromatic and heteroaromatic nitro compounds
    (2 classes). The primary catalog metric is Accuracy.
  data: Graph classification of mutagenic aromatic and heteroaromatic nitro compounds
    (2 classes). The cataloged artifact reports 188 graphs, 2 target classes or tasks.
...
- title: PyTorch Geometric MUTAG loader documentation
...
- arxiv_id: '2210.02636'
  ...
  venue: NeurIPS 2022
- arxiv_id: '2210.01906'
  title: 'Tree Mover''s Distance: Bridging Graph Metrics and Stability of Graph Neural
    Networks'
  date_iso: '2022-10-04'
  venue: NeurIPS 2022
- arxiv_id: '2209.14402'
