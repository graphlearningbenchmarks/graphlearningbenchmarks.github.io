...
short_description: Multi-task toxicological profile prediction (617 tasks) from the
  EPA ToxCast program.
description: '**617-task multi-label graph classification** Multi-task toxicological
  profile prediction (617 tasks) from the EPA ToxCast program. SMILES and labels are
  fixed; molecular graph featurization is implementation-defined. Evaluated by ROC-AUC.'
detailed_description:
  task: Multi-task toxicological profile prediction (617 tasks) from the EPA ToxCast
    program. The primary catalog metric is ROC-AUC.
  data: Multi-task toxicological profile prediction (617 tasks) from the EPA ToxCast
    program.
...
- title: PyTorch Geometric ToxCast loader documentation
...
stats:
  ...
  extra_stats:
    ...
    label_imbalance: 617-task multi-label toxicity assays with substantial missingness
