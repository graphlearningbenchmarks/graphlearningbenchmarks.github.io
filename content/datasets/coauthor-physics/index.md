...
slug: coauthor-physics
benchmark: Classic
task_type: node_classification
short_description: Predict each author’s physics field from paper-keyword features
  on one coauthorship graph.
description: '**Node classification** on one coauthorship graph, predicting each author’s
  physics field from paper-keyword features. Evaluated by Accuracy.'
detailed_description:
  task: Co-authorship graph (Physics) node classification from the "Pitfalls of Graph
    Neural Network Evaluation" paper. The primary catalog metric is Accuracy.
  data: Co-authorship graph (Physics) node classification from the "Pitfalls of Graph
...
- title: PyTorch Geometric Coauthor-Physics loader documentation
...
best_model:
  ...
  metric: Accuracy
  arxiv_id: '2411.17296'
  paper_title: 'GrokFormer: Graph Fourier Kolmogorov-Arnold Transformers'
papers:
- arxiv_id: '2605.20248'
