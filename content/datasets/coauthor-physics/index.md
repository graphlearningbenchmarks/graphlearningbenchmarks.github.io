...
description: Co-authorship graph (Physics) node classification from the "Pitfalls
  of Graph Neural Network Evaluation" paper.
...
best_model:
  ...
  metric: Accuracy
  arxiv_id: '2510.04522'
  paper_title: 'Toward a Unified Geometry Understanding: Riemannian Diffusion Framework
