...
### No GCN/GIN/GraphSAGE Baseline (37)
...
| DualEquiNet RNA Benchmarks | TorsionAngle | graph_regression | Circular MAE | 8 | — |
| GraphBench | Algorithmic Reasoning | graph_classification | Accuracy | 8 | — |
| GraphBench | BlueSky | node_classification | MAE | 0 | — |
| GraphBench | Bridges | graph_classification | F1 | 0 | — |
...
| GraphBench | MST | graph_classification | F1 | 0 | — |
...
| Other Graph Benchmarks | MalNet-Tiny | graph_classification | Accuracy | 21 | gatedgcn |
| Power Flow Benchmarks | Case 1 | graph_regression | Accuracy | 17 | — |
| Power Flow Benchmarks | Case 2 | graph_regression | Accuracy | 4 | — |
| Quantum Chemistry | MD17 | graph_regression | MAE | 422 | — |
