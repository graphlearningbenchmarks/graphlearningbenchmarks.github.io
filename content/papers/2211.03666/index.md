...
abstract: Graph classification is an important area in both modern research and industry.
  Multiple applications, especially in chemistry and novel drug discovery, encourage
  rapid development of machine learning models in this area. To keep up with the pace
  of new research, proper experimental design, fair evaluation, and independent benchmarks
  are essential. Design of strong baselines is an indispensable element of such works.
  In this thesis, we explore multiple approaches to graph classification. We focus
  on Graph Neural Networks (GNNs), which emerged as a de facto standard deep learning
  technique for graph representation learning. Classical approaches, such as graph
  descriptors and molecular fingerprints, are also addressed. We design fair evaluation
  experimental protocol and choose proper datasets collection. This allows us to perform
  numerous experiments and rigorously analyze modern approaches. We arrive to many
  conclusions, which shed new light on performance and quality of novel algorithms.
  We investigate application of Jumping Knowledge GNN architecture to graph classification,
  which proves to be an efficient tool for improving base graph neural network architectures.
  Multiple improvements to baseline models are also proposed and experimentally verified,
  which constitutes an important contribution to the field of fair model comparison.
codebase_url: ''
...
- &id001
  ...
  - model: Fingerprints concatenation
    model_key: fingerprints concatenation
  ...
  - model: GCN
    ...
    gap_vs_at_pub: 0.10520000000000007
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GraphSAGE
    ...
    value_gap_source_date_iso: '2022-11-07'
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.19909999999999994
    worse_than_at_pub: false
    surpassed_since_pub: false
  ...
  - model: MACCS
    ...
    is_best: false
    is_std_outlier: false
  - model: LDP with additional features
    model_key: ldp with additional features
    model_plain: LDP with additional features
    value: 0.8143
    std: null
    paper_value: 0.8143
    paper_std: null
  ...
  - model: GCN + JK concat
    ...
    is_std_outlier: false
  - model: LDP extended
    model_key: ldp extended
    model_plain: LDP extended
    value: 0.8102
    std: null
    paper_value: 0.8102
    paper_std: null
  ...
  - model: GraphSAGE + JK concat
    ...
    is_best: false
    is_std_outlier: false
  - model: Deep Multisets + atom encoding
    model_key: deep multisets + atom encoding
    model_plain: Deep Multisets + atom encoding
    value: 0.8093
    std: null
    paper_value: 0.8093
    paper_std: null
    ...
    is_best: false
    is_std_outlier: false
  - model: LDP with additional features and feature selection
    model_key: ldp with additional features and feature selection
    model_plain: LDP with additional features and feature selection
    value: 0.8082
    std: null
    paper_value: 0.8082
    paper_std: null
  ...
  - model: GraphSAGE + JK LSTM
    ...
    is_best: false
    is_std_outlier: false
  - model: GraphSAGE + JK max
    model_key: graphsage + jk max
    model_plain: GraphSAGE + JK max
    value: 0.7985
    std: null
    paper_value: 0.7985
    paper_std: null
  ...
  - model: MFPs
    ...
    is_best: false
    is_std_outlier: false
  - model: MFPs + atom encoding
    model_key: mfps + atom encoding
    model_plain: MFPs + atom encoding
    value: 0.7878
    std: null
    paper_value: 0.7878
    paper_std: null
    ...
    is_std_outlier: false
  - model: GAT + JK LSTM
    model_key: gat + jk lstm
    model_plain: GAT + JK LSTM
    value: 0.7609
    std: null
    paper_value: 0.7609
    paper_std: null
  ...
  - model: GAT + JK max
    ...
    is_best: false
    is_std_outlier: false
  - model: Deep Multisets
    model_key: deep multisets
    model_plain: Deep Multisets
    value: 0.7181
    std: null
    paper_value: 0.7181
    paper_std: null
  ...
  - model: GIN + JK LSTM
    ...
    is_std_outlier: false
  - model: GAT + JK concat
    model_key: gat + jk concat
    model_plain: GAT + JK concat
    value: 0.6776
    std: null
    paper_value: 0.6776
    paper_std: null
    ...
    is_std_outlier: false
  - model: GIN + JK concat
    model_key: gin + jk concat
    model_plain: GIN + JK concat
    value: 0.6561
    std: null
    paper_value: 0.6561
    paper_std: null
...
- &id002
  ...
  - model: GIN
    ...
    value_gap_source_date_iso: '2024-12-20'
    value_gap_source_date_label: AAAI 2024
    gap_vs_at_pub: 0.24719999999999998
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id003
  ...
  - model: GCN
    ...
    protocol_decision: standard
    protocol_note: Standard regression task on Lipophilicity
    date: Nov 7, 2022
    date_display: Nov 2022
    date_iso: '2022-11-07'
    published_venue: ''
...
main_figure: /figures/2211.03666/main_figure.jpegoptim.jpg
---
