...
- name: Federico Monti
  ...
  s2_url: null
published_date: Apr 23, 2020
published_date_iso: '2020-04-23'
published_venue: ''
...
abstract: Graph representation learning has recently been applied to a broad spectrum
  ...
  the computational cost is alleviated by a sampling strategy retaining a subset of
  node neighbors or subgraphs at training time. In this paper we propose a new, efficient
  and scalable graph deep learning architecture which sidesteps the need for graph
  sampling by using graph convolutional filters of different size that are amenable
  to efficient precomputation, allowing extremely fast training and inference. Our
  architecture allows using different local graph operators (e.g. motif-induced adjacency
  matrices or Personalized Page Rank diffusion matrix) to best suit the task at hand.
  We conduct extensive experimental evaluation on various open benchmarks and show
  that our approach is competitive with other state-of-the-art architectures, while
  requiring a fraction of the training and inference time. Moreover, we obtain state-of-the-art
  results on ogbn-papers100M, the largest public graph dataset, with over 110 million
  nodes and 1.5 billion edges.
codebase_url: ''
...
- &id002
  ...
  - model: GraphSAINT
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: DBLP:journals/corr/abs-1907-04931
  ...
  - model: SIGN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Inductive setting on PPI (best configuration)
    date: Apr 23, 2020
    date_display: Apr 2020
    date_iso: '2020-04-23'
    published_venue: ''
  ...
  - model: Stochastic-GCN
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: stochastic-training
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Inductive setting on PPI
  ...
  - model: S-GCN
    ...
    true_value: 0.963
    true_std: 0.01
    value_gap_source_arxiv: '1907.04931'
    value_gap_source_title: 'GraphSAINT: mpling Based ductive Learning Me hod'
    value_gap_source_is_current_paper: false
  ...
  - model: ClusterGCN
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: Chiang:2019:CEA:3292500.3330925
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Inductive setting on PPI
...
- &id001
  ...
  - model: GraphSAINT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Inductive setting on Reddit
    date: Apr 23, 2020
    date_display: Apr 2020
    date_iso: '2020-04-23'
    published_venue: ''
  ...
  - model: SIGN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Inductive setting on Reddit; best configuration (4,2,0)
    date: Apr 23, 2020
    date_display: Apr 2020
    date_iso: '2020-04-23'
    published_venue: ''
...
- &id004
  ...
  - model: SIGN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard test split for ogbn-papers100M
    date: Apr 23, 2020
    date_display: Apr 2020
    date_iso: '2020-04-23'
    published_venue: ''
...
single_proposed_model: SIGN
main_figure: /figures/2004.11198/main_figure.jpegoptim.jpg
---
