---
title: 'GIDN: A Lightweight Graph Inception Diffusion Network for High-efficient Link
  Prediction'
arxiv_id: '2210.01301'
source_url: ''
authors:
- name: Zixiao Wang
  orcid: null
  s2_author_id: '2117423861'
  s2_url: null
- name: Yuluo Guo
  orcid: null
  s2_author_id: '1978062716'
  s2_url: null
- name: Jin Zhao
  orcid: null
  s2_author_id: '2109972322'
  s2_url: null
- name: Yu Zhang
  orcid: null
  s2_author_id: '72095113'
  s2_url: null
- name: Hui Yu
  orcid: null
  s2_author_id: '2186953171'
  s2_url: null
- name: Xiaofei Liao
  orcid: null
  s2_author_id: '144925807'
  s2_url: null
- name: Hai Jin
  orcid: null
  s2_author_id: '145914251'
  s2_url: null
- name: Biao Wang
  orcid: null
  s2_author_id: '2112555729'
  s2_url: null
- name: Ting Yu
  orcid: null
  s2_author_id: '2186875712'
  s2_url: null
...
abstract: In this paper, we propose a Graph Inception Diffusion Networks(GIDN) model.
  This model generalizes graph diffusion in different feature spaces, and uses the
  inception module to avoid the large amount of computations caused by complex network
  structures. We evaluate GIDN model on Open Graph Benchmark(OGB) datasets, reached
