...
- name: Yancheng Wang
  orcid: null
  s2_author_id: '2115944576'
  s2_url: null
- name: Changyu Liu
  orcid: null
  s2_author_id: '2371147556'
  s2_url: null
- name: Yingzhen Yang
  orcid: null
  s2_author_id: '2193639833'
  s2_url: null
published_date: Mar 16, 2025
published_date_iso: '2025-03-16'
...
abstract: Graph diffusion models have recently been proposed to synthesize entire
  graphs, such as molecule graphs. Although existing methods have shown great performance
  in generating entire graphs for graph-level learning tasks, no graph diffusion models
  have been developed to generate synthetic graph structures, that is, synthetic nodes
  and associated edges within a given graph, for node-level learning tasks. Inspired
  by the research in the computer vision literature using synthetic data for enhanced
  performance, we propose Diffusion on Graph (DoG), which generates synthetic graph
  structures to boost the performance of GNNs. The synthetic graph structures generated
  by DoG are combined with the original graph to form an augmented graph for the training
  of node-level learning tasks, such as node classification and graph contrastive
  learning (GCL). To improve the efficiency of the generation process, a Bi-Level
  Neighbor Map Decoder (BLND) is introduced in DoG. To mitigate the adverse effect
  of the noise introduced by the synthetic graph structures, a low-rank regularization
  method is proposed for the training of graph neural networks (GNNs) on the augmented
  graphs. Extensive experiments on various graph datasets for semi-supervised node
  classification and graph contrastive learning have been conducted to demonstrate
  the effectiveness of DoG with low-rank regularization. The code of DoG is available
  at.
...
- &id006
  ...
  - model: DoG
    ...
    protocol_note: Accuracy on Film dataset using the standard heterophilic split
...
- &id007
  ...
  - model: ACM-GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: node classification on Chameleon using the standard Geom-GCN 10
      fixed splits (48/32/20).
    date: Mar 16, 2025
    date_display: Mar 2025
    date_iso: '2025-03-16'
    published_venue: TMLR 2025
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.057600000000000096
    has_value_note: false
    value_note: ''
    sort_value: 0.7476
    sort_std: 0.022
...
- &id002
  ...
  - model: GCN
    ...
    gap_vs_at_pub: 0.17190000000000005
  ...
  - model: SGFormer
    ...
    gap_vs_at_pub: 0.05380000000000007
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id004
  ...
  - model: DoG
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: node classification, standard split, Accuracy
    date: Mar 16, 2025
    date_display: Mar 2025
    date_iso: '2025-03-16'
    published_venue: TMLR 2025
  ...
  - model: Exphormer
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: node classification, standard split (as per baseline methods),
      Accuracy
    date: Mar 16, 2025
    date_display: Mar 2025
    date_iso: '2025-03-16'
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2025-04-22'
    value_gap_source_date_label: WWW 2025
    gap_vs_at_pub: 0.0019999999999998908
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: DGI
    ...
    feature_source_evidence: features learned from graph contrastive learning
    table_ref: Table 2
    source_ref: velickovic_2019_iclr
    variant_inference_reason: 'dataset: fuzzy match to coauthor-cs (score=100)'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: node classification, Accuracy, features from GCL pre-training
    date: Mar 16, 2025
    date_display: Mar 2025
    date_iso: '2025-03-16'
    published_venue: TMLR 2025
...
- &id001
  ...
  - model: GCN
    ...
    protocol_decision: standard
    protocol_note: Planetoid split (Yang et al. 2016 fixed 20-per-class train split)
      as per canonical definition and text.
    date: Mar 16, 2025
    date_display: Mar 2025
    date_iso: '2025-03-16'
    published_venue: TMLR 2025
    ...
    gap_vs_at_pub: 0.08340000000000003
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id005
  ...
  - model: DoG
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Texas node classification using standard split (Geom-GCN 10 fixed
      splits) as per canonical definition for heterophilic datasets.
    date: Mar 16, 2025
    date_display: Mar 2025
    date_iso: '2025-03-16'
    published_venue: TMLR 2025
...
single_proposed_model: DoG
main_figure: /figures/2503.12563/main_figure.jpegoptim.jpg
---
