...
- name: Johannes Klicpera
  ...
  s2_url: null
- name: Stefan Weißenberger
  orcid: null
  s2_author_id: '8350757'
  s2_url: null
...
- &id001
  ...
  - model: GCN (PPR)
    ...
    protocol_note: Accuracy on Coauthor CS test split
    date: Oct 28, 2019
    ...
    true_value: 0.9301
    true_std: 0.0007
    value_gap_source_arxiv: '1911.05485'
    value_gap_source_title: Diffusion Improves Graph Learning
  ...
  - model: JK (PPR)
    ...
    is_best: false
    is_std_outlier: false
  - model: APPNP (No diffusion)
    model_key: appnp (no diffusion)
    model_plain: APPNP (No diffusion)
    value: 0.9208
    std: 0.0007
    paper_value: 0.9208
    paper_std: 0.0007
  ...
  - model: GAT (PPR)
    ...
    is_std_outlier: false
  - model: DeepWalk (PPR)
    model_key: deepwalk (ppr)
    model_plain: DeepWalk (PPR)
    value: 0.6529
    std: 0.014
    paper_value: 0.6529
    paper_std: 0.014
  ...
  - model: DGI (PPR)
    ...
    is_std_outlier: false
  - model: DCSBM (Heat)
    model_key: dcsbm (heat)
    model_plain: DCSBM (Heat)
    value: 0.637
    std: 0.0093
    paper_value: 0.637
    paper_std: 0.0093
    ...
    is_std_outlier: false
  - model: Spectral (PPR)
    model_key: spectral (ppr)
    model_plain: Spectral (PPR)
    value: 0.5527
    std: 0.03
    paper_value: 0.5527
    paper_std: 0.03
...
main_figure: /figures/1911.05485/main_figure.jpegoptim.jpg
---
