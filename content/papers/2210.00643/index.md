...
- name: Lu Lin
  orcid: null
  s2_author_id: '9538465'
  s2_url: null
- name: Jinghui Chen
  orcid: null
  s2_author_id: '7557913'
  s2_url: null
- name: Hongning Wang
  orcid: null
  s2_author_id: '2108883660'
  s2_url: null
published_date: Oct 2, 2022
published_date_iso: '2022-10-02'
...
abstract: Graph contrastive learning (GCL), as an emerging self-supervised learning
  ...
  Its performance heavily relies on graph augmentation to reflect invariant patterns
  that are robust to small perturbations; yet it still remains unclear about what
  graph invariance GCL should capture. Recent studies mainly perform topology augmentations
  in a uniformly random manner in the spatial domain, ignoring its influence on the
  intrinsic structural properties embedded in the spectral domain. In this work, we
  aim to find a principled way for topology augmentations by exploring the invariance
  of graphs from the spectral perspective. We develop spectral augmentation which
  guides topology augmentations by maximizing the spectral change. Extensive experiments
  on both graph and node classification tasks demonstrate the effectiveness of our
  method in self-supervised representation learning. The proposed method also brings
  promising generalization capability in transfer learning, and is equipped with intriguing
  robustness property under adversarial attacks. Our study sheds light on a general
  principle for graph topology augmentation.
codebase_url: ''
...
- &id002
  ...
  - model: BGRL
    ...
    protocol_note: Unsupervised node classification on Amazon-Computer dataset.
    date: Oct 2, 2022
  ...
  - model: BGRL-SPAN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Unsupervised node classification on Amazon-Computer
    date: Oct 2, 2022
    date_display: Oct 2022
    date_iso: '2022-10-02'
    published_venue: ICLR 2022
    ...
    is_std_outlier: false
  - model: MVGRL-SPAN
    model_key: mvgrl-span
    model_plain: MVGRL-SPAN
    value: 0.9009
    std: 0.0032
    paper_value: 0.9009
    paper_std: 0.0032
    ...
    is_std_outlier: false
  - model: GRACE-SPAN
    model_key: grace-span
    model_plain: GRACE-SPAN
    value: 0.8995
    std: 0.0041
    paper_value: 0.8995
    paper_std: 0.0041
...
- &id001
  ...
  - model: BGRL-SPAN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Unsupervised node classification on Amazon-Photo co-purchase network.
    date: Oct 2, 2022
    date_display: Oct 2022
    date_iso: '2022-10-02'
    published_venue: ICLR 2022
...
- &id004
  ...
  - model: MVGRL
    ...
    protocol_decision: standard
    protocol_note: Out-of-domain transfer learning setting using Yelp pre-training
      and COLLAB fine-tuning.
    date: Oct 2, 2022
    date_display: Oct 2022
    date_iso: '2022-10-02'
    published_venue: ICLR 2022
...
- &id003
  ...
  - model: MVGRL-SPAN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Unsupervised node classification on Coauthor-CS
    date: Oct 2, 2022
    date_display: Oct 2022
    date_iso: '2022-10-02'
    published_venue: ICLR 2022
...
- &id005
  ...
  - model: AD-GCL
    ...
    protocol_decision: standard
    protocol_note: Out-of-domain transfer learning setting using Yelp pre-training
      and REDDIT-BINARY (RDT-B) fine-tuning.
    date: Oct 2, 2022
    date_display: Oct 2022
    date_iso: '2022-10-02'
    published_venue: ICLR 2022
...
main_figure: /figures/2210.00643/main_figure.jpegoptim.jpg
---
