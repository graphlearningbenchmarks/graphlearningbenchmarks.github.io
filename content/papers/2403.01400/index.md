...
- name: Stan Z. Li
  orcid: null
  s2_author_id: '2253952904'
  s2_url: null
published_date: Mar 3, 2024
published_date_iso: '2024-03-03'
published_venue: ICLR 2024
published_conference: ICLR 2024
published_conference_short: ICLR
published_conference_slug: iclr
abstract: 'Recent years have witnessed the great success of graph pre-training for
  graph representation learning. With hundreds of graph pre-training tasks proposed,
  integrating knowledge acquired from multiple pre-training tasks has become a popular
  research topic. In this paper, we identify two important collaborative processes
  for this topic: (1) select: how to select an optimal task combination from a given
  task pool based on their compatibility, and (2) weigh: how to weigh the selected
  tasks based on their importance. While there currently has been a lot of work focused
  on weighing, comparatively little effort has been devoted to selecting. This paper
  proposes a novel instance-level framework for integrating multiple graph pre-training
  tasks, eigh nd elect (WAS), where the two collaborative processes, weighing and
  selecting, are combined by decoupled siamese networks. Specifically, it first adaptively
  learns an optimal combination of tasks for each instance from a given task pool,
  based on which a customized instance-level task weighing strategy is learned. Extensive
  experiments on 16 graph datasets across node-level and graph-level downstream tasks
  have demonstrated that by combining a few simple but classical tasks, WAS can achieve
  comparable performance to other leading counterparts. The code is available at https://github.com/TianyuFan0504/WAS.'
codebase_url: https://github.com/TianyuFan0504/WAS
...
- &id002
  ...
  - model: GRACE
    ...
    protocol_note: Node classification using 2-layer GCN backbone
    date: Mar 3, 2024
...
- &id005
  ...
  - model: GraphCL
    ...
    is_std_outlier: false
  - model: Random-Select
    model_key: random-select
    model_plain: Random-Select
    value: 0.772
    std: 0.017
    paper_value: 0.772
    paper_std: 0.017
  ...
  - model: Average-Weight
    model_key: average-weight
    model_plain: Average-Weight
    value: 0.753
    std: 0.012
    paper_value: 0.753
    paper_std: 0.012
...
- &id006
  ...
  - model: GraphCL
    ...
    value_gap_source_date_iso: '2022-06-02'
    value_gap_source_date_label: KDD 2022
    gap_vs_at_pub: 0.18800000000000006
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GraphLoG
    ...
    value_gap_source_date_iso: '2022-06-02'
    value_gap_source_date_label: KDD 2022
    gap_vs_at_pub: 0.18199999999999994
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id007
  ...
  - model: AttrMask
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Scaffold split used for molecular property prediction.
    date: Mar 3, 2024
    date_display: Mar 2024
    date_iso: '2024-03-03'
    published_venue: ICLR 2024
    ...
    value_gap_source_date_iso: '2025-03-06'
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.17400000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GraphMAE
    ...
    value_gap_source_date_iso: '2025-03-06'
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.16999999999999993
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: G-Motif
    ...
    value_gap_source_date_iso: '2024-03-03'
    value_gap_source_date_label: ICLR 2024
    gap_vs_at_pub: 0.03599999999999992
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: true
  ...
  - model: GPT-GNN
    ...
    value_gap_source_date_iso: '2021-10-03'
    value_gap_source_date_label: NeurIPS 2021
    gap_vs_at_pub: 0.18799999999999994
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id003
  ...
  - model: GCA
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Physics dataset using 2-layer GCN backbone.
    date: Mar 3, 2024
    date_display: Mar 2024
    date_iso: '2024-03-03'
    published_venue: ICLR 2024
  ...
  - model: GRACE
    ...
    value_gap_source_title: Learn Beneficial Noise as Graph Augmentation
    value_gap_source_is_current_paper: false
    value_gap: 0.012400000000000078
    has_value_note: false
    value_note: ''
    sort_value: 0.9574
    sort_std: 0.0006
...
- &id008
  ...
  - model: InfoGraph
    ...
    value_gap_source_title: Community-Invariant Graph Contrastive Learning
    value_gap_source_is_current_paper: false
    value_gap: 0.023400000000000087
    has_value_note: false
    value_note: ''
    sort_value: 0.6054
    sort_std: 0.009
...
- &id004
  ...
  - model: EdgePred
    ...
    value_gap_source_date_iso: '2022-06-02'
    value_gap_source_date_label: KDD 2022
    gap_vs_at_pub: 0.1359999999999999
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id009
  ...
  - model: ContextPred
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Scaffold splitting used for molecular property prediction
    date: Mar 3, 2024
    date_display: Mar 2024
    date_iso: '2024-03-03'
    published_venue: ICLR 2024
...
single_proposed_model: WAS
main_figure: /figures/2403.01400/main_figure.jpegoptim.jpg
---
