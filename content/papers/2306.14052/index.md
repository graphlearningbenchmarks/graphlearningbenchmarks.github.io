---
title: 'A Survey on Graph Neural Network Acceleration: Algorithms, Systems, and Customized
  Hardware'
arxiv_id: '2306.14052'
source_url: ''
authors:
...
- name: Atefeh Sohrabizadeh
  orcid: null
  s2_author_id: '2242000525'
  s2_url: null
- name: Cheng Wan
  orcid: null
  s2_author_id: '2158998114'
  s2_url: null
- name: Zijie Huang
  orcid: null
  s2_author_id: '12318198'
  s2_url: null
- name: Ziniu Hu
  orcid: null
...
- name: Yingyan (Celine) Lin
  orcid: null
  s2_author_id: '3138925'
  s2_url: null
- name: Jason Cong
  orcid: null
  s2_author_id: '2066032921'
  s2_url: null
- name: Yizhou Sun
  orcid: null
  s2_author_id: '2279734673'
  s2_url: null
published_date: Jun 24, 2023
published_date_iso: '2023-06-24'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: Graph neural networks (GNNs) are emerging for machine learning research
  on graph-structured data. GNNs achieve state-of-the-art performance on many tasks,
  but they face scalability challenges when it comes to real-world applications that
  have numerous data and strict latency requirements. Many studies have been conducted
  on how to accelerate GNNs in an effort to address these challenges. These acceleration
  techniques touch on various aspects of the GNN pipeline, from smart training and
  inference algorithms to efficient systems and customized hardware. As the amount
  of research on GNN acceleration has grown rapidly, there lacks a systematic treatment
  to provide a unified view and address the complexity of relevant works. In this
  survey, we provide a taxonomy of GNN acceleration, review the existing approaches,
  and suggest future research directions. Our taxonomic treatment of GNN acceleration
  connects the existing works and sets the stage for further development in this area.
codebase_url: ''
...
- &id001
  ...
  - model: GraphSAGE
    ...
    input_feature_source: raw_features
    feature_source_evidence: Each publication has a TF/IDF word vector feature
    table_ref: Table 1
  ...
  - model: VR-GCN
    ...
    value_gap_source_date_iso: '2023-06-24'
    ...
    true_value: 0.814
    true_std: null
    value_gap_source_arxiv: '2306.14052'
    value_gap_source_title: 'A Survey on Graph Neural Network Acceleration: Algorithms,
...
- scope: node-level
  ...
  - benchmark: Classic
    ...
    - dataset: PubMed
      dataset_slug: pubmed
main_figure: /figures/2306.14052/main_figure.jpegoptim.jpg
---
