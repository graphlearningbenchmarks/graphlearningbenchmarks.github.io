...
abstract: Graph neural networks (GNNs) have shown remarkable success in learning representations
  for graph-structured data. However, GNNs still face challenges in modeling complex
  phenomena that involve feature transportation. In this paper, we propose a novel
  GNN architecture inspired by Advection-Diffusion-Reaction systems, called ADR-GNN.
  Advection models feature transportation, while diffusion captures the local smoothing
  of features, and reaction represents the non-linear transformation between feature
  channels. We provide an analysis of the qualitative behavior of ADR-GNN, that shows
  the benefit of combining advection, diffusion, and reaction. To demonstrate its
  efficacy, we evaluate ADR-GNN on real-world node classification and spatio-temporal
  datasets, and show that it improves or offers competitive performance compared to
...
- &id005
  ...
  - model: GCN
    ...
    value_gap_source_date_iso: '2021-01-04'
    value_gap_source_date_label: AAAI 2021
    gap_vs_at_pub: 0.10039999999999999
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id003
  ...
  - model: APPNP
    ...
    value_gap_source_date_iso: '2023-05-10'
    value_gap_source_date_label: ICML 2023
    gap_vs_at_pub: 0.048900000000000055
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: LINKX
    ...
    value_gap_source_date_iso: '2024-10-03'
    value_gap_source_date_label: TMLR 2024
    gap_vs_at_pub: 0.19530000000000003
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
- &id002
  ...
  - model: GRAND
    ...
    at_pub_value: 0.797
    at_pub_std: 0.003
    at_pub_source_arxiv: '2302.14806'
    at_pub_source_title: Framelet Message Passing
    at_pub_source_date_iso: '2023-02-28'
    at_pub_source_date_label: '2023'
    ...
    has_value_gap: true
    comparison_type: improved
    comparison_source_title: Framelet Message Passing
    comparison_source_arxiv: '2302.14806'
    is_best: false
    is_std_outlier: false
  - model: SAGE
    model_key: sage
  ...
  - model: LINKX
    ...
    value_gap_source_date_iso: '2024-10-03'
    value_gap_source_date_label: TMLR 2024
    gap_vs_at_pub: 0.20200000000000007
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
- &id007
  ...
  - model: ADR-GNN_S
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: 10 fixed splits as per Pei2020Geom-GCN
    date: Jul 29, 2023
    date_display: Jul 2023
    date_iso: '2023-07-29'
    published_venue: AAAI 2023
  ...
  - model: GAT
    ...
    gap_vs_at_pub: 0.26269999999999993
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GPRGNN
    ...
    value_gap_source_date_iso: '2025-05-28'
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.18539999999999995
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id004
  ...
  - model: MagNet
    ...
    at_pub_value: 0.824
    at_pub_std: 0.049
    at_pub_source_arxiv: '2202.10793'
    at_pub_source_title: 'PyTorch Geometric Signed Directed: A Software Package on
      Graph Neural Networks for Signed and Directed Graphs'
    at_pub_source_date_iso: '2022-02-22'
  ...
  - model: GAT
    ...
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.21420000000000006
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GCN
    ...
    value_gap_source_date_iso: '2025-04-22'
    value_gap_source_date_label: WWW 2025
    gap_vs_at_pub: 0.2624000000000001
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id008
  ...
  - model: G^2
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy on heterophilic datasets; standard split implied
      by context of heterophilic benchmarks.
    date: Jul 29, 2023
    date_display: Jul 2023
    date_iso: '2023-07-29'
    published_venue: AAAI 2023
...
main_figure: /figures/2307.16092/main_figure.jpegoptim.jpg
---
