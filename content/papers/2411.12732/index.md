...
- name: Florian Grötschla
  orcid: null
  s2_author_id: '2083572783'
  s2_url: null
- name: Jiaqing Xie
  orcid: null
  s2_author_id: '2324057690'
  s2_url: null
- name: R. Wattenhofer
  orcid: null
  s2_author_id: '2075356250'
  s2_url: null
published_date: Nov 19, 2024
published_date_iso: '2024-11-19'
published_venue: KDD 2024
published_conference: KDD 2024
published_conference_short: KDD
published_conference_slug: kdd
abstract: Positional Encodings (PEs) are essential for injecting structural information
  into Graph Neural Networks (GNNs), particularly Graph Transformers, yet their empirical
  impact remains insufficiently understood. We introduce a unified benchmarking framework
  that decouples PEs from architectural choices, enabling a fair comparison across
  8 GNN and Transformer models, 9 PEs, and 10 synthetic and real-world datasets. Across
  more than 500 model–PE–dataset configurations, we find that commonly used expressiveness
  proxies, including Weisfeiler–Lehman distinguishability, do not reliably predict
  downstream performance. In particular, highly expressive PEs frequently fail to
  improve, and can even degrade performance on real-world tasks. At the same time,
  we identify several simple and previously overlooked model–PE combinations that
  match or outperform recent state-of-the-art methods. Our results demonstrate the
  strong task-dependence of PEs and underscore the need for empirical validation beyond
  theoretical expressiveness. To support reproducible research, we release an open-source
  benchmarking framework for evaluating PEs for graph learning tasks.
...
- &id007
  ...
  - model: GRIT+RRWP
    ...
    protocol_note: Standard split for CIFAR10 graph classification task
    date: Nov 19, 2024
  ...
  - model: TIGT
    ...
    value_gap_source_date_iso: '2024-11-19'
    value_gap_source_date_label: KDD 2024
    gap_vs_at_pub: 4.999999999999449e-05
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
  ...
  - model: GatedGCN+RWSE
    ...
    published_venue: KDD 2024
    published_conference: KDD 2024
    at_pub_value: 0.70858
    at_pub_std: 0.00631
    at_pub_source_arxiv: '2110.07875'
    at_pub_source_title: Graph Neural Networks with Learnable Structural and Positional
      Representations
    at_pub_source_date_iso: '2021-10-15'
    at_pub_source_date_label: ICLR 2021
    value_gap_source_date_iso: '2021-10-15'
    value_gap_source_date_label: ICLR 2021
    gap_vs_at_pub: 0.012859999999999983
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap: 0.012859999999999983
    has_value_note: false
    value_note: ''
    sort_value: 0.70858
    sort_std: 0.00631
  ...
  - model: GatedGCN+LapPE
    ...
    is_std_outlier: false
  - model: GatedGCN + PPR
    model_key: gatedgcn + ppr
    model_plain: GatedGCN + PPR
    value: 0.69224
    std: 0.00546
    paper_value: 0.69224
    paper_std: 0.00546
  ...
  - model: EGT
    ...
    gap_vs_at_pub: 1.999999999990898e-05
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_title: 'GCCM: Enhancing Generative Graph Prediction via Contrastive
      Consistency Model'
    value_gap_source_is_current_paper: false
    value_gap: 1.999999999990898e-05
    has_value_note: false
    value_note: ''
    sort_value: 0.68702
    sort_std: 0.00409
  ...
  - model: GraphSAGE
    ...
    is_std_outlier: false
  - model: GINE + (ESLapPE)
    model_key: gine + (eslappe)
    model_plain: GINE + (ESLapPE)
    value: 0.6614
    std: 0.0031
    paper_value: 0.6614
    paper_std: 0.0031
  ...
  - model: GINE + GCKN
    ...
    is_std_outlier: false
  - model: GINE + RWDIFF
    model_key: gine + rwdiff
    model_plain: GINE + RWDIFF
    value: 0.65632
    std: 0.00553
    paper_value: 0.65632
    paper_std: 0.00553
  ...
  - model: GINE + noPE
    ...
    is_std_outlier: false
  - model: GINE+LapPE
    model_key: gine+lappe
    model_plain: GINE+LapPE
    value: 0.65325
    std: 0.00195
    paper_value: 0.65325
    paper_std: 0.00195
  ...
  - model: GINE + PPR
    ...
    is_std_outlier: false
  - model: GINE + SignNet
    model_key: gine + signnet
    model_plain: GINE + SignNet
    value: 0.64538
    std: 0.00314
    paper_value: 0.64538
    paper_std: 0.00314
...
- &id008
  ...
  - model: EGT
    ...
    protocol_decision: standard
    protocol_note: Standard split for BenchmarkingGNNs node classification
    date: Nov 19, 2024
    date_display: Nov 2024
    date_iso: '2024-11-19'
    published_venue: KDD 2024
...
- &id005
  ...
  - model: GraphGPS + RWSE
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard split for COCO-SP
    date: Nov 19, 2024
    date_display: Nov 2024
    date_iso: '2024-11-19'
    published_venue: KDD 2024
  ...
  - model: GatedGCN-VN
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: rosenbluth2024distinguished
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard split for COCO-SP
...
- &id009
  ...
  - model: GRIT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard split for PATTERN node classification
    date: Nov 19, 2024
    date_display: Nov 2024
    date_iso: '2024-11-19'
    published_venue: KDD 2024
    published_conference: KDD 2024
    at_pub_value: 0.87196
    at_pub_std: 0.00076
  ...
  - model: EGT
    ...
    value_gap_source_date_iso: '2026-05-07'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 1.0000000000065512e-05
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_title: 'GCCM: Enhancing Generative Graph Prediction via Contrastive
      Consistency Model'
    value_gap_source_is_current_paper: false
    value_gap: 1.0000000000065512e-05
    has_value_note: false
    value_note: ''
    sort_value: 0.86821
    sort_std: 0.0002
...
- &id004
  ...
  - model: Exphormer + LapPE
    ...
    protocol_decision: standard
    protocol_note: Standard split for PCQM-Contact
    date: Nov 19, 2024
    date_display: Nov 2024
    date_iso: '2024-11-19'
    published_venue: KDD 2024
  ...
  - model: Exphormer
    ...
    comparison_source_title: 'Exphormer: Sparse Transformers for Graphs'
    comparison_source_arxiv: '2303.06147'
    is_best: false
    is_std_outlier: false
  - model: GraphGPS + RWSE
    model_key: graphgps + rwse
  ...
  - model: GraphGPS+LapPE
    ...
    has_value_gap: true
    comparison_type: improved
    comparison_source_title: 'DRew: Dynamically Rewired Message Passing with Delay'
    comparison_source_arxiv: '2305.08018'
    is_best: false
    is_std_outlier: false
  - model: GINE
    model_key: gine
...
- &id003
  ...
  - model: CRaWl
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: LRGB evaluation protocol
    date: Nov 19, 2024
    date_display: Nov 2024
    date_iso: '2024-11-19'
    published_venue: KDD 2024
  ...
  - model: GraphGPS
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: LRGB evaluation protocol (GraphGPS + ESLapPE)
    date: Nov 19, 2024
    date_display: Nov 2024
    date_iso: '2024-11-19'
    published_venue: KDD 2024
  ...
  - model: GatedGCN-VN
    ...
    is_baseline: true
    is_overridden: true
    override_reason: Table 1 reports 44.77 +/- 1.37 percent; normalize both values
      to fractions.
    params_millions: null
    architecture_type: gnn
    architecture_label: GNN
  ...
  - model: Exphormer
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: LRGB evaluation protocol (Exphormer + LapPE)
    date: Nov 19, 2024
    date_display: Nov 2024
    date_iso: '2024-11-19'
    published_venue: KDD 2024
  ...
  - model: GatedGCN+RWSE
    ...
    value_gap_source_date_iso: '2024-11-19'
    value_gap_source_date_label: KDD 2024
    gap_vs_at_pub: 0.10220000000000001
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: GatedGCN
    ...
    is_baseline: true
    is_overridden: true
    override_reason: Table 1 reports 38.80 +/- 0.40 percent; normalize both values
      to fractions.
    params_millions: null
    architecture_type: gnn
    architecture_label: GNN
  ...
  - model: GRIT
    ...
    is_baseline: true
    is_overridden: true
    override_reason: Table 1 reports 35.56 +/- 0.19 percent; normalize both values
      to fractions.
    params_millions: null
    architecture_type: gnn
    architecture_label: GNN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: LRGB evaluation protocol (GRIT + noPE)
    date: Nov 19, 2024
    date_display: Nov 2024
    date_iso: '2024-11-19'
    published_venue: KDD 2024
  ...
  - model: SparseGRIT
    ...
    is_baseline: true
    is_overridden: true
    override_reason: Table 1 reports 35.19 +/- 0.40 percent; normalize both values
      to fractions.
    params_millions: null
    architecture_type: graph_transformer
    architecture_label: GT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: LRGB evaluation protocol (SparseGRIT + GCKN)
    date: Nov 19, 2024
    date_display: Nov 2024
    date_iso: '2024-11-19'
    published_venue: KDD 2024
  ...
  - model: DRew
    ...
    is_baseline: true
    is_overridden: true
    override_reason: Table 1 reports 33.14 +/- 0.24 percent; normalize both values
      to fractions.
    params_millions: null
    architecture_type: other_traditional
    architecture_label: Trad
  ...
  - model: GINE
    ...
    is_baseline: true
    is_overridden: true
    override_reason: Table 1 reports 27.18 +/- 0.54 percent; normalize both values
      to fractions.
    params_millions: null
    architecture_type: gnn
    architecture_label: GNN
  ...
  - model: GCN
    ...
    is_baseline: true
    is_overridden: true
    override_reason: Table 1 reports 0.78 +/- 0.31 percent; normalize both values
      to fractions.
    params_millions: null
    architecture_type: gnn
    architecture_label: GNN
...
- &id002
  ...
  - model: Graph ViT
    ...
    value_gap_source_date_iso: '2024-10-07'
    ...
    true_value: 0.6942
    true_std: 0.0075
    value_gap_source_arxiv: '2410.05499'
    value_gap_source_title: Unitary convolutions for learning on graphs and groups
    value_gap_source_is_current_paper: false
...
- &id001
  ...
  - model: GatedGCN+RWSE
    ...
    value_gap_source_date_iso: '2024-11-19'
    value_gap_source_date_label: KDD 2024
    gap_vs_at_pub: 0.004400000000000015
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
main_figure: /figures/2411.12732/main_figure.jpegoptim.jpg
---
