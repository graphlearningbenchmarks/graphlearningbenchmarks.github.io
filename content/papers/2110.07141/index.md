...
- name: Yuehao Wang
  orcid: null
  s2_author_id: '2115623711'
  s2_url: null
- name: Hua Lin
  orcid: null
  s2_author_id: '2117123351'
  s2_url: null
- name: Jianbo Shi
  orcid: null
  s2_author_id: '46865129'
  s2_url: null
published_date: Oct 14, 2021
published_date_iso: '2021-10-14'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: Graph Convolutional Networks (GCN) with multi-hop aggregation is more expressive
  than one-hop GCN but suffers from higher model complexity. Finding the shortest
  aggregation range that achieves comparable expressiveness and minimizes this side
  effect remains an open question. We answer this question by showing that multi-layer
  second-order graph convolution (SoGC) is sufficient to attain the ability of expressing
  polynomial spectral filters with arbitrary coefficients. Compared to models with
  one-hop aggregation, multi-hop propagation, and jump connections, SoGC possesses
  filter representational completeness while being lightweight, efficient, and easy
  to implement. Thereby, we suggest that SoGC is a simple design capable of forming
  the basic building block of GCNs, playing the same role as $3 3$ kernels in CNNs.
  We build our Second-Order Graph Convolutional Networks (SoGCN) with SoGC and design
  a synthetic dataset to verify its filter fitting capability to validate these points.
  For real-world tasks, we present the state-of-the-art performance of SoGCN on the
  benchmark of node classification, graph classification, and graph regression datasets.
...
- &id004
  ...
  - model: GatedGCN
    ...
    protocol_note: Test accuracy on CIFAR10 graph classification
    date: Oct 14, 2021
  ...
  - model: MoNet
    ...
    value_gap_source_date_iso: '2021-10-14'
    value_gap_source_date_label: '2021'
    gap_vs_at_pub: 0.036109999999999975
    worse_than_at_pub: false
    surpassed_since_pub: false
  ...
  - model: GIN
    ...
    is_best: false
    is_std_outlier: false
  - model: Vanilla GCN + GRU
    model_key: vanilla gcn + gru
    model_plain: Vanilla GCN + GRU
    value: 0.61332
    std: 0.00849
    paper_value: 0.61332
    paper_std: 0.00849
...
- &id005
  ...
  - model: GatedGCN
    ...
    gap_vs_at_pub: 0.16709999999999992
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GAT
    ...
    gap_vs_at_pub: 0.12847999999999993
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id003
  ...
  - model: GatedGCN
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Standard split for MNIST superpixels graph classification
    date: Oct 14, 2021
    date_display: Oct 2021
    date_iso: '2021-10-14'
    published_venue: ''
  ...
  - model: GIN
    ...
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.02485000000000004
    worse_than_at_pub: false
    surpassed_since_pub: true
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
    ...
    has_value_gap: true
    comparison_type: improved
    comparison_source_title: Rethinking pooling in graph neural networks
    comparison_source_arxiv: '2010.11418'
    is_best: false
    is_std_outlier: false
  - model: SoGCN-GRU
    model_key: sogcn-gru
  ...
  - model: GraphSAGE
    ...
    value_gap_source_date_iso: '2024-07-03'
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.0021200000000000108
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
...
- &id006
  ...
  - model: GatedGCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test split accuracy for PATTERN node classification
    date: Oct 14, 2021
    date_display: Oct 2021
    date_iso: '2021-10-14'
    published_venue: ''
    ...
    value_gap_source_title: IJCAI--23 Formatting Instructions
    value_gap_source_is_current_paper: false
    value_gap: 0.020279999999999965
    has_value_note: false
    value_note: ''
    sort_value: 0.86508
    sort_std: 0.00085
  ...
  - model: GAT
    ...
    value_gap_source_title: 'GCCM: Enhancing Generative Graph Prediction via Contrastive
      Consistency Model'
    value_gap_source_is_current_paper: false
    value_gap: 0.024469999999999992
    has_value_note: false
    value_note: ''
    sort_value: 0.78271
    sort_std: 0.00186
...
- &id002
  ...
  - model: APPNP
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node-level multi-label classification on ogbn-proteins
      test split.
    date: Oct 14, 2021
    date_display: Oct 2021
    date_iso: '2021-10-14'
...
main_figure: /figures/2110.07141/main_figure.jpegoptim.jpg
---
