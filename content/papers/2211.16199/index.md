...
- name: Pietro Lio
  orcid: null
  s2_author_id: '2267341660'
  s2_url: null
published_date: Nov 26, 2022
published_date_iso: '2022-11-26'
...
abstract: Graph Neural Networks usually rely on the assumption that the graph topology
  is available to the network as well as optimal for the downstream task. Latent graph
  inference allows models to dynamically learn the intrinsic graph structure of problems
  where the connectivity patterns of data may not be directly accessible. In this
  work, we generalize the discrete Differentiable Graph Module (dDGM) for latent graph
  learning. The original dDGM architecture used the Euclidean plane to encode latent
  features based on which the latent graphs were generated. By incorporating Riemannian
  geometry into the model and generating more complex embedding spaces, we can improve
  the performance of the latent graph inference system. In particular, we propose
  a computationally tractable approach to produce product manifolds of constant curvature
  model spaces that can encode latent features of varying structure. The latent representations
  mapped onto the inferred product manifold are used to compute richer similarity
  measures that are leveraged by the latent graph learning model to obtain optimized
  latent graphs. Moreover, the curvature of the product manifold is learned during
  training alongside the rest of the network parameters and based on the downstream
  task, rather than it being a static embedding space. Our novel approach is tested
  on a wide range of datasets, and outperforms the original dDGM model.
codebase_url: ''
...
- &id001
  ...
  - model: GCN
    ...
    protocol_note: Table reports results for 'Physics' and 'CS' datasets, which are
      not 'ogbn-products'.
    date: Nov 26, 2022
    ...
    is_std_outlier: false
  - model: GCN-dDGM-EHS
    model_key: gcn-ddgm-ehs
    model_plain: GCN-dDGM-EHS
    value: 0.9618
    std: 0.0031
    paper_value: 0.9618
    paper_std: 0.0031
    ...
    protocol_note: Standard homophilic dataset evaluation
    date: Nov 26, 2022
    date_display: Nov 2022
    date_iso: '2022-11-26'
    published_venue: ICLR 2022
    ...
    is_std_outlier: false
  - model: GCN-dDGM-H
    model_key: gcn-ddgm-h
    model_plain: GCN-dDGM-H
    value: 0.9606
    std: 0.0042
    paper_value: 0.9606
    paper_std: 0.0042
    ...
    is_std_outlier: false
  - model: GCN-dDGM-E
    model_key: gcn-ddgm-e
    model_plain: GCN-dDGM-E
    value: 0.9603
    std: 0.0041
    paper_value: 0.9603
    paper_std: 0.0041
  ...
  - model: MLP*
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: MLP* uses only pointcloud
    date: Nov 26, 2022
    date_display: Nov 2022
    date_iso: '2022-11-26'
    published_venue: ICLR 2022
    ...
    is_std_outlier: false
  - model: GCN-dDGM-S
    model_key: gcn-ddgm-s
    model_plain: GCN-dDGM-S
    value: 0.9591
    std: 0.0041
    paper_value: 0.9591
    paper_std: 0.0041
...
- &id003
  ...
  - model: MLP*
    ...
    is_std_outlier: false
  - model: GCN-dDGM*-EH
    model_key: gcn-ddgm*-eh
    model_plain: GCN-dDGM*-EH
    value: 0.8167
    std: 0.0705
    paper_value: 0.8167
    paper_std: 0.0705
    ...
    is_std_outlier: false
  - model: GCN-dDGM*-ES
    model_key: gcn-ddgm*-es
    model_plain: GCN-dDGM*-ES
    value: 0.8111
    std: 0.103
    paper_value: 0.8111
    paper_std: 0.103
    ...
    is_std_outlier: false
  - model: GCN-dDGM*-HS
    model_key: gcn-ddgm*-hs
    model_plain: GCN-dDGM*-HS
    value: 0.8111
    std: 0.0969
    paper_value: 0.8111
    paper_std: 0.0969
    ...
    is_std_outlier: false
  - model: GCN-dDGM*-EHH
    model_key: gcn-ddgm*-ehh
    model_plain: GCN-dDGM*-EHH
    value: 0.8111
    std: 0.0509
    paper_value: 0.8111
    paper_std: 0.0509
  ...
  - model: GCN
    ...
    is_std_outlier: false
  - model: GCN-dDGM*-HH
    model_key: gcn-ddgm*-hh
    model_plain: GCN-dDGM*-HH
    value: 0.7889
    std: 0.0853
    paper_value: 0.7889
    paper_std: 0.0853
    ...
    is_std_outlier: false
  - model: GCN-dDGM*-SS
    model_key: gcn-ddgm*-ss
    model_plain: GCN-dDGM*-SS
    value: 0.7389
    std: 0.0862
    paper_value: 0.7389
    paper_std: 0.0862
...
- &id002
  ...
  - model: GATv2
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification on OGB-Products
    date: Nov 26, 2022
    date_display: Nov 2022
    date_iso: '2022-11-26'
    published_venue: ICLR 2022
    ...
    is_std_outlier: false
  - model: GATv2-dDGM-E
    model_key: gatv2-ddgm-e
    model_plain: GATv2-dDGM-E
    value: 0.6659
    std: 0.003
    paper_value: 0.6659
    paper_std: 0.003
  ...
  - model: MLP
    ...
    is_std_outlier: false
  - model: GATv2-dDGM-EH
    model_key: gatv2-ddgm-eh
    model_plain: GATv2-dDGM-EH
    value: 0.6562
    std: 0.002
    paper_value: 0.6562
    paper_std: 0.002
    ...
    is_std_outlier: false
  - model: GATv2-dDGM-H
    model_key: gatv2-ddgm-h
    model_plain: GATv2-dDGM-H
    value: 0.6395
    std: 0.0042
    paper_value: 0.6395
    paper_std: 0.0042
