...
abstract: The emerging graph Transformers have achieved impressive performance for
  graph representation learning over graph neural networks (GNNs). In this work, we
  regard the self-attention mechanism, the core module of graph Transformers, as a
  two-step aggregation operation on a fully connected graph. Due to the property of
  generating positive attention values, the self-attention mechanism is equal to conducting
  a smooth operation on all nodes, preserving the low-frequency information. However,
  only capturing the low-frequency information is inefficient in learning complex
  relations of nodes on diverse graphs, such as heterophily graphs where the high-frequency
  information is crucial. To this end, we propose a Signed Attention-based Graph Transformer
  (SignGT) to adaptively capture various frequency information from the graphs. Specifically,
  SignGT develops a new signed self-attention mechanism (SignSA) that produces signed
  attention values according to the semantic relevance of node pairs. Hence, the diverse
  frequency information between different node pairs could be carefully preserved.
  Besides, SignGT proposes a structure-aware feed-forward network (SFFN) that introduces
  the neighborhood bias to preserve the local topology information. In this way, SignGT
  could learn informative node representations from both long-range dependencies and
  local topology information. Extensive empirical results on both node-level and graph-level
  tasks indicate the superiority of SignGT against state-of-the-art graph Transformers
  as well as advanced GNNs.
codebase_url: ''
...
- &id007
  ...
  - model: SignGT
    ...
    protocol_note: Node classification task on ACM dataset
    date: Oct 17, 2023
  ...
  - model: FAGCN
    ...
    at_pub_value: 0.9038
    at_pub_std: 0.0086
    at_pub_source_arxiv: '2303.07778'
    at_pub_source_title: 'GANN: Graph Alignment Neural Network for Semi-Supervised
      Learning'
    at_pub_source_date_iso: '2023-03-14'
    at_pub_source_date_label: '2023'
    value_gap_source_date_iso: '2023-10-17'
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.04489999999999994
    worse_than_at_pub: false
    surpassed_since_pub: false
    ...
    comparison_source_title: 'GANN: Graph Alignment Neural Network for Semi-Supervised
      Learning'
    comparison_source_arxiv: '2303.07778'
    is_best: true
    is_std_outlier: false
  - model: Specformer
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2023-10-17'
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.04080000000000006
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
- &id006
  ...
  - model: GPRGNN
    ...
    gap_vs_at_pub: 0.020600000000000007
  ...
  - model: GloGNN
    ...
    value_gap_source_date_iso: '2023-10-17'
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.013899999999999968
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: true
  ...
  - model: GCN
    ...
    value_gap_source_date_iso: '2021-01-04'
    value_gap_source_date_label: AAAI 2021
    gap_vs_at_pub: 0.014500000000000013
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: NodeFormer
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.022799999999999987
    has_value_note: false
    value_note: ''
    sort_value: 0.369
    sort_std: 0.01
  ...
  - model: SGC
    ...
    gap_vs_at_pub: 0.049299999999999955
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_title: Restructuring Graphs for Higher Homophily via Adaptive
      Spectral Clustering
    value_gap_source_is_current_paper: false
    value_gap: 0.049299999999999955
    has_value_note: false
    value_note: ''
    sort_value: 0.349
    sort_std: 0.007
...
- &id001
  ...
  - model: Specformer
    ...
    value_gap_source_title: 'NTFormer: A Composite Node Tokenized Graph Transformer
      for Node Classification'
    value_gap_source_is_current_paper: false
    value_gap: 0.012899999999999912
    has_value_note: false
    value_note: ''
    sort_value: 0.958
    sort_std: 0.0026
...
- &id005
  ...
  - model: GCN
    ...
    protocol_decision: standard
    protocol_note: Mean accuracy reported via 10-fold CV as per canonical task description.
    date: Oct 17, 2023
    date_display: Oct 2023
    date_iso: '2023-10-17'
    published_venue: ''
    ...
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.0868000000000001
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: Graphormer
    ...
    at_pub_value: 0.725
    at_pub_std: 0.021
    at_pub_source_arxiv: '2203.07678'
    at_pub_source_title: Incorporating Heterophily into Graph Neural Networks for
      Graph Classification
    at_pub_source_date_iso: '2022-03-15'
    at_pub_source_date_label: '2022'
    value_gap_source_date_iso: '2023-10-17'
    value_gap_source_date_label: '2023'
    ...
    has_value_gap: true
    comparison_type: improved
    comparison_source_title: Incorporating Heterophily into Graph Neural Networks
      for Graph Classification
    comparison_source_arxiv: '2203.07678'
    is_best: false
    is_std_outlier: false
  - model: SAT
    model_key: sat
  ...
  - model: Set2Set
    ...
    gap_vs_at_pub: 0.14260000000000006
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id003
  ...
  - model: SAT
    ...
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: fuzzy match to mutag (score=100)'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Mean accuracy reported in %; task is graph classification on Mutag.
    date: Oct 17, 2023
    date_display: Oct 2023
    date_iso: '2023-10-17'
    published_venue: ''
  ...
  - model: GraphSAGE
    ...
    has_value_gap: true
    comparison_type: behind
    comparison_source_title: Asynchronous Neural Networks for Learning in Graphs
    comparison_source_arxiv: '2205.12245'
    is_best: false
    is_std_outlier: false
  - model: GAT
    model_key: gat
  ...
  - model: SortPool
    ...
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.06820000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: Graphormer
    ...
    value_gap_source_date_iso: '2024-08-21'
    value_gap_source_date_label: NeurIPS 2024
    gap_vs_at_pub: 0.056499999999999995
    worse_than_at_pub: false
    surpassed_since_pub: true
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id004
  ...
  - model: GCN
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Mean accuracy reported for NCI1
    date: Oct 17, 2023
    date_display: Oct 2023
    date_iso: '2023-10-17'
    published_venue: ''
    ...
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.17590000000000006
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2022-02-21'
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.1635000000000001
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GraphSAGE
    ...
    gap_vs_at_pub: 0.04050000000000009
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- scope: graph-level
  ...
  - benchmark: TU Dortmund
    ...
    - dataset: COLLAB
      dataset_slug: collab
main_figure: /figures/2310.11025/main_figure.jpegoptim.jpg
---
