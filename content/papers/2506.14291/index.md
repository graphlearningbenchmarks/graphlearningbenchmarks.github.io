...
published_date_iso: '2025-06-17'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: 'Graph machine learning architectures are typically tailored to specific
  tasks on specific datasets, which hinders their broader applicability. This has
  led to a new quest in graph machine learning: how to build graph foundation models
  capable of generalizing across arbitrary graphs and features? In this work, we present
  a recipe for designing graph foundation models for node-level tasks from first principles.
  The key ingredient underpinning our study is a systematic investigation of the symmetries
  that a graph foundation model must respect. In a nutshell, we argue that label permutation-equivariance
  alongside feature permutation-invariance are necessary in addition to the common
  node permutation-equivariance on each local neighborhood of the graph. To this end,
  we first characterize the space of linear transformations that are equivariant to
  permutations of nodes and labels, and invariant to permutations of features. We
  then prove that the resulting network is a universal approximator on multisets that
  respect the aforementioned symmetries. Our recipe uses such layers on the multiset
  of features induced by the local neighborhood of the graph to obtain a class of
  graph foundation models for node property prediction. We validate our approach through
  extensive experiments on 29 real-world node classification datasets, demonstrating
  both strong zero-shot empirical performance and consistent improvement as the number
  of training graphs increases.'
...
- &id007
  ...
  - model: GraphAny
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Zero-shot accuracy on Chameleon using the standard split/task as
      per canonical definition.
    date: Jun 17, 2025
    date_display: Jun 2025
    date_iso: '2025-06-17'
    published_venue: ''
...
- &id001
  ...
  - model: GAT
    ...
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.23420000000000007
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id005
  ...
  - model: GAT
    ...
    gap_vs_at_pub: 0.12169999999999992
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id002
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split (Yang et al. 2016) as per dataset description.
    date: Jun 17, 2025
    date_display: Jun 2025
    date_iso: '2025-06-17'
    published_venue: ''
    ...
    value_gap_source_date_iso: '2025-05-19'
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.17210000000000003
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id012
  ...
  - model: MeanGNN
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: platonov2024criticallookevaluationgnns
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy on the questions dataset split.
    date: Jun 17, 2025
    date_display: Jun 2025
    date_iso: '2025-06-17'
    published_venue: ''
...
- &id010
  ...
  - model: TS-Mean
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Zero-shot evaluation on the official roman-empire split
    date: Jun 17, 2025
    date_display: Jun 2025
    date_iso: '2025-06-17'
    published_venue: ''
...
- &id008
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2022-06-06'
    value_gap_source_date_label: AAAI 2022
    gap_vs_at_pub: 0.18139999999999995
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id011
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: End-to-end training on the dataset split
    date: Jun 17, 2025
    date_display: Jun 2025
    date_iso: '2025-06-17'
    published_venue: ''
...
main_figure: /figures/2506.14291/main_figure.jpegoptim.jpg
---
