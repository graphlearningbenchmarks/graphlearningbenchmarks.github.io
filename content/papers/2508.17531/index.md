...
- name: Marcel Hoffmann
  orcid: null
  s2_author_id: '2216471764'
  s2_url: null
- name: Lukas Galke Poech
  orcid: null
  s2_author_id: '11220282'
  s2_url: null
- name: A. Scherp
  orcid: null
  s2_author_id: '1753135'
  s2_url: null
published_date: Aug 24, 2025
published_date_iso: '2025-08-24'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: Graph homophily has been considered an essential property for message-passing
  neural networks (MPNN) in node classification. Recent findings suggest that performance
  is more closely tied to the consistency of neighborhood class distributions. We
  demonstrate that the MPNN performance depends on the number of components of the
  overall neighborhood distribution within a class. By breaking down the classes into
  their neighborhood distribution components, we increase measures of neighborhood
  distribution informativeness but do not observe an improvement in MPNN performance.
  We propose a Gumbel-Softmax-based rewiring method that reduces deviations in neighborhood
  distributions. Our results show that our new method enhances neighborhood informativeness,
  handles long-range dependencies, mitigates oversquashing, and increases the classification
  performance of the MPNN. The code is available at.
...
- &id002
  ...
  - model: MLP
    ...
    gap_vs_at_pub: 0.03760000000000002
  ...
  - model: GAT
    ...
    is_std_outlier: false
  - model: SDRF with GCN
    model_key: sdrf with gcn
    model_plain: SDRF with GCN
    value: 0.3515
    std: 0.0005
    paper_value: 0.3515
    paper_std: 0.0005
  ...
  - model: GIN
    ...
    is_best: false
    is_std_outlier: false
  - model: GCN with DropEdge
    model_key: gcn with dropedge
    model_plain: GCN with DropEdge
    value: 0.3359
    std: 0.001
    paper_value: 0.3359
    paper_std: 0.001
...
- &id004
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on heterophilic dataset Amazon-ratings
    date: Aug 24, 2025
    date_display: Aug 2025
    date_iso: '2025-08-24'
    published_venue: ''
  ...
  - model: GCN
    ...
    value_gap_source_date_iso: '2026-05-18'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.04150000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id001
  ...
  - model: GraphSAGE
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification on CiteSeer using Planetoid split.
    date: Aug 24, 2025
    date_display: Aug 2025
    date_iso: '2025-08-24'
    published_venue: ''
...
- &id005
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Minesweeper dataset
    date: Aug 24, 2025
    date_display: Aug 2025
    date_iso: '2025-08-24'
    published_venue: ''
...
- &id007
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on heterophilic dataset Questions
    date: Aug 24, 2025
    date_display: Aug 2025
    date_iso: '2025-08-24'
    published_venue: ''
  ...
  - model: GAT
    ...
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.048899999999999944
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.048899999999999944
    has_value_note: false
    value_note: ''
    sort_value: 0.7743
    sort_std: 0.012
...
- &id003
  ...
  - model: GraphSAGE
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on the Roman-Empire dataset
    date: Aug 24, 2025
    date_display: Aug 2025
    date_iso: '2025-08-24'
    published_venue: ''
...
- &id006
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on heterophilic dataset Tolokers
    date: Aug 24, 2025
    date_display: Aug 2025
    date_iso: '2025-08-24'
    published_venue: ''
    ...
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.0344000000000001
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
single_proposed_model: Gumbel-MPNN
main_figure: /figures/2508.17531/main_figure.jpegoptim.jpg
---
