...
- name: Asiri Wijesinghe
  orcid: null
  s2_author_id: '9120994'
  s2_url: null
- name: Hao Zhu
  orcid: null
  s2_author_id: '2289122696'
  s2_url: null
- name: Piotr Koniusz
  orcid: null
  s2_author_id: '2288276495'
  s2_url: null
...
abstract: 'Traditional Graph Self-Supervised Learning (GSSL) struggles to capture
  complex structural properties well. This limitation stems from two main factors:
  (1) the inadequacy of conventional Graph Neural Networks (GNNs) in representing
  sophisticated topological features, and (2) the focus of self-supervised learning
  solely on final graph representations. To address these issues, we introduce GenHopNet,
  a GNN framework that integrates a $k$-hop message-passing scheme, enhancing its
  ability to capture local structural information without explicit substructure extraction.
  We theoretically demonstrate that GenHopNet surpasses the expressiveness of the
  classical Weisfeiler-Lehman (WL) test for graph isomorphism. Furthermore, we propose
  a structural- and positional-aware GSSL framework that incorporates topological
  information throughout the learning process. This approach enables the learning
  of representations that are both sensitive to graph topology and invariant to specific
  structural and feature augmentations. Comprehensive experiments on graph classification
  datasets, including those designed to test structural sensitivity, show that our
  method consistently outperforms the existing approaches and maintains computational
  efficiency. Our work significantly advances GSSL''s capability in distinguishing
  graphs with similar local structures but different global topologies.'
...
- &id004
  ...
  - model: GIN
    ...
    protocol_note: 10-fold cross-validation, best mean accuracy reported
    date: Feb 22, 2025
  ...
  - model: WL-PM
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: nikolentzos2017matching
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold cross-validation, best mean accuracy reported
...
- &id009
  ...
  - model: GCN
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold cross-validation on isomorphism classes
    date: Feb 22, 2025
    date_display: Feb 2025
    date_iso: '2025-02-22'
    published_venue: WWW 2025
  ...
  - model: GCN-RNI
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: abboud2020surprising
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold cross-validation on isomorphism classes
...
- &id001
  ...
  - model: GCS
    ...
    at_pub_value: 0.9045
    at_pub_std: 0.0081
    at_pub_source_arxiv: '2410.10365'
    at_pub_source_title: 'SpeGCL: Self-supervised Graph Spectrum Contrastive Learning
  ...
  - model: G3N
    ...
    is_std_outlier: false
  - model: GraphCL+HTML
    model_key: graphcl+html
    model_plain: GraphCL+HTML
    value: 0.889
    std: 0.018
    paper_value: 0.889
    paper_std: 0.018
...
- &id008
  ...
  - model: GraphSNN
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: wijesinghe2021new
    variant_inference_reason: 'dataset: fuzzy match to ogbg-moltox21 (score=79)'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold cross-validation on OGB dataset
    date: Feb 22, 2025
    date_display: Feb 2025
    date_iso: '2025-02-22'
    published_venue: WWW 2025
    ...
    gap_vs_at_pub: 0.26839999999999997
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: DSS-GNN (EGO+)
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: bevilacquaequivariant
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold cross-validation on OGB dataset
  ...
  - model: Policy-Learn
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: bevilacquaefficient
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold cross-validation on OGB dataset
...
- &id007
  ...
  - model: StructPosGSSL-FA
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold cross-validation on OGB protein-protein association network
    date: Feb 22, 2025
    date_display: Feb 2025
    date_iso: '2025-02-22'
    published_venue: WWW 2025
  ...
  - model: GraphSNN
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: Wijesinghe et al. 2021
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold cross-validation on OGB protein-protein association network
...
- scope: graph-level
  ...
  - benchmark: GNNBenchmark
    ...
    - dataset: CSL
      dataset_slug: csl
main_figure: /figures/2502.16233/main_figure.jpegoptim.jpg
---
