...
- &id003
  ...
  - model: MoCL-DK-G(CL)
    ...
    protocol_note: Linear Protocol (test set results)
    date: Jun 5, 2021
...
- &id004
  ...
  - model: InfoGraph
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Semi-supervised Protocol
    date: Jun 5, 2021
    date_display: Jun 2021
    date_iso: '2021-06-05'
    published_venue: KDD 2021
  ...
  - model: MICRO-Graph
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Linear Protocol (linear evaluation on pretrained representations)
    date: Jun 5, 2021
    date_display: Jun 2021
    date_iso: '2021-06-05'
    published_venue: KDD 2021
...
- &id001
  ...
  - model: MoCL-DK-G(CL)
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Semi-supervised Protocol (test AUC)
    date: Jun 5, 2021
    date_display: Jun 2021
    date_iso: '2021-06-05'
    published_venue: KDD 2021
...
- &id005
  ...
  - model: MoCL-DK-G(CL)
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Linear Protocol (test set evaluation)
    date: Jun 5, 2021
    date_display: Jun 2021
    date_iso: '2021-06-05'
    published_venue: KDD 2021
...
- &id002
  ...
  - model: scratch
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Linear evaluation protocol on Tox21
    date: Jun 5, 2021
    date_display: Jun 2021
    date_iso: '2021-06-05'
    published_venue: KDD 2021
  ...
  - model: InfoGraph
    ...
    is_std_outlier: false
  - model: MoCL-DK-G(LS)
    model_key: mocl-dk-g(ls)
    model_plain: MoCL-DK-G(LS)
    value: 0.777
    std: null
    paper_value: 0.777
    paper_std: null
...
- &id006
  ...
  - model: ContextPred
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Linear Protocol (test set AUC)
    date: Jun 5, 2021
    date_display: Jun 2021
    date_iso: '2021-06-05'
    published_venue: KDD 2021
