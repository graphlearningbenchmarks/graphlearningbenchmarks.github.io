...
- name: Jingzhe Liu
  orcid: null
  s2_author_id: '2282543720'
  s2_url: null
- name: Yu Song
  orcid: null
  s2_author_id: '2298357027'
  s2_url: null
- name: Bingheng Li
  orcid: null
...
published_date_iso: '2024-06-15'
published_venue: NeurIPS 2024
published_conference: NeurIPS 2024
published_conference_short: NeurIPS
published_conference_slug: neurips
abstract: Given the ubiquity of graph data and its applications in diverse domains,
  building a Graph Foundation Model (GFM) that can work well across different graphs
  ...
  domains often exhibit diverse node features. Inspired by multi-modal models that
  align different modalities with natural language, the text has recently been adopted
  to provide a unified feature space for diverse graphs. Despite the great potential
  of these text-space GFMs, current research in this field is hampered by two problems.
  First, the absence of a comprehensive benchmark with unified problem settings hinders
  a clear understanding of the comparative effectiveness and practical value of different
  text-space GFMs. Second, there is a lack of sufficient datasets to thoroughly explore
  the methods' full potential and verify their effectiveness across diverse settings.
  To address these issues, we conduct a comprehensive benchmark providing novel text-space
  datasets and comprehensive evaluation under unified problem settings. Empirical
  results provide new insights and inspire future research directions. Our code and
...
- &id005
  ...
  - model: GCN
    ...
    protocol_note: ST (training on a single graph from scratch) split
    date: Jun 15, 2024
    ...
    gap_vs_at_pub: 0.02290000000000003
  ...
  - model: mpnet
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard evaluation of LLM encoder
    date: Jun 15, 2024
    date_display: Jun 2024
    date_iso: '2024-06-15'
    published_venue: NeurIPS 2024
  ...
  - model: Single
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard split (implied by comparison to Table 1)
    date: Jun 15, 2024
    date_display: Jun 2024
    date_iso: '2024-06-15'
    published_venue: NeurIPS 2024
...
- &id004
  ...
  - model: GCN
    ...
    value_gap_source_date_iso: '2026-05-18'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.12339999999999995
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: mpnet
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard evaluation of LLM encoders
    date: Jun 15, 2024
    date_display: Jun 2024
    date_iso: '2024-06-15'
    published_venue: NeurIPS 2024
  ...
  - model: Single
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard configuration (implied by comparison to Table 1/4)
    date: Jun 15, 2024
    date_display: Jun 2024
    date_iso: '2024-06-15'
    published_venue: NeurIPS 2024
...
- &id009
  ...
  - model: OFA
    ...
    protocol_decision: standard
    protocol_note: Scaffold split as per canonical record
    date: Jun 15, 2024
    date_display: Jun 2024
    date_iso: '2024-06-15'
    published_venue: NeurIPS 2024
    ...
    is_std_outlier: false
  - model: Single (Atom)
    model_key: single (atom)
    model_plain: Single (Atom)
    value: 0.724
    std: null
    paper_value: 0.724
    paper_std: null
...
- &id010
  ...
  - model: OFA
    ...
    is_std_outlier: false
  - model: Single (Text)
    model_key: single (text)
    model_plain: Single (Text)
    value: 0.6771
    std: null
    paper_value: 0.6771
    paper_std: null
...
- &id002
  ...
  - model: GraphMAE
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: ST (training on a single graph from scratch) on Planetoid split.
    date: Jun 15, 2024
    date_display: Jun 2024
    date_iso: '2024-06-15'
    published_venue: NeurIPS 2024
...
- &id001
  ...
  - model: GraphMAE
    ...
    value_gap_source_date_label: NeurIPS 2024
    gap_vs_at_pub: 0.044499999999999984
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_title: 'HC-GAE: The Hierarchical Cluster-based Graph Auto-Encoder
      for Graph Representation Learning'
    value_gap_source_is_current_paper: false
    value_gap: 0.044499999999999984
    has_value_note: false
    value_note: ''
    sort_value: 0.8545
    sort_std: 0.004
  ...
  - model: mpnet
    ...
    protocol_note: LLM encoder performance comparison; split not specified.
    date: Jun 15, 2024
    date_display: Jun 2024
    date_iso: '2024-06-15'
    published_venue: NeurIPS 2024
...
- &id003
  ...
  - model: mpnet
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split (fixed split) as per canonical definition for node
      classification on Pubmed.
    date: Jun 15, 2024
    date_display: Jun 2024
    date_iso: '2024-06-15'
    published_venue: NeurIPS 2024
...
- &id011
  ...
  - model: OFA
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Standard graph classification task on TOXCAST using the original
      split; uses LLM-generated text features.
    date: Jun 15, 2024
    date_display: Jun 2024
    date_iso: '2024-06-15'
    published_venue: NeurIPS 2024
...
- &id006
  ...
  - model: mpnet
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification task on WikiCS using the original
      split as per paper setup.
    date: Jun 15, 2024
    date_display: Jun 2024
    date_iso: '2024-06-15'
    published_venue: NeurIPS 2024
...
- &id007
  ...
  - model: Single
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard training ratio configuration.
    date: Jun 15, 2024
    date_display: Jun 2024
    date_iso: '2024-06-15'
    published_venue: NeurIPS 2024
  ...
  - model: mpnet
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification using LLM encoder mpnet.
    date: Jun 15, 2024
    date_display: Jun 2024
    date_iso: '2024-06-15'
    published_venue: NeurIPS 2024
  ...
  - model: minilm
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification using LLM encoder minilm.
    date: Jun 15, 2024
    date_display: Jun 2024
    date_iso: '2024-06-15'
    published_venue: NeurIPS 2024
...
main_figure: /figures/2406.10727/main_figure.jpegoptim.jpg
---
