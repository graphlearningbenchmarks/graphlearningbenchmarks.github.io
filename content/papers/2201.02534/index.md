...
published_date_iso: '2022-01-07'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: We introduce a novel masked graph autoencoder (MGAE) framework to perform
  effective learning on graph structure data. Taking insights from self-supervised
  learning, we randomly mask a large proportion of edges and try to reconstruct these
  missing edges during training. MGAE has two core designs. First, we find that masking
  a high ratio of the input graph structure, e.g., $70\ Second, we employ a graph
  neural network (GNN) as an encoder to perform message propagation on the partially-masked
  graph. To reconstruct the large number of masked edges, a tailored cross-correlation
  decoder is proposed. It could capture the cross-correlation between the head and
  tail nodes of anchor edge in multi-granularity. Coupling these two designs enables
  MGAE to be trained efficiently and effectively. Extensive experiments on multiple
  open datasets (Planetoid and OGB benchmarks) demonstrate that MGAE generally performs
  better than state-of-the-art unsupervised learning competitors on link prediction
...
- &id001
  ...
  - model: MGAE-GCN
    ...
    value_gap_source_date_iso: '2022-01-07'
    ...
    true_value: 0.5474
    true_std: 0.0106
    value_gap_source_arxiv: '2201.02534'
    value_gap_source_title: 'MGAE: Masked Autoencoders for Self-Supervised Learning
      on Graphs'
  ...
  - model: MLP
    ...
    is_std_outlier: false
  - model: SelfTask-GNN
    model_key: selftask-gnn
    model_plain: SelfTask-GNN
    value: 0.3303
    std: 0.0511
    paper_value: 0.3303
    paper_std: 0.0511
...
main_figure: /figures/2201.02534/main_figure.jpegoptim.jpg
---
