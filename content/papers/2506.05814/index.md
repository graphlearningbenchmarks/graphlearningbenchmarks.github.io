...
- PiPE
- PiPE (VC) [DE-based]
- PiPE (RePHINE) [DE-based]
- PiPE (VC) [RW-based]
- PiPE (RePHINE) [RW-based]
- PiPE (VC) [SignNet-based]
- PiPE (RePHINE) [SignNet-based]
- PiPE (VC) [SPE-based]
...
- &id001
  ...
  - model: PiPE (RePHINE) [SPE-based]
    ...
    model_plain: PiPE (RePHINE) [SPE-based]
    value: 0.0588
    std: 0.007
    paper_value: 0.0588
    paper_std: 0.007
    ...
    protocol_note: Standard ZINC graph regression task using the full dataset split.
    date: Jun 6, 2025
    ...
    true_value: 0.0588
    true_std: 0.007
    value_gap_source_arxiv: '2506.05814'
    value_gap_source_title: Positional Encoding meets Persistent Homology on Graphs
    ...
    is_best: false
    is_std_outlier: false
  - model: PiPE (VC) [SPE-based]
    model_key: pipe (vc) [spe-based]
    model_plain: PiPE (VC) [SPE-based]
    value: 0.0599
    std: 0.01
    paper_value: 0.0599
    paper_std: 0.01
...
- &id002
  ...
  - model: PiPE
    ...
    is_best: false
    is_std_outlier: false
  - model: PiPE (RePHINE) with SPE
    model_key: pipe (rephine) with spe
    model_plain: PiPE (RePHINE) with SPE
    value: 0.791
    std: 0.003
    paper_value: 0.791
    paper_std: 0.003
    ...
    is_best: false
    is_std_outlier: false
  - model: PiPE (VC) with SPE
    model_key: pipe (vc) with spe
    model_plain: PiPE (VC) with SPE
    value: 0.785
    std: 0.005
    paper_value: 0.785
    paper_std: 0.005
