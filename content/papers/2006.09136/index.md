...
codebase_url: https://github.com/Shen-Lab/SS-GCNs
...
- &id001
  ...
  - model: GMNN
    ...
    is_std_outlier: false
  - model: GraphMix+Par
    model_key: graphmix+par
    model_plain: GraphMix+Par
    value: 0.8136
    std: 0.0033
    paper_value: 0.8136
    paper_std: 0.0033
    ...
    true_value: 0.8136
    true_std: 0.0033
    value_gap_source_arxiv: '2006.09136'
    value_gap_source_title: When Does Self-Supervision Help Graph Convolutional Networks?
  ...
  - model: GMNN+Par
    ...
    is_std_outlier: false
  - model: GraphMix+Comp
    model_key: graphmix+comp
    model_plain: GraphMix+Comp
    value: 0.8082
    std: 0.0054
    paper_value: 0.8082
    paper_std: 0.0054
  ...
  - model: GCN+Par
    ...
    is_std_outlier: false
  - model: GraphMix+Clu
    model_key: graphmix+clu
    model_plain: GraphMix+Clu
    value: 0.7999
    std: 0.0082
    paper_value: 0.7999
    paper_std: 0.0082
...
- scope: node-level
  ...
  - benchmark: Classic
    ...
    - dataset: PubMed
      dataset_slug: pubmed
main_figure: /figures/2006.09136/main_figure.jpegoptim.jpg
---
