...
abstract: We propose a novel class of graph neural networks based on the discretised
  Beltrami flow, a non-Euclidean diffusion PDE. In our model, node features are supplemented
  with positional encodings derived from the graph topology and jointly evolved by
  the Beltrami flow, producing simultaneously continuous feature learning and topology
  evolution. The resulting model generalises many popular graph neural networks and
  achieves state-of-the-art results on several benchmarks.
codebase_url: https://github.com/twitter-research/graph-neural-pde
...
- &id003
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: test accuracy using random splits
    date: Oct 18, 2021
    date_display: Oct 2021
    date_iso: '2021-10-18'
    published_venue: NeurIPS 2021
  ...
  - model: GAT-ppr
    ...
    is_std_outlier: false
  - model: GS-maxpool
    model_key: gs-maxpool
    model_plain: GS-maxpool
    value: 0.904
    std: 0.013
    paper_value: 0.904
    paper_std: 0.013
...
- &id001
  ...
  - model: GODE
    ...
    is_std_outlier: false
  - model: AdaLanczos
    model_key: adalanczos
    model_plain: AdaLanczos
    value: 0.687
    std: 0.01
    paper_value: 0.687
    paper_std: 0.01
...
main_figure: /figures/2110.09443/main_figure.jpegoptim.jpg
---
