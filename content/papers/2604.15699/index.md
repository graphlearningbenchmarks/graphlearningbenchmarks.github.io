...
- name: Guanfeng Liu
  orcid: null
  s2_author_id: '47061818'
  s2_url: null
- name: Qiang Hu
  orcid: null
  s2_author_id: '2400659760'
  s2_url: null
- name: Yan Wang
  orcid: null
  s2_author_id: null
...
abstract: Graph self-supervised learning (GSSL) alleviates the graph data labeling
  bottleneck without supervision, enabling wide application in domains like recommendation
  systems and social network analysis. High-frequency signals are valuable in GSSL
  for capturing local structural preferences, thereby enriching graph representations
  and boosting model performance. However, in practical applications, two critical
  problems hinder the efficient and robust use of these signals. First, the locality
  of high-frequency signals limits their full utilization by the model. Second, over-reliance
  on specific high-frequency signals will affect the model's generalization. To address
  the above problems, we propose the Frequency-Corrupt Based Graph Self-Supervised
  Learning (FC-GSSL) algorithm. Specifically, we generate corrupted graphs biased
  toward high-frequency signals by corrupting nodes and edges according to their low-frequency
  contributions. These corrupted graphs are fed as input to an autoencoder, with low-frequency
  and general features serving as the supervision. This compels the model to effectively
  fuse high- and low-frequency signals, thereby integrating and utilizing more valuable
  high-frequency information. Additionally, we design multiple sampling strategies
  and form diverse corrupted graphs based on the intersections and union between the
  results obtained from these strategies. By aligning the node representations from
  these views, the model can identify valuable frequency combinations, which helps
  reduce the negative impact of specific high-frequency components and improve generalization.
  FC-GSSL optimizes the design of GSSL for web applications, significantly improving
  model performance on complex web-related graphs, such as social networks and citation
  networks. This work makes a direct contribution to advancing the "Graph Algorithms
  and Modeling for the Web" research track. Experimental results on 14 datasets across
  multiple tasks illustrate the superiority of the proposed approach.
...
- &id001
  ...
  - model: FC-GSSL
    ...
    protocol_note: Node classification on Actor dataset using mean accuracy.
    date: Apr 17, 2026
  ...
  - model: CCA-SSG
    ...
    gap_vs_at_pub: 0.07070000000000004
  ...
  - model: MVGRL
    ...
    value_gap_source_date_iso: '2026-04-17'
    value_gap_source_date_label: WWW 2026
    gap_vs_at_pub: 0.025499999999999967
    worse_than_at_pub: false
    surpassed_since_pub: false
  ...
  - model: MaskGAE
    ...
    value_gap_source_date_iso: '2026-04-17'
    value_gap_source_date_label: WWW 2026
    gap_vs_at_pub: 0.07119999999999999
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: GraphMAE
    ...
    value_gap_source_date_iso: '2026-04-17'
    value_gap_source_date_label: WWW 2026
    gap_vs_at_pub: 0.031799999999999995
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: DGI
    ...
    value_gap_source_date_iso: '2026-04-02'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.041100000000000025
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_title: 'ASPECT: Node-Level Adaptive Spectral Fusion for Graph
      Contrastive Learning'
    value_gap_source_is_current_paper: false
    value_gap: 0.041100000000000025
    has_value_note: false
    value_note: ''
    sort_value: 0.3209
    sort_std: 0.0118
...
- &id002
  ...
  - model: FC-GSSL
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Chameleon using standard split (Geom-GCN
      10 fixed splits).
    date: Apr 17, 2026
    date_display: Apr 2026
    date_iso: '2026-04-17'
  ...
  - model: BGRL
    ...
    value_gap_source_date_iso: '2025-06-24'
    value_gap_source_date_label: KDD 2025
    gap_vs_at_pub: 0.0361999999999999
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: VGAE
    ...
    value_gap_source_date_iso: '2026-04-17'
    value_gap_source_date_label: WWW 2026
    gap_vs_at_pub: 0.19669999999999999
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
- &id004
  ...
  - model: GraphPAE
    ...
    protocol_decision: standard
    protocol_note: Regression task on OGB molfreesolv dataset
    date: Apr 17, 2026
    date_display: Apr 2026
    date_iso: '2026-04-17'
    published_venue: WWW 2026
    ...
    at_pub_value: 2.058
    at_pub_std: 0.19
    at_pub_source_arxiv: '2505.23345'
    at_pub_source_title: Graph Positional Autoencoders as Self-supervised Learners
...
- &id003
  ...
  - model: FC-GSSL
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Squirrel dataset using mean accuracy.
    date: Apr 17, 2026
    date_display: Apr 2026
    date_iso: '2026-04-17'
    published_venue: WWW 2026
  ...
  - model: AUG-MAE
    ...
    value_gap_source_date_iso: '2026-04-17'
    value_gap_source_date_label: WWW 2026
    gap_vs_at_pub: 0.09340000000000004
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: GraphMAE
    ...
    value_gap_source_date_iso: '2026-04-17'
    value_gap_source_date_label: WWW 2026
    gap_vs_at_pub: 0.16219999999999996
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: MVGRL
    ...
    value_gap_source_date_iso: '2026-04-17'
    value_gap_source_date_label: WWW 2026
    gap_vs_at_pub: 0.21339999999999998
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: VGAE
    ...
    value_gap_source_date_iso: '2026-04-17'
    value_gap_source_date_label: WWW 2026
    gap_vs_at_pub: 0.07389999999999997
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
- &id006
  ...
  - model: BGRL
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Large Graphs split
    date: Apr 17, 2026
    date_display: Apr 2026
    date_iso: '2026-04-17'
    published_venue: WWW 2026
...
single_proposed_model: FC-GSSL
main_figure: /figures/2604.15699/main_figure.jpegoptim.jpg
---
