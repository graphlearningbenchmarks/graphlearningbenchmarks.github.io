...
- name: Shouheng Li
  orcid: null
  s2_author_id: '122616351'
  s2_url: null
- name: Dongwoo Kim
  orcid: null
  s2_author_id: '2111896065'
  s2_url: null
- name: Qing Wang
  orcid: null
  s2_author_id: '2117944930'
  s2_url: null
...
abstract: 'While a growing body of literature has been studying new Graph Neural Networks
  (GNNs) that work on both homophilic and heterophilic graphs, little has been done
  on adapting classical GNNs to less-homophilic graphs. Although the ability to handle
  less-homophilic graphs is restricted, classical GNNs still stand out in several
  nice properties such as efficiency, simplicity, and explainability. In this work,
  we propose a novel graph restructuring method that can be integrated into any type
  of GNNs, including classical GNNs, to leverage the benefits of existing GNNs while
  alleviating their limitations. Our contribution is threefold: [label= *)] learning
  the weight of pseudo-eigenvectors for an adaptive spectral clustering that aligns
  well with known node labels, proposing a new density-aware homophilic metric that
  is robust to label imbalance, and reconstructing the adjacency matrix based on the
  result of adaptive spectral clustering to maximize homophilic scores. The experimental
  results show that our graph restructuring method can significantly boost the performance
  of six classical GNNs by an average of 25\'
...
- &id003
  ...
  - model: BernNet
    ...
    gap_vs_at_pub: 0.06610000000000005
  ...
  - model: APPNP
    ...
    gap_vs_at_pub: 0.03860000000000002
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GAT
    ...
    gap_vs_at_pub: 0.05099999999999999
    worse_than_at_pub: false
    surpassed_since_pub: false
  ...
  - model: SGC
    ...
    is_std_outlier: false
  - model: GPRGNN (GDC)
    model_key: gprgnn (gdc)
    model_plain: GPRGNN (GDC)
    value: 0.344
    std: 0.01
    paper_value: 0.344
    paper_std: 0.01
...
- &id004
  ...
  - model: BernNet
    ...
    value_gap_source_date_label: ICML 2024
    gap_vs_at_pub: 0.06289999999999996
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id002
  ...
  - model: ARMA
    ...
    gap_vs_at_pub: 0.04519999999999991
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GCN
    ...
    value_gap_source_date_label: TMLR 2025
    gap_vs_at_pub: 0.13419999999999999
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
- &id005
  ...
  - model: H2GCN
    ...
    gap_vs_at_pub: 0.08989999999999998
    worse_than_at_pub: false
    surpassed_since_pub: true
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: GCN
    ...
    value_gap_source_title: Understanding Heterophily for Graph Neural Networks
    value_gap_source_is_current_paper: false
    value_gap: 0.049699999999999966
    has_value_note: false
    value_note: ''
    sort_value: 0.6067
    sort_std: null
  ...
  - model: GPRGNN
    ...
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.01930000000000004
    worse_than_at_pub: false
    surpassed_since_pub: true
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id001
  ...
  - model: BernNet
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification on Texas split
    date: Jun 6, 2022
    date_display: Jun 2022
    date_iso: '2022-06-06'
    published_venue: AAAI 2022
  ...
  - model: APPNP
    ...
    value_gap_source_date_iso: '2023-10-18'
    value_gap_source_date_label: WWW 2023
    gap_vs_at_pub: 0.10339999999999994
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id006
  ...
  - model: GCN
    ...
    value_gap_source_date_iso: '2022-06-06'
    value_gap_source_date_label: AAAI 2022
    gap_vs_at_pub: 0.21339999999999992
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
main_figure: /figures/2206.02386/main_figure.jpegoptim.jpg
---
