...
- &id006
  ...
  - model: GPS
    ...
    protocol_note: Test F1 on COCO-SP standard split
    date: May 20, 2024
...
- &id002
  ...
  - model: LGI-GT
    ...
    table_ref: Table 1
    source_ref: lgi-gt
    variant_inference_reason: 'dataset: fuzzy match to ogbg-code2 (score=95)'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Test F1 on official OGB split
    date: May 20, 2024
    date_display: May 2024
    date_iso: '2024-05-20'
    published_venue: ICLR 2024
...
- &id005
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test F1 on PascalVOC-SP standard split
    date: May 20, 2024
    date_display: May 2024
    date_iso: '2024-05-20'
    published_venue: ICLR 2024
...
- &id004
  ...
  - model: GCN
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Test AP on Peptides-func standard split
    date: May 20, 2024
    date_display: May 2024
    date_iso: '2024-05-20'
    published_venue: ICLR 2024
...
- &id003
  ...
  - model: GCN
    ...
    protocol_decision: standard
    protocol_note: Test MAE on Peptides-struct standard split
    date: May 20, 2024
    date_display: May 2024
    date_iso: '2024-05-20'
    published_venue: ICLR 2024
...
- &id001
  ...
  - model: GatedGCN-VN
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: OGB scaffold split; Test AP averaged across all 128 tasks.
    date: May 20, 2024
    date_display: May 2024
    date_iso: '2024-05-20'
    published_venue: ICLR 2024
  ...
  - model: GCN
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.020700000000000024
    has_value_note: false
    value_note: ''
    sort_value: 0.269
    sort_std: 0.002
