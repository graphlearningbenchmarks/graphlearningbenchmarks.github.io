...
- &id002
  ...
  - model: C (orthogonal)
    ...
    is_best: false
    is_std_outlier: false
  - model: Enhanced GCNII
    model_key: enhanced gcnii
    model_plain: Enhanced GCNII
    value: 0.8166
    std: null
    paper_value: 0.8166
    paper_std: null
    ...
    protocol_note: Node classification performance on the Computers dataset.
    date: Feb 7, 2024
    ...
    true_value: 0.8166
    true_std: null
    value_gap_source_arxiv: '2402.04621'
    value_gap_source_title: 'Feature Distribution on Graph Topology Mediates the Effect
      of Graph Convolution: Homophily Perspective'
    ...
    is_std_outlier: false
  - model: Vanila GCNII
    model_key: vanila gcnii
    model_plain: Vanila GCNII
    value: 0.811
    std: null
    paper_value: 0.811
    paper_std: null
...
- &id001
  ...
  - model: Enhanced GCNII
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification performance reported in Table 3.
    date: Feb 7, 2024
    date_display: Feb 2024
    date_iso: '2024-02-07'
    published_venue: ICML 2024
...
- &id003
  ...
  - model: Enhanced GCNII
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification performance on Physics dataset
    date: Feb 7, 2024
    date_display: Feb 2024
    date_iso: '2024-02-07'
    published_venue: ICML 2024
...
- scope: node-level
  ...
  - benchmark: Heterogeneous Graph Benchmarks
    ...
    - dataset: DBLP
      dataset_slug: dblp
main_figure: /figures/2402.04621/main_figure.jpegoptim.jpg
---
