...
- name: Erkan Turan
  orcid: null
  s2_author_id: '2371073035'
  s2_url: null
- name: Gaspard Abel
  orcid: null
  s2_author_id: '2367190914'
  s2_url: null
- name: M. Behmanesh
  orcid: null
...
published_date_iso: '2026-02-17'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: Graph Neural Networks (GNNs) learn node representations through iterative
  network-based message-passing. While powerful, deep GNNs suffer from oversmoothing,
  where node features converge to a homogeneous, non-informative state. We re-frame
  this problem of representational collapse from a bifurcation theory perspective,
  characterizing oversmoothing as convergence to a stable ``homogeneous fixed point.''
  Our central contribution is the theoretical discovery that this undesired stability
  can be broken by replacing standard monotone activations (e.g., ReLU) with a class
  of functions. Using Lyapunov-Schmidt reduction, we analytically prove that this
  substitution induces a bifurcation that destabilizes the homogeneous state and creates
  a new pair of stable, non-homogeneous patterns that provably resist oversmoothing.
  Our theory predicts a precise, nontrivial scaling law for the amplitude of these
  emergent patterns, which we quantitatively validate in experiments. Finally, we
  demonstrate the practical utility of our theory by deriving a closed-form, bifurcation-aware
  initialization and showing its utility in real benchmark experiments.
codebase_url: ''
...
- &id005
  ...
  - model: GCN
    ...
    protocol_note: Node classification on Computers dataset using standard split
    date: Feb 17, 2026
...
- &id004
  ...
  - model: GRAND
    ...
    value_gap_source_date_iso: '2025-04-22'
    value_gap_source_date_label: WWW 2025
    gap_vs_at_pub: 0.11149999999999993
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id009
  ...
  - model: GAT
    ...
    gap_vs_at_pub: 0.25339999999999996
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GRAND
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.030500000000000083
    has_value_note: false
    value_note: ''
    sort_value: 0.5772
    sort_std: 0.0186
...
- &id003
  ...
  - model: CGNN
    ...
    value_gap_source_date_iso: '2026-02-17'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.06410000000000005
    worse_than_at_pub: false
    surpassed_since_pub: false
  ...
  - model: GRAND
    ...
    gap_vs_at_pub: 0.001100000000000101
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id006
  ...
  - model: CGNN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard split for CoauthorCS node classification
    date: Feb 17, 2026
    date_display: Feb 2026
    date_iso: '2026-02-17'
    published_venue: ''
...
- &id008
  ...
  - model: GREAD
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard split for Cornell node classification (Geom-GCN 10 fixed
      splits).
    date: Feb 17, 2026
    date_display: Feb 2026
    date_iso: '2026-02-17'
    ...
    has_value_gap: true
    comparison_type: behind
    comparison_source_title: Graph Neural Reaction Diffusion Models Submitted to the
      editors June 2023. Accepted in March 2024.
    comparison_source_arxiv: '2406.10871'
    is_best: false
    is_std_outlier: false
  - model: SAGE
    model_key: sage
...
- &id002
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2025-05-19'
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.05030000000000001
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id007
  ...
  - model: Sine-Poly(A)-pl
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard split for Texas node classification; results averaged
...
main_figure: /figures/2602.15634/main_figure.jpegoptim.jpg
---
