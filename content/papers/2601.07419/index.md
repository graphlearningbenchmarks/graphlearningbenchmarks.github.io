...
- name: Niklas Kormann
  orcid: null
  s2_author_id: '2365035031'
  s2_url: null
- name: Benjamin Doerr
  orcid: null
  s2_author_id: '2364749595'
  s2_url: null
- name: Johannes F. Lutzeyer
  orcid: null
  s2_author_id: '2378706332'
  s2_url: null
published_date: Jan 12, 2026
published_date_iso: '2026-01-12'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: Over-smoothing and over-squashing have been extensively studied in the literature
  on Graph Neural Networks (GNNs) over the past years. We challenge this prevailing
  focus in GNN research, arguing that these phenomena are less critical for practical
  applications than assumed. We suggest that performance decreases often stem from
  uninformative receptive fields rather than over-smoothing. We support this position
  with extensive experiments on several standard benchmark datasets, demonstrating
  that accuracy and over-smoothing are mostly uncorrelated and that optimal model
  depths remain small even with mitigation techniques, thus highlighting the negligible
  role of over-smoothing. Similarly, we challenge that over-squashing is always detrimental
  in practical applications. Instead, we posit that the distribution of relevant information
  over the graph frequently factorises and is often localised within a small k-hop
  neighbourhood, questioning the necessity of jointly observing entire receptive fields
  or engaging in an extensive search for long-range interactions. The results of our
  experiments show that architectural interventions designed to mitigate over-squashing
  fail to yield significant performance gains. This position paper advocates for a
  paradigm shift in theoretical research, urging a diligent analysis of learning tasks
  and datasets using statistics that measure the underlying distribution of label-relevant
  information to better understand their localisation and factorisation.
codebase_url: ''
...
- &id003
  ...
  - model: GCN
    ...
    protocol_note: Planetoid split, 2 layers, Accuracy
    date: Jan 12, 2026
    ...
    gap_vs_at_pub: 0.12190000000000001
  ...
  - model: GCNII
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split, 64 layers, Accuracy
    date: Jan 12, 2026
    date_display: Jan 2026
    date_iso: '2026-01-12'
    published_venue: ''
  ...
  - model: G²
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split, 4 layers, Accuracy
    date: Jan 12, 2026
    date_display: Jan 2026
    date_iso: '2026-01-12'
    published_venue: ''
    ...
    value_gap_source_date_iso: '2026-01-12'
    ...
    true_value: 0.765
    true_std: 0.004
    value_gap_source_arxiv: '2601.07419'
    value_gap_source_title: 'Position: Don''t be Afraid of Over-Smoothing And Over-Squashing'
  ...
  - model: MLP
    ...
    is_std_outlier: false
  - model: GCN + Pairnorm
    model_key: gcn + pairnorm
    model_plain: GCN + Pairnorm
    value: 0.683
    std: 0.016
    paper_value: 0.683
    paper_std: 0.016
...
- &id001
  ...
  - model: GCN
    ...
    gap_vs_at_pub: 0.12939999999999996
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GCNII
    ...
    gap_vs_at_pub: 0.12629999999999997
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: G²
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split, 32 layers, Accuracy
    date: Jan 12, 2026
    date_display: Jan 2026
    date_iso: '2026-01-12'
    published_venue: ''
...
- &id005
  ...
  - model: GIN
    ...
    protocol_decision: standard
    protocol_note: 10-fold CV on the 80/10/10 split as per Errica protocol
    date: Jan 12, 2026
    date_display: Jan 2026
    date_iso: '2026-01-12'
    published_venue: ''
    ...
    gap_vs_at_pub: 0.07067000000000001
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GATv2
    ...
    true_value: 0.477
    true_std: 0.021
    value_gap_source_arxiv: '2110.09344'
    value_gap_source_title: 'ifMixup: Interpolating Graph Pair to Regularize Graph
      Classification'
    value_gap_source_is_current_paper: false
  ...
  - model: GraphSAGE + SDRF
    ...
    is_std_outlier: false
  - model: GATv2 + BORF
    model_key: gatv2 + borf
    model_plain: GATv2 + BORF
    value: 0.374
    std: 0.041
    paper_value: 0.374
    paper_std: 0.041
    ...
    is_std_outlier: false
  - model: GATv2 + SDRF
    model_key: gatv2 + sdrf
    model_plain: GATv2 + SDRF
    value: 0.353
    std: 0.031
    paper_value: 0.353
    paper_std: 0.031
    ...
    is_best: false
    is_std_outlier: false
  - model: GraphSAGE + BORF
    model_key: graphsage + borf
    model_plain: GraphSAGE + BORF
    value: 0.31
    std: 0.025
    paper_value: 0.31
    paper_std: 0.025
...
- &id004
  ...
  - model: GIN
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV on 80/10/10 split as per Errica protocol
    date: Jan 12, 2026
    date_display: Jan 2026
    date_iso: '2026-01-12'
    published_venue: ''
...
- &id007
  ...
  - model: GIN
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Peptides-func test split, AP metric, 4 layers
    date: Jan 12, 2026
    date_display: Jan 2026
    date_iso: '2026-01-12'
    published_venue: ''
...
- &id002
  ...
  - model: GCN
    ...
    gap_vs_at_pub: 0.05259999999999998
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id008
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy on 10 random 50/25/25 splits as per Platonov et al.
      2024
    date: Jan 12, 2026
    date_display: Jan 2026
    date_iso: '2026-01-12'
    ...
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.41220000000000007
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id006
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: node classification on ogbn-arxiv using the official split (8-fold
      CV for hyperparameter optimization, test set unchanged)
    date: Jan 12, 2026
    date_display: Jan 2026
    date_iso: '2026-01-12'
    published_venue: ''
    ...
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.1621999999999999
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
main_figure: /figures/2601.07419/main_figure.jpegoptim.jpg
---
