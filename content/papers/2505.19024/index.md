...
- name: Siqi Huang
  orcid: null
  s2_author_id: '2334818659'
  s2_url: null
- name: Yanchen Xu
  orcid: null
  s2_author_id: '2316428413'
  s2_url: null
- name: Hongyuan Zhang
  orcid: null
  s2_author_id: '2108879612'
  s2_url: null
- name: Xuelong Li
  orcid: null
  s2_author_id: '2158128246'
  s2_url: null
published_date: May 25, 2025
published_date_iso: '2025-05-25'
...
abstract: Although graph contrastive learning (GCL) has been widely investigated,
  ...
  paper, we propose Positive-incentive Noise driven Graph Data Augmentation (PiNGDA),
  where positive-incentive noise (pi-noise) scientifically analyzes the beneficial
  effect of noise under the information theory. To bridge the standard GCL and pi-noise
  framework, we design a Gaussian auxiliary variable to convert the loss function
  to information entropy. We prove that the standard GCL with pre-defined augmentations
  is equivalent to estimate the beneficial noise via the point estimation. Following
  our analysis, PiNGDA is derived from learning the beneficial noise on both topology
  and attributes through a trainable noise generator for graph augmentations, instead
  of the simple estimation. Since the generator learns how to produce beneficial perturbations
  on graph topology and node attributes, PiNGDA is more reliable compared with the
  existing methods. Extensive experimental results validate the effectiveness and
  stability of PiNGDA.
codebase_url: ''
...
- &id001
  ...
  - model: GCA
    ...
    is_std_outlier: false
  - model: GRACE +PiNGDA
    model_key: grace +pingda
    model_plain: GRACE +PiNGDA
    value: 0.9319
    std: 0.0018
    paper_value: 0.9319
    paper_std: 0.0018
  ...
  - model: GRACE
    ...
    is_std_outlier: false
  - model: Sp2GCL +PiNGDA
    model_key: sp2gcl +pingda
    model_plain: Sp2GCL +PiNGDA
    value: 0.9311
    std: 0.0014
    paper_value: 0.9311
    paper_std: 0.0014
...
- &id002
  ...
  - model: GAT
    ...
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: fuzzy match to coauthor-physics (score=86)'
    evaluation_task: ''
    protocol_decision: uncertain
    protocol_note: ''
    date: May 25, 2025
...
- &id007
  ...
  - model: GREET
    ...
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.33240000000000003
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GAT
    ...
    value_gap_source_date_label: AAAI 2022
    gap_vs_at_pub: 0.34279999999999994
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: DGI
    ...
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.15459999999999996
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: BGRL
    ...
    gap_vs_at_pub: 0.22149999999999997
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GCA
    ...
    value_gap_source_date_iso: '2022-11-25'
    value_gap_source_date_label: AAAI 2022
    gap_vs_at_pub: 0.07960000000000006
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id005
  ...
  - model: AD-GCL
    ...
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.04580000000000006
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: RU-GIN
    ...
    value_gap_source_date_iso: '2021-06-10'
    value_gap_source_date_label: NeurIPS 2021
    gap_vs_at_pub: 0.17889999999999995
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id006
  ...
  - model: GREET
    ...
    value_gap_source_date_iso: '2024-08-24'
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.24239999999999995
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GAT
    ...
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.24630000000000007
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: JOAO
    ...
    value_gap_source_date_iso: '2025-05-25'
    value_gap_source_date_label: ICML 2025
    gap_vs_at_pub: 0.05390000000000006
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: true
...
- scope: graph-level
  ...
  - benchmark: TU Dortmund
    ...
    - dataset: RDT-B
      dataset_slug: rdt-b
single_proposed_model: CL
main_figure: /figures/2505.19024/main_figure.jpegoptim.jpg
---
