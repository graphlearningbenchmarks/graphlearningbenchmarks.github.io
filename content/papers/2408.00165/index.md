...
- name: Kyunghyun Cho
  orcid: null
  s2_author_id: '2314552008'
  s2_url: null
published_date: Jul 31, 2024
published_date_iso: '2024-07-31'
published_venue: NeurIPS 2024
published_conference: NeurIPS 2024
published_conference_short: NeurIPS
published_conference_slug: neurips
abstract: Rethink convolution-based graph neural networks (GNN)---they characteristically
  suffer from limited expressiveness, over-smoothing, and over-squashing, and require
  specialized sparse kernels for efficient computation. Here, we design a simple graph
  learning module entirely free of convolution operators, coined random walk with
  unifying memory (RUM) neural network, where an RNN merges the topological and semantic
  graph features along the random walks terminating at each node. Relating the rich
  literature on RNN behavior and graph topology, we theoretically show and experimentally
  verify that RUM attenuates the aforementioned symptoms and is more expressive than
  the Weisfeiler-Lehman (WL) isomorphism test. On a variety of node- and graph-level
  classification and regression tasks, RUM not only achieves competitive performance,
  but is also robust, memory-efficient, scalable, and faster than the simplest convolutional
  GNNs.
codebase_url: https://github.com/yuanqing-wang/rum
...
- &id001
  ...
  - model: GraphSAGE
    ...
    gap_vs_at_pub: 0.04679999999999995
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id003
  ...
  - model: CRaWl
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: tönshoff2023walking
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: ''
    protocol_decision: uncertain
    protocol_note: ''
...
- scope: graph-level
  ...
  - benchmark: TU Dortmund
    ...
    - dataset: NCI1
      dataset_slug: nci1
single_proposed_model: RUM
main_figure: /figures/2408.00165/main_figure.jpegoptim.jpg
---
