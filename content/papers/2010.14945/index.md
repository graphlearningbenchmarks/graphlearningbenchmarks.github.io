...
- name: Yichen Xu
  orcid: null
  s2_author_id: '47103911'
  s2_url: null
- name: Feng Yu
  orcid: null
  s2_author_id: '2155385667'
  s2_url: null
- name: Q. Liu
  orcid: null
...
abstract: Recently, contrastive learning (CL) has emerged as a successful method for
  ...
  stochastic augmentation on the input graph to obtain two graph views and maximize
  the agreement of representations in the two views. Despite the prosperous development
  of graph CL methods, the design of graph augmentation schemes---a crucial component
  in CL---remains rarely explored. We argue that the data augmentation schemes should
  preserve intrinsic structures and attributes of graphs, which will force the model
  to learn representations that are insensitive to perturbation on unimportant nodes
  and edges. However, most existing methods adopt uniform data augmentation schemes,
  like uniformly dropping edges and uniformly shuffling features, leading to suboptimal
  ...
  topological and semantic aspects of the graph. Specifically, on the topology level,
  we design augmentation schemes based on node centrality measures to highlight important
  connective structures. On the node attribute level, we corrupt node features by
  adding more noise to unimportant node features, to enforce the model to recognize
  underlying semantic information. We perform extensive experiments of node classification
  on a variety of real-world datasets. Experimental results demonstrate that our proposed
  method consistently outperforms existing state-of-the-art baselines and even surpasses
...
codebase_url: https://github.com/CRIPAC-DIG/GCA
...
- &id002
  ...
  - model: GCN
    ...
    protocol_note: Linear evaluation using labels Y
    date: Oct 27, 2020
  ...
  - model: MVGRL
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Linear evaluation on node features/adjacency matrix
    date: Oct 27, 2020
    date_display: Oct 2020
    date_iso: '2020-10-27'
    published_venue: WWW 2020
...
- &id001
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Transductive node classification using node features X, adjacency
      matrix A, and labels Y.
    date: Oct 27, 2020
    date_display: Oct 2020
    date_iso: '2020-10-27'
    published_venue: WWW 2020
  ...
  - model: MVGRL
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Transductive node classification using node features X and adjacency
      matrix A.
    date: Oct 27, 2020
    date_display: Oct 2020
    date_iso: '2020-10-27'
  ...
  - model: DeepWalk
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Transductive node classification using adjacency matrix A.
    date: Oct 27, 2020
    date_display: Oct 2020
    date_iso: '2020-10-27'
    published_venue: WWW 2020
...
- &id004
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Supervised node classification using features, adjacency, and labels
    date: Oct 27, 2020
    date_display: Oct 2020
    date_iso: '2020-10-27'
    published_venue: WWW 2020
  ...
  - model: DGI
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Transductive node classification using node features and adjacency
      matrix
    date: Oct 27, 2020
    date_display: Oct 2020
    date_iso: '2020-10-27'
  ...
  - model: Node2Vec
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Transductive node classification using adjacency matrix
    date: Oct 27, 2020
    date_display: Oct 2020
    date_iso: '2020-10-27'
    published_venue: WWW 2020
...
- &id003
  ...
  - model: GCA-EV
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Transductive node classification using features and adjacency matrix
    date: Oct 27, 2020
    date_display: Oct 2020
    date_iso: '2020-10-27'
    published_venue: WWW 2020
