...
- name: Seongjun Yun
  orcid: null
  s2_author_id: '3110007'
  s2_url: null
- name: Seoyoon Kim
  orcid: null
  s2_author_id: '2320811800'
  s2_url: null
- name: Junhyun Lee
  orcid: null
...
abstract: Graph Neural Networks (GNNs) have been widely applied to various fields
  for learning over graph-structured data. They have shown significant improvements
  over traditional heuristic methods in various tasks such as node classification
  and graph classification. However, since GNNs heavily rely on smoothed node features
  rather than graph structure, they often show poor performance than simple heuristic
  methods in link prediction where the structural information, e.g., overlapped neighborhoods,
  degrees, and shortest paths, is crucial. To address this limitation, we propose
  Neighborhood Overlap-aware Graph Neural Networks (Neo-GNNs) that learn useful structural
  features from an adjacency matrix and estimate overlapped neighborhoods for link
  prediction. Our Neo-GNNs generalize neighborhood overlap-based heuristic methods
  and handle overlapped multi-hop neighborhoods. Our extensive experiments on Open
  Graph Benchmark datasets (OGB) demonstrate that Neo-GNNs consistently achieve state-of-the-art
...
- &id003
  ...
  - model: SEAL
    ...
    protocol_note: Standard link prediction task on OGB-Citation2 using MRR.
    date: Jun 9, 2022
  ...
  - model: GraphSAGE
    ...
    is_best: false
    is_std_outlier: false
  - model: Common Neighbors
    model_key: common neighbors
    model_plain: Common Neighbors
    value: 0.762
    std: 0.0
    paper_value: 0.762
    paper_std: 0.0
  ...
  - model: Resource Allocation
    ...
    value_gap_source_date_iso: '2022-06-09'
    value_gap_source_date_label: NeurIPS 2022
    gap_vs_at_pub: 0.24219999999999997
    worse_than_at_pub: false
    surpassed_since_pub: false
  ...
  - model: Adamic Adar
    ...
    value_gap_source_date_iso: '2022-06-09'
    value_gap_source_date_label: NeurIPS 2022
    gap_vs_at_pub: 0.24229999999999996
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: Matrix Factorization
    ...
    value_gap_source_date_iso: '2022-06-09'
    value_gap_source_date_label: NeurIPS 2022
    gap_vs_at_pub: 0.0122000000000001
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: true
...
- &id001
  ...
  - model: GCN
    ...
    evaluation_task: link_prediction
    protocol_decision: standard
    protocol_note: Standard OGB link prediction task using Hits@50 metric.
    date: Jun 9, 2022
    date_display: Jun 2022
    date_iso: '2022-06-09'
    published_venue: NeurIPS 2022
  ...
  - model: Node2Vec
    ...
    value_gap_source_date_iso: '2023-03-01'
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.07539999999999997
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id004
  ...
  - model: Neo-GNN
    ...
    evaluation_task: link_prediction
    protocol_decision: standard
    protocol_note: Standard OGB link prediction task using Hits@20 metric.
    date: Jun 9, 2022
    date_display: Jun 2022
    date_iso: '2022-06-09'
    published_venue: NeurIPS 2022
  ...
  - model: GraphSAGE
    ...
    value_gap_source_date_iso: '2020-10-30'
    value_gap_source_date_label: NeurIPS 2020
    gap_vs_at_pub: 0.05890000000000001
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GCN
    ...
    at_pub_value: 0.3711
    at_pub_std: 0.0021
    at_pub_source_arxiv: '2203.00199'
    at_pub_source_title: Equivariant and Stable Positional Encoding for More Powerful
      Graph Neural Networks
    at_pub_source_date_iso: '2022-03-01'
    at_pub_source_date_label: ICLR 2022
    value_gap_source_date_iso: '2023-10-01'
    value_gap_source_date_label: ICLR 2023
    gap_vs_at_pub: 0.07490000000000002
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: true
  ...
  - model: SEAL
    ...
    value_gap_source_date_iso: '2023-10-14'
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.04309999999999997
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: Node2Vec
    ...
    gap_vs_at_pub: 0.013500000000000012
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.013500000000000012
    has_value_note: false
    value_note: ''
    sort_value: 0.233
    sort_std: 0.021
...
- &id002
  ...
  - model: Resource Allocation
    ...
    evaluation_task: link_prediction
    protocol_decision: standard
    protocol_note: Ranking performance of positive test edges over negative test edges.
    date: Jun 9, 2022
    date_display: Jun 2022
    date_iso: '2022-06-09'
    published_venue: NeurIPS 2022
  ...
  - model: SEAL
    ...
    value_gap_source_date_iso: '2023-03-01'
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.006500000000000006
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: MLP
    ...
    value_gap_source_date_iso: '2023-10-14'
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.45530000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: Matrix Factorization
    ...
    value_gap_source_date_iso: '2020-12-30'
    value_gap_source_date_label: '2020'
    gap_vs_at_pub: 0.04460000000000003
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: Node2Vec
    ...
    value_gap_source_date_iso: '2020-06-14'
    value_gap_source_date_label: '2020'
    gap_vs_at_pub: 0.050600000000000006
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_title: Formatting Instructions for ICLR 2021 Conference Submissions
    value_gap_source_is_current_paper: false
    value_gap: 0.050600000000000006
    has_value_note: false
    value_note: ''
    sort_value: 0.223
    sort_std: 0.008
...
main_figure: /figures/2206.04216/main_figure.jpegoptim.jpg
---
