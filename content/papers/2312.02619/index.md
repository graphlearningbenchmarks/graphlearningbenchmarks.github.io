...
- name: Liang Chen
  orcid: null
  s2_author_id: '2260621461'
  s2_url: null
- name: Bingzhe Wu
  orcid: null
  s2_author_id: '2257376927'
  s2_url: null
- name: Yatao Bian
  orcid: null
  s2_author_id: '2257039155'
  s2_url: null
- name: Zibin Zheng
  orcid: null
  s2_author_id: '2259915933'
  s2_url: null
published_date: Dec 5, 2023
published_date_iso: '2023-12-05'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: Graph contrastive learning (GCL) has emerged as a representative paradigm
  in graph self-supervised learning, where negative samples are commonly regarded
  as the key to preventing model collapse and producing distinguishable representations.
  Recent studies have shown that GCL without negative samples can achieve state-of-the-art
  performance as well as scalability improvement, with bootstrapped graph latent (BGRL)
  as a prominent step forward. However, BGRL relies on a complex architecture to maintain
  the ability to scatter representations, and the underlying mechanisms enabling the
  success remain largely unexplored. In this paper, we introduce an instance-level
  decorrelation perspective to tackle the aforementioned issue and leverage it as
  a springboard to reveal the potential unnecessary model complexity within BGRL.
  Based on our findings, we present SGCL, a simple yet effective GCL framework that
  utilizes the outputs from two consecutive iterations as positive pairs, eliminating
  the negative samples. SGCL only requires a single graph augmentation and a single
  graph encoder without additional parameters. Extensive experiments conducted on
  various graph benchmarks demonstrate that SGCL can achieve competitive performance
  with fewer parameters, lower time and space costs, and significant convergence speedup..
codebase_url: https://github.com/ZsZsZs25/SGCL
...
- &id002
  ...
  - model: GraphMAE
    ...
    at_pub_value: 0.8834
    at_pub_std: 0.0027
    at_pub_source_arxiv: '2301.12458'
    at_pub_source_title: 'SeeGera: Self-supervised Semi-implicit Graph Variational
      Auto-encoders with Masking'
    at_pub_source_date_iso: '2023-01-29'
    ...
    comparison_source_title: 'SeeGera: Self-supervised Semi-implicit Graph Variational
      Auto-encoders with Masking'
    comparison_source_arxiv: '2301.12458'
    is_best: false
    is_std_outlier: false
  - model: AFGRL
    model_key: afgrl
...
- &id001
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification accuracy on Amazon-Photos
    date: Dec 5, 2023
    date_display: Dec 2023
    date_iso: '2023-12-05'
    published_venue: ''
...
- &id005
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification accuracy on Coauthor-CS
    date: Dec 5, 2023
    date_display: Dec 2023
    date_iso: '2023-12-05'
    published_venue: ''
...
- &id003
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification accuracy on Coauthor-Physics
    date: Dec 5, 2023
    date_display: Dec 2023
    date_iso: '2023-12-05'
    published_venue: ''
...
- &id004
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification task on WikiCS
    date: Dec 5, 2023
    date_display: Dec 2023
    date_iso: '2023-12-05'
    published_venue: ''
...
- &id007
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Linear evaluation protocol using public OGB split
    date: Dec 5, 2023
    date_display: Dec 2023
    date_iso: '2023-12-05'
    published_venue: ''
    ...
    value_gap_source_date_label: TMLR 2024
    gap_vs_at_pub: 0.16369999999999996
    worse_than_at_pub: false
    surpassed_since_pub: true
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
- &id008
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Linear evaluation protocol using 10% training/validation/80% testing
      random divisions as per text.
    date: Dec 5, 2023
    date_display: Dec 2023
    date_iso: '2023-12-05'
    published_venue: ''
  ...
  - model: GCN
    ...
    value_gap_source_date_iso: '2026-04-30'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.04770000000000002
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: MLP
    ...
    value_gap_source_date_label: '2021'
    gap_vs_at_pub: 0.10329999999999998
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id006
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Linear evaluation protocol using 10% training/validation/testing
      random divisions as specified in the evaluation section.
    date: Dec 5, 2023
    date_display: Dec 2023
    date_iso: '2023-12-05'
    published_venue: ''
...
single_proposed_model: SGCL
main_figure: /figures/2312.02619/main_figure.jpegoptim.jpg
---
