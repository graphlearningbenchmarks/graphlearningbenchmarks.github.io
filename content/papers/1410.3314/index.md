...
- name: Marion Neumann
  orcid: null
  s2_author_id: '40059761'
  s2_url: null
- name: Roman Garnett
  orcid: null
  s2_author_id: '145974030'
  s2_url: null
- name: Christian Bauckhage
  orcid: null
  s2_author_id: '1692283'
  s2_url: null
- name: Kristian Kersting
  orcid: null
  s2_author_id: '1746871'
  s2_url: null
published_date: Oct 13, 2014
published_date_iso: '2014-10-13'
published_venue: ''
...
abstract: We introduce propagation kernels, a general graph-kernel framework for efficiently
  ...
  how information spreads through a set of given graphs. They leverage early-stage
  distributions from propagation schemes such as random walks to capture structural
  information encoded in node labels, attributes, and edge information. This has two
  benefits. First, off-the-shelf propagation schemes can be used to naturally construct
  kernels for many graph types, including labeled, partially labeled, unlabeled, directed,
  and attributed graphs. Second, by leveraging existing efficient and informative
  propagation schemes, propagation kernels can be considerably faster than state-of-the-art
  approaches without sacrificing predictive performance. We will also show that if
  the graphs at hand have a regular structure, for instance when modeling image or
  video data, one can exploit this regularity to scale the kernel computation to large
  databases of graphs with thousands of nodes. We support our contributions by exhaustive
  experiments on a number of real-world graphs from a variety of application domains.
codebase_url: https://github.com/marionmari/propagation_kernels
...
- &id001
  ...
  - model: WL
    ...
    protocol_note: 10-fold cross validation (10 runs) on labeled graphs
    date: Oct 13, 2014
    date_display: Oct 2014
    date_iso: '2014-10-13'
    published_venue: ''
    published_conference: ''
    at_pub_value: null
  ...
  - model: PK
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold cross validation (10 runs)
    date: Oct 13, 2014
    date_display: Oct 2014
    date_iso: '2014-10-13'
    published_venue: ''
...
- scope: graph-level
  ...
  - benchmark: TU Dortmund
    ...
    - dataset: NCI1
      dataset_slug: nci1
main_figure: /figures/1410.3314/main_figure.jpegoptim.jpg
---
