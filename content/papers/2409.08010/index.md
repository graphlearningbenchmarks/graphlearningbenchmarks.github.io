...
- name: Zhenhao Zhao
  orcid: null
  s2_author_id: '2265772742'
  s2_url: null
- name: Minhong Zhu
  orcid: null
  s2_author_id: '2265898628'
  s2_url: null
- name: Chen Wang
  orcid: null
  s2_author_id: '2321396157'
  s2_url: null
- name: Sijia Wang
  orcid: null
  s2_author_id: '2321373662'
  s2_url: null
- name: Jiqiang Zhang
  orcid: null
  s2_author_id: '2276255943'
  s2_url: null
- name: Li Chen
  orcid: null
  s2_author_id: '2146028036'
  s2_url: null
- name: Weiran Cai
  orcid: null
  s2_author_id: '2265675542'
  s2_url: null
published_date: Sep 12, 2024
published_date_iso: '2024-09-12'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: Graph Contrastive Learning (GCL) seeks to learn nodal or graph representations
  that contain maximal consistent information from graph-structured data. While node-level
  contrasting modes are dominating, some efforts commence to explore consistency across
  different scales. Yet, they tend to lose consistent information and be contaminated
  by disturbing features. Here, we introduce MUX-GCL, a novel cross-scale contrastive
  learning paradigm that utilizes multiplex representations as effective patches.
  While this learning mode minimizes contaminating noises, a commensurate contrasting
  strategy using positional affinities further avoids information loss by correcting
  false negative pairs across scales. Extensive downstream experiments demonstrate
  that MUX-GCL yields multiple state-of-the-art results on public datasets. Our theoretical
  analysis further guarantees the new objective function as a stricter lower bound
  of mutual information of raw input features and output embeddings, which rationalizes
  this paradigm. Code is available at https://github.com/MUX-GCL/Code.
codebase_url: https://github.com/MUX-GCL/Code
...
- &id002
  ...
  - model: MUX-GCL
    ...
    protocol_note: Randomly divided into 10% train, 10% val, and 80% test proportions.
    date: Sep 12, 2024
...
- &id001
  ...
  - model: MUX-GCL
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Randomly divided into 10%, 10%, and 80% for training, validation,
      and testing.
    date: Sep 12, 2024
    date_display: Sep 2024
    date_iso: '2024-09-12'
  ...
  - model: MA-GCL
    ...
    gap_vs_at_pub: 0.0039999999999998925
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_title: 'MA-GCL: Model Augmentation Tricks for Graph Contrastive
      Learning'
    value_gap_source_is_current_paper: false
    value_gap: 0.0039999999999998925
    has_value_note: false
    value_note: ''
    sort_value: 0.938
    sort_std: 0.001
...
single_proposed_model: MUX-GCL
main_figure: /figures/2409.08010/main_figure.jpegoptim.jpg
---
