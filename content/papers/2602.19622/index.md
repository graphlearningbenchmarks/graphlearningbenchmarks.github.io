...
- &id002
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Photo dataset using standard split and Accuracy
      metric.
    date: Feb 23, 2026
    date_display: Feb 2026
    date_iso: '2026-02-23'
  ...
  - model: VQGraph
    ...
    value_gap_source_date_iso: '2024-02-14'
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.07339999999999991
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id004
  ...
  - model: SGFormer
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Physics dataset using standard split and
      Accuracy metric.
    date: Feb 23, 2026
    date_display: Feb 2026
    date_iso: '2026-02-23'
...
- &id001
  ...
  - model: NodeFormer
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on PubMed using the Planetoid split.
    date: Feb 23, 2026
    date_display: Feb 2026
    date_iso: '2026-02-23'
    published_venue: WWW 2026
