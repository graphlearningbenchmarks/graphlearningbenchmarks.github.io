...
- name: Yizhu Jiao
  orcid: null
  s2_author_id: '1381900594'
  s2_url: null
- name: Yun Xiong
  orcid: null
  s2_author_id: '33629364'
  s2_url: null
- name: Jiawei Zhang
  orcid: null
  s2_author_id: '1718428'
  s2_url: null
- name: Yao Zhang
  orcid: null
  s2_author_id: '49889358'
  s2_url: null
- name: Tianqi Zhang
  orcid: null
  s2_author_id: '2146332011'
  s2_url: null
- name: Yangyong Zhu
  orcid: null
  s2_author_id: '8247706'
  s2_url: null
...
abstract: Graph representation learning has attracted lots of attention recently.
  Existing graph neural networks fed with the complete graph data are not scalable
  due to limited computation and memory costs. Thus, it remains a great challenge
  to capture rich information in large-scale graph data. Besides, these methods mainly
  focus on supervised learning and highly depend on node label information, which
  is expensive to obtain in the real world. As to unsupervised network embedding approaches,
  they overemphasize node proximity instead, whose learned representations can hardly
  be used in downstream application tasks directly. In recent years, emerging self-supervised
  learning provides a potential solution to address the aforementioned problems. However,
  existing self-supervised works also operate on the complete graph data and are biased
  to fit either global or very local (1-hop neighborhood) graph structures in defining
  the mutual information based loss terms. In this paper, a novel self-supervised
  representation learning method via raph trast, namely Subg-Con, is proposed by utilizing
  the strong correlation between central nodes and their sampled subgraphs to capture
  regional structure information. Instead of learning on the complete input graph
  data, with a novel data augmentation strategy, Subg-Con learns node representations
  through a contrastive loss defined based on subgraphs sampled from the original
  graph instead. Compared with existing graph representation learning approaches,
  Subg-Con has prominent performance advantages in weaker supervision requirements,
  model learning scalability, and parallelization. Extensive experiments verify both
  the effectiveness and the efficiency of our work compared with both classic and
  state-of-the-art graph representation learning approaches on multiple real-world
  large-scale benchmark datasets from different domains.
codebase_url: https://github.com/yzjiao/Subg-Con
...
- &id002
  ...
  - model: GCN
    ...
    protocol_note: Supervised GCN using labels for training.
    date: Sep 22, 2020
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Supervised GAT using labels for training.
    date: Sep 22, 2020
    date_display: Sep 2020
    date_iso: '2020-09-22'
    published_venue: ''
  ...
  - model: GraphSAGE
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Supervised GraphSAGE using labels for training.
    date: Sep 22, 2020
    date_display: Sep 2020
    date_iso: '2020-09-22'
    published_venue: ''
  ...
  - model: SubG-Con
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Micro-averaged F1 score on test nodes using logistic regression
  ...
  - model: FastGCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Supervised FastGCN using labels for training.
    date: Sep 22, 2020
    date_display: Sep 2020
    date_iso: '2020-09-22'
    published_venue: ''
  ...
  - model: DeepWalk
    ...
    at_pub_value: 0.2502
    at_pub_std: 0.0138
    at_pub_source_arxiv: '1710.03059'
    at_pub_source_title: Learning Graph Representations with Embedding Propagation
    at_pub_source_date_iso: '2017-10-09'
    at_pub_source_date_label: NeurIPS 2017
    value_gap_source_date_iso: '2022-07-25'
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.27880000000000005
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
    ...
    has_value_gap: true
    comparison_type: improved
    comparison_source_title: Learning Graph Representations with Embedding Propagation
    comparison_source_arxiv: '1710.03059'
    is_best: false
    is_std_outlier: false
  - model: Unsup-GraphSAGE
    model_key: unsup-graphsage
    model_plain: Unsup-GraphSAGE
    value: 0.465
    std: 0.007
    paper_value: 0.465
    paper_std: 0.007
...
- scope: node-level
  ...
  - benchmark: Classic
    ...
    - dataset: PPI
      dataset_slug: ppi
single_proposed_model: SubG-Con
main_figure: /figures/2009.10273/main_figure.jpegoptim.jpg
---
