...
- name: J. E. Lenssen
  ...
  s2_url: null
published_date: Mar 6, 2019
published_date_iso: '2019-03-06'
...
- &id005
  ...
  - model: GlobalAttention
    model_key: globalattention
    model_plain: GlobalAttention
    value: 0.796
    std: 0.022
    paper_value: 0.796
    paper_std: 0.022
...
- &id001
  ...
  - model: GCN
    ...
    protocol_decision: standard
    protocol_note: Fixed split (Yang et al. 2016) for node classification
    date: Mar 6, 2019
    date_display: Mar 2019
    date_iso: '2019-03-06'
    published_venue: ICLR 2019
...
- &id003
  ...
  - model: GCN
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: We only make use of discrete node features.
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
...
- &id002
  ...
  - model: APPNP
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: The paper mentions using discrete node features and following
      hyperparameter setups of respective papers.
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Fixed split (Planetoid split) as per Yang et al. 2016.
    date: Mar 6, 2019
    date_display: Mar 2019
    date_iso: '2019-03-06'
    published_venue: ICLR 2019
...
- scope: graph-level
  ...
  - benchmark: TU Dortmund
    ...
    - dataset: COLLAB
      dataset_slug: collab
main_figure: /figures/1903.02428/main_figure.jpegoptim.jpg
---
