...
- name: Vikas Verma
  orcid: null
  s2_author_id: '50346446'
  s2_url: null
- name: Meng Qu
  orcid: null
  s2_author_id: '145252498'
  s2_url: null
- name: Alex Lamb
  orcid: null
  s2_author_id: '49071560'
  s2_url: null
- name: Yoshua Bengio
  orcid: null
...
abstract: 'We present GraphMix, a regularization method for Graph Neural Network based
  semi-supervised object classification, whereby we propose to train a fully-connected
  ...
  any assumptions about the "aggregation" layer or the depth of the graph neural networks.
  We experimentally validate this analysis by applying GraphMix to various architectures
  such as Graph Convolutional Networks, Graph Attention Networks and Graph-U-Net.
  Despite its simplicity, we demonstrate that GraphMix can consistently improve or
  closely match state-of-the-art performance using even simpler architectures such
  as Graph Convolutional Networks, across three established graph benchmarks: Cora,
  Citeseer and Pubmed citation network datasets, as well as three newly proposed datasets:
  Cora-Full, Co-author-CS and Co-author-Physics.'
codebase_url: https://github.com/vikasverma1077/GraphMix
...
- &id002
  ...
  - model: DropEdge
    ...
    input_feature_source: raw_features
    feature_source_evidence: ''
    table_ref: Table 1 (Standard Split)
  ...
  - model: GraphAT
    ...
    is_best: false
    is_std_outlier: false
  - model: GCN (self-training)
    model_key: gcn (self-training)
    model_plain: GCN (self-training)
    value: 0.7338
    std: 0.0035
    paper_value: 0.7338
    paper_std: 0.0035
    ...
    input_feature_source: raw_features
    feature_source_evidence: trained with self-generated targets
    table_ref: Table 1 (Standard Split)
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
  ...
  - model: MLP
    ...
    is_best: false
    is_std_outlier: false
  - model: GAT (self-training)
    model_key: gat (self-training)
    model_plain: GAT (self-training)
    value: 0.7287
    std: 0.0051
    paper_value: 0.7287
    paper_std: 0.0051
    ...
    is_best: false
    is_std_outlier: false
  - model: FCN (self-training)
    model_key: fcn (self-training)
    model_plain: FCN (self-training)
    value: 0.715
    std: 0.008
    paper_value: 0.715
    paper_std: 0.008
...
- &id001
  ...
  - model: GCN (self-training)
    ...
    is_best: false
    is_std_outlier: false
  - model: Graph-U-Net (self-training)
    model_key: graph-u-net (self-training)
    model_plain: Graph-U-Net (self-training)
    value: 0.8201
    std: 0.0091
    paper_value: 0.8201
    paper_std: 0.0091
