...
- name: Junbin Gao
  ...
  s2_url: null
published_date: May 1, 2022
published_date_iso: '2022-05-01'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: Learning efficient graph representation is the key to addressing downstream
  tasks on graphs, such as node or graph property prediction. Given the non-Euclidean
  structural property of graphs, preserving the original graph data's similarity relationship
  in the embedded space needs specific tools and a similarity metric. This paper develops.
  The proposed to a Grassmann point of a low dimensional manifold through singular
...
- &id006
  ...
  - model: Attention
    ...
    protocol_note: 10-fold CV (mean test accuracy averaged over 10 repetitions)
    date: May 1, 2022
  ...
  - model: SAGPool
    ...
    value_gap_source_date_iso: '2022-05-01'
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.14759999999999995
    worse_than_at_pub: false
    surpassed_since_pub: false
...
- &id001
  ...
  - model: DGI (PPR)
    ...
    is_best: true
    is_std_outlier: false
  - model: k-means+EGG 0.8 (99.48%)
    model_key: k-means+egg 0.8 (99.48%)
    model_plain: k-means+EGG 0.8 (99.48%)
    value: 0.67
    std: 0.0201
    paper_value: 0.67
    paper_std: 0.0201
    ...
    protocol_decision: standard
    protocol_note: Node clustering task on Coauthor-CS dataset; scores averaged over
      10 repetitions.
    date: May 1, 2022
    date_display: May 2022
    date_iso: '2022-05-01'
  ...
  - model: K-means
    ...
    is_best: false
    is_std_outlier: false
  - model: k-means+EGG 0.5 (90.73%)
    model_key: k-means+egg 0.5 (90.73%)
    model_plain: k-means+EGG 0.5 (90.73%)
    value: 0.5878
    std: 0.0188
    paper_value: 0.5878
    paper_std: 0.0188
    ...
    is_best: false
    is_std_outlier: false
  - model: k-means+EGG 0.2 (45.28%)
    model_key: k-means+egg 0.2 (45.28%)
    model_plain: k-means+EGG 0.2 (45.28%)
    value: 0.5483
    std: 0.025
    paper_value: 0.5483
    paper_std: 0.025
...
- &id003
  ...
  - model: EdgePool
    ...
    value_gap_source_date_iso: '2022-05-01'
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.051100000000000034
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: true
...
- &id004
  ...
  - model: EGG
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV (averaged over 10 repetitions)
    date: May 1, 2022
    date_display: May 2022
    date_iso: '2022-05-01'
    published_venue: ''
...
- &id005
  ...
  - model: EGG
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV with GIN convolution
    date: May 1, 2022
    date_display: May 2022
    date_iso: '2022-05-01'
    published_venue: ''
