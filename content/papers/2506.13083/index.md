...
- name: Qingfeng Chen
  orcid: null
  s2_author_id: '2303729500'
  s2_url: null
- name: Shiyuan Li
  orcid: null
  s2_author_id: '2291165055'
  s2_url: null
- name: Yixin Liu
  orcid: null
...
- name: Shirui Pan
  orcid: null
  s2_author_id: '2291081128'
  s2_url: null
- name: Geoffrey I. Webb
  orcid: null
  s2_author_id: '2243967976'
  s2_url: null
- name: Shichao Zhang
  orcid: null
  s2_author_id: '2280957320'
  s2_url: null
...
abstract: Graph neural networks (GNNs) excel in graph representation learning by integrating
  graph structure and node features. Existing GNNs, unfortunately, fail to account
  for the uncertainty of class probabilities that vary with the depth of the model,
  leading to unreliable and risky predictions in real-world scenarios. To bridge the
  gap, in this paper, we propose a novel vidence using raph eural etwork (EFGNN for
  short) to achieve trustworthy prediction, enhance node classification accuracy,
  and make explicit the risk of wrong predictions. In particular, we integrate the
  evidence theory with multi-hop propagation-based GNN architecture to quantify the
  prediction uncertainty of each node with the consideration of multiple receptive
  fields. Moreover, a parameter-free cumulative belief fusion (CBF) mechanism is developed
  to leverage the changes in prediction uncertainty and fuse the evidence to improve
  the trustworthiness of the final prediction. To effectively optimize the EFGNN model,
  we carefully design a joint learning objective composed of evidence cross-entropy,
  dissonance coefficient, and false confident penalty. The experimental results on
  various datasets and theoretical analyses demonstrate the effectiveness of the proposed
  model in terms of accuracy and trustworthiness, as well as its robustness to potential
  attacks. The source code of EFGNN is available at https://github.com/Shiy-Li/EFGNN.
codebase_url: https://github.com/Shiy-Li/EFGNN
...
- &id004
  ...
  - model: SIGN
    ...
    gap_vs_at_pub: 0.12720000000000004
  ...
  - model: GAT
    ...
    gap_vs_at_pub: 0.10349999999999998
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: EFGNN
    ...
    is_std_outlier: false
  - model: Flip-APPNP
    model_key: flip-appnp
    model_plain: Flip-APPNP
    value: 0.299
    std: 0.011
    paper_value: 0.299
    paper_std: 0.011
...
- &id003
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy on node classification benchmark
    date: Jun 16, 2025
    date_display: Jun 2025
    date_iso: '2025-06-16'
    published_venue: ''
...
- &id001
  ...
  - model: APPNP
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy on node classification benchmark using Planetoid
      split.
    date: Jun 16, 2025
    date_display: Jun 2025
    date_iso: '2025-06-16'
  ...
  - model: GCN
    ...
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.13659999999999994
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- scope: node-level
  ...
  - benchmark: Heterophilic Graphs
    ...
    - dataset: Actor
      dataset_slug: actor
single_proposed_model: EFGNN
main_figure: /figures/2506.13083/main_figure.jpegoptim.jpg
---
