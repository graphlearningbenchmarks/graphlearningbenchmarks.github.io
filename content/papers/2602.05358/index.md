...
- name: Paribesh Regmi
  orcid: null
  s2_author_id: '151403415'
  s2_url: null
- name: Rui Li
  orcid: null
  s2_author_id: '2287781450'
  s2_url: null
- name: KC Kishan
  orcid: null
  s2_author_id: '2162165314'
  s2_url: null
published_date: Jul 1, 2025
published_date_iso: '2025-07-01'
published_venue: TMLR 2025
published_conference: TMLR 2025
published_conference_short: TMLR
published_conference_slug: tmlr
abstract: 'The neighborhood scope (i.e., number of hops) where graph neural networks
  (GNNs) aggregate information to characterize a node''s statistical property is critical
  to GNNs'' performance. Two-stage approaches, training and validating GNNs for every
  pre-specified neighborhood scope to search for the best setting, is a time-consuming
  task and tends to be biased due to the search space design. How to adaptively determine
  proper neighborhood scopes for the aggregation process for both homophilic and heterophilic
  graphs remains largely unexplored. We thus propose to model the GNNs'' message-passing
  behavior on a graph as a stochastic process by treating the number of hops as a
  beta process. This Bayesian framework allows us to infer the most plausible neighborhood
  scope for message aggregation simultaneously with the optimization of GNN parameters.
  Our theoretical analysis shows that the scope inference improves the expressivity
  of a GNN. Experiments on benchmark homophilic and heterophilic datasets show that
  the proposed method is compatible with state-of-the-art GNN variants, achieving
  competitive or superior performance on the node classification task, and providing
  well-calibrated predictions. Implementation is available at:'
codebase_url: https://github.com/paribeshregmi/BNA-GNN
extraction_model: cyankiwi/gemma-4-26B-A4B-it-AWQ-4bit
has_results: true
paper_type: method
proposed_models:
- general Bayesian inference strategy + ResGCN
- general Bayesian inference strategy + GCNII
mrr: 0.0
adjusted_mrr: 0.0
mrr_dataset_count: 0
...
- &id002
  ...
  - model: general Bayesian inference strategy + GCNII
    model_key: general bayesian inference strategy + gcnii
  ...
  - model: BBGDC
    ...
    is_best: false
    is_std_outlier: false
  - model: general Bayesian inference strategy + ResGCN
    model_key: general bayesian inference strategy + resgcn
    model_plain: general Bayesian inference strategy + ResGCN
    value: 0.777
    std: 0.041
    paper_value: 0.777
    paper_std: 0.041
