...
- name: Zhiyuan Ning
  orcid: null
  s2_author_id: '2053976443'
  s2_url: null
- name: Pengfei Wang
  orcid: null
  s2_author_id: '2301248160'
  s2_url: null
- name: Ziyue Qiao
  orcid: null
...
- name: Pengyang Wang
  orcid: null
  s2_author_id: '35629977'
  s2_url: null
- name: Yuanchun Zhou
  orcid: null
  s2_author_id: '2145108199'
  s2_url: null
published_date: May 8, 2025
published_date_iso: '2025-05-08'
...
abstract: 'Graph contrastive learning (GCL) has achieved remarkable success by following
  the computer vision paradigm of preserving absolute similarity between augmented
  views. However, this approach faces fundamental challenges in graphs due to their
  discrete, non-Euclidean nature---view generation often breaks semantic validity
  and similarity verification becomes unreliable. Through analyzing 11 real-world
  graphs, we discover a universal pattern transcending the homophily-heterophily dichotomy:
  label consistency systematically diminishes as structural distance increases, manifesting
  as smooth decay in homophily graphs and oscillatory decay in heterophily graphs.
  We establish theoretical guarantees for this pattern through random walk theory,
  proving label distribution convergence and characterizing the mechanisms behind
  different decay behaviors. This discovery reveals that graphs naturally encode relative
  similarity patterns, where structurally closer nodes exhibit collectively stronger
  semantic relationships. Leveraging this insight, we propose RelGCL, a novel GCL
  framework with complementary pairwise and listwise implementations that preserve
  these inherent patterns through collective similarity objectives. Extensive experiments
  demonstrate that our method consistently outperforms 20 existing approaches across
  both homophily and heterophily graphs, validating the effectiveness of leveraging
  natural relative similarity over artificial absolute similarity.'
codebase_url: ''
...
- &id008
  ...
  - model: SP-GCL
    ...
    protocol_note: Standard split for Actor heterophily graph
    date: May 8, 2025
    date_display: May 2025
    date_iso: '2025-05-08'
    published_venue: IJCAI 2025
...
- &id005
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard split for Amazon-Computers node classification
    date: May 8, 2025
    date_display: May 2025
    date_iso: '2025-05-08'
    published_venue: IJCAI 2025
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2026-05-18'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.05470000000000008
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: HomoGCL
    ...
    at_pub_value: 0.89
    at_pub_std: 0.001
    at_pub_source_arxiv: '2409.08010'
    at_pub_source_title: Multiplex Graph Contrastive Learning with Soft Negatives
    at_pub_source_date_iso: '2024-09-12'
    ...
    has_value_gap: true
    comparison_type: behind
    comparison_source_title: Multiplex Graph Contrastive Learning with Soft Negatives
    comparison_source_arxiv: '2409.08010'
    is_best: false
    is_std_outlier: false
  - model: CCA-SSG
    model_key: cca-ssg
...
- &id004
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard split for Amazon-Photo node classification
    date: May 8, 2025
    date_display: May 2025
    date_iso: '2025-05-08'
    published_venue: IJCAI 2025
  ...
  - model: DGI
    ...
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.014799999999999924
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id003
  ...
  - model: RelGCL_List
    ...
    is_best: false
    is_std_outlier: false
  - model: RelGCL_List - L_out
    model_key: relgcl_list - l_out
    model_plain: RelGCL_List - L_out
    value: 0.733
    std: null
    paper_value: 0.733
    paper_std: null
    ...
    is_best: false
    is_std_outlier: false
  - model: RelGCL_Pair - L_out
    model_key: relgcl_pair - l_out
    model_plain: RelGCL_Pair - L_out
    value: 0.731
    std: null
    paper_value: 0.731
    paper_std: null
...
- &id001
  ...
  - model: DGI
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: Velickovic2019DeepGI
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split (Yang et al. 2016 fixed 20-per-class train split)
  ...
  - model: VGAE
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: Kipf2016VariationalGA
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split (Yang et al. 2016 fixed 20-per-class train split)
  ...
  - model: AFGRL
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: Lee2022AugmentationFreeSL
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split (Yang et al. 2016 fixed 20-per-class train split)
...
- &id002
  ...
  - model: COSTA
    ...
    value_gap_source_date_iso: '2024-07-29'
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.05879999999999996
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GAE
    ...
    value_gap_source_date_iso: '2024-10-20'
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.10840000000000005
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: AFGRL
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split (Yang etet al. 2016 fixed split)
    date: May 8, 2025
    date_display: May 2025
    date_iso: '2025-05-08'
    published_venue: IJCAI 2025
...
- &id010
  ...
  - model: RelGCL_Pair
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Heterophily graph node classification task.
    date: May 8, 2025
    date_display: May 2025
    date_iso: '2025-05-08'
    published_venue: IJCAI 2025
...
- &id006
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Average accuracy over 20 random runs using linear evaluation on
      the standard WikiCS split.
    date: May 8, 2025
    date_display: May 2025
    date_iso: '2025-05-08'
    published_venue: IJCAI 2025
  ...
  - model: GAE
    ...
    value_gap_source_date_iso: '2024-10-01'
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.07719999999999994
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
main_figure: /figures/2505.05533/main_figure.jpegoptim.jpg
---
