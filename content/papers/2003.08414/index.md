...
- name: Guy Wolf
  ...
  s2_url: null
published_date: Mar 18, 2020
published_date_iso: '2020-03-18'
published_venue: NeurIPS 2020
published_conference: NeurIPS 2020
published_conference_short: NeurIPS
published_conference_slug: neurips
abstract: Graph convolutional networks (GCNs) have shown promising results in processing
  graph data by extracting structure-aware features. This gave rise to extensive work
  in geometric deep learning, focusing on designing network architectures that ensure
  neuron activations conform to regularity patterns within the input graph. However,
  in most cases the graph structure is only accounted for by considering the similarity
  of activations between adjacent nodes, which limits the capabilities of such methods
  to discriminate between nodes in a graph. Here, we propose to augment conventional
  GCNs with geometric scattering transforms and residual convolutions. The former
  enables band-pass filtering of graph signals, thus alleviating the so-called oversmoothing
  often encountered in GCNs, while the latter is introduced to clear the resulting
  features of high-frequency noise. We establish the advantages of the presented Scattering
  GCN with both theoretical results establishing the complementary benefits of scattering
  and GCN features, as well as experimental results showing the benefits of our method
  compared to leading graph neural networks for semi-supervised node classification,
  including the recently proposed GAT network that typically alleviates oversmoothing
  using graph attention mechanisms.
codebase_url: http://github.com/dms-net/scatteringGCN
...
- &id002
  ...
  - model: Scattering GCN
    ...
    value_gap_source_date_iso: '2020-03-18'
    ...
    true_value: 0.717
    true_std: null
    value_gap_source_arxiv: '2003.08414'
    value_gap_source_title: 'Scattering GCN: Overcoming Oversmoothness in Graph Convolutional
      Networks'
    ...
    is_best: false
    is_std_outlier: false
  - model: Partially absorbing
    model_key: partially absorbing
    model_plain: Partially absorbing
    value: 0.712
    std: null
    paper_value: 0.712
    paper_std: null
  ...
  - model: Chebyshev
    ...
    is_best: false
    is_std_outlier: false
  - model: Graph scattering
    model_key: graph scattering
    model_plain: Graph scattering
    value: 0.675
    std: null
    paper_value: 0.675
    paper_std: null
    ...
    is_best: false
    is_std_outlier: false
  - model: Node features (SVM)
    model_key: node features (svm)
    model_plain: Node features (SVM)
    value: 0.611
    std: null
    paper_value: 0.611
    paper_std: null
  ...
  - model: Label propagation
    model_key: label propagation
    model_plain: Label propagation
    value: 0.582
    std: null
    paper_value: 0.582
    paper_std: null
...
- scope: node-level
  ...
  - benchmark: Heterogeneous Graph Benchmarks
    ...
    - dataset: DBLP
      dataset_slug: dblp
main_figure: /figures/2003.08414/main_figure.jpegoptim.jpg
---
