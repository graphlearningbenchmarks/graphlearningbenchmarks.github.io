...
- name: Brian Godwin Lim
  orcid: null
  s2_author_id: '2292204186'
  s2_url: null
published_date: Mar 19, 2024
published_date_iso: '2024-03-19'
...
abstract: Graph neural networks (GNNs) have gained significant attention in recent
  ...
  on the graph isomorphism task. Notably, these works inherently assume a countable
  node feature representation, potentially limiting their applicability. Interestingly,
  only a few study GNNs with uncountable node feature representation. In the paper,
  a new perspective on the representational capability of GNNs is investigated across
  all levels---node-level, neighborhood-level, and graph-level---when the space of
  node feature representation is uncountable. Specifically, the injective and metric
  requirements of previous works are softly relaxed by employing a pseudometric distance
  on the space of input to create a soft-injective function such that distinct inputs
  may produce similar outputs if and only if the pseudometric deems the inputs to
  be sufficiently similar on some representation. As a consequence, a simple and computationally
  ...
  and dynamic message functions is proposed. Furthermore, a mathematical discussion
  on the relationship between SIR-GCN and key GNNs in literature is laid out to put
  the contribution into context, establishing SIR-GCN as a generalization of classical
  GNN methodologies. To close, experiments on synthetic and benchmark datasets demonstrate
  the relative superiority of SIR-GCN, outperforming comparable models in node and
...
- &id005
  ...
  - model: H2GCN
    ...
    protocol_note: Test performance on heterophilous datasets
    date: Mar 19, 2024
...
- &id010
  ...
  - model: PNA
    ...
    protocol_decision: standard
    protocol_note: Test performance using mean pooling as described in setup for CIFAR10
    date: Mar 19, 2024
    date_display: Mar 2024
    date_iso: '2024-03-19'
    published_venue: TMLR 2024
...
- &id011
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test split following dwivedi2023benchmarking
    date: Mar 19, 2024
    date_display: Mar 2024
    date_iso: '2024-03-19'
    published_venue: TMLR 2024
    ...
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.12856999999999996
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GCN
    ...
    gap_vs_at_pub: 0.21195999999999998
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GIN
    ...
    value_gap_source_date_iso: '2026-05-07'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.06335999999999997
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GraphSAGE
    ...
    gap_vs_at_pub: 0.13434000000000001
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id009
  ...
  - model: GIN
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Test split following dwivedi2023benchmarking; mean pooling used
      for MNIST
    date: Mar 19, 2024
    date_display: Mar 2024
    date_iso: '2024-03-19'
  ...
  - model: PNA
    ...
    value_gap_source_title: 'GCCM: Enhancing Generative Graph Prediction via Contrastive
      Consistency Model'
    value_gap_source_is_current_paper: false
    value_gap: 0.007500000000000062
    has_value_note: false
    value_note: ''
    sort_value: 0.9794
    sort_std: 0.0012
...
- &id006
  ...
  - model: SIR-GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test performance on heterophilous dataset minesweeper
    date: Mar 19, 2024
    date_display: Mar 2024
    date_iso: '2024-03-19'
    published_venue: TMLR 2024
...
- &id012
  ...
  - model: SIR-GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test split as defined in dwivedi2023benchmarking
    date: Mar 19, 2024
    date_display: Mar 2024
    date_iso: '2024-03-19'
    published_venue: TMLR 2024
  ...
  - model: GCN
    ...
    value_gap_source_date_iso: '2023-12-03'
    value_gap_source_date_label: ICML 2023
    gap_vs_at_pub: 0.0011400000000000299
    worse_than_at_pub: false
    surpassed_since_pub: true
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_title: Recurrent Distance Filtering for Graph Representation
      Learning
    value_gap_source_is_current_paper: false
    value_gap: 0.0011400000000000299
    has_value_note: false
    value_note: ''
    sort_value: 0.85614
    sort_std: 0.00032
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2026-05-07'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.024510000000000032
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_title: 'GCCM: Enhancing Generative Graph Prediction via Contrastive
      Consistency Model'
    value_gap_source_is_current_paper: false
    value_gap: 0.024510000000000032
    has_value_note: false
    value_note: ''
    sort_value: 0.78271
    sort_std: 0.00186
  ...
  - model: GraphSAGE
    ...
    value_gap_source_date_iso: '2024-03-19'
    value_gap_source_date_label: TMLR 2024
    gap_vs_at_pub: 3.999999999992898e-05
    worse_than_at_pub: false
    surpassed_since_pub: false
...
- &id008
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test performance on heterophilous dataset 'questions'
    date: Mar 19, 2024
    date_display: Mar 2024
    date_iso: '2024-03-19'
    published_venue: TMLR 2024
...
- &id004
  ...
  - model: GraphSAGE
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test performance on heterophilous dataset roman-empire
    date: Mar 19, 2024
    date_display: Mar 2024
    date_iso: '2024-03-19'
    published_venue: TMLR 2024
...
- &id007
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test performance on heterophilous dataset tolokers
    date: Mar 19, 2024
    date_display: Mar 2024
    date_iso: '2024-03-19'
    published_venue: TMLR 2024
...
- &id001
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test performance on WikiCS using the split from dwivedi2023benchmarking
    date: Mar 19, 2024
    date_display: Mar 2024
    date_iso: '2024-03-19'
    published_venue: TMLR 2024
...
- &id003
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: OGB official split for ogbn-arxiv
    date: Mar 19, 2024
    date_display: Mar 2024
    date_iso: '2024-03-19'
    published_venue: TMLR 2024
...
main_figure: /figures/2403.12529/main_figure.jpegoptim.jpg
---
