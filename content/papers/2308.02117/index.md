...
- name: Ling Yang
  orcid: null
  s2_author_id: '2155557947'
  s2_url: null
- name: Ye Tian
  orcid: null
  s2_author_id: '2143701186'
  s2_url: null
- name: Minkai Xu
  orcid: null
  s2_author_id: '1490886784'
  s2_url: null
- name: Zhongyi Liu
  orcid: null
  s2_author_id: '2145285454'
  s2_url: null
- name: Shenda Hong
  orcid: null
  s2_author_id: '2145267154'
  s2_url: null
- name: Wei Qu
  orcid: null
  s2_author_id: '2228684032'
  s2_url: null
- name: Wentao Zhang
  orcid: null
...
- name: J. Leskovec
  ...
  s2_url: null
published_date: Aug 4, 2023
published_date_iso: '2023-08-04'
...
abstract: GNN-to-MLP distillation aims to utilize knowledge distillation (KD) to learn
  ...
  mimicking the output representations of teacher GNN. Existing methods mainly make
  the MLP to mimic the GNN predictions over a few class labels. However, the class
  space may not be expressive enough for covering numerous diverse local graph structures,
  thus limiting the performance of knowledge transfer from GNN to MLP. To address
  this issue, we propose to learn a new powerful graph representation space by directly
  labeling nodes' diverse local structures for GNN-to-MLP distillation. Specifically,
  we propose a variant of VQ-VAE to learn a structure-aware tokenizer on graph data
  that can encode each node's local substructure as a discrete code. The discrete
  codes constitute a codebook as a new graph representation space that is able to
  identify different local graph structures of nodes with the corresponding code indices.
  Then, based on the learned codebook, we propose a new distillation target, namely
  soft code assignments, to directly transfer the structural knowledge of each node
  from GNN to MLP. The resulting framework VQGraph achieves new state-of-the-art performance
  on GNN-to-MLP distillation in both transductive and inductive settings across seven
  graph datasets. We show that VQGraph with better performance infers faster than
  GNNs by 828×, and also achieves accuracy improvement over GNNs and stand-alone MLPs
  by 3.90\
codebase_url: https://github.com/YangLing0818/VQGraph
...
- &id002
  ...
  - model: Only-VQ
    ...
    value_gap_source_date_iso: '2023-08-04'
    ...
    true_value: 0.7496
    true_std: 0.015
    value_gap_source_arxiv: '2308.02117'
    value_gap_source_title: 'VQGraph: Rethinking Graph Representation Space for Bridging
      GNNs and MLPs'
  ...
  - model: MLP
    ...
    is_best: false
    is_std_outlier: false
  - model: AE+Class-based
    model_key: ae+class-based
    model_plain: AE+Class-based
    value: 0.7165
    std: 0.0069
    paper_value: 0.7165
    paper_std: 0.0069
    ...
    is_std_outlier: false
  - model: Class-based
    model_key: class-based
    model_plain: Class-based
    value: 0.7122
    std: 0.0154
    paper_value: 0.7122
    paper_std: 0.0154
...
- &id001
  ...
  - model: NOSMOG
    ...
    at_pub_value: 0.8304
    at_pub_std: 0.0126
    at_pub_source_arxiv: '2208.10010'
    at_pub_source_title: 'NOSMOG: Learning Noise-robust and Structure-aware MLPs on
      Graphs'
    at_pub_source_date_iso: '2022-08-22'
...
- &id005
  ...
  - model: MLP
    ...
    gap_vs_at_pub: 0.14979999999999993
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GCNII
    ...
    is_best: true
    is_std_outlier: false
  - model: ACMGCN with our Graph VQ-VAE
    model_key: acmgcn with our graph vq-vae
    model_plain: ACMGCN with our Graph VQ-VAE
    value: 0.8459
    std: null
    paper_value: 0.8459
    paper_std: null
  ...
  - model: SAGE
    ...
    is_best: false
    is_std_outlier: false
  - model: MLP with our Graph VQ-VAE
    model_key: mlp with our graph vq-vae
    model_plain: MLP with our Graph VQ-VAE
    value: 0.7829
    std: null
    paper_value: 0.7829
    paper_std: null
    ...
    is_best: false
    is_std_outlier: false
  - model: GCNII with our Graph VQ-VAE
    model_key: gcnii with our graph vq-vae
    model_plain: GCNII with our Graph VQ-VAE
    value: 0.7829
    std: null
    paper_value: 0.7829
    paper_std: null
...
- &id004
  ...
  - model: MLP
    ...
    gap_vs_at_pub: 0.16579999999999995
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
single_proposed_model: VQGraph
main_figure: /figures/2308.02117/main_figure.jpegoptim.jpg
---
