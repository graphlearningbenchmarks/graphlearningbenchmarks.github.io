...
- name: Reza Shirkavand
  orcid: null
  s2_author_id: '2055028725'
  s2_url: null
- name: Heng Huang
  orcid: null
  s2_author_id: '2243268584'
  s2_url: null
published_date: Sep 18, 2023
published_date_iso: '2023-09-18'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: Graph transformers have gained popularity in various graph-based tasks by
  addressing challenges faced by traditional Graph Neural Networks. However, the quadratic
  complexity of self-attention operations and the extensive layering in graph transformer
  architectures present challenges when applying them to graph based prediction tasks.
  Fine-tuning, a common approach, is resource-intensive and requires storing multiple
  copies of large models. We propose a novel approach called deep graph prompt tuning
  as an alternative to fine-tuning for leveraging large graph transformer models in
  downstream graph based prediction tasks. Our method introduces trainable feature
  nodes to the graph and pre-pends task-specific tokens to the graph transformer,
  enhancing the model's expressive power. By freezing the pre-trained parameters and
  only updating the added tokens, our approach reduces the number of free parameters
  and eliminates the need for multiple model copies, making it suitable for small
  datasets and scalable to large graphs. Through extensive experiments on various-sized
  datasets, we demonstrate that deep graph prompt tuning achieves comparable or even
  superior performance to fine-tuning, despite utilizing significantly fewer task-specific
  parameters. Our contributions include the introduction of prompt tuning for graph
  transformers, its application to both graph transformers and message passing graph
  neural networks, improved efficiency and resource utilization, and compelling experimental
  results. This work brings attention to a promising approach to leverage pre-trained
  models in graph based prediction tasks and offers new opportunities for exploring
  and advancing graph representation learning.
codebase_url: ''
...
- &id004
  ...
  - model: GraphGPS FT
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: ladislav2022graphgps
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 5-fold cross-validation on BACE
    date: Sep 18, 2023
...
- &id008
  ...
  - model: LiGhT FT
    ...
    protocol_decision: standard
    protocol_note: MoleculeNet regression task using standard split
    date: Sep 18, 2023
    date_display: Sep 2023
    date_iso: '2023-09-18'
    published_venue: ''
...
- &id009
  ...
  - model: LiGhT FT
    ...
    evaluation_task: graph_regression
    protocol_decision: standard
    protocol_note: MoleculeNet regression task using standard scaffold split
    date: Sep 18, 2023
    date_display: Sep 2023
    date_iso: '2023-09-18'
    published_venue: ''
...
- &id006
  ...
  - model: LiGhT DeepGPT
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 5-fold cross-validation on MoleculeNet SIDER
    date: Sep 18, 2023
    date_display: Sep 2023
    date_iso: '2023-09-18'
    published_venue: ''
...
- &id003
  ...
  - model: GINE
    ...
    at_pub_value: 0.8668
    at_pub_std: 0.0077
    at_pub_source_arxiv: '2306.10767'
    at_pub_source_title: 'P-tensors: a General Framework for Higher Order Message
      Passing in Subgraph Neural Networks'
    at_pub_source_date_iso: '2023-06-19'
    at_pub_source_date_label: '2023'
    value_gap_source_date_iso: '2023-06-19'
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.15280000000000005
    ...
    comparison_source_title: 'P-tensors: a General Framework for Higher Order Message
      Passing in Subgraph Neural Networks'
    comparison_source_arxiv: '2306.10767'
    is_best: true
    is_std_outlier: false
  - model: LiGhT FT
    model_key: light ft
...
- &id007
  ...
  - model: LiGhT DeepGPT
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 5-fold cross-validation on ToxCast classification task
    date: Sep 18, 2023
    date_display: Sep 2023
    date_iso: '2023-09-18'
    published_venue: ''
...
- &id002
  ...
  - model: PNA
    ...
    value_gap_source_date_iso: '2026-04-19'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.02679999999999999
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
main_figure: /figures/2309.10131/main_figure.jpegoptim.jpg
---
