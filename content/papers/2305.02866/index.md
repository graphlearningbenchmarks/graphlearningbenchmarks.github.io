...
- name: Wenhao Zhu
  orcid: null
  s2_author_id: '2131383723'
  s2_url: null
- name: Tianyu Wen
  orcid: null
  s2_author_id: '2150913321'
  s2_url: null
- name: Guojie Song
  orcid: null
...
- name: Liang Wang
  orcid: null
  s2_author_id: '2155131551'
  s2_url: null
published_date: May 4, 2023
published_date_iso: '2023-05-04'
...
abstract: Graph Transformer is gaining increasing attention in the field of machine
  learning and has demonstrated state-of-the-art performance on benchmarks for graph
  representation learning. However, as current implementations of Graph Transformer
  primarily focus on learning representations of small-scale graphs, the quadratic
  complexity of the global self-attention mechanism presents a challenge for full-batch
  training when applied to larger graphs. Additionally, conventional sampling-based
  methods fail to capture necessary high-level contextual information, resulting in
  a significant loss of performance. In this paper, we introduce the Hierarchical
  Scalable Graph Transformer (HSGT) as a solution to these challenges. HSGT successfully
  scales the Transformer architecture to node representation learning tasks on large-scale
  graphs, while maintaining high performance. By utilizing graph hierarchies constructed
  through coarsening techniques, HSGT efficiently updates and stores multi-scale information
  in node embeddings at different levels. Together with sampling-based training methods,
  HSGT effectively captures and aggregates multi-level information on the hierarchical
  graph using only Transformer blocks. Empirical evaluations demonstrate that HSGT
  achieves state-of-the-art performance on large-scale benchmarks with graphs containing
  millions of nodes with high efficiency.
codebase_url: ''
...
- &id004
  ...
  - model: GAT
    ...
    protocol_note: node classification task on Amazon-Photo dataset
    date: May 4, 2023
  ...
  - model: HSGT
    ...
    is_best: false
    is_std_outlier: false
  - model: Graphormer-SAMPLE
    model_key: graphormer-sample
    model_plain: Graphormer-SAMPLE
    value: 0.9276
    std: 0.0059
    paper_value: 0.9276
    paper_std: 0.0059
  ...
  - model: GIN
    ...
    gap_vs_at_pub: 0.10760000000000003
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    is_std_outlier: false
  - model: SAT-SAMPLE
    model_key: sat-sample
    model_plain: SAT-SAMPLE
    value: 0.9135
    std: 0.0042
    paper_value: 0.9135
    paper_std: 0.0042
...
- &id002
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2023-05-10'
    value_gap_source_date_label: ICML 2023
    gap_vs_at_pub: 0.10930000000000006
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GIN
    ...
    gap_vs_at_pub: 0.12560000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id001
  ...
  - model: GCN
    ...
    gap_vs_at_pub: 0.10129999999999995
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id005
  ...
  - model: HSGT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: node classification task on Reddit dataset
    date: May 4, 2023
    date_display: May 2023
    date_iso: '2023-05-04'
    published_venue: IJCAI 2023
  ...
  - model: Cluster-GCN
    ...
    at_pub_value: 0.9623
    at_pub_std: null
    at_pub_source_arxiv: '2104.10569'
    at_pub_source_title: 'GraphTheta: A Distributed Graph Neural Network Learning
      System With Flexible Training Strategy'
    at_pub_source_date_iso: '2021-04-21'
    at_pub_source_date_label: '2021'
    ...
    has_value_gap: true
    comparison_type: behind
    comparison_source_title: 'GraphTheta: A Distributed Graph Neural Network Learning
      System With Flexible Training Strategy'
    comparison_source_arxiv: '2104.10569'
    is_best: false
    is_std_outlier: false
  - model: GAS-GCN
    model_key: gas-gcn
...
- &id006
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on ogbn-products test split
    date: May 4, 2023
    date_display: May 2023
    date_iso: '2023-05-04'
    published_venue: IJCAI 2023
...
- &id007
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: ROC-AUC on ogbn-proteins test split
    date: May 4, 2023
    date_display: May 2023
    date_iso: '2023-05-04'
    published_venue: IJCAI 2023
...
single_proposed_model: HSGT
main_figure: /figures/2305.02866/main_figure.jpegoptim.jpg
---
