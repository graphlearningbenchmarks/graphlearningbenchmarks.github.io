...
- name: Xiaorui Liu
  orcid: null
  s2_author_id: '2124928119'
  s2_url: null
- name: Torkamani Ali
  orcid: null
  s2_author_id: '2168447484'
  s2_url: null
- name: Feng Shi
  orcid: null
  s2_author_id: '122710522'
  s2_url: null
- name: Victor E. Lee
  orcid: null
  s2_author_id: '2058056841'
  s2_url: null
- name: Jiliang Tang
  orcid: null
  s2_author_id: '1736632'
  s2_url: null
published_date: Jun 8, 2022
published_date_iso: '2022-06-08'
...
abstract: Graph Neural Networks (GNNs) have greatly advanced the semi-supervised node
  ...
  new optimization framework for semi-supervised learning on graphs. The proposed
  framework can be conveniently solved by the alternating optimization algorithms,
  resulting in significantly improved efficiency. Extensive experiments demonstrate
  that the proposed method can achieve comparable or better performance with state-of-the-art
  baselines while it has significantly better computation and memory efficiency.
codebase_url: https://github.com/haoyuhan1/ALT-OPT
...
- &id002
  ...
  - model: GCN
    ...
    protocol_note: transductive node classification with 20% label rate
    date: Jun 8, 2022
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2026-05-18'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.08549999999999991
  ...
  - model: SIGN
    ...
    gap_vs_at_pub: 0.10059999999999991
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id001
  ...
  - model: SIGN
    ...
    value_gap_source_date_iso: '2025-06-16'
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.05590000000000006
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id003
  ...
  - model: GAT
    ...
    gap_vs_at_pub: 0.03389999999999993
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id004
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Transductive node classification with 8% label rate
    date: Jun 8, 2022
    date_display: Jun 2022
    date_iso: '2022-06-08'
    published_venue: ICML 2022
  ...
  - model: SGC
    ...
    value_gap_source_date_iso: '2022-03-01'
    value_gap_source_date_label: WWW 2022
    gap_vs_at_pub: 0.07909999999999995
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
single_proposed_model: ALT-OPT
main_figure: /figures/2206.03638/main_figure.jpegoptim.jpg
---
