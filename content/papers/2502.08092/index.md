...
- name: Yuan Fang
  ...
  s2_url: null
published_date: Feb 12, 2025
published_date_iso: '2025-02-12'
...
abstract: 'Chain-of-thought (CoT) prompting has achieved remarkable success in natural
  language processing (NLP). However, its vast potential remains largely unexplored
  for graphs. This raises an interesting question: How can we design CoT prompting
  for graphs to guide graph models to learn step by step? On one hand, unlike natural
  languages, graphs are non-linear and characterized by complex topological structures.
  On the other hand, many graphs lack textual data, making it difficult to formulate
  language-based CoT prompting. In this work, we propose the first CoT prompt learning
  framework for text-free graphs,. Specifically, we decompose the adaptation process
  for each downstream task into a series of inference steps, with each step consisting
  of prompt-based inference, ``thought'''' generation, and thought-conditioned prompt
  learning. While the steps mimic CoT prompting in NLP, the exact mechanism differs
  significantly. Specifically, at each step, an input graph, along with a prompt,
  is first fed into a pre-trained graph encoder for prompt-based inference. We then
  aggregate the hidden layers of the encoder to construct a ``thought'''', which captures
  the working state of each node in the current step. Conditioned on this thought,
  we learn a prompt specific to each node based on the current state. These prompts
  are fed into the next inference step, repeating the cycle. To evaluate and analyze
  the effectiveness of, we conduct comprehensive experiments on eight public datasets,
  which demonstrate the advantage of our approach.'
codebase_url: ''
...
- &id004
  ...
  - model: GAT
    ...
    protocol_note: One-shot node classification task
    date: Feb 12, 2025
    ...
    gap_vs_at_pub: 0.43189999999999995
  ...
  - model: GraphCL
    ...
    gap_vs_at_pub: 0.23919999999999997
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GPF
    ...
    is_std_outlier: true
  - model: DGI/InfoGraph
    model_key: dgi/infograph
    model_plain: DGI/InfoGraph
    value: 0.5889
    std: 0.1097
    paper_value: 0.5889
    paper_std: 0.1097
...
- &id008
  ...
  - model: GCoT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: One-shot node classification on the large-scale CLUSTER dataset
    date: Feb 12, 2025
    date_display: Feb 2025
    date_iso: '2025-02-12'
    published_venue: KDD 2025
...
- &id003
  ...
  - model: GraphCL
    ...
    gap_vs_at_pub: 0.29379999999999995
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GPF
    ...
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.12120000000000003
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
  ...
  - model: DGI/InfoGraph
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: velivckovic2017graph; sun2019infograph
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split (Yang et al. 2016 fixed split) for node classification
...
- &id001
  ...
  - model: GCN
    ...
    protocol_note: Planetoid split (Yang et al. 2016 fixed 20-per-class train split)
      for one-shot node classification.
    date: Feb 12, 2025
    date_display: Feb 2025
    date_iso: '2025-02-12'
    published_venue: KDD 2025
    ...
    gap_vs_at_pub: 0.5753999999999999
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GraphCL
    ...
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.32320000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GPF
    ...
    value_gap_source_date_iso: '2025-02-12'
    value_gap_source_date_label: KDD 2025
    gap_vs_at_pub: 0.19029999999999997
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: true
...
- &id005
  ...
  - model: GAT
    ...
    gap_vs_at_pub: 0.37610000000000005
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GCN
    ...
    gap_vs_at_pub: 0.36369999999999997
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GPF
    ...
    value_gap_source_date_label: NeurIPS 2024
    gap_vs_at_pub: 0.09330000000000005
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id002
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2025-05-19'
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.39680000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GraphCL
    ...
    value_gap_source_date_iso: '2022-06-07'
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.35159999999999997
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id007
  ...
  - model: DGI
    ...
    gap_vs_at_pub: 0.27370000000000005
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
single_proposed_model: GCoT
main_figure: /figures/2502.08092/main_figure.jpegoptim.jpg
---
