...
- name: Shixuan Liu
  orcid: null
  s2_author_id: '2131176508'
  s2_url: null
- name: Kuihua Huang
  orcid: null
  s2_author_id: '46431995'
  s2_url: null
- name: Xiang Zhao
  orcid: null
  s2_author_id: '1862330484'
  s2_url: null
- name: Jincai Huang
  orcid: null
  s2_author_id: '2377286733'
  s2_url: null
- name: Zhong Liu
  orcid: null
  s2_author_id: '2204875701'
  s2_url: null
...
abstract: Graph neural networks (GNNs) are effective machine learning models for many
  graph-related applications. Despite their empirical success, many research efforts
  focus on the theoretical limitations of GNNs, i.e., the GNNs expressive power. Early
  works in this domain mainly focus on studying the graph isomorphism recognition
  ability of GNNs, and recent works try to leverage the properties such as subgraph
  counting and connectivity learning to characterize the expressive power of GNNs,
  which are more practical and closer to real-world. However, no survey papers and
  open-source repositories comprehensively summarize and discuss models in this important
  direction. To fill the gap, we conduct a first survey for models for enhancing expressive
  power under different forms of definition. Concretely, the models are reviewed based
  on three categories, i.e., Graph feature enhancement, Graph topology enhancement,
  and GNNs architecture enhancement.
codebase_url: ''
...
- &id002
  ...
  - model: GNN-HF
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: zhu2021interpreting
    ...
    gap_vs_at_pub: 0.16170000000000007
  ...
  - model: PEG
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: wang2022equivariant
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split (Yang et al. 2016 fixed split)
...
- &id005
  ...
  - model: SAGNN
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: zeng2023substructure
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV
  ...
  - model: GraphSNN
    ...
    value_gap_source_date_iso: '2025-03-03'
    value_gap_source_date_label: KDD 2025
    gap_vs_at_pub: 0.10659999999999992
    worse_than_at_pub: false
    surpassed_since_pub: false
  ...
  - model: CLIP
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: dasoulas2019coloring
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV
  ...
  - model: GNNML3
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: balcilar2021breaking
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV
  ...
  - model: PPGN
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: geerts2020expressive
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV
...
- &id003
  ...
  - model: Geom-GCN
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.021499999999999964
    has_value_note: false
    value_note: ''
    sort_value: 0.9005
    sort_std: 0.0047
...
- &id004
  ...
  - model: IGN
    ...
    protocol_decision: standard
    protocol_note: Standard ZINC graph regression task
    date: Aug 16, 2023
    date_display: Aug 2023
    date_iso: '2023-08-16'
    published_venue: ''
...
main_figure: /figures/2308.08235/main_figure.jpegoptim.jpg
---
