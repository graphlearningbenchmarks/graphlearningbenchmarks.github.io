...
source_url: ''
authors:
- name: Andreea Deac Mila, Universit\'e de Montr\'eal Marc Lackenby Petar Veli kovi\'c
  orcid: null
...
- &id001
  ...
  - model: GIN + EGP
    ...
    true_value: 0.7934
    true_std: 0.0035
    value_gap_source_arxiv: '2210.02997'
    value_gap_source_title: Expander Graph Propagation
  ...
  - model: GIN + FA
    ...
    is_std_outlier: false
  - model: GIN + G-RLEF
    model_key: gin + g-rlef
    model_plain: GIN + G-RLEF
    value: 0.7802
    std: 0.0024
    paper_value: 0.7802
    paper_std: 0.0024
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: banerjee2022oversquashing
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: OGB scaffold split for graph classification
...
- &id003
  ...
  - model: GIN
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: OGB species split as per canonical definition.
    date: Oct 6, 2022
    date_display: Oct 2022
    date_iso: '2022-10-06'
    published_venue: LoG 2022
...
main_figure: /figures/2210.02997/main_figure.jpegoptim.jpg
---
