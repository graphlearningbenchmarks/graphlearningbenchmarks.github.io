...
abstract: Graph Contrastive Learning (GCL) is a widely adopted approach in self-supervised
  graph representation learning, applying contrastive objectives to produce effective
  representations. However, current GCL methods primarily focus on capturing implicit
  semantic relationships, often overlooking the structural commonsense embedded within
  the graph’s structure and attributes, which contains underlying knowledge crucial
  for effective representation learning. Due to the lack of explicit information and
  clear guidance in general graph, identifying and integrating such structural commonsense
  in GCL poses a significant challenge. To address this gap, we propose a novel framework
  called Structural Commonsense Unveiling in Graph Contrastive Learning (Str-GCL).
  Str-GCL leverages first-order logic rules to represent structural commonsense and
  explicitly integrates them into the GCL framework. It introduces topological and
  attribute-based rules without altering the original graph and employs a representation
  alignment mechanism to guide the encoder in effectively capturing this commonsense.
  To the best of our knowledge, this is the first attempt to directly incorporate
  structural commonsense into GCL. Extensive experiments demonstrate that Str-GCL
  outperforms existing GCL methods, providing a new perspective on leveraging structural
  commonsense in graph representation learning.
codebase_url: ''
...
- &id002
  ...
  - model: Supervised GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Computers dataset using labels Y
    date: Apr 22, 2025
    date_display: Apr 2025
    date_iso: '2025-04-22'
    published_venue: WWW 2025
    ...
    at_pub_value: 0.8811
    at_pub_std: 0.0014
    at_pub_source_arxiv: '2310.03977'
    at_pub_source_title: Perfect Alignment May be Poisonous to Graph Contrastive Learning
    ...
    has_value_gap: true
    comparison_type: behind
    comparison_source_title: Perfect Alignment May be Poisonous to Graph Contrastive
      Learning
    comparison_source_arxiv: '2310.03977'
    is_best: false
    is_std_outlier: false
  - model: DGI
    model_key: dgi
...
- &id001
  ...
  - model: Str-GCL
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Photo dataset using features X and adjacency
      A.
    date: Apr 22, 2025
    date_display: Apr 2025
    date_iso: '2025-04-22'
  ...
  - model: ProGCL
    ...
    has_value_gap: true
    comparison_type: behind
    comparison_source_title: 'Architecture Matters: Uncovering Implicit Mechanisms
      in Graph Contrastive Learning'
    comparison_source_arxiv: '2311.02687'
    is_best: false
    is_std_outlier: false
  - model: BGRL
    model_key: bgrl
  ...
  - model: Supervised GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Photo dataset using features X, adjacency
      A, and labels Y.
    date: Apr 22, 2025
    date_display: Apr 2025
    date_iso: '2025-04-22'
    ...
    value_gap_source_date_iso: '2023-10-06'
    value_gap_source_date_label: ICML 2023
    gap_vs_at_pub: 0.008599999999999941
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: DeepWalk
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Photo dataset using adjacency A.
    date: Apr 22, 2025
    date_display: Apr 2025
    date_iso: '2025-04-22'
    published_venue: WWW 2025
...
single_proposed_model: Str-GCL
main_figure: /figures/2507.07141/main_figure.jpegoptim.jpg
---
