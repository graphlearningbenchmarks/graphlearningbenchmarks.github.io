...
- name: Xiao Liu
  orcid: null
  s2_author_id: '2111310607'
  s2_url: null
- name: Lijun Zhang
  orcid: null
  s2_author_id: '2108877321'
  s2_url: null
- name: Hui Guan
  orcid: null
  s2_author_id: '2055337890'
  s2_url: null
...
abstract: Message passing neural networks (MPNNs) learn the representation of graph-structured
  data based on graph original information, including node features and graph structures,
  and have shown astonishing improvement in node classiﬁcation tasks. However, the
  expressive power of MPNNs is upper bounded by the ﬁrst-order Weisfeiler-Leman test
  and its accuracy still has room for improvement. This work studies how to improve
  MPNNs’ expressiveness and generalizability by fully exploiting graph original information
  both theoretically and empirically. It further proposes a new GNN model called INGNN
  (INformation-enhanced Graph Neural Network) that leverages the insights to improve
  node classiﬁcation performance. Extensive experiments on both synthetic and real
  datasets demonstrate the superiority (av-erage rank 1.78) of our INGNN compared
...
- &id002
  ...
  - model: GCN
    ...
    gap_vs_at_pub: 0.16069999999999995
  ...
  - model: DAGNN
    ...
    gap_vs_at_pub: 0.11480000000000001
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id003
  ...
  - model: GloGNN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: test accuracy on penn94 using official splits
    date: Oct 8, 2022
    date_display: Oct 2022
    date_iso: '2022-10-08'
    published_venue: ''
  ...
  - model: H2GCN
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.016599999999999948
    has_value_note: false
    value_note: ''
    sort_value: 0.832
    sort_std: 0.0055
...
- &id001
  ...
  - model: H2GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: PubMed node classification using Planetoid split (Yang et al. 2016)
      as per dataset description.
    date: Oct 8, 2022
    date_display: Oct 2022
    date_iso: '2022-10-08'
    published_venue: ''
    ...
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.13190000000000002
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GCN
    ...
    value_gap_source_date_iso: '2025-05-19'
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.11580000000000001
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id004
  ...
  - model: INGNN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy on arXiv-year using official split
    date: Oct 8, 2022
    date_display: Oct 2022
    date_iso: '2022-10-08'
    published_venue: ''
  ...
  - model: BernNet
    ...
    gap_vs_at_pub: 0.09849999999999998
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GPR-GNN
    ...
    value_gap_source_title: Convolutional Neural Networks on Graphs with Chebyshev
      Approximation, Revisited
    value_gap_source_is_current_paper: false
    value_gap: 0.010799999999999976
    has_value_note: false
    value_note: ''
    sort_value: 0.4597
    sort_std: 0.0026
...
single_proposed_model: INGNN
main_figure: /figures/2210.05382/main_figure.jpegoptim.jpg
---
