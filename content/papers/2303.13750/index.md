...
- name: Wenyuan Yu
  orcid: null
  s2_author_id: '2116673448'
  s2_url: null
- name: Yaliang Li
  orcid: null
  s2_author_id: '2110479359'
  s2_url: null
- name: Zhewei Wei
  orcid: null
  s2_author_id: '12457830'
  s2_url: null
published_date: Mar 24, 2023
published_date_iso: '2023-03-24'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: In recent years, a plethora of spectral graph neural networks (GNN) methods
  have utilized polynomial basis with learnable coefficients to achieve top-tier performances
  on many node-level tasks. Although various kinds of polynomial bases have been explored,
  each such method adopts a fixed polynomial basis which might not be the optimal
  choice for the given graph. Besides, we identify the so-called over-passing issue
  of these methods and show that it is somewhat rooted in their less-principled regularization
  strategy and unnormalized basis. In this paper, we make the first attempts to address
  these two issues. Leveraging Jacobi polynomials, we design a novel spectral GNN,
  LON-GNN, with Learnable OrthoNormal bases and prove that regularizing coefficients
  becomes equivalent to regularizing the norm of learned filter function now. We conduct
  extensive experiments on diverse graph datasets to evaluate the fitting and generalization
  capability of LON-GNN, where the results imply its superiority.
...
- &id004
  ...
  - model: BernNet
    ...
    protocol_note: 60/20/20 split, 10-fold average reported
    date: Mar 24, 2023
  ...
  - model: GCN
    ...
    value_gap_source_title: Restructuring Graphs for Higher Homophily via Adaptive
      Spectral Clustering
    value_gap_source_is_current_paper: false
    value_gap: 0.029700000000000004
    has_value_note: false
    value_note: ''
    sort_value: 0.362
    sort_std: 0.01
...
- &id002
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: 60/20/20 split as described in setup
    date: Mar 24, 2023
    date_display: Mar 2023
    date_iso: '2023-03-24'
    published_venue: ''
...
- &id001
  ...
  - model: GCN
    ...
    value_gap_source_date_iso: '2026-05-18'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.0482999999999999
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id005
  ...
  - model: JacobiConv
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: 60/20/20 split, 10-fold average accuracy
    date: Mar 24, 2023
    date_display: Mar 2023
    date_iso: '2023-03-24'
    published_venue: ''
  ...
  - model: APPNP
    ...
    value_gap_source_date_iso: '2022-06-06'
    value_gap_source_date_label: AAAI 2022
    gap_vs_at_pub: 0.14860000000000007
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id003
  ...
  - model: BernNet
    ...
    is_best: true
    is_std_outlier: false
  - model: Jacobi+Learnable
    model_key: jacobi+learnable
    model_plain: Jacobi+Learnable
    value: 0.9191
    std: null
    paper_value: 0.9191
    paper_std: null
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Ablation study comparison against JacobiConv
    date: Mar 24, 2023
    date_display: Mar 2023
    date_iso: '2023-03-24'
    published_venue: ''
  ...
  - model: LON-GNN
    ...
    is_best: false
    is_std_outlier: false
  - model: Jacobi+OrthNorm
    model_key: jacobi+orthnorm
    model_plain: Jacobi+OrthNorm
    value: 0.8383
    std: null
    paper_value: 0.8383
    paper_std: null
...
- &id006
  ...
  - model: JacobiConv
    ...
    value_gap_source_date_iso: '2024-03-12'
    value_gap_source_date_label: WWW 2024
    gap_vs_at_pub: 0.25379999999999997
    worse_than_at_pub: false
    surpassed_since_pub: false
  ...
  - model: APPNP
    ...
    value_gap_source_date_iso: '2022-06-06'
    value_gap_source_date_label: AAAI 2022
    gap_vs_at_pub: 0.21190000000000003
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GPRGNN
    ...
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.0041000000000001036
    worse_than_at_pub: false
    surpassed_since_pub: true
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
single_proposed_model: LON-GNN
main_figure: /figures/2303.13750/main_figure.jpegoptim.jpg
---
