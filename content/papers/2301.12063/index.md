...
- name: Ling Chi
  ...
  s2_author_id: null
  s2_url: null
published_date: Jan 28, 2023
published_date_iso: '2023-01-28'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: '[S U M M A R Y] Self-supervised auto-encoders have emerged as a successful
  framework for representation learning in computer vision and natural language processing
  in recent years, However, their application to graph data has been met with limited
  performance due to the non-Euclidean and complex structure of graphs in comparison
  to images or text, as well as the limitations of conventional auto-encoder architectures.
  In this paper, we investigate factors impacting the performance of auto-encoders
  on graph data and propose a novel auto-encoder model for graph representation learning.
  Our model incorporates a hierarchical adaptive masking mechanism to incrementally
  increase the difficulty of training in order to mimic the process of human cognitive
  learning, and a trainable corruption scheme to enhance the robustness of learned
  representations. Through extensive experimentation on ten benchmark datasets, we
  demonstrate the superiority of our proposed method over state-of-the-art graph representation
  learning models.'
codebase_url: ''
...
- &id002
  ...
  - model: GCN
    ...
    protocol_note: Transductive task accuracy
    date: Jan 28, 2023
  ...
  - model: DGI
    ...
    is_std_outlier: false
  - model: HAT-GAE-TC
    model_key: hat-gae-tc
    model_plain: HAT-GAE-TC
    value: 0.8769
    std: 0.0026
    paper_value: 0.8769
    paper_std: 0.0026
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Ablation variant accuracy
    date: Jan 28, 2023
    date_display: Jan 2023
    date_iso: '2023-01-28'
    published_venue: ''
    ...
    is_std_outlier: false
  - model: HAT-GAE-HM
    model_key: hat-gae-hm
    model_plain: HAT-GAE-HM
    value: 0.8767
    std: 0.0016
    paper_value: 0.8767
    paper_std: 0.0016
    ...
    is_std_outlier: false
  - model: HAT-GAE-AM
    model_key: hat-gae-am
    model_plain: HAT-GAE-AM
    value: 0.8741
    std: 0.0003
    paper_value: 0.8741
    paper_std: 0.0003
...
- &id004
  ...
  - model: GCN
    ...
    value_gap_source_title: 'Graph Transductive Sharpening: Leveraging Unlabeled Predictions
      in Node Classification'
    value_gap_source_is_current_paper: false
    value_gap: 0.019400000000000084
    has_value_note: false
    value_note: ''
    sort_value: 0.9744
    sort_std: 0.0014
...
- &id006
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Inductive task evaluation on PPI dataset
    date: Jan 28, 2023
    date_display: Jan 2023
    date_iso: '2023-01-28'
    published_venue: ''
...
- &id003
  ...
  - model: HAT-GAE
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Inductive task evaluation on Reddit
    date: Jan 28, 2023
    date_display: Jan 2023
    date_iso: '2023-01-28'
    published_venue: ''
