...
codebase_url: https://github.com/wbkzwqtzw/MDGFM
...
- &id001
  ...
  - model: GAT
    ...
    protocol_note: 3-shot node classification
    date: Feb 4, 2025
    ...
    gap_vs_at_pub: 0.47369999999999995
  ...
  - model: DGI
    ...
    gap_vs_at_pub: 0.20129999999999998
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GraphCL
    ...
    gap_vs_at_pub: 0.14450000000000002
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id002
  ...
  - model: MDGFM
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: 500-shot node classification
    date: Feb 4, 2025
    date_display: Feb 2025
    date_iso: '2025-02-04'
    published_venue: ICML 2025
