...
- name: Juwei Yue
  orcid: null
  s2_author_id: '1999184651'
  s2_url: null
- name: Haikuo Li
  orcid: null
  s2_author_id: '2356916019'
  s2_url: null
- name: Jiawei Sheng
  orcid: null
  s2_author_id: '2054250919'
  s2_url: null
- name: Yihan Guo
  orcid: null
  s2_author_id: '2349893162'
  s2_url: null
- name: Xinghua Zhang
  orcid: null
  s2_author_id: '2267115542'
  s2_url: null
- name: Chuan Zhou
  orcid: null
  s2_author_id: '2300672508'
  s2_url: null
- name: Tingwen Liu
  orcid: null
  s2_author_id: '2288903320'
  s2_url: null
- name: Li Guo
  orcid: null
  s2_author_id: '2356885684'
  s2_url: null
published_date: Apr 22, 2025
published_date_iso: '2025-04-22'
...
abstract: Dynamics modeling has been introduced as a novel paradigm in message passing
  (MP) of graph neural networks (GNNs). Existing methods consider MP between nodes
  as a heat diffusion process, and leverage heat equation to model the temporal evolution
  of nodes in the embedding space. However, heat equation can hardly depict the wave
  nature of graph signals in graph signal processing. Besides, heat equation is essentially
  a partial differential equation (PDE) involving a first partial derivative of time,
  whose numerical solution usually has low stability, and leads to inefficient model
  training. In this paper, we would like to depict more wave details in MP, since
  graph signals are essentially wave signals that can be seen as a superposition of
  a series of waves in the form of eigenvector. This motivates us to consider MP as
  a wave propagation process to capture the temporal evolution of wave signals in
  the space. Based on wave equation in physics, we innovatively develop a graph wave
  equation to leverage the wave propagation on graphs. In details, we demonstrate
  that the graph wave equation can be connected to traditional spectral GNNs, facilitating
  the design of graph wave networks (GWNs) based on various Laplacians and enhancing
  the performance of the spectral GNNs. Besides, the graph wave equation is particularly
  a PDE involving a second partial derivative of time, which has stronger stability
  on graphs than the heat equation that involves a first partial derivative of time.
  Additionally, we theoretically prove that the numerical solution derived from the
  graph wave equation are constantly stable, enabling to significantly enhance model
  efficiency while ensuring its performance. Extensive experiments show that GWNs
  achieve state-of-the-art and efficient performance on benchmark datasets, and exhibit
  outstanding performance in addressing challenging graph problems, such as over-smoothing
  and heterophily. Our code is available at.
...
- &id002
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: 60%/20%/20% random split
    date: Apr 22, 2025
    date_display: Apr 2025
    date_iso: '2025-04-22'
    published_venue: WWW 2025
  ...
  - model: FAGCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Comparison with base models using best parameters
    date: Apr 22, 2025
    date_display: Apr 2025
    date_iso: '2025-04-22'
    published_venue: WWW 2025
  ...
  - model: GDC
    ...
    value_gap_source_date_iso: '2025-04-22'
    value_gap_source_date_label: WWW 2025
    gap_vs_at_pub: 0.0696000000000001
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: CGNN
    ...
    value_gap_source_date_iso: '2025-04-22'
    value_gap_source_date_label: WWW 2025
    gap_vs_at_pub: 0.08009999999999995
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
    ...
    has_value_gap: true
    comparison_type: improved
    comparison_source_title: Beltrami Flow and Neural Diffusion on Graphs
    comparison_source_arxiv: '2110.09443'
    is_best: false
    is_std_outlier: false
  - model: GADC
    model_key: gadc
...
- &id001
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: 60%/20%/20% random splits
    date: Apr 22, 2025
    date_display: Apr 2025
    date_iso: '2025-04-22'
    published_venue: WWW 2025
  ...
  - model: GDC
    ...
    value_gap_source_date_iso: '2025-04-22'
    value_gap_source_date_label: WWW 2025
    gap_vs_at_pub: 0.047599999999999976
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
- scope: node-level
  ...
  - benchmark: Heterophilic Graphs
    ...
    - dataset: Actor
      dataset_slug: actor
main_figure: /figures/2505.20034/main_figure.jpegoptim.jpg
---
