...
- name: Kai-Lang Yao
  orcid: null
  s2_author_id: '40895035'
  s2_url: null
- name: Wusuo Li
  orcid: null
  s2_author_id: '2108768720'
  s2_url: null
...
abstract: Link prediction is a fundamental problem in many graph based applications,
  such as protein-protein interaction prediction. Graph neural network (GNN) has recently
  been widely used for link prediction. However, existing GNN based link prediction
  (GNN-LP) methods suffer from scalability problem during training for large-scale
  graphs, which has received little attention by researchers. In this paper, we first
  give computation complexity analysis of existing GNN-LP methods, which reveals that
  the scalability problem stems from their symmetric learning strategy adopting the
  same class of GNN models to learn representation for both head and tail nodes. Then
  we propose a novel method, called sym etric earning (AML), for GNN-LP. The main
  idea of AML is to adopt a GNN model for learning head node representation while
  using a multi-layer perceptron (MLP) model for learning tail node representation.
  Furthermore, AML proposes a row-wise sampling strategy to generate mini-batch for
  training, which is a necessary component to make the asymmetric learning strategy
  work for training speedup. To the best of our knowledge, AML is the first GNN-LP
  method adopting an asymmetric learning strategy for node representation learning.
  Experiments on three real large-scale datasets show that AML is $1.7 7.3 $ faster
  in training than baselines with a symmetric learning strategy, while having almost
  no accuracy loss.
codebase_url: ''
...
- &id003
  ...
  - model: SEAL
    ...
    feature_source_evidence: ''
    table_ref: Table 2
    source_ref: ZhangLXWJ21
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: link_prediction
    protocol_decision: standard
    protocol_note: Standard test split for ogbl-citation2 link prediction
    date: Mar 1, 2023
...
- &id001
  ...
  - model: SEAL
    ...
    evaluation_task: link_prediction
    protocol_decision: standard
    protocol_note: Rerunning authors' code on clean ogbl-collab
    date: Mar 1, 2023
    date_display: Mar 2023
    date_iso: '2023-03-01'
    published_venue: ''
  ...
  - model: CN
    ...
    value_gap_source_date_iso: '2025-04-08'
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.11410000000000003
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: SAGE
    ...
    evaluation_task: link_prediction
    protocol_decision: standard
    protocol_note: Standard link prediction task on ogbl-collab
    date: Mar 1, 2023
    date_display: Mar 2023
    date_iso: '2023-03-01'
    published_venue: ''
  ...
  - model: AML
    ...
    input_feature_source: null
    feature_source_evidence: ''
    table_ref: Table 1 (GAT as the GNN model)
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: link_prediction
    protocol_decision: standard
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2023-03-01'
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.049290000000000056
    worse_than_at_pub: false
    surpassed_since_pub: false
  ...
  - model: MF
    ...
    value_gap_source_date_iso: '2024-10-02'
    value_gap_source_date_label: TMLR 2024
    gap_vs_at_pub: 0.009699999999999986
    worse_than_at_pub: false
    surpassed_since_pub: true
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id002
  ...
  - model: AML-R (G)
    ...
    evaluation_task: link_prediction
    protocol_decision: standard
    protocol_note: Standard test split for ogbl-ppa
    date: Mar 1, 2023
    date_display: Mar 2023
    date_iso: '2023-03-01'
    published_venue: ''
  ...
  - model: AML
    ...
    input_feature_source: null
    feature_source_evidence: ''
    table_ref: Table 1 (subtable GAT)
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: link_prediction
    protocol_decision: standard
...
main_figure: /figures/2303.00170/main_figure.jpegoptim.jpg
---
