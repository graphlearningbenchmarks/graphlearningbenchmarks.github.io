...
- name: Lukas Fesser Melanie Weber
  ...
  s2_url: null
published_date: Sep 17, 2023
published_date_iso: '2023-09-17'
published_venue: ''
...
- &id006
  ...
  - model: AFR-3
    ...
    value_gap_source_date_iso: '2023-09-17'
    ...
    true_value: 0.101
    true_std: 0.011
    value_gap_source_arxiv: '2309.09384'
    value_gap_source_title: Mitigating Over-Smoothing and Over-Squashing using Augmentations
...
- &id002
  ...
  - model: FoSR
    ...
    gap_vs_at_pub: 0.20650000000000002
  ...
  - model: SDRF
    ...
    value_gap_source_date_iso: '2022-10-21'
    value_gap_source_date_label: ICLR 2022
    gap_vs_at_pub: 0.15283000000000002
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: BORF
    ...
    gap_vs_at_pub: 0.035999999999999976
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_title: Revisiting Over-smoothing and Over-squashing using Ollivier's
      Ricci Curvature
    value_gap_source_is_current_paper: false
    value_gap: 0.035999999999999976
    has_value_note: false
    value_note: ''
    sort_value: 0.355
    sort_std: 0.012
...
- &id003
  ...
  - model: AFR-4
    ...
    is_best: false
    is_std_outlier: false
  - model: GCN with AFR-4
    model_key: gcn with afr-4
    model_plain: GCN with AFR-4
    value: 0.514
    std: 0.005
    paper_value: 0.514
    paper_std: 0.005
    ...
    is_best: false
    is_std_outlier: false
  - model: GCN with AFR-3
    model_key: gcn with afr-3
    model_plain: GCN with AFR-3
    value: 0.497
    std: 0.005
    paper_value: 0.497
    paper_std: 0.005
    ...
    is_std_outlier: false
  - model: GCN with BORF
    model_key: gcn with borf
    model_plain: GCN with BORF
    value: 0.489
    std: 0.005
    paper_value: 0.489
    paper_std: 0.005
    ...
    is_std_outlier: false
  - model: GCN with FoSR
    model_key: gcn with fosr
    model_plain: GCN with FoSR
    value: 0.469
    std: 0.012
    paper_value: 0.469
    paper_std: 0.012
    ...
    is_std_outlier: false
  - model: GCN with None
    model_key: gcn with none
    model_plain: GCN with None
    value: 0.441
    std: 0.005
    paper_value: 0.441
    paper_std: 0.005
    ...
    is_std_outlier: false
  - model: GCN with SDRF
    model_key: gcn with sdrf
    model_plain: GCN with SDRF
    value: 0.436
    std: 0.012
    paper_value: 0.436
    paper_std: 0.012
...
main_figure: /figures/2309.09384/main_figure.jpegoptim.jpg
---
