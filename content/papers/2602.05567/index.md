...
- name: Long D. Nguyen
  orcid: null
  s2_author_id: '2406197573'
  s2_url: null
- name: Binh P. Nguyen
  orcid: null
  s2_author_id: '2406356032'
  s2_url: null
published_date: Feb 5, 2026
published_date_iso: '2026-02-05'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: Pre-trained graph neural networks (GNNs) transfer well, but adapting them
  to downstream tasks remains challenging due to mismatches between pre-training objectives
  and task requirements. Graph prompt tuning offers a parameter-efficient alternative
  to fine-tuning, yet most methods only modify inputs or representations and leave
  message passing unchanged, limiting their ability to adapt neighborhood interactions.
  We propose message-adaptive graph prompt tuning, which injects learnable prompts
  into the message passing step to reweight incoming neighbor messages and add task-specific
  prompt vectors during message aggregation, while keeping the backbone GNN frozen.
  The approach is compatible with common GNN backbones and pre-training strategies,
  and applicable across downstream settings. Experiments on diverse node- and graph-level
  datasets show consistent gains over prior graph prompting methods in few-shot settings,
  while achieving performance competitive with fine-tuning in full-shot regimes.
codebase_url: ''
...
- &id004
  ...
  - model: MAGPrompt+
    ...
    protocol_note: ROC-AUC on BACE using Scaffold split (MoleculeNet full-shot)
    date: Feb 5, 2026
...
- &id005
  ...
  - model: MAGPrompt+
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: ROC-AUC on BBBP using full-shot MoleculeNet split
    date: Feb 5, 2026
    date_display: Feb 2026
    date_iso: '2026-02-05'
    published_venue: ''
  ...
  - model: GPF
    ...
    value_gap_source_date_iso: '2026-02-05'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.21620000000000006
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
- &id001
  ...
  - model: GPPT
    ...
    protocol_decision: standard
    protocol_note: 5-shot node classification on CiteSeer (Planetoid split) under
      LP-GraphPrompt pre-training
    date: Feb 5, 2026
    date_display: Feb 2026
    date_iso: '2026-02-05'
    published_venue: ''
    ...
    gap_vs_at_pub: 0.24499999999999994
  ...
  - model: EdgePrompt+
    ...
    value_gap_source_date_iso: '2026-02-05'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.11169999999999997
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
- &id006
  ...
  - model: GPF-plus
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: ROC-AUC on ClinTox using full-shot graph classification task
    date: Feb 5, 2026
    date_display: Feb 2026
    date_iso: '2026-02-05'
    published_venue: ''
...
- &id003
  ...
  - model: MAGPrompt+
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 50-shot graph classification task using LP-GPPT pre-training
    date: Feb 5, 2026
    date_display: Feb 2026
    date_iso: '2026-02-05'
    published_venue: ''
...
- &id002
  ...
  - model: EdgePrompt+
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 50-shot graph classification using GraphCL pre-training
    date: Feb 5, 2026
    date_display: Feb 2026
    date_iso: '2026-02-05'
    published_venue: ''
  ...
  - model: All-In-One
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 50-shot graph classification using LP-GPPT pre-training
    date: Feb 5, 2026
    date_display: Feb 2026
    date_iso: '2026-02-05'
    published_venue: ''
...
- &id007
  ...
  - model: GPF
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: ROC-AUC on SIDER using full-shot graph classification task (AttrMasking
      pre-training)
    date: Feb 5, 2026
    date_display: Feb 2026
    date_iso: '2026-02-05'
  ...
  - model: Fine-tune
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: ROC-AUC on SIDER using full-shot graph classification task (EdgePred
      pre-training)
    date: Feb 5, 2026
    date_display: Feb 2026
    date_iso: '2026-02-05'
  ...
  - model: MAGPrompt+
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: ROC-AUC on SIDER using full-shot graph classification task
    date: Feb 5, 2026
    date_display: Feb 2026
    date_iso: '2026-02-05'
    published_venue: ''
  ...
  - model: DGI
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: ROC-AUC on SIDER using full-shot graph classification task (DGI
      pre-training)
    date: Feb 5, 2026
    date_display: Feb 2026
    date_iso: '2026-02-05'
...
- scope: graph-level
  ...
  - benchmark: MoleculeNet
    ...
    - dataset: SIDER
      dataset_slug: sider
single_proposed_model: MAGPrompt+
main_figure: /figures/2602.05567/main_figure.jpegoptim.jpg
---
