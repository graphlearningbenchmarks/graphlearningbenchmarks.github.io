...
paper_type: method
proposed_models:
- Energy GNN (edge-wise)
- Energy GNN + attention
mrr: 0.0049
adjusted_mrr: 0.0049
mrr_dataset_count: 5
...
- &id002
  ...
  - model: GIN
    ...
    protocol_note: 10-fold cross validation for graph classification accuracy on MUTAG
    date: Jun 29, 2024
...
- &id001
  ...
  - model: IGNN
    ...
    protocol_decision: standard
    protocol_note: 20/2/2 train/valid/test split consistent with GraphSAGE, micro-F1
      score
    date: Jun 29, 2024
    date_display: Jun 2024
    date_iso: '2024-06-29'
...
- &id003
  ...
  - model: GIN
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold cross validation for graph classification accuracy
    date: Jun 29, 2024
    date_display: Jun 2024
    date_iso: '2024-06-29'
    published_venue: ICLR 2024
...
- &id005
  ...
  - model: Energy GNN + attention
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Average Precision (AP) on Peptides-func using a train/valid/test
      split consistent with LRGB.
    date: Jun 29, 2024
    date_display: Jun 2024
    date_iso: '2024-06-29'
    published_venue: ICLR 2024
  ...
  - model: GSD GNN
    ...
    is_std_outlier: false
  - model: IGNN (1 layer)
    model_key: ignn (1 layer)
    model_plain: IGNN (1 layer)
    value: 0.211
    std: null
    paper_value: 0.211
    paper_std: null
...
- &id004
  ...
  - model: GCN
    ...
    is_baseline: true
    is_overridden: true
    override_reason: Correct value from the source Peptides-func/Peptides-struct results
      table.
    params_millions: null
    architecture_type: gnn
    architecture_label: GNN
  ...
  - model: GAT (5 layer)
    ...
    protocol_decision: standard
    protocol_note: MAE on Peptides-struct using a train/valid/test split consistent
      with LRGB
    date: Jun 29, 2024
    date_display: Jun 2024
    date_iso: '2024-06-29'
