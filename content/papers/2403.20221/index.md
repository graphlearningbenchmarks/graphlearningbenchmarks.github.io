...
- name: Kaiyuan Cui
  orcid: null
  s2_author_id: '2294176052'
  s2_url: null
- name: Xinyan Wang
  orcid: null
  s2_author_id: '2286386128'
  s2_url: null
- name: Zicheng Zhang
  orcid: null
  s2_author_id: '2422361956'
  s2_url: null
- name: Weichen Zhao
  orcid: null
  s2_author_id: '2294502396'
  s2_url: null
published_date: Mar 29, 2024
published_date_iso: '2024-03-29'
published_venue: ''
...
abstract: Continuous graph neural models based on differential equations have expanded
  ...
  graph diffusion and message passing, diffusion-based models have been widely studied.
  However, diffusion naturally drives the system towards an equilibrium state, leading
  to issues like over-smoothing. To this end, we propose GRADE inspired by aph ggregation-
  iffusion quations, which includes the delicate balance between nonlinear diffusion
  and aggregation induced by interaction potentials. The node representations obtained
  through aggregation-diffusion equations exhibit metastability, indicating that features
  can aggregate into multiple clusters. In addition, the dynamics within these clusters
  can persist for long time periods, offering the potential to alleviate over-smoothing
  effects. This nonlinear diffusion in our model generalizes existing diffusion-based
  models and establishes a connection with classical GNNs. We prove that GRADE achieves
  competitive performance across various benchmarks and alleviates the over-smoothing
  issue in GNNs evidenced by the enhanced Dirichlet energy.
codebase_url: ''
...
- &id009
  ...
  - model: ACM-GCN
    ...
    protocol_note: 100 random train-val-test splits
    date: Mar 29, 2024
...
- &id005
  ...
  - model: MLP
    ...
    is_best: false
    is_std_outlier: false
  - model: GRADE-Gaussian
    model_key: grade-gaussian
    model_plain: GRADE-Gaussian
    value: 0.846
    std: 0.014
    paper_value: 0.846
    paper_std: 0.014
  ...
  - model: MoNet
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: Monti2016GeometricDL
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: 100 random train-val-test splits
...
- &id010
  ...
  - model: GloGNN
    ...
    value_gap_source_title: '$P^2$GNN: Two Prototype Sets to boost GNN Performance'
    value_gap_source_is_current_paper: false
    value_gap: 0.015300000000000091
    has_value_note: false
    value_note: ''
    sort_value: 0.7133
    sort_std: 0.0242
...
- &id003
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split (Yang et al. 2016 fixed split) using 100 random
    ...
    gap_vs_at_pub: 0.15790000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id006
  ...
  - model: GraphSage-max
    ...
    has_value_gap: true
    comparison_type: improved
    comparison_source_title: 'ACMP: Allen-Cahn Message Passing with Attractive and
      Repulsive Forces for Graph Neural Networks'
    comparison_source_arxiv: '2206.05437'
    is_best: false
    is_std_outlier: true
  - model: MoNet
    model_key: monet
...
- &id001
  ...
  - model: GRAND
    ...
    value_gap_source_title: Feature Transportation Improves Graph Neural Networks
    value_gap_source_is_current_paper: false
    value_gap: 0.056499999999999995
    has_value_note: false
    value_note: ''
    sort_value: 0.8815
    sort_std: null
...
- &id008
  ...
  - model: GloGNN
    ...
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.024500000000000077
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id002
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split (100 random train-val-test splits as per caption)
    date: Mar 29, 2024
    date_display: Mar 2024
    date_iso: '2024-03-29'
    published_venue: ''
...
- &id007
  ...
  - model: ACM-GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: 10 initialization and 100 random train-val-test splits
    date: Mar 29, 2024
    date_display: Mar 2024
    date_iso: '2024-03-29'
    published_venue: ''
  ...
  - model: GloGNN
    ...
    value_gap_source_title: '$P^2$GNN: Two Prototype Sets to boost GNN Performance'
    value_gap_source_is_current_paper: false
    value_gap: 0.009400000000000075
    has_value_note: false
    value_note: ''
    sort_value: 0.8524
    sort_std: 0.049
...
main_figure: /figures/2403.20221/main_figure.jpegoptim.jpg
---
