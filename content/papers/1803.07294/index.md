...
- name: Jiani Zhang
  orcid: null
  s2_author_id: '73329314'
  s2_url: null
- name: Xingjian Shi
  orcid: null
  s2_author_id: '3008587'
  s2_url: null
- name: Junyuan Xie
  orcid: null
  s2_author_id: '2369548'
  s2_url: null
- name: Hao Ma
  orcid: null
  s2_author_id: '144988795'
  s2_url: null
- name: Irwin King
  orcid: null
  s2_author_id: '145310663'
  s2_url: null
- name: D. Yeung
  orcid: null
  s2_author_id: '1739816'
  s2_url: null
published_date: Mar 20, 2018
published_date_iso: '2018-03-20'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: We propose a new network architecture, ted ttention etworks (GaAN), for
  learning on graphs. Unlike the traditional multi-head attention mechanism, which
  equally consumes all attention heads, GaAN uses a convolutional sub-network to control
  each attention head's importance. We demonstrate the effectiveness of GaAN on the
  inductive node classification problem. Moreover, with GaAN as a building block,
  we construct the Graph Gated Recurrent Unit (GGRU) to address the traffic speed
  forecasting problem. Extensive experiments on three real-world datasets show that
  our GaAN framework achieves state-of-the-art results on both tasks.
codebase_url: ''
...
- &id002
  ...
  - model: GaAN
    ...
    protocol_note: Inductive node classification on PPI split as described in setup
      (20 train, 2 val, 2 test sub-graphs).
    date: Mar 20, 2018
  ...
  - model: Attention-only
    ...
    at_pub_source_date_iso: ''
    at_pub_source_date_label: ''
    value_gap_source_date_iso: '2018-03-20'
    ...
    true_value: 0.9846
    true_std: 0.0009
    value_gap_source_arxiv: '1803.07294'
    value_gap_source_title: 'GaAN: Gated Attention Networks for Learning on Large
  ...
  - model: GAT
    ...
    is_std_outlier: false
  - model: Avg. pooling
    model_key: avg. pooling
    model_plain: Avg. pooling
    value: 0.9685
    std: 0.0019
    paper_value: 0.9685
    paper_std: 0.0019
  ...
  - model: GraphSAGE
    ...
    is_std_outlier: false
  - model: 2-Layer FNN
    model_key: 2-layer fnn
    model_plain: 2-Layer FNN
    value: 0.5407
    std: 0.0006
    paper_value: 0.5407
    paper_std: 0.0006
...
- &id001
  ...
  - model: GraphSAGE
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Inductive node classification on Reddit using maximum number sampling
      strategy with S1=25 and S2=10
    date: Mar 20, 2018
    date_display: Mar 2018
    date_iso: '2018-03-20'
    published_venue: ''
...
- scope: node-level
  ...
  - benchmark: Classic
    ...
    - dataset: PPI
      dataset_slug: ppi
single_proposed_model: GaAN
main_figure: /figures/1803.07294/main_figure.jpegoptim.jpg
---
