...
- &id002
  ...
  - model: NAGphormer
    ...
    protocol_note: node classification on Amazon2M using the split from Grand+ (large-scale
      dataset protocol)
    date: May 22, 2023
...
- &id001
  ...
  - model: GraphSAINT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Reddit node classification using the Grand+ split
    date: May 22, 2023
    date_display: May 2023
    date_iso: '2023-05-22'
    published_venue: ''
...
single_proposed_model: NAGphormer
