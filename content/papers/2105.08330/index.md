---
title: 'Residual Network and Embedding Usage: New Tricks of Node Classification with
...
- name: Hong Xia
  orcid: null
  s2_author_id: '2065044667'
  s2_url: null
published_date: May 18, 2021
published_date_iso: '2021-05-18'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: Graph Convolutional Networks (GCNs) and subsequent variants have been proposed
  to solve tasks on graphs, especially node classification tasks. In the literature,
  however, most tricks or techniques are either briefly mentioned as implementation
  details or only visible in source code. In this paper, we first summarize some existing
  effective tricks used in GCNs mini-batch training. Based on this, two novel tricks
  named GCN_res Framework and Embedding Usage are proposed by leveraging residual
  network and pre-trained embedding to improve baseline's test accuracy in different
  datasets. Experiments on Open Graph Benchmark (OGB) show that, by combining these
  techniques, the test accuracy of various GCNs increases by 1.21\ We open source
...
- &id003
  ...
  - model: GraphSAINT + metapath2vec
    model_key: graphsaint + metapath2vec
    ...
    is_best: false
    is_std_outlier: false
  - model: GraphSAINT (R-GCN aggr)
    model_key: graphsaint (r-gcn aggr)
    model_plain: GraphSAINT (R-GCN aggr)
    value: 0.4751
    std: 0.0022
    paper_value: 0.4751
    paper_std: 0.0022
...
- &id001
  ...
  - model: LargeGT-full
    ...
    is_best: false
    is_std_outlier: false
  - model: GraphSAGE w/NS + BN + C&S + node2vec
    model_key: graphsage w/ns + bn + c&s + node2vec
    model_plain: GraphSAGE w/NS + BN + C&S + node2vec
    value: 0.8154
    std: 0.005
    paper_value: 0.8154
    paper_std: 0.005
    ...
    is_best: false
    is_std_outlier: false
  - model: GraphSAGE w/NS + BN + C&S
    model_key: graphsage w/ns + bn + c&s
    model_plain: GraphSAGE w/NS + BN + C&S
    value: 0.8041
    std: 0.0022
    paper_value: 0.8041
    paper_std: 0.0022
    ...
    is_best: false
    is_std_outlier: false
  - model: GraphSAGE w/NS + FLAG
    model_key: graphsage w/ns + flag
    model_plain: GraphSAGE w/NS + FLAG
    value: 0.7936
    std: 0.0057
    paper_value: 0.7936
    paper_std: 0.0057
    ...
    is_best: false
    is_std_outlier: false
  - model: GraphSAGE w/NS
    model_key: graphsage w/ns
    model_plain: GraphSAGE w/NS
    value: 0.787
    std: 0.0036
    paper_value: 0.787
    paper_std: 0.0036
    ...
    is_best: false
    is_std_outlier: false
  - model: Full-batch GraphSAGE
    model_key: full-batch graphsage
    model_plain: Full-batch GraphSAGE
    value: 0.785
    std: 0.0014
    paper_value: 0.785
    paper_std: 0.0014
