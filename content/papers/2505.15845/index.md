...
abstract: 'Graph Transformers, leveraging the global attention to capture long-range
  dependencies in graph structures, have significantly advanced graph machine learning,
  but face prohibitive computational complexity. Tokenized Graph Learning Models (TGLMs)
  address this issue by converting graphs into ordered token lists for scalable processing.
  Besides, TGLMs also empower Large Language Models (LLMs) to handle text-attributed
  graphs more effectively, and thus are also employed in Graph LLMs. However, existing
  TGLMs rely on hand-designed token lists and their adaptability to diverse graph
  learning scenarios remains unexplored. In this paper, we first conduct extensive
  empirical and theoretical preliminary studies for hand-designed token lists. Surprisingly,
  we identify an unexplored ``hop-overpriority problem'''': the common predefined
  token lists overemphasize nearby nodes and overwhelm the ability of TGLMs to balance
  local and global signals. This phenomenon is especially harmful for heterophilic
  graphs. To address this problem, we propose the Learnable Graph Token List (LGTL),
  a plug-and-play module to replace hand-designed token lists in TGLMs. Specifically,
  LGTL adaptively adjusts the weights across hops and prioritizes informative nodes
  within hops through a graph attention gate module and a selection module, respectively.
  In this way, contextually informative nodes can be adaptively emphasized for both
  homophilic and heterophilic graphs. Besides, we theoretically show that LGTL can
  address the hop-overpriority problem. Extensive experiments on benchmarks validate
  the efficacy of LGTL across both Graph Transformers and Graph LLM backbones.'
codebase_url: ''
...
- &id007
  ...
  - model: NodeFormer
    ...
    protocol_note: Node classification on Actor using standard split (Geom-GCN masks).
    date: May 19, 2025
  ...
  - model: NAGphormer
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Actor using standard split.
    date: May 19, 2025
    date_display: May 2025
    date_iso: '2025-05-19'
    published_venue: ''
...
- &id004
  ...
  - model: GCN
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: numerical node features
    table_ref: Table 3
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: node classification on Computers dataset using numerical node features
    date: May 19, 2025
    date_display: May 2025
    date_iso: '2025-05-19'
    published_venue: ''
...
- &id003
  ...
  - model: GAT
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: using numerical node features
    table_ref: Table 3
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: node classification on Photo dataset using numerical node features
    date: May 19, 2025
    date_display: May 2025
    date_iso: '2025-05-19'
    published_venue: ''
...
- &id006
  ...
  - model: H2GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Cornell using standard split (Geom-GCN 10
      fixed splits).
    date: May 19, 2025
    date_display: May 2025
    date_iso: '2025-05-19'
    ...
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.23039999999999994
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GAT
    ...
    gap_vs_at_pub: 0.37159999999999993
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: NodeFormer
    ...
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.17829999999999996
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: LLAGA-ND
    ...
    feature_source_evidence: LLaGA is a representative Graph LLM using text-attributed
      features.
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
...
- &id002
  ...
  - model: LGTL
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on PubMed using LLaGA backbone; standard Planetoid
      split.
    date: May 19, 2025
    date_display: May 2025
    date_iso: '2025-05-19'
...
- &id005
  ...
  - model: H2GCN
    ...
    value_gap_source_date_iso: '2024-11-26'
    value_gap_source_date_label: ICML 2024
    gap_vs_at_pub: 0.09310000000000007
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: LGTL
    ...
    uses_external_data: 1
    input_feature_source: mixed
    feature_source_evidence: LLaGA backbone uses text-attributed features.
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
  ...
  - model: NodeFormer
    ...
    value_gap_source_title: 'GrokFormer: Graph Fourier Kolmogorov-Arnold Transformers'
    value_gap_source_is_current_paper: false
    value_gap: 0.033400000000000096
    has_value_note: false
    value_note: ''
    sort_value: 0.8463
    sort_std: 0.0347
...
- &id008
  ...
  - model: H2GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification task on Wisconsin using the standard split
    ...
    gap_vs_at_pub: 0.18320000000000003
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GCN
    ...
    value_gap_source_date_iso: '2022-06-06'
    value_gap_source_date_label: AAAI 2022
    gap_vs_at_pub: 0.2900999999999999
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: LGTL
    ...
    feature_source_evidence: LLaGA is a representative Graph LLM... replace the token
      list of LLaGA with LGTL
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
...
main_figure: /figures/2505.15845/main_figure.jpegoptim.jpg
---
