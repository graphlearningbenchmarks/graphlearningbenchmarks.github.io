...
- name: Yaliang Li
  ...
  s2_url: null
published_date: Jul 4, 2020
published_date_iso: '2020-07-04'
...
abstract: 'Graph convolutional networks (GCNs) are a powerful deep learning approach
  ...
  most of the current GCN models are shallow, due to the over-smoothing problem. In
  this paper, we study the problem of designing and analyzing deep graph convolutional
  networks. We propose the GCNII, an extension of the vanilla GCN model with two simple
  yet effective techniques: Initial residual and Identity mapping. We provide theoretical
  and empirical evidence that the two techniques effectively relieves the problem
  of over-smoothing. Our experiments show that the deep GCNII model outperforms the
  state-of-the-art methods on various semi- and full-supervised tasks. Code is available
  at.'
...
- &id002
  ...
  - model: APPNP
    ...
    input_feature_source: raw_features
    feature_source_evidence: bag-of-words representation of the document
    table_ref: Table 1
...
- &id001
  ...
  - model: GCN(Drop)
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: 'Planetoid split: 2 layers.'
    date: Jul 4, 2020
    date_display: Jul 2020
    date_iso: '2020-07-04'
    published_venue: ICML 2020
...
- &id004
  ...
  - model: GCNII
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Inductive node classification on PPI using 20 training, 2 validation,
      and 2 testing graphs.
    date: Jul 4, 2020
    date_display: Jul 2020
    date_iso: '2020-07-04'
    published_venue: ICML 2020
...
- &id003
  ...
  - model: APPNP
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy on Planetoid split (20 train, 500 val, 1000 test
      nodes)
    date: Jul 4, 2020
    date_display: Jul 2020
    date_iso: '2020-07-04'
  ...
  - model: GCN(Drop)
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy on Planetoid split; 2 layers
    date: Jul 4, 2020
    date_display: Jul 2020
    date_iso: '2020-07-04'
    published_venue: ICML 2020
...
- scope: node-level
  ...
  - benchmark: Classic
    ...
    - dataset: PPI
      dataset_slug: ppi
single_proposed_model: GCNII
main_figure: /figures/2007.02133/main_figure.jpegoptim.jpg
---
