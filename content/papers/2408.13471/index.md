...
- name: Xinyue Hu
  orcid: null
  s2_author_id: '2294819438'
  s2_url: null
- name: Zhibin Duan
  orcid: null
  s2_author_id: '48398111'
  s2_url: null
- name: Xinyang Liu
  orcid: null
  s2_author_id: '2288608513'
  s2_url: null
- name: Yuxin Li
  orcid: null
  s2_author_id: '2205237058'
  s2_url: null
- name: Bo Chen
  orcid: null
  s2_author_id: '2288768070'
  s2_url: null
- name: Mingyuan Zhou
  orcid: null
  s2_author_id: '2262091016'
  s2_url: null
published_date: Aug 24, 2024
published_date_iso: '2024-08-24'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: Generative graph models have recently emerged as a powerful paradigm in
  self-supervised learning for graph representation tasks, demonstrating remarkable
  potential in capturing complex structural and feature information. Despite their
  promise, most existing Generative Graph Representation Learning (GRL) methods treat
  the entire graph as a monolithic entity, employing random masking strategies across
  the entire structure. This approach often neglects the intricate interplay between
  different substructures of the graph, leading to entangled representations. Such
  entanglement can reduce the robustness of learned models and limit their ability
  to produce reliable outputs. To address these limitations, this paper presents DiGGR
  (Disentangled Generative Graph Representation Learning), a novel self-supervised
  learning framework designed to disentangle latent factors in graph representations.
  DiGGR introduces a disentanglement-driven approach to guide graph mask modeling,
  enabling the framework to learn distinct latent factors that better capture the
  underlying structure of graphs. By incorporating these latent factors into an end-to-end
  joint learning process, DiGGR enhances the clarity and structural alignment of the
  learned representations, while also improving their robustness and generalization
  across tasks. The effectiveness of DiGGR is validated through extensive experiments
  on 15 public datasets spanning three distinct graph learning tasks. The results
  consistently demonstrate that DiGGR outperforms a wide range of previous self-supervised
  methods, highlighting its superior ability to learn meaningful, disentangled representations.
  These findings underscore the potential of DiGGR to advance the state of the art
  in Generative GRL research.
codebase_url: ''
...
- &id012
  ...
  - model: DiGGR
    ...
    protocol_note: Node classification on Actor dataset using the standard Geom-GCN
      10 fixed splits.
    date: Aug 24, 2024
  ...
  - model: LRGNN
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: liang2023predicting
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Actor dataset using the standard Geom-GCN
...
- &id008
  ...
  - model: GraphMAE2
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: hou2023graphmae2
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Accuracy on COLLAB using 10-fold CV as per canonical task description.
    date: Aug 24, 2024
    date_display: Aug 2024
    date_iso: '2024-08-24'
    published_venue: ''
...
- &id003
  ...
  - model: DGI
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: DBLP:conf/iclr/VelickovicFHLBH19
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on CiteSeer using Planetoid split.
  ...
  - model: IPGDN
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: liu2020independence
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on CiteSeer using Planetoid split.
...
- &id001
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on Cora using Planetoid split (Yang et al. 2016 fixed
...
- &id011
  ...
  - model: DiGGR
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Cornell using Geom-GCN 10 fixed splits.
    date: Aug 24, 2024
    date_display: Aug 2024
    date_iso: '2024-08-24'
    published_venue: ''
  ...
  - model: GraphMAE
    ...
    value_gap_source_date_iso: '2024-08-24'
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.1782999999999999
    worse_than_at_pub: false
    surpassed_since_pub: false
...
- &id009
  ...
  - model: H_d
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Accuracy on IMDB-MULTI using 10-fold CV (canonical for this dataset)
      over 5 random seeds.
    date: Aug 24, 2024
    date_display: Aug 2024
    date_iso: '2024-08-24'
...
- &id005
  ...
  - model: VEPM
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Accuracy on MUTAG
    date: Aug 24, 2024
    date_display: Aug 2024
    date_iso: '2024-08-24'
    published_venue: ''
  ...
  - model: GIN
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Accuracy on MUTAG using supervised GIN
    date: Aug 24, 2024
    date_display: Aug 2024
    date_iso: '2024-08-24'
    published_venue: ''
  ...
  - model: DiffPool
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Accuracy on MUTAG using supervised DiffPool
    date: Aug 24, 2024
    date_display: Aug 2024
    date_iso: '2024-08-24'
    published_venue: ''
...
- &id004
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: PPI node classification using micro-F1 score on the standard split.
    date: Aug 24, 2024
    date_display: Aug 2024
    date_iso: '2024-08-24'
    published_venue: ''
...
- &id007
  ...
  - model: DiffPool
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Accuracy on PROTEINS using 10-fold CV
    date: Aug 24, 2024
    date_display: Aug 2024
    date_iso: '2024-08-24'
    published_venue: ''
...
- &id002
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on Pubmed using Planetoid split.
    date: Aug 24, 2024
    date_display: Aug 2024
    date_iso: '2024-08-24'
    published_venue: ''
  ...
  - model: SEEGERA
    ...
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.0260999999999999
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id010
  ...
  - model: LRGNN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Texas using the standard Geom-GCN 10 fixed
      splits.
    date: Aug 24, 2024
    date_display: Aug 2024
    date_iso: '2024-08-24'
  ...
  - model: DiGGR
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: The framework is a generative self-supervised framework
      designed to reconstruct masked graph components.
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
...
- &id013
  ...
  - model: MUSE
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on Wisconsin dataset using Geom-GCN 10 fixed splits.
    date: Aug 24, 2024
    date_display: Aug 2024
    date_iso: '2024-08-24'
    published_venue: ''
  ...
  - model: DiGGR
    ...
    input_feature_source: raw_features
    feature_source_evidence: The framework is a generative self-supervised framework
      designed to capture latent disentangled factors.
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
...
single_proposed_model: DiGGR
main_figure: /figures/2408.13471/main_figure.jpegoptim.jpg
---
