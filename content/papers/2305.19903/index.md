...
- name: Mingli Song
  ...
  s2_author_id: '2152127912'
  s2_url: null
published_date: May 31, 2023
published_date_iso: '2023-05-31'
...
abstract: Graph Neural Networks (GNNs) have emerged as a powerful category of learning
  architecture for handling graph-structured data. However, existing GNNs typically
  ignore crucial structural characteristics in node-induced subgraphs, which thus
  limits their expressiveness for various downstream tasks. In this paper, we strive
  to strengthen the representative capabilities of GNNs by devising a dedicated plug-and-play
  normalization scheme, termed as SUbgraph-sPEcific FactoR Embedded Normalization
  (SuperNorm), that explicitly considers the intra-connection information within each
  node-induced subgraph. To this end, we embed the subgraph-specific factor at the
  beginning and the end of the standard BatchNorm, as well as incorporate graph instance-specific
  statistics for improved distinguishable capabilities. In the meantime, we provide
  theoretical analysis to support that, with the elaborated SuperNorm, an arbitrary
  GNN is at least as powerful as the 1-WL test in distinguishing non-isomorphism graphs.
  Furthermore, the proposed SuperNorm scheme is also demonstrated to alleviate the
  over-smoothing phenomenon. Experimental results related to predictions of graph,
  node, and link properties on the eight popular datasets demonstrate the effectiveness
  of the proposed method. The code is available at.
...
- SuperNorm
- SIGN with SuperNorm
- LEGNN with SuperNorm
- InfoGraph with SuperNorm
- MVGRL with SuperNorm
mrr: 0.0
adjusted_mrr: 0.0
mrr_dataset_count: 0
...
- &id006
  ...
  - model: GraphSNN
    ...
    protocol_note: Hierarchical split used for test set as described in dataset details.
    date: May 31, 2023
...
- &id005
  ...
  - model: ECC
    ...
    is_best: false
    is_std_outlier: false
  - model: MVGRL with SuperNorm
    model_key: mvgrl with supernorm
    model_plain: MVGRL with SuperNorm
    value: 0.9068
    std: 0.0671
    paper_value: 0.9068
    paper_std: 0.0671
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Unsupervised/self-supervised setting on MUTAG
    date: May 31, 2023
    date_display: May 2023
    date_iso: '2023-05-31'
    published_venue: KDD 2023
    ...
    is_best: false
    is_std_outlier: false
  - model: InfoGraph with SuperNorm
    model_key: infograph with supernorm
    model_plain: InfoGraph with SuperNorm
    value: 0.9037
    std: 0.0607
    paper_value: 0.9037
    paper_std: 0.0607
...
- &id007
  ...
  - model: SuperNorm
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Evaluation on ogbg-moltoxcast with GCN backbone and 4 layers.
    date: May 31, 2023
    date_display: May 2023
    date_iso: '2023-05-31'
    published_venue: KDD 2023
  ...
  - model: ExpreNorm
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Evaluation on ogbg-moltoxcast with GIN backbone and 4 layers.
    date: May 31, 2023
    date_display: May 2023
    date_iso: '2023-05-31'
    published_venue: KDD 2023
  ...
  - model: NoNorm
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Evaluation on ogbg-moltoxcast with GAT backbone and 4 layers.
    date: May 31, 2023
    date_display: May 2023
    date_iso: '2023-05-31'
    published_venue: KDD 2023
...
- &id002
  ...
  - model: SuperNorm
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: GCN backbone, l=4 layers, no tricks
    date: May 31, 2023
    date_display: May 2023
    date_iso: '2023-05-31'
    published_venue: KDD 2023
  ...
  - model: ExpreNorm
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: GAT backbone, l=4 layers, no tricks
    date: May 31, 2023
    date_display: May 2023
    date_iso: '2023-05-31'
    published_venue: KDD 2023
  ...
  - model: BatchNorm
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: GAT backbone, l=16 layers, no tricks
    date: May 31, 2023
    date_display: May 2023
    date_iso: '2023-05-31'
    published_venue: KDD 2023
  ...
  - model: GraphNorm
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: GIN backbone, l=4 layers, no tricks
    date: May 31, 2023
    date_display: May 2023
    date_iso: '2023-05-31'
    published_venue: KDD 2023
...
- &id003
  ...
  - model: SuperNorm
    ...
    protocol_decision: standard
    protocol_note: GraphSage backbone with 4 layers, no empirical tricks.
    date: May 31, 2023
    date_display: May 2023
    date_iso: '2023-05-31'
    published_venue: KDD 2023
  ...
  - model: NoNorm
    ...
    evaluation_task: link_prediction
    protocol_decision: standard
    protocol_note: GCN backbone with 4 layers, no empirical tricks.
    date: May 31, 2023
    date_display: May 2023
    date_iso: '2023-05-31'
    published_venue: KDD 2023
...
- &id004
  ...
  - model: LEGNN with SuperNorm
    model_key: legnn with supernorm
    ...
    protocol_decision: standard
    protocol_note: Standard node classification task on ogbn-mag as reported in OGB
      leaderboards.
    date: May 31, 2023
    date_display: May 2023
    date_iso: '2023-05-31'
...
- &id001
  ...
  - model: SIGN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification task on ogbn-products as reported
      in OGB leaderboards.
    date: May 31, 2023
    date_display: May 2023
    date_iso: '2023-05-31'
    ...
    is_best: false
    is_std_outlier: false
  - model: SIGN with SuperNorm
    model_key: sign with supernorm
    model_plain: SIGN with SuperNorm
    value: 0.812
    std: 0.0029
    paper_value: 0.812
    paper_std: 0.0029
...
main_figure: /figures/2305.19903/main_figure.jpegoptim.jpg
---
