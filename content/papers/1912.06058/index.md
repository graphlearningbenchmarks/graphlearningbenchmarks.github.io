...
- name: George Dasoulas
  orcid: null
  s2_author_id: '150109816'
  s2_url: null
- name: Ludovic Dos Santos
  orcid: null
  s2_author_id: '2779486'
  s2_url: null
- name: Kevin Scaman
  orcid: null
  s2_author_id: '2695305'
  s2_url: null
- name: Aladin Virmaux
  orcid: null
  s2_author_id: '8229598'
  s2_url: null
published_date: Dec 12, 2019
published_date_iso: '2019-12-12'
...
abstract: In this paper, we show that a simple coloring scheme can improve, both theoretically
  and empirically, the expressive power of Message Passing Neural Networks (MPNNs).
  More specifically, we introduce a graph neural network called Colored Local Iterative
  Procedure that uses colors to disambiguate identical node attributes, and show that
  this representation is a universal approximator of continuous functions on graphs
  with node attributes. Our method relies on separability, a key topological characteristic
  that allows to extend well-chosen neural networks into universal representations.
  Finally, we show experimentally that is capable of capturing structural characteristics
  that traditional MPNNs fail to distinguish, while being state-of-the-art on benchmark
...
- &id001
  ...
  - model: MPNNs
    ...
    value_gap_source_date_iso: '2019-12-12'
    ...
    true_value: 0.939
    true_std: 0.04
    value_gap_source_arxiv: '1912.06058'
    value_gap_source_title: Coloring graph neural networks for node disambiguation
  ...
  - model: WL
    ...
    at_pub_value: 0.862
    at_pub_std: null
    at_pub_source_arxiv: '1910.12091'
    at_pub_source_title: Understanding Isomorphism Bias in Graph Data Sets
...
- scope: graph-level
  ...
  - benchmark: TU Dortmund
    ...
    - dataset: MUTAG
      dataset_slug: mutag
main_figure: /figures/1912.06058/main_figure.jpegoptim.jpg
---
