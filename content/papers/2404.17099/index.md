...
- &id005
  ...
  - model: ACM-GCN
    ...
    protocol_note: Node classification accuracy on Film dataset
    date: Apr 26, 2024
...
- &id002
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Computer dataset using random train-val-test
      split.
    date: Apr 26, 2024
    date_display: Apr 2024
    date_iso: '2024-04-26'
...
- &id001
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Photo with random train-val-test splits.
    date: Apr 26, 2024
    date_display: Apr 2024
    date_iso: '2024-04-26'
    published_venue: ICLR 2024
...
- &id010
  ...
  - model: H2GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification accuracy on Amazon-ratings test split
    date: Apr 26, 2024
    date_display: Apr 2024
    date_iso: '2024-04-26'
    published_venue: ICLR 2024
...
- &id006
  ...
  - model: ACM-GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification accuracy on Chameleon using standard split.
    date: Apr 26, 2024
    date_display: Apr 2024
    date_iso: '2024-04-26'
    published_venue: ICLR 2024
  ...
  - model: Sheaf
    ...
    feature_source_evidence: ''
    table_ref: Table 22
    source_ref: Crifraben et al. 2022
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification accuracy on Chameleon using standard split.
  ...
  - model: BLEND
    ...
    feature_source_evidence: ''
    table_ref: Table 22
    source_ref: Charoweyn et al. 2021
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification accuracy on Chameleon using standard split.
  ...
  - model: CGNN
    ...
    feature_source_evidence: ''
    table_ref: Table 22
    source_ref: Xhonneux et al. 2020
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification accuracy on Chameleon using standard split.
...
- &id009
  ...
  - model: F-CDE
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification accuracy on Roman-empire dataset using standard
      split.
    date: Apr 26, 2024
    date_display: Apr 2024
    date_iso: '2024-04-26'
...
- &id007
  ...
  - model: GloGNN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on Squirrel using standard heterophilic node classification
      setup.
    date: Apr 26, 2024
    date_display: Apr 2024
    date_iso: '2024-04-26'
...
- &id004
  ...
  - model: ACM-GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification accuracy on Texas using Geom-GCN 10 fixed splits.
    date: Apr 26, 2024
    date_display: Apr 2024
    date_iso: '2024-04-26'
    published_venue: ICLR 2024
...
- &id008
  ...
  - model: ACM-GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: 'GREAD setting: 10 fixed train/validation/test splits from Pei
      et al. (Geom-GCN).'
    date: Apr 26, 2024
    date_display: Apr 2024
    date_iso: '2024-04-26'
...
- &id003
  ...
  - model: GraphSAGE
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification accuracy on ogbn-products using standard split.
    date: Apr 26, 2024
    date_display: Apr 2024
    date_iso: '2024-04-26'
    published_venue: ICLR 2024
...
main_figure: /figures/2404.17099/main_figure.jpegoptim.jpg
---
