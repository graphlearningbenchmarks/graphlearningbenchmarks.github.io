...
abstract: 'Spectral graph convolution, an important tool of data filtering on graphs,
  ...
  of the proposed model in handling different scenarios. Our code is available at
...
- &id002
  ...
  - model: GCN
    ...
    protocol_note: PyG short-range task split
    date: May 22, 2024
  ...
  - model: Matrix-valued
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Comparison of kernel types on Computer dataset
    date: May 22, 2024
    date_display: May 2024
    date_iso: '2024-05-22'
    published_venue: ICML 2024
  ...
  - model: GWNN
    ...
    is_std_outlier: false
  - model: Vector-valued
    model_key: vector-valued
    model_plain: Vector-valued
    value: 0.8996
    std: null
    paper_value: 0.8996
    paper_std: null
  ...
  - model: Scattering GCN
    ...
    value_gap_source_date_iso: '2024-05-22'
    value_gap_source_date_label: ICML 2024
    gap_vs_at_pub: 0.20140000000000002
    worse_than_at_pub: false
    surpassed_since_pub: false
  ...
  - model: UFGConvS
    ...
    is_best: false
    is_std_outlier: false
  - model: WaveShrink-ChebNet
    model_key: waveshrink-chebnet
    model_plain: WaveShrink-ChebNet
    value: 0.882
    std: 0.0065
    paper_value: 0.882
    paper_std: 0.0065
    ...
    is_std_outlier: false
  - model: Scattering
    model_key: scattering
    model_plain: Scattering
    value: 0.8568
    std: 0.0071
    paper_value: 0.8568
    paper_std: 0.0071
...
- &id001
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard short-range task settings from nagphormer [cite]
    date: May 22, 2024
    date_display: May 2024
    date_iso: '2024-05-22'
    published_venue: ICML 2024
  ...
  - model: Scattering GCN
    ...
    value_gap_source_date_iso: '2024-05-22'
    value_gap_source_date_label: ICML 2024
    gap_vs_at_pub: 0.11559999999999993
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
- &id003
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: OGB public split
    date: May 22, 2024
    date_display: May 2024
    date_iso: '2024-05-22'
    published_venue: ICML 2024
...
single_proposed_model: WaveGC
main_figure: /figures/2405.13806/main_figure.jpegoptim.jpg
---
