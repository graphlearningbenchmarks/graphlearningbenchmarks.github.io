...
- name: Aosong Feng
  orcid: null
  s2_author_id: '14128921'
  s2_url: null
- name: Chenyu You
  orcid: null
  s2_author_id: '2061592207'
  s2_url: null
- name: Shiqiang Wang
  orcid: null
  s2_author_id: '50695457'
  s2_url: null
- name: L. Tassiulas
  orcid: null
  s2_author_id: '2065219256'
  s2_url: null
published_date: Jan 3, 2022
published_date_iso: '2022-01-03'
...
abstract: Graph kernels are historically the most widely-used technique for graph
  classification tasks. However, these methods suffer from limited performance because
  of the hand-crafted combinatorial features of graphs. In recent years, graph neural
  networks (GNNs) have become the state-of-the-art method in downstream graph-related
  tasks due to their superior performance. Most GNNs are based on Message Passing
  Neural Network (MPNN) frameworks. However, recent studies show that MPNNs can not
  exceed the power of the Weisfeiler-Lehman (WL) algorithm in graph isomorphism test.
  To address the limitations of existing graph kernel and GNN methods, in this paper,
  we propose a novel GNN framework, termed Kernel Graph Neural Networks (KerGNNs),
  which integrates graph kernels into the message passing process of GNNs. Inspired
  by convolution filters in convolutional neural networks (CNNs), KerGNNs adopt trainable
  hidden graphs as graph filters which are combined with subgraphs to update node
  embeddings using graph kernels. In addition, we show that MPNNs can be viewed as
  special cases of KerGNNs. We apply KerGNNs to multiple graph-related tasks and use
  cross-validation to make fair comparisons with benchmarks. We show that our method
  achieves competitive performance compared with existing state-of-the-art methods,
  demonstrating the potential to increase the representation ability of GNNs. We also
  show that the trained graph filters in KerGNNs can reveal the local graph structures
  of the dataset, which significantly improves the model interpretability compared
  with conventional GNN models.
codebase_url: https://github.com/asFeng/kergnns
...
- &id002
  ...
  - model: GIN
    ...
    protocol_note: Test set classification accuracy via 10-fold CV
    date: Jan 3, 2022
  ...
  - model: WL-sub
    ...
    value_gap_source_date_iso: '2022-01-03'
    ...
    true_value: 0.775
    true_std: 0.024
    value_gap_source_arxiv: '2201.00491'
    value_gap_source_title: 'KerGNNs: Interpretable Graph Neural Networks with Graph
      Kernels'
  ...
  - model: PK
    ...
    is_std_outlier: false
  - model: Powerful GNN
    model_key: powerful gnn
    model_plain: Powerful GNN
    value: 0.754
    std: 0.014
    paper_value: 0.754
    paper_std: 0.014
    ...
    is_std_outlier: false
  - model: KerGNN-2-DRW
    model_key: kergnn-2-drw
    model_plain: KerGNN-2-DRW
    value: 0.751
    std: 0.023
    paper_value: 0.751
    paper_std: 0.023
...
- &id003
  ...
  - model: GraphSAGE
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Test set classification accuracy reported as percentage in table
    date: Jan 3, 2022
    date_display: Jan 2022
    date_iso: '2022-01-03'
    published_venue: AAAI 2022
  ...
  - model: DGCNN
    ...
    gap_vs_at_pub: 0.18220000000000003
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: ECC
    ...
    gap_vs_at_pub: 0.24000000000000005
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id001
  ...
  - model: GIN
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Test set classification accuracy reported via mean and std.
    date: Jan 3, 2022
    date_display: Jan 2022
    date_iso: '2022-01-03'
    published_venue: AAAI 2022
...
main_figure: /figures/2201.00491/main_figure.jpegoptim.jpg
---
