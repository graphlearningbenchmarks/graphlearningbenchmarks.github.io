...
- name: Yuhui Ding
  orcid: null
  s2_author_id: '2269701174'
  s2_url: null
- name: Antonio Orvieto
  orcid: null
  s2_author_id: '51931942'
  s2_url: null
- name: Bobby He
  orcid: null
  s2_author_id: '2265492842'
  s2_url: null
- name: Thomas Hofmann
  orcid: null
  s2_author_id: '2265384015'
  s2_url: null
published_date: Dec 3, 2023
published_date_iso: '2023-12-03'
...
- &id004
  ...
  - model: GRED
    ...
    input_feature_source: raw_features
    feature_source_evidence: Our model doesn't use any positional encoding.
    table_ref: Table 1
...
- &id005
  ...
  - model: SAT
    ...
    at_pub_value: 0.094
    at_pub_std: 0.008
    at_pub_source_arxiv: '2303.00579'
    at_pub_source_title: Are More Layers Beneficial to Graph Transformers?
    at_pub_source_date_iso: '2023-03-01'
    at_pub_source_date_label: ICLR 2023
    value_gap_source_date_iso: '2023-12-03'
    value_gap_source_date_label: ICML 2023
    gap_vs_at_pub: 0.6845600000000001
    worse_than_at_pub: false
    surpassed_since_pub: false
    ...
    comparison_source_title: Are More Layers Beneficial to Graph Transformers?
    comparison_source_arxiv: '2303.00579'
    is_best: false
    is_std_outlier: false
  - model: SAN
    model_key: san
...
- &id002
  ...
  - model: GCN
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: The paper notes GCN, GINE and GatedGCN were tuned with
      positional encoding, but the table entry for GCN is a baseline from a recent
      report.
    table_ref: Table 3
  ...
  - model: DRew
    ...
    is_std_outlier: false
  - model: DRew+LapPE
    model_key: drew+lappe
    model_plain: DRew+LapPE
    value: 0.715
    std: 0.0044
    paper_value: 0.715
    paper_std: 0.0044
    ...
    feature_source_evidence: Uses Laplacian Positional Encoding (LapPE) as extra features.
    table_ref: Table 3
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    ...
    is_std_outlier: false
  - model: GRED+LapPE
    model_key: gred+lappe
    model_plain: GRED+LapPE
    value: 0.7133
    std: 0.0011
    paper_value: 0.7133
    paper_std: 0.0011
    ...
    uses_external_data: 1
    input_feature_source: mixed
    feature_source_evidence: Concatenating Laplacian positional encoding with node
      features.
    table_ref: Table 3
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
  ...
  - model: GRED
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: The paper states GRED can encode neighborhood hierarchy
      without the need for positional encoding.
    table_ref: Table 3
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
  ...
  - model: GatedGCN
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: The paper notes GatedGCN was tuned with positional encoding
      in the cited report.
    table_ref: Table 3
    source_ref: tonshoff2023did
    variant_inference_reason: 'dataset: exact match'
  ...
  - model: GRIT
    ...
    is_best: false
    is_std_outlier: false
  - model: Graph-MLPMixer
    model_key: graph-mlpmixer
    model_plain: Graph-MLPMixer
    value: 0.697
    std: 0.008
    paper_value: 0.697
    paper_std: 0.008
  ...
  - model: GINE
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: The paper notes GINE was tuned with positional encoding
      in the cited report.
    table_ref: Table 3
    source_ref: tonshoff2023did
    variant_inference_reason: 'dataset: exact match'
...
- &id001
  ...
  - model: GCN
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: The paper notes GCN* results come from a report that
      tuned hyper-parameters with positional encoding, but the table entry for GCN*
      is treated as a baseline. The text implies standard GCN doesn't use it, but
      the asterisked version does. However, the prompt asks for the standard configuration.
      Given the asterisk refers to the tuned version from Tonshoff, we extract the
      value provided.
    table_ref: Table 3
    source_ref: tonshoff2023did
    variant_inference_reason: 'dataset: exact match'
  ...
  - model: GRED
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: The paper states GRED encodes neighborhood hierarchy
      without the need for positional encoding.
    table_ref: Table 3
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
...
main_figure: /figures/2312.01538/main_figure.jpegoptim.jpg
---
