...
- name: Jiho Choi
  orcid: null
  s2_author_id: '2155314445'
  s2_url: null
- name: Taewook Ko
  orcid: null
  s2_author_id: '2124027689'
  s2_url: null
- name: Chong-Kwon Kim
  orcid: null
...
abstract: Message-passing neural networks have shown satisfactory performance and
  are widely employed in various graph mining applications. However, like many other
  machine learning techniques, these methods suffer from the overfitting problem when
  labeled data are scarce. Our observations suggest that sparse initial vectors along
  with scarce labeled data further exacerbate this issue by failing to fully represent
  the range of learnable parameters. To overcome this challenge, we propose a novel
  perturbation technique that introduces variability to the initial features and the
  projection hyperplane. Experimental results on real-world datasets reveal that our
  technique significantly enhances node classification accuracy in semi-supervised
  scenarios. In addition, our extensive experiments reveal the effect and robustness
  of hyperplane shifting.
codebase_url: ''
...
- &id006
  ...
  - model: ACM-GCN
    ...
    protocol_note: Test accuracy on Actor dataset with 100 train, 3750 valid, 3750
      test nodes.
    date: Nov 28, 2022
  ...
  - model: MLP
    ...
    feature_source_evidence: ''
    table_ref: Table 2
    source_ref: popescu2009multilayer
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy on Actor dataset with 100 train, 3750 valid, 3750
    ...
    gap_vs_at_pub: 0.12279999999999996
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2022-10-08'
    value_gap_source_date_label: NeurIPS 2022
    gap_vs_at_pub: 0.13549999999999998
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: Shift-MLP
    ...
    is_std_outlier: false
  - model: Shift-FAGCN
    model_key: shift-fagcn
    model_plain: Shift-FAGCN
    value: 0.347
    std: 0.006
    paper_value: 0.347
    paper_std: 0.006
...
- &id007
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy on Chameleon split (1089 test nodes)
    date: Nov 28, 2022
    date_display: Nov 2022
    date_iso: '2022-11-28'
    published_venue: ''
  ...
  - model: GPR-GNN
    ...
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.18879999999999997
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: JacobiConv
    ...
    value_gap_source_date_iso: '2022-05-23'
    ...
    true_value: 0.742
    true_std: 0.0103
    value_gap_source_arxiv: '2205.11172'
    value_gap_source_title: How Powerful are Spectral Graph Neural Networks
    value_gap_source_is_current_paper: false
  ...
  - model: APPNP
    ...
    value_gap_source_date_iso: '2022-06-06'
    value_gap_source_date_label: AAAI 2022
    gap_vs_at_pub: 0.21700000000000003
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GCNII
    ...
    gap_vs_at_pub: 0.18759999999999993
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: FAGCN
    ...
    value_gap_source_date_label: AAAI 2022
    gap_vs_at_pub: 0.16639999999999994
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id002
  ...
  - model: Shift-MLP
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: shifting of the initial features and parameters simultaneously
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on Planetoid split (fixed split) for Citeseer.
    date: Nov 28, 2022
    date_display: Nov 2022
    date_iso: '2022-11-28'
    published_venue: ''
  ...
  - model: MO-SFL
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: gong2015multiobjective
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on Planetoid split (fixed split) for Citeseer.
    ...
    is_std_outlier: false
  - model: Sparse PCA
    model_key: sparse pca
    model_plain: Sparse PCA
    value: 0.498
    std: null
    paper_value: 0.498
    paper_std: null
...
- &id003
  ...
  - model: MLP
    ...
    gap_vs_at_pub: 0.16680000000000006
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id008
  ...
  - model: GPR-GNN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy on Squirrel dataset with 100 train, 2550 valid, and
      2551 test nodes.
    date: Nov 28, 2022
    date_display: Nov 2022
    date_iso: '2022-11-28'
  ...
  - model: ACM-GCN
    ...
    value_gap_source_date_iso: '2025-05-28'
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.22800000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GCN
    ...
    value_gap_source_date_iso: '2024-01-17'
    value_gap_source_date_label: ICML 2024
    gap_vs_at_pub: 0.23900000000000005
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2022-06-06'
    value_gap_source_date_label: AAAI 2022
    gap_vs_at_pub: 0.25499999999999995
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: APPNP
    ...
    value_gap_source_date_iso: '2022-06-06'
    value_gap_source_date_label: AAAI 2022
    gap_vs_at_pub: 0.25600000000000006
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GCNII
    ...
    value_gap_source_date_iso: '2026-03-10'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.10369999999999996
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
main_figure: /figures/2211.15081/main_figure.jpegoptim.jpg
---
