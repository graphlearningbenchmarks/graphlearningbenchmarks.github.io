...
abstract: Graph neural networks (GNNs) have shown remarkable performance on homophilic
  graph data while being far less impressive when handling non-homophilic graph data
  due to the inherent low-pass filtering property of GNNs. In general, since real-world
  graphs are often complex mixtures of diverse subgraph patterns, learning a universal
  spectral filter on the graph from the global perspective as in most current works
  may still suffer from great difficulty in adapting to the variation of local patterns.
  On the basis of the theoretical analysis of local patterns, we rethink the existing
  spectral filtering methods and propose the ode-oriented spectral iltering for raph
  eural etwork (namely NFGNN). By estimating the node-oriented spectral filter for
  each node, NFGNN is provided with the capability of precise local node positioning
  via the generalized translated operator, thus discriminating the variations of local
  homophily patterns adaptively. Meanwhile, the utilization of re-parameterization
  brings a good trade-off between global consistency and local sensibility for learning
  the node-oriented spectral filters. Furthermore, we theoretically analyze the localization
  property of NFGNN, demonstrating that the signal after adaptive filtering is still
  positioned around the corresponding node. Extensive experimental results demonstrate
  that the proposed NFGNN achieves more favorable performance.
codebase_url: ''
...
- &id006
  ...
  - model: BernNet
    ...
    protocol_note: full-supervised learning setting
    date: Dec 7, 2022
    ...
    value_gap: 0.017799999999999983
  ...
  - model: FAGCN
    ...
    value_gap_source_date_iso: '2022-12-07'
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.006200000000000039
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GCN
    ...
    gap_vs_at_pub: 0.06309999999999999
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GAT
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.0006999999999999784
    has_value_note: false
    value_note: ''
    sort_value: 0.3605
    sort_std: 0.0035
...
- &id002
  ...
  - model: APPNP
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.028900000000000037
    has_value_note: false
    value_note: ''
    sort_value: 0.9093
    sort_std: 0.0018
  ...
  - model: ChebNet
    ...
    value_gap_source_date_iso: '2022-12-07'
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.06819999999999993
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: MLP
    ...
    at_pub_value: 0.8414
    at_pub_std: null
    at_pub_source_arxiv: '2202.08057'
    at_pub_source_title: Understanding and Improving Graph Injection Attack by Promoting
      Unnoticeability
    ...
    has_value_gap: true
    comparison_type: behind
    comparison_source_title: Understanding and Improving Graph Injection Attack by
      Promoting Unnoticeability
    comparison_source_arxiv: '2202.08057'
    is_best: false
    is_std_outlier: false
  - model: LINK
    model_key: link
...
- &id001
  ...
  - model: APPNP
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: semi-supervised learning setting
    date: Dec 7, 2022
    date_display: Dec 2022
    date_iso: '2022-12-07'
    published_venue: ''
  ...
  - model: ChebNet
    ...
    value_gap_source_date_iso: '2023-03-24'
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.03179999999999994
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
- &id005
  ...
  - model: GCN
    ...
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.12480000000000002
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: LINK
    ...
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.14250000000000002
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    has_value_gap: true
    comparison_type: behind
    comparison_source_title: Comprehensive Graph Gradual Pruning for Sparse Training
      in Graph Neural Networks
    comparison_source_arxiv: '2207.08629'
    is_best: false
    is_std_outlier: false
  rank_metric: Accuracy
  higher_is_better: true
...
- &id003
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Transductive node classification on large-scale OGB dataset
    date: Dec 7, 2022
    date_display: Dec 2022
    date_iso: '2022-12-07'
    published_venue: ''
