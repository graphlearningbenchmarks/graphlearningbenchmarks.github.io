...
- &id003
  ...
  - model: GCN
    ...
    protocol_note: Node-level classification on Citeseer using Planetoid split, Accuracy
      metric.
    date: Oct 6, 2025
...
- &id001
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node-level classification on Cora using Planetoid split, Accuracy
      metric.
    date: Oct 6, 2025
    date_display: Oct 2025
    date_iso: '2025-10-06'
  ...
  - model: GraphGPS
    ...
    at_pub_value: 0.809
    at_pub_std: 0.011
    at_pub_source_arxiv: '2409.09111'
    at_pub_source_title: 'Transformers from Diffusion: A Unified Framework for Neural
      Message Passing'
    at_pub_source_date_iso: '2024-09-13'
    at_pub_source_date_label: JMLR 2024
    ...
    has_value_gap: true
    comparison_type: improved
    comparison_source_title: 'Transformers from Diffusion: A Unified Framework for
      Neural Message Passing'
    comparison_source_arxiv: '2409.09111'
    is_best: false
    is_std_outlier: false
  - model: GeoMancer
    model_key: geomancer
...
- &id002
  ...
  - model: GeoMancer
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node-level classification on Pubmed using Planetoid split.
    date: Oct 6, 2025
    date_display: Oct 2025
    date_iso: '2025-10-06'
    published_venue: NeurIPS 2025
  ...
  - model: LGD
    ...
    value_gap_source_date_iso: '2025-10-06'
    value_gap_source_date_label: NeurIPS 2025
    gap_vs_at_pub: 0.22139999999999993
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: GraphSAINT
    ...
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.033199999999999896
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_title: 'DAM-GT: Dual Positional Encoding-Based Attention Masking
      Graph Transformer for Node Classification'
    value_gap_source_is_current_paper: false
    value_gap: 0.033199999999999896
    has_value_note: false
    value_note: ''
    sort_value: 0.8896
    sort_std: 0.0016
