...
- &id006
  ...
  - model: FloydNet
    ...
    protocol_note: Node classification on COCO-SP using F1 metric; part of LRGB benchmarks.
    date: Jan 27, 2026
...
- &id005
  ...
  - model: FloydNet
    ...
    protocol_decision: standard
    protocol_note: Link prediction on PCQM-Contact using MRR metric; standard LRGB
      benchmark split.
    date: Jan 27, 2026
    date_display: Jan 2026
    date_iso: '2026-01-27'
...
- &id004
  ...
  - model: GPS
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on PascalVOC-SP using F1 metric; part of LRGB
      benchmarks.
    date: Jan 27, 2026
    date_display: Jan 2026
    date_iso: '2026-01-27'
...
- &id003
  ...
  - model: GCN
    ...
    protocol_decision: standard
    protocol_note: Standard split, graph classification task, AP metric
    date: Jan 27, 2026
    date_display: Jan 2026
    date_iso: '2026-01-27'
    published_venue: ''
...
- &id002
  ...
  - model: GCN
    ...
    protocol_decision: standard
    protocol_note: MAE on Peptides-Struct graph regression task using standard LRGB
      benchmark split
    date: Jan 27, 2026
    date_display: Jan 2026
    date_iso: '2026-01-27'
...
- &id001
  ...
  - model: FloydNet
    ...
    evaluation_task: graph_regression
    protocol_decision: standard
    protocol_note: Full ZINC dataset, MAE metric
    date: Jan 27, 2026
    date_display: Jan 2026
    date_iso: '2026-01-27'
    published_venue: ''
