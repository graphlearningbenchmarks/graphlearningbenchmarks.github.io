...
- &id002
  ...
  - model: NeuralSparse
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV accuracy (SAGE backbone)
    date: Jun 13, 2024
    date_display: Jun 2024
    date_iso: '2024-06-13'
    published_venue: ''
  ...
  - model: HGP-SL
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV accuracy (GIN backbone)
    date: Jun 13, 2024
    date_display: Jun 2024
    date_iso: '2024-06-13'
    published_venue: ''
...
- &id001
  ...
  - model: GIN
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV (mean of 10 runs) on PROTEINS
    date: Jun 13, 2024
    date_display: Jun 2024
    date_iso: '2024-06-13'
    published_venue: ''
  ...
  - model: SAGE
    ...
    has_value_gap: true
    comparison_type: behind
    comparison_source_title: 'Semi-Supervised Graph Classification: A Hierarchical
      Graph Perspective'
    comparison_source_arxiv: '1904.05003'
    is_best: false
    is_std_outlier: false
  - model: GraphSAGE
    model_key: graphsage
  ...
  - model: GCN
    ...
    gap_vs_at_pub: 0.10159999999999991
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- scope: graph-level
  ...
  - benchmark: TU Dortmund
    ...
    - dataset: RDT-B
      dataset_slug: rdt-b
main_figure: /figures/2406.08897/main_figure.jpegoptim.jpg
---
