...
abstract: In the last few years, graph neural networks (GNNs) have become the standard
  ...
  witnessed an extensive growth of promising techniques that have been applied with
  success to computer science, mathematics, biology, physics and chemistry. But for
  any successful field to become mainstream and reliable, benchmarks must be developed
  to quantify progress. This led us in March 2020 to release a benchmark framework
  that i) comprises of a diverse collection of mathematical and real-world graphs,
  ii) enables fair model comparison with the same parameter budget to identify key
  architectures, iii) has an open-source, easy-to-use and reproducible code infrastructure,
  and iv) is flexible for researchers to experiment with new theoretical ideas. As
  of December 2022, the GitHub repository. has reached 2,000 stars and 380 forks,
  which demonstrates the utility of the proposed open-source framework through the
  wide usage by the GNN community. In this paper, we present an updated version of
  our benchmark with a concise presentation of the aforementioned framework characteristics,
  an additional medium-sized molecular dataset AQSOL, similar to the popular ZINC,
  but with a real-world measured chemical target, and discuss how this framework can
  be leveraged to explore new GNN designs and insights. As a proof of value of our
  benchmark, we study the case of graph positional encoding (PE) in GNNs, which was
  introduced with this benchmark and has since spurred interest of exploring more
  powerful PE for Transformers and GNNs in a robust experimental setting.
...
- &id008
  ...
  - model: vanilla GCN
    ...
    value_gap_source_date_iso: '2023-01-01'
    value_gap_source_date_label: JMLR 2023
    gap_vs_at_pub: 0.15053000000000005
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: 3WLGNN
    ...
    value_gap_source_date_iso: '2021-10-14'
    value_gap_source_date_label: '2021'
    gap_vs_at_pub: 0.03273999999999999
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id010
  ...
  - model: RingGNN
    ...
    is_std_outlier: false
  - model: All MP-GCNs
    model_key: all mp-gcns
    model_plain: All MP-GCNs
    value: 0.01
    std: 0.0
    paper_value: 0.01
    paper_std: 0.0
...
- &id004
  ...
  - model: GIN
    ...
    gap_vs_at_pub: 0.054669999999999996
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: true
  ...
  - model: GraphSAGE
    ...
    value_gap_source_date_iso: '2023-01-01'
    value_gap_source_date_label: JMLR 2023
    gap_vs_at_pub: 0.07867000000000002
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: true
...
- &id009
  ...
  - model: GraphSAGE
    ...
    value_gap_source_title: Contextualized Messages Boost Graph Representations
    value_gap_source_is_current_paper: false
    value_gap: 3.999999999992898e-05
    has_value_note: false
    value_note: ''
    sort_value: 0.5052
    sort_std: 0.0
...
- &id003
  ...
  - model: GIN
    ...
    gap_vs_at_pub: 0.020830000000000015
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GAT
    ...
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.00376999999999994
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: true
  ...
  - model: MLP
    ...
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.015229999999999966
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: true
    ...
    value_gap_source_title: Simplifying Graph Convolutional Networks with Redundancy-Free
      Neighbors
    value_gap_source_is_current_paper: false
    value_gap: 0.0017700000000000493
    has_value_note: false
    value_note: ''
    sort_value: 0.76
    sort_std: 0.032
...
- &id001
  ...
  - model: GCN
    ...
    gap_vs_at_pub: 0.15551000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: MLP
    ...
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.12527999999999995
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id005
  ...
  - model: GCN
    ...
    value_gap_source_date_label: NeurIPS 2024
    gap_vs_at_pub: 0.01816000000000001
    worse_than_at_pub: false
    surpassed_since_pub: true
    better_than_at_pub: false
    insignificant_improvement_at_pub: true
  ...
  - model: GAT
    ...
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.06610999999999995
    worse_than_at_pub: false
    surpassed_since_pub: true
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_title: Asymmetric Learning for Graph Neural Network based Link
      Prediction
    value_gap_source_is_current_paper: false
    value_gap: 0.049290000000000056
    has_value_note: false
    value_note: ''
    sort_value: 0.5643
    sort_std: 0.0086
  ...
  - model: GraphSAGE
    ...
    gap_vs_at_pub: 0.030120000000000036
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.030120000000000036
    has_value_note: false
    value_note: ''
    sort_value: 0.5463
    sort_std: 0.0112
  ...
  - model: MLP
    ...
    is_std_outlier: false
  - model: Matrix Fact.
    model_key: matrix fact.
    model_plain: Matrix Fact.
    value: 0.44206
    std: 0.00452
    paper_value: 0.44206
    paper_std: 0.00452
