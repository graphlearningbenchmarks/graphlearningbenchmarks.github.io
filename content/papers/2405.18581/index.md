...
- &id003
  ...
  - model: GCN
    ...
    is_std_outlier: false
  - model: TAGs + GIN (8b)
    model_key: tags + gin (8b)
    model_plain: TAGs + GIN (8b)
    value: 0.682
    std: 0.0148
    paper_value: 0.682
    paper_std: 0.0148
    ...
    is_std_outlier: false
  - model: TAGs + UniMP (8b)
    model_key: tags + unimp (8b)
    model_plain: TAGs + UniMP (8b)
    value: 0.678
    std: 0.0213
    paper_value: 0.678
    paper_std: 0.0213
...
- &id002
  ...
  - model: UniMP
    ...
    is_std_outlier: false
  - model: TAGs + HAN (8b)
    model_key: tags + han (8b)
    model_plain: TAGs + HAN (8b)
    value: 0.7294
    std: 0.0164
    paper_value: 0.7294
    paper_std: 0.0164
