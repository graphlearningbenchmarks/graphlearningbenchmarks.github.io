---
title: 'SelfGNN: Self-supervised Graph Neural Networks without explicit negative sampling'
arxiv_id: '2103.14958'
source_url: ''
authors:
- name: Zekarias T. Kefato
  orcid: null
  s2_author_id: '32612989'
  s2_url: null
- name: Sarunas Girdzijauskas
  orcid: null
  s2_author_id: '69947993'
  s2_url: null
...
abstract: Real world data is mostly unlabeled or only few instances are labeled. Manually
  labeling data is a very expensive and daunting task. This calls for unsupervised
  learning techniques that are powerful enough to achieve comparable results as semi-supervised/supervised
  techniques. Contrastive self-supervised learning has emerged as a powerful direction,
  in some cases outperforming supervised techniques. In this study, we propose, SelfGNN,
  a novel contrastive self-supervised graph neural network (GNN) without relying on
  explicit contrastive terms. We leverage Batch Normalization, which introduces implicit
  contrastive terms, without sacrificing performance. Furthermore, as data augmentation
  is key in contrastive learning, we introduce four feature augmentation (FA) techniques
  for graphs. Though graph topological augmentation (TA) is commonly used, our empirical
  findings show that FA perform as good as TA. Moreover, FA incurs no computational
  overhead, unlike TA, which often has $O(N^3)$ time complexity, $N$ -- number of
  nodes. Our empirical evaluation on seven publicly available real-world data shows
  that, SelfGNN is powerful and leads to a performance comparable with SOTA supervised
  GNNs and always better than SOTA semi-supervised and unsupervised GNNs. The source
  code is available at https://github.com/zekarias-tilahun/SelfGNN.
codebase_url: https://github.com/zekarias-tilahun/SelfGNN
...
- &id002
  ...
  - model: DGI
    ...
    protocol_note: Uses the Planetoid split for the citation networks.
    date: Mar 27, 2021
  ...
  - model: SelfPPR
    ...
    true_value: 0.6808
    true_std: 0.0048
    value_gap_source_arxiv: '2103.14958'
    value_gap_source_title: 'SelfGNN: Self-supervised Graph Neural Networks without
...
- &id004
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: node classification task, 5-fold cross validation (mean on 40%
      fold) as per experiment 1 setup
    date: Mar 27, 2021
    date_display: Mar 2021
    date_iso: '2021-03-27'
    published_venue: WWW 2021
  ...
  - model: MLP
    ...
    is_std_outlier: false
  - model: SelfGNN Split
    model_key: selfgnn split
    model_plain: SelfGNN Split
    value: 0.955
    std: 0.003
    paper_value: 0.955
    paper_std: 0.003
    ...
    is_std_outlier: false
  - model: SelfGNN Paste
    model_key: selfgnn paste
    model_plain: SelfGNN Paste
    value: 0.955
    std: 0.002
    paper_value: 0.955
    paper_std: 0.002
  ...
  - model: SelfGNN LDP
    ...
    is_best: false
    is_std_outlier: false
  - model: SelfGNN Standard
    model_key: selfgnn standard
    model_plain: SelfGNN Standard
    value: 0.948
    std: 0.0
    paper_value: 0.948
    paper_std: 0.0
...
- &id001
  ...
  - model: DGI
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Uses the Planetoid split for Cora as stated in Experiment 3 setup.
    date: Mar 27, 2021
    date_display: Mar 2021
    date_iso: '2021-03-27'
    published_venue: WWW 2021
...
- &id003
  ...
  - model: MLP
    ...
    is_best: false
    is_std_outlier: false
  - model: SelfGNN PPR (GAT)
    model_key: selfgnn ppr (gat)
    model_plain: SelfGNN PPR (GAT)
    value: 0.827
    std: 0.01
    paper_value: 0.827
    paper_std: 0.01
    ...
    is_best: false
    is_std_outlier: false
  - model: SelfGNN hk (GAT)
    model_key: selfgnn hk (gat)
    model_plain: SelfGNN hk (GAT)
    value: 0.826
    std: 0.01
    paper_value: 0.826
    paper_std: 0.01
  ...
  - model: SelfGNN Split
    ...
    is_std_outlier: false
  - model: SelfGNN Katz
    model_key: selfgnn katz
    model_plain: SelfGNN Katz
    value: 0.81
    std: 0.01
    paper_value: 0.81
    paper_std: 0.01
  ...
  - model: SelfGNN LDP
    ...
    is_best: false
    is_std_outlier: false
  - model: SelfGNN Paste (GAT)
    model_key: selfgnn paste (gat)
    model_plain: SelfGNN Paste (GAT)
    value: 0.761
    std: 0.01
    paper_value: 0.761
    paper_std: 0.01
...
main_figure: /figures/2103.14958/main_figure.jpegoptim.jpg
---
