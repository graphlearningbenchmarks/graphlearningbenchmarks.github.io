...
- &id007
  ...
  - model: BORF
    ...
    protocol_note: Test accuracy reported after 100 random trials as described in
      experiment details.
    date: Nov 28, 2022
...
- &id002
  ...
  - model: FoSR
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy on Planetoid split (Yang et al. 2016) using GCN.
    date: Nov 28, 2022
    date_display: Nov 2022
    date_iso: '2022-11-28'
    published_venue: ICML 2022
...
- &id001
  ...
  - model: GCN + BORF
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy on Planetoid split (random 100 trials, mean and 95%
      CI reported)
    date: Nov 28, 2022
    date_display: Nov 2022
    date_iso: '2022-11-28'
...
- &id006
  ...
  - model: GCN with BORF
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy reported after 100 random trials with best validation
      performance; standard split for Cornell node classification.
    date: Nov 28, 2022
    date_display: Nov 2022
    date_iso: '2022-11-28'
    published_venue: ICML 2022
    ...
    is_std_outlier: false
  - model: GIN with BORF
    model_key: gin with borf
    model_plain: GIN with BORF
    value: 0.486
    std: 0.012
    paper_value: 0.486
    paper_std: 0.012
  ...
  - model: GCN with FoSR
    ...
    is_std_outlier: false
  - model: GIN with SDRF
    model_key: gin with sdrf
    model_plain: GIN with SDRF
    value: 0.4
    std: 0.021
    paper_value: 0.4
    paper_std: 0.021
    ...
    is_std_outlier: false
  - model: GIN with None
    model_key: gin with none
    model_plain: GIN with None
    value: 0.365
    std: 0.022
    paper_value: 0.365
    paper_std: 0.022
    ...
    is_std_outlier: false
  - model: GIN with FoSR
    model_key: gin with fosr
    model_plain: GIN with FoSR
    value: 0.356
    std: 0.024
    paper_value: 0.356
    paper_std: 0.024
...
- &id004
  ...
  - model: FoSR
    ...
    protocol_decision: standard
    protocol_note: Test accuracy via 100 random trials (mean and 95% CI) on TUDataset
      Enzymes split.
    date: Nov 28, 2022
    date_display: Nov 2022
    date_iso: '2022-11-28'
...
- &id003
  ...
  - model: BORF
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Test accuracy reported via mean of 100 random trials as per experiment
      details.
    date: Nov 28, 2022
    date_display: Nov 2022
    date_iso: '2022-11-28'
...
- &id005
  ...
  - model: None
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy averaged over 100 random trials.
    date: Nov 28, 2022
    date_display: Nov 2022
    date_iso: '2022-11-28'
    published_venue: ICML 2022
  ...
  - model: SDRF
    ...
    gap_vs_at_pub: 0.14159999999999995
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
