...
- name: Or Feldman
  orcid: null
  s2_author_id: '2151789902'
  s2_url: null
- name: A. Boyarski
  orcid: null
  s2_author_id: '29984409'
  s2_url: null
- name: Shai Feldman
  orcid: null
  s2_author_id: '47922223'
  s2_url: null
- name: D. Kogan
  orcid: null
  s2_author_id: '3407063'
  s2_url: null
- name: A. Mendelson
  orcid: null
  s2_author_id: '144188849'
  s2_url: null
- name: Chaim Baskin
  orcid: null
  s2_author_id: '46906102'
  s2_url: null
published_date: Jan 31, 2022
published_date_iso: '2022-01-31'
...
abstract: Graph isomorphism testing is usually approached via the comparison of graph
  invariants. Two popular alternatives that offer a good trade-off between expressive
  power and computational efficiency are combinatorial (i.e., obtained via the Weisfeiler-Leman
  (WL) test) and spectral invariants. While the exact power of the latter is still
  an open question, the former is regularly criticized for its limited power, when
  a standard configuration of uniform pre-coloring is used. This drawback hinders
  the applicability of Message Passing Graph Neural Networks (MPGNNs), whose expressive
  power is upper bounded by the WL test. Relaxing the assumption of uniform pre-coloring,
  we show that one can increase the expressive power of the WL test ad infinitum.
  Following that, we propose an efficient pre-coloring based on spectral features
  that provably increases the expressive power of the vanilla WL test. The above claims
  are accompanied by extensive synthetic and real data experiments. The code to reproduce
  our experiments is available at.
...
- &id008
  ...
  - model: SP-GCN
    ...
    is_std_outlier: false
  - model: SP-GraphSAGE
    model_key: sp-graphsage
    model_plain: SP-GraphSAGE
    value: 0.77
    std: 0.02
    paper_value: 0.77
    paper_std: 0.02
...
- &id004
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on PPI dataset
    date: Jan 31, 2022
    date_display: Jan 2022
    date_iso: '2022-01-31'
    published_venue: TMLR 2022
  ...
  - model: GIN
    ...
    at_pub_value: 0.8724
    at_pub_std: 0.0002
    at_pub_source_arxiv: '2104.06608'
    at_pub_source_title: Search to aggregate neighborhood for graph neural network
    at_pub_source_date_iso: '2021-04-01'
    at_pub_source_date_label: '2021'
    value_gap_source_date_iso: '2022-01-31'
    value_gap_source_date_label: TMLR 2022
    gap_vs_at_pub: 0.03860000000000008
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
    ...
    has_value_gap: true
    comparison_type: improved
    comparison_source_title: Search to aggregate neighborhood for graph neural network
    comparison_source_arxiv: '2104.06608'
    is_best: false
    is_std_outlier: false
  - model: SP-GCN
    model_key: sp-gcn
...
- &id003
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2026-05-24'
    value_gap_source_date_label: ICML 2026
    gap_vs_at_pub: 0.06309999999999993
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
