...
- name: Hadar Serviansky
  orcid: null
  s2_author_id: '73771259'
  s2_url: null
- name: Y. Lipman
  orcid: null
  s2_author_id: '3232072'
  s2_url: null
published_date: May 27, 2019
published_date_iso: '2019-05-27'
...
abstract: 'Recently, the Weisfeiler-Lehman (WL) graph isomorphism test was used to
  ...
  popular message passing GNN cannot distinguish between graphs that are indistinguishable
  by the $1$-WL test. Unfortunately, many simple instances of graphs are indistinguishable
  by the $1$-WL test. In search for more expressive graph learning models we build
  upon the recent $k$-order invariant and equivariant graph neural networks and present
  two results: First, we show that such $k$-order networks can distinguish between
  non-isomorphic graphs as good as the $k$-WL tests, which are provably stronger than
  the $1$-WL test for $k>2$. This makes these models strictly stronger than message
  passing models. Unfortunately, the higher expressiveness of these models comes with
  a computational cost of processing high order tensors. Second, setting our goal
  at building a provably stronger, simple and scalable model we show that a reduced
  $2$-order network containing just scaled identity operator, augmented with a single
  quadratic operation (matrix multiplication) has a provable $3$-WL expressive power.
  Differently put, we suggest a simple model that interleaves applications of standard
  Multilayer-Perceptron (MLP) applied to the feature dimension and matrix multiplication.
  We validate this model by presenting state of the art results on popular graph classification
  and regression tasks. To the best of our knowledge, this is the first practical
  invariant/equivariant model with guaranteed $3$-WL expressiveness, strictly stronger
...
- &id001
  ...
  - model: Ours 1
    ...
    at_pub_source_date_iso: ''
    at_pub_source_date_label: ''
    value_gap_source_date_iso: '2019-05-27'
    ...
    true_value: 0.9055
    true_std: 0.087
    value_gap_source_arxiv: '1905.11136'
    value_gap_source_title: Provably Powerful Graph Networks
  ...
  - model: 1-2-3 GNN
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: morris2018weisfeiler
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: ''
    protocol_decision: uncertain
    protocol_note: ''
  ...
  - model: DGK
    ...
    comparison_source_title: Anonymous Walk Embeddings
    comparison_source_arxiv: '1805.11921'
    is_best: false
    is_std_outlier: false
  - model: MLP
    model_key: mlp
  ...
  - model: PK
    ...
    is_best: false
    is_std_outlier: false
  - model: Invariant Graph Networks
    model_key: invariant graph networks
    model_plain: Invariant Graph Networks
    value: 0.8389
    std: 0.1295
    paper_value: 0.8389
    paper_std: 0.1295
...
main_figure: /figures/1905.11136/main_figure.jpegoptim.jpg
---
