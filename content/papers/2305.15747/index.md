...
- &id005
  ...
  - model: GCN
    ...
    protocol_note: Node classification on Computer dataset using standard split and
      accuracy metric.
    date: May 25, 2023
  ...
  - model: UnionGCN
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: injecting our structural coefficients to GCN
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
  ...
  - model: UnionGIN
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: injecting our structural coefficients to GIN
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
  ...
  - model: GIN
    ...
    at_pub_value: 0.648
    at_pub_std: 0.014
    at_pub_source_arxiv: '2211.16494'
    at_pub_source_title: On the Ability of Graph Neural Networks to Model Interactions
      Between Vertices
    at_pub_source_date_iso: '2022-11-29'
    ...
    comparison_source_title: On the Ability of Graph Neural Networks to Model Interactions
      Between Vertices
    comparison_source_arxiv: '2211.16494'
    is_best: false
    is_std_outlier: false
  - model: MLP
    model_key: mlp
  ...
  - model: UnionGraphSNN
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: injecting our structural coefficients to GraphSNN
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
...
- &id004
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: node classification on Photo dataset, 10 runs
    date: May 25, 2023
    date_display: May 2023
    date_iso: '2023-05-25'
    published_venue: AAAI 2023
...
- &id003
  ...
  - model: GraphSAGE
    ...
    protocol_note: node classification on CiteSeer using the Planetoid split (Yang
      et al. 2016) with Accuracy metric.
    date: May 25, 2023
    date_display: May 2023
    date_iso: '2023-05-25'
    published_venue: AAAI 2023
  ...
  - model: GCN
    ...
    value_gap_source_date_iso: '2023-05-10'
    value_gap_source_date_label: ICML 2023
    gap_vs_at_pub: 0.29390000000000005
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id001
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split, node classification accuracy
    date: May 25, 2023
    date_display: May 2023
    date_iso: '2023-05-25'
    published_venue: AAAI 2023
  ...
  - model: GAT
    ...
    gap_vs_at_pub: 0.14080000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GraphSAGE
    ...
    gap_vs_at_pub: 0.17170000000000007
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id009
  ...
  - model: GatedGCN
    ...
    protocol_decision: standard
    protocol_note: 10-fold CV on ENZYMES graph classification task
    date: May 25, 2023
    date_display: May 2023
    date_iso: '2023-05-25'
    published_venue: AAAI 2023
  ...
  - model: UnionGatedGCN
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: structural coefficient injected into GatedGCN
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
  ...
  - model: UnionGIN
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: structural coefficient injected into GIN
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
  ...
  - model: GIN
    ...
    value_gap_source_date_iso: '2023-01-01'
    value_gap_source_date_label: JMLR 2023
    gap_vs_at_pub: 0.018369999999999997
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_title: GNNBenchmark
    value_gap_source_is_current_paper: false
    value_gap: 0.018369999999999997
    has_value_note: false
    value_note: ''
    sort_value: 0.67667
    sort_std: 0.05831
  ...
  - model: UnionGCN
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: structural coefficient injected into GCN
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
  ...
  - model: UnionGraphSAGE
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: structural coefficient injected into GraphSAGE
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
...
- &id008
  ...
  - model: UnionGatedGCN
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: The structural coefficient is injected into the base
      GatedGCN model.
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
...
- &id002
  ...
  - model: GeniePath
    ...
    gap_vs_at_pub: 0.07540000000000002
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id011
  ...
  - model: GraphSNN
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold cross-validation on Tox21 graph classification task
    date: May 25, 2023
    date_display: May 2023
    date_iso: '2023-05-25'
    published_venue: AAAI 2023
