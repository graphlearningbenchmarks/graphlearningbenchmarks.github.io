...
- name: Siyu Jiang
  orcid: null
  s2_author_id: '2308566551'
  s2_url: null
- name: Kun He
  orcid: null
  s2_author_id: '2258947294'
  s2_url: null
published_date: Jun 27, 2024
published_date_iso: '2024-06-27'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: Recently, the emerging graph Transformers have made significant advancements
  for node classification on graphs. In most graph Transformers, a crucial step involves
  transforming the input graph into token sequences as the model input, enabling Transformer
  to effectively learn the node representations. However, we observe that existing
  methods only express partial graph information of nodes through single-type token
  generation. Consequently, they require tailored strategies to encode additional
  graph-specific features into the Transformer to ensure the quality of node representation
  learning, limiting the model flexibility to handle diverse graphs. To this end,
  we propose a new graph Transformer called NTFormer to address this issue. NTFormer
  introduces a novel token generator called Node2Par, which constructs various token
  sequences using different token elements for each node. This flexibility allows
  Node2Par to generate valuable token sequences from different perspectives, ensuring
  comprehensive expression of rich graph features. Benefiting from the merits of Node2Par,
  NTFormer only leverages a Transformer-based backbone without graph-specific modifications
  to learn node representations, eliminating the need for graph-specific modifications.
  Extensive experiments conducted on various benchmark datasets containing homophily
  and heterophily graphs with different scales demonstrate the superiority of NTFormer
  over representative graph Transformers and graph neural networks for node classification.
codebase_url: ''
...
- &id004
  ...
  - model: GCN
    ...
    protocol_note: Mean accuracy on small-scale datasets
    date: Jun 27, 2024
  ...
  - model: FAGCN
    ...
    gap_vs_at_pub: 0.06910000000000005
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id003
  ...
  - model: NAGphormer
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Photo dataset using mean accuracy and stdev
      over 10 runs.
    date: Jun 27, 2024
    date_display: Jun 2024
    date_iso: '2024-06-27'
  ...
  - model: Specformer
    ...
    value_gap_source_date_iso: '2024-06-27'
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.012899999999999912
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: SGC
    ...
    value_gap_source_date_iso: '2023-10-17'
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.017099999999999893
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_title: 'SignGT: Signed Attention-based Graph Transformer for
      Graph Representation Learning'
    value_gap_source_is_current_paper: false
    value_gap: 0.017099999999999893
    has_value_note: false
    value_note: ''
    sort_value: 0.9511
    sort_std: 0.0009
...
- &id007
  ...
  - model: SGFormer
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on large-scale dataset Amazon2M
    date: Jun 27, 2024
    date_display: Jun 2024
    date_iso: '2024-06-27'
    published_venue: ''
...
- &id001
  ...
  - model: GPRGNN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split as per canonical definition for Citeseer node classification.
    date: Jun 27, 2024
    date_display: Jun 2024
    date_iso: '2024-06-27'
    published_venue: ''
  ...
  - model: SGC
    ...
    value_gap_source_date_iso: '2023-11-30'
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.054300000000000015
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id002
  ...
  - model: NodeFormer
    ...
    gap_vs_at_pub: 0.0677000000000001
    worse_than_at_pub: false
    surpassed_since_pub: true
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: SGC
    ...
    value_gap_source_date_iso: '2024-05-22'
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.08809999999999996
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id005
  ...
  - model: ANS-GT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Large-scale node classification on Reddit dataset
    date: Jun 27, 2024
    date_display: Jun 2024
    date_iso: '2024-06-27'
    published_venue: ''
...
- &id006
  ...
  - model: SGFormer
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Mean accuracy reported on small-scale datasets
    date: Jun 27, 2024
    date_display: Jun 2024
    date_iso: '2024-06-27'
    published_venue: ''
  ...
  - model: GCN
    ...
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.12870000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: NodeFormer
    ...
    value_gap_source_date_iso: '2026-05-18'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.15049999999999997
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: APPNP
    ...
    value_gap_source_date_iso: '2024-04-06'
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.20900000000000007
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
single_proposed_model: NTFormer
main_figure: /figures/2406.19249/main_figure.jpegoptim.jpg
---
