...
- name: Jianhua Zhao
  ...
  s2_url: null
published_date: Aug 9, 2024
published_date_iso: '2024-08-09'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: Contrastive learning is a significant paradigm in graph self-supervised
  learning. However, it requires negative samples to prevent model collapse and learn
  discriminative representations. These negative samples inevitably lead to heavy
  computation, memory overhead and class collision, compromising the representation
  learning. Recent studies present that methods obviating negative samples can attain
  competitive performance and scalability enhancements, exemplified by bootstrapped
  graph latents (BGRL). However, BGRL neglects the inherent graph homophily, which
  provides valuable insights into underlying positive pairs. Our motivation arises
  from the observation that subtly introducing a few ground-truth positive pairs significantly
  improves BGRL. Although we can't obtain ground-truth positive pairs without labels
  under the self-supervised setting, edges in the graph can reflect noisy positive
  pairs, i.e., neighboring nodes often share the same label. Therefore, we propose
  to expand the positive pair set with node-neighbor pairs. Subsequently, we introduce
  a cross-attention module to predict the supportiveness score of a neighbor with
  respect to the anchor node. This score quantifies the positive support from each
  neighboring node, and is encoded into the training objective. Consequently, our
  method mitigates class collision from negative and noisy positive samples, concurrently
  enhancing intra-class compactness. Extensive experiments are conducted on five benchmark
  datasets and three downstream task node classification, node clustering, and node
  similarity search. The results demonstrate that our method generates node representations
  with enhanced intra-class compactness and achieves state-of-the-art performance.
  Our implementation code is available at.
codebase_url: https://github.com/Cloudy1225/BLNN
...
- &id002
  ...
  - model: GCN
    ...
    protocol_note: Node classification on Amazon-Computers dataset using supervised
      input (A, X, Y)
    date: Aug 9, 2024
  ...
  - model: BLNN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Amazon-Computers dataset using self-supervised
      input (A, X)
    date: Aug 9, 2024
    date_display: Aug 2024
    date_iso: '2024-08-09'
  ...
  - model: ProGCL
    ...
    value_gap_source_title: Adaptive Negative Scheduling for Graph Contrastive Learning
    value_gap_source_is_current_paper: false
    value_gap: 0.0026999999999999247
    has_value_note: false
    value_note: ''
    sort_value: 0.8955
    sort_std: 0.0016
...
- &id001
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Photo dataset using supervised input (A,
      X, Y)
    date: Aug 9, 2024
    date_display: Aug 2024
    date_iso: '2024-08-09'
  ...
  - model: ProGCL
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Self-supervised node classification on Photo using (A, X)
    date: Aug 9, 2024
    date_display: Aug 2024
    date_iso: '2024-08-09'
    published_venue: ''
    ...
    at_pub_value: 0.9381
    at_pub_std: 0.0048
    at_pub_source_arxiv: '2311.02687'
    at_pub_source_title: 'Architecture Matters: Uncovering Implicit Mechanisms in
      Graph Contrastive Learning'
    at_pub_source_date_iso: '2023-11-05'
  ...
  - model: MVGRL
    ...
    value_gap_source_title: Decoupling Weighing and Selecting for Integrating Multiple
      Graph Pre-training Tasks
    value_gap_source_is_current_paper: false
    value_gap: 0.010600000000000054
    has_value_note: false
    value_note: ''
    sort_value: 0.931
    sort_std: 0.004
  ...
  - model: MLP
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Photo dataset using supervised input (X,
      Y)
    date: Aug 9, 2024
    date_display: Aug 2024
    date_iso: '2024-08-09'
...
- &id003
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification task on Physics dataset
    date: Aug 9, 2024
    date_display: Aug 2024
    date_iso: '2024-08-09'
    published_venue: ''
...
- &id004
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: 20 random splits (1:1:8) as per BGRL protocol
    date: Aug 9, 2024
    date_display: Aug 2024
    date_iso: '2024-08-09'
    published_venue: ''
...
- scope: node-level
  ...
  - benchmark: Classic
    ...
    - dataset: WikiCS
      dataset_slug: wikics
single_proposed_model: BLNN
main_figure: /figures/2408.05087/main_figure.jpegoptim.jpg
---
