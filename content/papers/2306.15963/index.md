...
- name: Xinyu Ma
  orcid: null
  s2_author_id: '2164707525'
  s2_url: null
- name: Xu Chu
  orcid: null
  s2_author_id: '2056598391'
  s2_url: null
- name: Yasha Wang
  orcid: null
  s2_author_id: '2253831765'
  s2_url: null
- name: Yang Lin
  orcid: null
  s2_author_id: '2149200707'
  s2_url: null
- name: Junfeng Zhao
  orcid: null
  s2_author_id: '2145804723'
  s2_url: null
- name: Liantao Ma
  orcid: null
  s2_author_id: '2219046611'
  s2_url: null
- name: Wenwu Zhu
  orcid: null
...
abstract: Graph data augmentation has shown superiority in enhancing generalizability
  and robustness of GNNs in graph-level classifications. However, existing methods
  primarily focus on the augmentation in the graph signal space and the graph structure
  space independently, neglecting the joint interaction between them. In this paper,
  we address this limitation by formulating the problem as an optimal transport problem
  that aims to find an optimal inter-graph node matching strategy considering the
  interactions between graph structures and signals. To solve this problem, we propose
  a novel graph mixup algorithm called FGWMixup, which seeks a "midpoint" of source
  graphs in the Fused Gromov-Wasserstein (FGW) metric space. To enhance the scalability
  of our method, we introduce a relaxed FGW solver that accelerates FGWMixup by improving
  the convergence rate from $ (t^-1)$ to $ (t^-2)$. Extensive experiments conducted
  on five datasets using both classic (MPNNs) and advanced (Graphormers) GNN backbones
  demonstrate that FGWMixup effectively improves the generalizability and robustness
  of GNNs. Codes are available at.
codebase_url: https://github.com/ArthurLeoM/FGWMixup
...
- &id001
  ...
  - model: ifMixup
    ...
    protocol_note: 10-fold CV on NCI1 using vGCN backbone
    date: Jun 28, 2023
  ...
  - model: DropNode
    ...
    has_value_gap: true
    comparison_type: behind
    comparison_source_title: 'SoftEdge: Regularizing Graph Classification with Random
      Soft Edges'
    comparison_source_arxiv: '2204.10390'
    is_best: false
    is_std_outlier: false
  - model: DropEdge
    model_key: dropedge
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV on NCI1 using vGIN backbone
    date: Jun 28, 2023
    date_display: Jun 2023
    date_iso: '2023-06-28'
    published_venue: NeurIPS 2023
  ...
  - model: Graphormer
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV on NCI1 using Graphormer backbone
    date: Jun 28, 2023
    date_display: Jun 2023
    date_iso: '2023-06-28'
    published_venue: NeurIPS 2023
  ...
  - model: Vanilla
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.020999999999999908
    has_value_note: false
    value_note: ''
    sort_value: 0.7908
    sort_std: 0.0212
    ...
    is_best: false
    is_std_outlier: false
  - model: vGCN-FGWMixup_*
    model_key: vgcn-fgwmixup_
    model_plain: vGCN-FGWMixup_*
    value: 0.7871
    std: 0.0149
    paper_value: 0.7871
    paper_std: 0.0149
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV on NCI1 using vGCN backbone with k=0.5
    date: Jun 28, 2023
    date_display: Jun 2023
    date_iso: '2023-06-28'
    published_venue: NeurIPS 2023
  ...
  - model: FGWMixup
    ...
    is_std_outlier: false
  - model: vGIN-FGWMixup
    model_key: vgin-fgwmixup
    model_plain: vGIN-FGWMixup
    value: 0.7832
    std: 0.0265
    paper_value: 0.7832
    paper_std: 0.0265
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV on NCI1 using vGIN backbone with k=0.2
    date: Jun 28, 2023
    date_display: Jun 2023
    date_iso: '2023-06-28'
    published_venue: NeurIPS 2023
  ...
  - model: G-Mixup
    ...
    is_std_outlier: false
  - model: G-Mixup+FGW
    model_key: g-mixup+fgw
    model_plain: G-Mixup+FGW
    value: 0.7818
    std: 0.0173
    paper_value: 0.7818
    paper_std: 0.0173
    ...
    is_std_outlier: false
  - model: GraphormerGD
    model_key: graphormergd
    model_plain: GraphormerGD
    value: 0.7601
    std: 0.0202
    paper_value: 0.7601
    paper_std: 0.0202
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV on NCI1 using GraphormerGD backbone
    date: Jun 28, 2023
    date_display: Jun 2023
    date_iso: '2023-06-28'
    published_venue: NeurIPS 2023
...
- &id002
  ...
  - model: FGWMixup
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV on PROTEINS, Accuracy for GraphormerGD backbone
    date: Jun 28, 2023
    date_display: Jun 2023
    date_iso: '2023-06-28'
    published_venue: NeurIPS 2023
  ...
  - model: G-Mixup
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV on PROTEINS, Accuracy for Graphormer backbone
    date: Jun 28, 2023
    date_display: Jun 2023
    date_iso: '2023-06-28'
    published_venue: NeurIPS 2023
  ...
  - model: DropNode
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV on PROTEINS, Accuracy for vGCN backbone
    date: Jun 28, 2023
    date_display: Jun 2023
    date_iso: '2023-06-28'
    published_venue: NeurIPS 2023
  ...
  - model: ifMixup
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV on PROTEINS, Accuracy for vGIN backbone
    date: Jun 28, 2023
    date_display: Jun 2023
    date_iso: '2023-06-28'
    published_venue: NeurIPS 2023
  ...
  - model: Vanilla
    ...
    value_gap_source_date_iso: '2023-06-28'
    value_gap_source_date_label: NeurIPS 2023
    gap_vs_at_pub: 0.03499999999999992
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: true
...
- &id003
  ...
  - model: G-Mixup
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: In spite of the existence of edge features in OGB datasets,
      in this work, both of our GNN backbones and augmentation methods do not encode
      or consider the edge features.
    table_ref: Table 12
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: ROC-AUC on OGB scaffold split for ogbg-molhiv
    date: Jun 28, 2023
    date_display: Jun 2023
    date_iso: '2023-06-28'
    published_venue: NeurIPS 2023
    ...
    value_gap_source_date_iso: '2023-06-11'
    value_gap_source_date_label: ICML 2023
    gap_vs_at_pub: 0.027699999999999947
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_title: Graph Mixup with Soft Alignments
    value_gap_source_is_current_paper: false
    value_gap: 0.027699999999999947
    has_value_note: false
    value_note: ''
    sort_value: 0.7742
    sort_std: 0.0145
...
- &id004
  ...
  - model: FGWMixup
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: ROC-AUC on ogbg-molbace using official OGB split
    date: Jun 28, 2023
    date_display: Jun 2023
    date_iso: '2023-06-28'
    published_venue: NeurIPS 2023
