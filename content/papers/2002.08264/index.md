...
- &id001
  ...
  - model: GCN
    ...
    protocol_note: ROC AUC on BBBP test set, 500 HP budget
    date: Feb 19, 2020
  ...
  - model: Weave
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: ROC AUC on BBBP test set, 150 HP budget
    date: Feb 19, 2020
    date_display: Feb 2020
    date_iso: '2020-02-19'
    published_venue: NeurIPS 2020
  ...
  - model: MAT
    ...
    input_feature_source: raw_features
    feature_source_evidence: self-supervised pre-training further improves performance
    table_ref: Table 3
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: ROC AUC on BBBP test set, pretrained version
    date: Feb 19, 2020
    date_display: Feb 2020
    date_iso: '2020-02-19'
    published_venue: NeurIPS 2020
  ...
  - model: SMILES
    ...
    uses_external_data: 1
    input_feature_source: raw_features
    feature_source_evidence: methods that use pretraining
    table_ref: Table 3
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
