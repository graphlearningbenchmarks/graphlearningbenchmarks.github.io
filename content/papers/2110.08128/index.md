...
abstract: Graph Neural Networks (GNNs) have achieved remarkable performance in modeling
  ...
  have dissimilar labels and attributes. Therefore, we investigate a novel framework
  that performs well on graphs with either homophily or heterophily. Specifically,
  we propose a label-wise message passing mechanism to avoid the negative effects
  caused by aggregating dissimilar node representations and preserve the heterophilic
  contexts for representation learning. We further propose a bi-level optimization
  method to automatically select the model for graphs with homophily/heterophily.
...
- &id001
  ...
  - model: SimP-GCN
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.010999999999999899
    has_value_note: false
    value_note: ''
    sort_value: 0.816
    sort_std: null
...
- &id003
  ...
  - model: LINKX
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: 5 public splits used for evaluation
    date: Oct 15, 2021
    date_display: Oct 2021
    date_iso: '2021-10-15'
    published_venue: ''
...
main_figure: /figures/2110.08128/main_figure.jpegoptim.jpg
---
