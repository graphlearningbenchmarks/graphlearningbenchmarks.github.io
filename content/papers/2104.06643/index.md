...
abstract: This paper presents Gem, a model-agnostic approach for providing interpretable
  ...
  on Granger causality. Different from existing explainers for GNNs, Gem explains
  ...
  knowledge on the graph learning tasks. In addition, Gem, once trained, can be used
  to explain the target GNN very quickly. Our theoretical analysis shows that several
  recent explainers fall into a unified framework of additive feature attribution
  methods. Experimental results on synthetic and real-world datasets show that Gem
  achieves a relative increase of the explanation accuracy by up to $30\
codebase_url: https://github.com/wanyu-lin/ICML2021-Gem
extraction_model: cyankiwi/gemma-4-26B-A4B-it-AWQ-4bit
has_results: true
paper_type: method
proposed_models:
- approximate computation strategy
mrr: 0.0018
adjusted_mrr: 0.0006
mrr_dataset_count: 1
...
- &id001
  ...
  - model: GNNExplainer
    ...
    protocol_note: Explaining the entire test set
    date: Apr 14, 2021
  ...
  - model: MLP
    ...
    is_best: false
    is_std_outlier: false
  - model: approximate computation strategy
    model_key: approximate computation strategy
    model_plain: approximate computation strategy
    value: 0.834
    std: null
    paper_value: 0.834
    paper_std: null
...
- &id002
  ...
  - model: GEM
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Explanation accuracy for K=30
    date: Apr 14, 2021
    date_display: Apr 2021
    date_iso: '2021-04-14'
    published_venue: ICML 2021
...
- scope: graph-level
  ...
  - benchmark: TU Dortmund
    ...
    - dataset: NCI1
      dataset_slug: nci1
single_proposed_model: approximate computation strategy
main_figure: /figures/2104.06643/main_figure.jpegoptim.jpg
---
