...
- name: Suhang Wang
  ...
  s2_url: null
published_date: Aug 26, 2021
published_date_iso: '2021-08-26'
published_venue: ''
...
codebase_url: https://github.com/EnyanDai/SEGNN
...
- &id002
  ...
  - model: GCN
    ...
    protocol_note: Node classification on CiteSeer using Planetoid split (Yang et
      al. 2016).
    date: Aug 26, 2021
...
- &id001
  ...
  - model: SuperGAT
    ...
    input_feature_source: raw_features
    feature_source_evidence: SuperGAT deploys the edge prediction as self-supervised
      task to guide the learning of attention.
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
  ...
  - model: SEGNN
    ...
    feature_source_evidence: adopts contrastive learning on node and edge representations
      to supervise node similarity and edge matching explanations.
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
...
- scope: node-level
  ...
  - benchmark: Classic
    ...
    - dataset: PubMed
      dataset_slug: pubmed
single_proposed_model: SEGNN
main_figure: /figures/2108.12055/main_figure.jpegoptim.jpg
---
