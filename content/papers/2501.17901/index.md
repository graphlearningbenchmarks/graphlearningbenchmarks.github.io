...
- &id002
  ...
  - model: Extremely Randomized Trees
    model_key: extremely randomized trees
...
- &id001
  ...
  - model: ECFP + Extremely Randomized Trees
    model_key: ecfp + extremely randomized trees
  ...
  - model: RDKit + Extremely Randomized Trees
    model_key: rdkit + extremely randomized trees
  ...
  - model: TT + Extremely Randomized Trees
    model_key: tt + extremely randomized trees
    ...
    is_best: false
    is_std_outlier: false
  - model: TT + Random Forest
    model_key: tt + random forest
    model_plain: TT + Random Forest
    value: 0.2471
    std: 0.0003
    paper_value: 0.2471
    paper_std: 0.0003
