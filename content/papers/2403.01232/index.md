...
- name: Zichao Yue
  orcid: null
  s2_author_id: '2229467567'
  s2_url: null
- name: Zhiru Zhang
  orcid: null
  s2_author_id: '2284031854'
  s2_url: null
...
abstract: 'Graph transformers (GTs) have emerged as a promising architecture that
  is theoretically more expressive than message-passing graph neural networks (GNNs).
  However, typical GT models have at least quadratic complexity and thus cannot scale
  to large graphs. While there are several linear GTs recently proposed, they still
  lag behind GNN counterparts on several popular graph datasets, which poses a critical
  concern on their practical expressivity. To balance the trade-off between expressivity
  and scalability of GTs, we propose Polynormer, a polynomial-expressive GT model
  with linear complexity. Polynormer is built upon a novel base model that learns
  a high-degree polynomial on input features. To enable the base model permutation
  equivariant, we integrate it with graph topology and node features separately, resulting
  in local and global equivariant attention models. Consequently, Polynormer adopts
  a linear local-to-global attention scheme to learn high-degree equivariant polynomials
  whose coefficients are controlled by attention scores. Polynormer has been evaluated
  on $13$ homophilic and heterophilic datasets, including large graphs with millions
  of nodes. Our extensive experiment results show that Polynormer outperforms state-of-the-art
  GNN and GT baselines on most datasets, even without the use of nonlinear activation
  functions. Source code of Polynormer is freely available at: github.com/cornell-zhang/Polynormer.'
...
- &id002
  ...
  - model: GCN
    ...
    protocol_note: Node classification accuracy on Computer dataset, averaged over
      10 runs.
    date: Mar 2, 2024
  ...
  - model: Polynormer-v2
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification accuracy on Computer dataset.
    date: Mar 2, 2024
    date_display: Mar 2024
    date_iso: '2024-03-02'
    published_venue: ICLR 2024
  ...
  - model: GGCN
    ...
    at_pub_value: 0.808
    at_pub_std: 0.007
    at_pub_source_arxiv: '2401.11750'
    at_pub_source_title: 'AdaFGL: A New Paradigm for Federated Node Classification
    ...
    comparison_source_title: 'AdaFGL: A New Paradigm for Federated Node Classification
      with Topology Heterogeneity'
    comparison_source_arxiv: '2401.11750'
    is_best: false
    is_std_outlier: false
  - model: Exphormer
    model_key: exphormer
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: Shirzad2023ExphormerST
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification accuracy on Computer dataset, averaged over
  ...
  - model: PPRGo
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: bojchevski2020scaling
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification accuracy on Computer dataset, averaged over
...
- &id001
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: node classification accuracy on Photo dataset, averaged over 10
      runs
    date: Mar 2, 2024
    date_display: Mar 2024
    date_iso: '2024-03-02'
  ...
  - model: Polynormer-v1
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: node classification accuracy on Photo dataset
    date: Mar 2, 2024
    date_display: Mar 2024
    date_iso: '2024-03-02'
    published_venue: ICLR 2024
  ...
  - model: GCNII
    ...
    at_pub_value: 0.9105
    at_pub_std: null
    at_pub_source_arxiv: '2306.12091'
    at_pub_source_title: Structure-Aware DropEdge Towards Deep Graph Convolutional
      Networks
    at_pub_source_date_iso: '2023-06-21'
    at_pub_source_date_label: '2023'
    value_gap_source_date_iso: '2024-03-02'
    value_gap_source_date_label: ICLR 2024
    ...
    has_value_gap: true
    comparison_type: improved
    comparison_source_title: Structure-Aware DropEdge Towards Deep Graph Convolutional
      Networks
    comparison_source_arxiv: '2306.12091'
    is_best: false
    is_std_outlier: false
  - model: PPRGo
    model_key: pprgo
...
- &id006
  ...
  - model: H2GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on amazon-ratings heterophilic dataset, averaged over
      10 runs.
    date: Mar 2, 2024
    date_display: Mar 2024
    date_iso: '2024-03-02'
  ...
  - model: Polynormer-v1
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on amazon-ratings heterophilic dataset.
    date: Mar 2, 2024
    date_display: Mar 2024
    date_iso: '2024-03-02'
    published_venue: ICLR 2024
...
- &id003
  ...
  - model: NAGphormer
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification accuracy on Physics dataset, 10 runs.
    date: Mar 2, 2024
    date_display: Mar 2024
    date_iso: '2024-03-02'
    published_venue: ICLR 2024
  ...
  - model: Polynormer-r
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification accuracy on Physics dataset, 10 runs (Polynormer
      with ReLU).
    date: Mar 2, 2024
    date_display: Mar 2024
    date_iso: '2024-03-02'
  ...
  - model: GraphSAGE
    ...
    gap_vs_at_pub: 0.03489999999999993
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
- &id008
  ...
  - model: Polynormer-r
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: ROC AUC on minesweeper heterophilic dataset, averaged over 10 runs.
    date: Mar 2, 2024
    date_display: Mar 2024
    date_iso: '2024-03-02'
    published_venue: ICLR 2024
  ...
  - model: Polynormer-v1
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: ROC AUC on minesweeper heterophilic dataset.
    date: Mar 2, 2024
    date_display: Mar 2024
    date_iso: '2024-03-02'
    published_venue: ICLR 2024
...
- &id009
  ...
  - model: H2GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: ROC-AUC on questions heterophilic dataset, averaged over 10 runs
    date: Mar 2, 2024
    date_display: Mar 2024
    date_iso: '2024-03-02'
    published_venue: ICLR 2024
...
- &id005
  ...
  - model: Polynormer
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on roman-empire heterophilic dataset, averaged over 10
      runs.
    date: Mar 2, 2024
    date_display: Mar 2024
    date_iso: '2024-03-02'
  ...
  - model: Polynormer-v1
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on roman-empire heterophilic dataset.
    date: Mar 2, 2024
    date_display: Mar 2024
    date_iso: '2024-03-02'
    published_venue: ICLR 2024
  ...
  - model: SAGE
    ...
    date_iso: '2025-07-19'
    venue: null
    codebase_url: https://github.com/liyle3/REDISC
    uses_external_data: false
    input_feature_source: null
    feature_source_evidence: ''
    is_global_top: true
...
- &id007
  ...
  - model: Polynormer-r
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: ROC-AUC on tolokers heterophilic dataset, averaged over 10 runs.
    date: Mar 2, 2024
    date_display: Mar 2024
    date_iso: '2024-03-02'
    published_venue: ICLR 2024
...
- &id004
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on WikiCS, averaged over 10 runs.
    date: Mar 2, 2024
    date_display: Mar 2024
    date_iso: '2024-03-02'
    published_venue: ICLR 2024
  ...
  - model: GraphSAGE
    ...
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 3.0000000000085514e-05
    worse_than_at_pub: false
    surpassed_since_pub: true
    better_than_at_pub: false
    insignificant_improvement_at_pub: true
  ...
  - model: Polynormer-v2
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on WikiCS.
    date: Mar 2, 2024
    date_display: Mar 2024
    date_iso: '2024-03-02'
    published_venue: ICLR 2024
...
main_figure: /figures/2403.01232/main_figure.jpegoptim.jpg
---
