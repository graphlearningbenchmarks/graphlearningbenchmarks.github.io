...
- name: Takanori Maehara
  ...
  s2_url: null
published_date: May 23, 2019
published_date_iso: '2019-05-23'
published_venue: ''
...
abstract: Graph neural networks have become one of the most important techniques to
  ...
  classification proposed deep and distributed learning models to achieve high performance
  and scalability. However, we find that the feature vectors of benchmark datasets
  are already quite informative for the classification task, and the graph structure
  only provides a means to denoise the data. In this paper, we develop a theoretical
  framework based on graph signal processing for analyzing graph neural networks.
  Our results indicate that graph neural networks only perform low-pass filtering
  on feature vectors and do not have the non-linear manifold learning property. We
  further investigate their resilience to feature noise and propose some insights
...
- &id002
  ...
  - model: gfNN
    ...
    value_gap_source_date_iso: '2019-05-23'
    ...
    true_value: 0.622
    true_std: 0.015
    value_gap_source_arxiv: '1905.09550'
    value_gap_source_title: 'Revisiting Graph Neural Networks: All We Have is Low-Pass
      Filters'
...
- scope: node-level
  ...
  - benchmark: Classic
    ...
    - dataset: PPI
      dataset_slug: ppi
single_proposed_model: gfNN
main_figure: /figures/1905.09550/main_figure.jpegoptim.jpg
---
