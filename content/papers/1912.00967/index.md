...
- name: Jian Tang
  ...
  s2_url: null
published_date: Dec 2, 2019
published_date_iso: '2019-12-02'
...
abstract: This paper builds on the connection between graph neural networks and traditional
  ...
  continuous graph neural networks are robust to over-smoothing and hence allow us
...
- &id002
  ...
  - model: SGC+TSC
    ...
    is_best: false
    is_std_outlier: false
  - model: CGNN with weight
    model_key: cgnn with weight
    model_plain: CGNN with weight
    value: 0.729
    std: 0.006
    paper_value: 0.729
    paper_std: 0.006
    ...
    protocol_note: Planetoid split (Yang et al. 2016 fixed split) with 20 training
      nodes and 500 validation nodes per class.
    date: Dec 2, 2019
    ...
    value_gap_source_date_iso: '2019-12-02'
    ...
    true_value: 0.729
    true_std: 0.006
    value_gap_source_arxiv: '1912.00967'
    value_gap_source_title: Continuous Graph Neural Networks
...
- &id001
  ...
  - model: GAT-GODE
    ...
    is_std_outlier: false
  - model: CGNN discrete
    model_key: cgnn discrete
    model_plain: CGNN discrete
    value: 0.818
    std: 0.006
    paper_value: 0.818
    paper_std: 0.006
...
- scope: node-level
  ...
  - benchmark: Classic
    ...
    - dataset: PubMed
      dataset_slug: pubmed
main_figure: /figures/1912.00967/main_figure.jpegoptim.jpg
---
