...
- name: Yuxiang Wang
  orcid: null
  s2_author_id: '2261673488'
  s2_url: null
- name: Xiao Yan
  orcid: null
  s2_author_id: '2261469490'
  s2_url: null
- name: Chuang Hu
  orcid: null
  s2_author_id: '2237020867'
  s2_url: null
- name: Fangcheng Fu
  orcid: null
  s2_author_id: '46182701'
  s2_url: null
- name: Wentao Zhang
  orcid: null
  s2_author_id: '2261449153'
  s2_url: null
- name: Hao Wang
  orcid: null
  s2_author_id: '2261415832'
  s2_url: null
- name: Shuo Shang
  orcid: null
  s2_author_id: '2261391734'
  s2_url: null
- name: Jiawei Jiang
  orcid: null
  s2_author_id: '2261477561'
  s2_url: null
published_date: Oct 24, 2023
published_date_iso: '2023-10-24'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: For graph self-supervised learning (GSSL), masked autoencoder (MAE) follows
  the generative paradigm and learns to reconstruct masked graph edges or node features.
  Contrastive Learning (CL) maximizes the similarity between augmented views of the
  same graph and is widely used for GSSL. However, MAE and CL are considered separately
  in existing works for GSSL. We observe that the MAE and CL paradigms are complementary
  and propose the graph contrastive masked autoencoder (GCMAE) framework to unify
  them. Specifically, by focusing on local edges or node features, MAE cannot capture
  global information of the graph and is sensitive to particular edges and features.
  On the contrary, CL excels in extracting global information because it considers
  the relation between graphs. As such, we equip GCMAE with an MAE branch and a CL
  branch, and the two branches share a common encoder, which allows the MAE branch
  to exploit the global information extracted by the CL branch. To force GCMAE to
  capture global graph structures, we train it to reconstruct the entire adjacency
  matrix instead of only the masked edges as in existing works. Moreover, a discrimination
  loss is proposed for feature reconstruction, which improves the disparity between
  node embeddings rather than reducing the reconstruction error to tackle the feature
  smoothing problem of MAE. We evaluate GCMAE on four popular graph tasks (i.e., node
  classification, node clustering, link prediction, and graph classification) and
  compare it with 14 state-of-the-art baselines. The results show that GCMAE consistently
  provides good accuracy across these tasks, and the maximum accuracy improvement
  is up to 3.2\
codebase_url: ''
...
- &id002
  ...
  - model: DGI
    ...
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.07080000000000009
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GRACE
    ...
    value_gap_source_date_iso: '2023-06-03'
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.03290000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id001
  ...
  - model: MaskGAE
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.011500000000000066
    has_value_note: false
    value_note: ''
    sort_value: 0.8748
    sort_std: 0.002
...
- &id003
  ...
  - model: GCMAE
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification accuracy on Reddit
    date: Oct 24, 2023
    date_display: Oct 2023
    date_iso: '2023-10-24'
    published_venue: ''
...
- scope: graph-level
  ...
  - benchmark: TU Dortmund
    ...
    - dataset: COLLAB
      dataset_slug: collab
single_proposed_model: GCMAE
main_figure: /figures/2310.15523/main_figure.jpegoptim.jpg
---
