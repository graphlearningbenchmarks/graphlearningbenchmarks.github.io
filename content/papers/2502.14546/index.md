...
- name: Christopher Morris
  ...
  s2_url: null
published_date: Feb 20, 2025
published_date_iso: '2025-02-20'
published_venue: ICML 2025
published_conference: ICML 2025
published_conference_short: ICML
published_conference_slug: icml
abstract: While machine learning on graphs has demonstrated promise in drug design
  and molecular property prediction, significant benchmarking challenges hinder its
  further progress and relevance. Current benchmarking practices often lack focus
  on transformative, real-world applications, favoring narrow domains like two-dimensional
  molecular graphs over broader, impactful areas such as combinatorial optimization,
  relational databases, or chip design. Additionally, many benchmark datasets poorly
  represent the underlying data, leading to inadequate abstractions and misaligned
  use cases. Fragmented evaluations and an excessive focus on accuracy further exacerbate
  these issues, incentivizing overfitting rather than fostering generalizable insights.
  These limitations have prevented the development of truly useful graph foundation
  models. This position paper calls for a paradigm shift toward more meaningful benchmarks,
  rigorous evaluation protocols, and stronger collaboration with domain experts to
  drive impactful and reliable advances in graph learning research, unlocking the
  potential of graph learning.
codebase_url: ''
...
- &id002
  ...
  - model: MLP
    ...
    is_best: false
    is_std_outlier: false
  - model: GAT Re-evaluated
    model_key: gat re-evaluated
    model_plain: GAT Re-evaluated
    value: 0.4452
    std: 0.0048
    paper_value: 0.4452
    paper_std: 0.0048
    ...
    protocol_note: Accuracy on the amazon-ratings dataset using the re-evaluated setup
    ...
    value_gap_source_date_iso: '2025-02-20'
    ...
    true_value: 0.4452
    true_std: 0.0048
    value_gap_source_arxiv: '2502.14546'
    value_gap_source_title: 'Position: Graph Learning Will Lose Relevance Due To Poor
      Benchmarks'
    ...
    is_best: false
    is_std_outlier: false
  - model: GCN Re-evaluated
    model_key: gcn re-evaluated
    model_plain: GCN Re-evaluated
    value: 0.443
    std: 0.0052
    paper_value: 0.443
    paper_std: 0.0052
    ...
    is_best: false
    is_std_outlier: false
  - model: SAGE Re-evaluated
    model_key: sage re-evaluated
    model_plain: SAGE Re-evaluated
    value: 0.4335
    std: 0.008
    paper_value: 0.4335
    paper_std: 0.008
...
- &id003
  ...
  - model: SAGE Re-evaluated
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: ROC-AUC on minesweeper test set via re-evaluation
    date: Feb 20, 2025
    date_display: Feb 2025
    date_iso: '2025-02-20'
    published_venue: ICML 2025
...
- &id001
  ...
  - model: GIN Orig.
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: Uses the original graph structure.
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Standard scaffold split for ogbg-molhiv using original graph structure.
    date: Feb 20, 2025
    date_display: Feb 2025
    date_iso: '2025-02-20'
    published_venue: ICML 2025
    ...
    is_best: false
    is_std_outlier: false
  - model: GraphConv Orig.
    model_key: graphconv orig.
    model_plain: GraphConv Orig.
    value: 0.6824
    std: 0.0177
    paper_value: 0.6824
    paper_std: 0.0177
...
main_figure: /figures/2502.14546/main_figure.jpegoptim.jpg
---
