...
- name: Jiaqi Sun
  orcid: null
  s2_author_id: '2188389873'
  s2_url: null
- name: Lin Zhang
  orcid: null
  s2_author_id: '2217098681'
  s2_url: null
- name: Guan-Hong Chen
  orcid: null
...
- name: Kun Zhang
  orcid: null
  s2_author_id: '2175349484'
  s2_url: null
- name: Peng Xu
  orcid: null
  s2_author_id: '2153917758'
  s2_url: null
- name: Yujiu Yang
  orcid: null
  s2_author_id: '3001727'
  s2_url: null
published_date: May 10, 2023
published_date_iso: '2023-05-10'
published_venue: ICML 2023
published_conference: ICML 2023
published_conference_short: ICML
published_conference_slug: icml
abstract: Graph neural networks aim to learn representations for graph-structured
  data and show impressive performance, particularly in node classification. Recently,
  many methods have studied the representations of GNNs from the perspective of optimization
  goals and spectral graph theory. However, the feature space that dominates representation
  ...
  matrix space analysis. In particular, we theoretically find that the feature space
  tends to be linearly correlated due to repeated aggregations. Motivated by these
  findings, we propose 1) feature subspaces flattening and 2) structural principal
  components to expand the feature space. Extensive experiments verify the effectiveness
  of our proposed more comprehensive feature space, with comparable inference time
  to the baseline, and demonstrate its efficient convergence capability.
...
- &id006
  ...
  - model: GNN-HF
    ...
    protocol_note: Accuracy on Actor dataset using the standard split (Geom-GCN 10
      fixed splits).
    date: May 10, 2023
  ...
  - model: BernNet
    ...
    gap_vs_at_pub: 0.04899999999999999
  ...
  - model: APPNP
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.005599999999999994
    has_value_note: false
    value_note: ''
    sort_value: 0.4046
    sort_std: 0.0064
  ...
  - model: GPRGNN
    ...
    gap_vs_at_pub: 0.029899999999999982
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.029899999999999982
    has_value_note: false
    value_note: ''
    sort_value: 0.3992
    sort_std: 0.0067
...
- &id005
  ...
  - model: FE-GNN
    ...
    is_std_outlier: false
  - model: CW_c (random)
    model_key: cw_c (random)
    model_plain: CW_c (random)
    value: 0.8954
    std: 0.0083
    paper_value: 0.8954
    paper_std: 0.0083
...
- &id004
  ...
  - model: FE-GNN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on Photo dataset test split
    date: May 10, 2023
    date_display: May 2023
    date_iso: '2023-05-10'
    published_venue: ICML 2023
    ...
    is_best: false
    is_std_outlier: false
  - model: CW_c (orthogonal)
    model_key: cw_c (orthogonal)
    model_plain: CW_c (orthogonal)
    value: 0.9487
    std: 0.0073
    paper_value: 0.9487
    paper_std: 0.0073
...
- &id007
  ...
  - model: FE-GNN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test Accuracy on Chameleon
    date: May 10, 2023
    date_display: May 2023
    date_iso: '2023-05-10'
    published_venue: ICML 2023
...
- &id003
  ...
  - model: BernNet
    ...
    value_gap_source_date_iso: '2023-05-10'
    value_gap_source_date_label: ICML 2023
    gap_vs_at_pub: 0.34140000000000004
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: ChebyNet
    ...
    value_gap_source_date_iso: '2023-05-10'
    value_gap_source_date_label: ICML 2023
    gap_vs_at_pub: 0.17370000000000008
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
single_proposed_model: FE-GNN
main_figure: /figures/2305.06142/main_figure.jpegoptim.jpg
---
