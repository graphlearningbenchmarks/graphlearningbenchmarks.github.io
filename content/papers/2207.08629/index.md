...
- name: Xueqi Ma
  orcid: null
  s2_author_id: '8848225'
  s2_url: null
- name: Yinbing Zhan
  orcid: null
  s2_author_id: '2176785211'
  s2_url: null
- name: Liang Ding
  orcid: null
  s2_author_id: '46573238'
  s2_url: null
- name: Dapeng Tao
  orcid: null
  s2_author_id: '1701119'
  s2_url: null
- name: Bo Du
  orcid: null
  s2_author_id: '2064618916'
  s2_url: null
- name: Wenbin Hu
  orcid: null
  s2_author_id: '2566294'
  s2_url: null
- name: Danilo P. Mandic
  orcid: null
  s2_author_id: '2155041542'
  s2_url: null
...
abstract: 'Graph Neural Networks (GNNs) tend to suffer from high computation costs
  due to the exponentially increasing scale of graph data and the number of model
  parameters, which restricts their utility in practical applications. To this end,
  some recent works focus on sparsifying GNNs (including graph structures and model
  parameters) with the lottery ticket hypothesis (LTH) to reduce inference costs while
  maintaining performance levels. However, the LTH-based methods suffer from two major
  drawbacks: 1) they require exhaustive and iterative training of dense models, resulting
  in an extremely large training computation cost, and 2) they only trim graph structures
  and model parameters but ignore the node feature dimension, where significant redundancy
  exists. To overcome the above limitations, we propose a comprehensive graph gradual
  pruning framework termed CGP. This is achieved by designing a during-training graph
  pruning paradigm to dynamically prune GNNs within one training process. Unlike LTH-based
  methods, the proposed CGP approach requires no re-training, which significantly
  reduces the computation costs. Furthermore, we design a co-sparsifying strategy
  to comprehensively trim all three core elements of GNNs: graph structures, node
  features, and model parameters. Meanwhile, aiming at refining the pruning operation,
  we introduce a regrowth process into our CGP framework, in order to re-establish
  the pruned but important connections. The proposed CGP is evaluated by using a node
  classification task across 6 GNN architectures, including shallow models (GCN and
  GAT), shallow-but-deep-propagation models (SGC and APPNP), and deep models (GCNII
  and ResGCN), on a total of 14 real-world graph datasets, including large-scale graph
  datasets from the challenging Open Graph Benchmark. Experiments reveal that our
  proposed strategy greatly improves both training and inference efficiency while
  matching or even exceeding the accuracy of existing methods.'
codebase_url: ''
...
- &id003
  ...
  - model: APPNP
    ...
    protocol_note: Standard node classification on Actor dataset
    date: Jul 18, 2022
    ...
    gap_vs_at_pub: 0.12459999999999999
  ...
  - model: GPRGNN
    ...
    gap_vs_at_pub: 0.003400000000000014
  ...
  - model: CGP (GCN)
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: CGP applied to GCN backbone
    date: Jul 18, 2022
    date_display: Jul 2022
    date_iso: '2022-07-18'
    published_venue: ''
    ...
    true_value: 0.3921
    true_std: null
    value_gap_source_arxiv: '2207.08629'
    value_gap_source_title: Comprehensive Graph Gradual Pruning for Sparse Training
  ...
  - model: H2GCN
    ...
    gap_vs_at_pub: 0.027400000000000035
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: SGC
    ...
    gap_vs_at_pub: 0.08059999999999995
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id002
  ...
  - model: APPNP
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification on heterophily dataset
    date: Jul 18, 2022
    date_display: Jul 2022
    date_iso: '2022-07-18'
    published_venue: ''
  ...
  - model: FAGCN
    ...
    value_gap_source_date_iso: '2022-12-07'
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.016799999999999926
    worse_than_at_pub: false
    surpassed_since_pub: true
    better_than_at_pub: false
    insignificant_improvement_at_pub: true
  ...
  - model: H2GCN
    ...
    value_gap_source_date_iso: '2026-03-10'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.043199999999999905
    worse_than_at_pub: false
    surpassed_since_pub: true
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: MixHop
    ...
    gap_vs_at_pub: 0.22740000000000005
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id001
  ...
  - model: GPRGNN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard heterophilous benchmark task for Texas
    date: Jul 18, 2022
    date_display: Jul 2022
    date_iso: '2022-07-18'
    published_venue: ''
  ...
  - model: MLP
    ...
    gap_vs_at_pub: 0.08429999999999993
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: H2GCN
    ...
    value_gap_source_date_iso: '2024-11-26'
    value_gap_source_date_label: ICML 2024
    gap_vs_at_pub: 0.03820000000000001
    worse_than_at_pub: false
    surpassed_since_pub: true
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: APPNP
    ...
    value_gap_source_date_iso: '2023-10-18'
    value_gap_source_date_label: WWW 2023
    gap_vs_at_pub: 0.31179999999999997
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: LINK
    ...
    value_gap_source_date_iso: '2022-12-07'
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.1886000000000001
    worse_than_at_pub: false
    surpassed_since_pub: true
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: SGC
    ...
    gap_vs_at_pub: 0.14939999999999998
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- scope: node-level
  ...
  - benchmark: Heterophilic Graphs
    ...
    - dataset: Actor
      dataset_slug: actor
main_figure: /figures/2207.08629/main_figure.jpegoptim.jpg
---
