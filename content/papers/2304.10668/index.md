...
- name: Costas Mavromatis
  orcid: null
  s2_author_id: '1944251405'
  s2_url: null
- name: Vassilis N. Ioannidis
  orcid: null
  s2_author_id: '40043851'
  s2_url: null
- name: Shen Wang
  orcid: null
  s2_author_id: '2151226309'
  s2_url: null
- name: Da Zheng
  orcid: null
...
- name: Soji Adeshina
  orcid: null
  s2_author_id: '2121390172'
  s2_url: null
- name: Jun Ma
  orcid: null
  s2_author_id: '65743795'
  s2_url: null
- name: Han Zhao
  orcid: null
  s2_author_id: '1390716752'
  s2_url: null
- name: Christos Faloutsos
  orcid: null
  s2_author_id: '1702392'
  s2_url: null
- name: George Karypis
  orcid: null
...
abstract: How can we learn effective node representations on textual graphs? Graph
  Neural Networks (GNNs) that use Language Models (LMs) to encode textual information
  of graphs achieve state-of-the-art performance in many node classification tasks.
  Yet, combining GNNs with LMs has not been widely explored for practical deployments
  due to its scalability issues. In this work, we tackle this challenge by developing
  a Graph-Aware Distillation framework (GraD) to encode graph structures into an LM
  for graph-free, fast inference. Different from conventional knowledge distillation,
  GraD jointly optimizes a GNN teacher and a graph-free student over the graph's nodes
  via a shared LM. This encourages the graph-free student to exploit graph information
  encoded by the GNN teacher while at the same time, enables the GNN teacher to better
  leverage textual information from unlabeled nodes. As a result, the teacher and
  the student models learn from each other to improve their overall performance. Experiments
  in eight node classification benchmarks in both transductive and inductive settings
  showcase GraD 's superiority over existing distillation approaches for textual graphs.
  Our code is available at:.
codebase_url: https://github.com/cmavro/GRAD
...
- &id001
  ...
  - model: GLEM-GNN
    ...
    protocol_note: Standard node classification task on ogbn-products
    date: Apr 20, 2023
  ...
  - model: GLEM
    ...
    is_best: false
    is_std_outlier: false
  - model: GraD-BERT + SAGN+
    model_key: grad-bert + sagn+
    model_plain: GraD-BERT + SAGN+
    value: 0.8692
    std: 0.0007
    paper_value: 0.8692
    paper_std: 0.0007
    ...
    is_best: false
    is_std_outlier: false
  - model: OGB-feat + GraD-BERT
    model_key: ogb-feat + grad-bert
    model_plain: OGB-feat + GraD-BERT
    value: 0.8551
    std: 0.0051
    paper_value: 0.8551
    paper_std: 0.0051
    ...
    is_std_outlier: false
  - model: OGB-feat + SAGN+
    model_key: ogb-feat + sagn+
    model_plain: OGB-feat + SAGN+
    value: 0.8485
    std: 0.001
    paper_value: 0.8485
    paper_std: 0.001
    ...
    is_best: false
    is_std_outlier: false
  - model: GIANT + GraD-BERT
    model_key: giant + grad-bert
    model_plain: GIANT + GraD-BERT
    value: 0.8415
    std: 0.0015
    paper_value: 0.8415
    paper_std: 0.0015
  ...
  - model: GraD-GNN
    ...
    is_best: false
    is_std_outlier: false
  - model: GLEM + GraD-BERT
    model_key: glem + grad-bert
    model_plain: GLEM + GraD-BERT
    value: 0.8316
    std: 0.0019
    paper_value: 0.8316
    paper_std: 0.0019
  ...
  - model: JKD
    ...
    is_std_outlier: false
  - model: GA-BERT-GNN
    model_key: ga-bert-gnn
    model_plain: GA-BERT-GNN
    value: 0.8235
    std: null
    paper_value: 0.8235
    paper_std: null
    ...
    is_best: false
    is_std_outlier: false
  - model: GA-BERT + GraD-BERT
    model_key: ga-bert + grad-bert
    model_plain: GA-BERT + GraD-BERT
    value: 0.8235
    std: null
    paper_value: 0.8235
    paper_std: null
  ...
  - model: Joint
    ...
    is_best: false
    is_std_outlier: false
  - model: BERT + GraD-BERT
    model_key: bert + grad-bert
    model_plain: BERT + GraD-BERT
    value: 0.8124
    std: null
    paper_value: 0.8124
    paper_std: null
  ...
  - model: GLNN
    ...
    comparison_source_title: Efficient Graph Neural Network Inference at Large Scale
    comparison_source_arxiv: '2211.00495'
    is_best: false
    is_std_outlier: false
  - model: BERT
    model_key: bert
...
main_figure: /figures/2304.10668/main_figure.jpegoptim.jpg
---
