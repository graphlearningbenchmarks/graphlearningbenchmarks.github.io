...
- &id002
  ...
  - model: MolCLR
    ...
    protocol_note: Scaffold split as specified in caption.
    date: May 28, 2023
  ...
  - model: InfoGraph
    ...
    is_best: false
    is_std_outlier: false
  - model: SchNet (MoleculeSDE)
    model_key: schnet (moleculesde)
    model_plain: SchNet (MoleculeSDE)
    value: 0.786
    std: 0.004
    paper_value: 0.786
    paper_std: 0.004
...
- &id007
  ...
  - model: MoleculeSDE
    ...
    protocol_decision: standard
    protocol_note: MD17 force prediction tasks with 1K train, 1K val, and 48K-991K
      test molecules.
    date: May 28, 2023
    date_display: May 2023
    date_iso: '2023-05-28'
...
- &id005
  ...
  - model: InfoGraph
    ...
    is_best: false
    is_std_outlier: false
  - model: SchNet with MoleculeSDE
    model_key: schnet with moleculesde
    model_plain: SchNet with MoleculeSDE
    value: 0.605
    std: 0.0039
    paper_value: 0.605
    paper_std: 0.0039
    ...
    is_best: false
    is_std_outlier: false
  - model: SchNet with ConfGF
    model_key: schnet with confgf
    model_plain: SchNet with ConfGF
    value: 0.601
    std: 0.0087
    paper_value: 0.601
    paper_std: 0.0087
    ...
    is_best: false
    is_std_outlier: false
  - model: SchNet with MMFF
    model_key: schnet with mmff
    model_plain: SchNet with MMFF
    value: 0.594
    std: 0.0027
    paper_value: 0.594
    paper_std: 0.0027
    ...
    is_best: false
    is_std_outlier: false
  - model: SchNet with ClofNet
    model_key: schnet with clofnet
    model_plain: SchNet with ClofNet
    value: 0.56
    std: 0.001
    paper_value: 0.56
    paper_std: 0.001
...
- &id001
  ...
  - model: MoleculeSDE
    ...
    is_best: false
    is_std_outlier: false
  - model: SDE (MoleculeSDE)
    model_key: sde (moleculesde)
    model_plain: SDE (MoleculeSDE)
    value: 0.756
    std: null
    paper_value: 0.756
    paper_std: null
  ...
  - model: AttrMask
    ...
    is_std_outlier: false
  - model: VRR (GraphMVP)
    model_key: vrr (graphmvp)
    model_plain: VRR (GraphMVP)
    value: 0.736
    std: null
    paper_value: 0.736
    paper_std: null
...
- scope: graph-level
  ...
  - benchmark: Quantum Chemistry
    ...
    - dataset: MD17
      dataset_slug: md17
main_figure: /figures/2305.18407/main_figure.jpegoptim.jpg
---
