...
- name: Yule Li
  orcid: null
  s2_author_id: '2364831969'
  s2_url: null
- name: Yifeng Lu
  orcid: null
  s2_author_id: '2316615958'
  s2_url: null
- name: Zhen Wang
  orcid: null
  s2_author_id: '2118453148'
  s2_url: null
- name: Zhewei Wei
  orcid: null
  s2_author_id: '2279989467'
  s2_url: null
- name: Yaliang Li
  orcid: null
  s2_author_id: '2237607166'
  s2_url: null
- name: Bolin Ding
  orcid: null
  s2_author_id: '2266389996'
  s2_url: null
...
abstract: In recent years, graph neural networks (GNN) have achieved unprecedented
  successes in node classification tasks. Although GNNs inherently encode specific
  inductive biases (e.g., acting as low-pass or high-pass filters), most existing
  methods implicitly assume conditional independence among node labels in their optimization
  objectives. While this assumption is suitable for traditional classification tasks
  such as image recognition, it contradicts the intuitive observation that node labels
  in graphs remain correlated, even after conditioning on the graph structure. To
  make structured predictions for node labels, we propose ReDiSC, namely, Reparameterized
  masked Diffusion model for Structured node Classification. ReDiSC estimates the
  joint distribution of node labels using a reparameterized masked diffusion model,
  which is learned through the variational expectation-maximization (EM) framework.
  Our theoretical analysis shows the efficiency advantage of ReDiSC in the E-step
  compared to DPM-SNC, a state-of-the-art model that relies on a manifold-constrained
  diffusion model in continuous domain. Meanwhile, we explicitly link ReDiSC 's M-step
  objective to popular GNN and label propagation hybrid approaches. Extensive experiments
  demonstrate that ReDiSC achieves superior or highly competitive performance compared
  to state-of-the-art GNN, label propagation, and diffusion-based baselines across
  both homophilic and heterophilic graphs of varying sizes. Notably, ReDiSC scales
  effectively to large-scale datasets on which previous structured diffusion methods
  fail due to computational constraints, highlighting its significant practical advantage
  in structured node classification tasks. The code for ReDiSC is available here.
...
- &id005
  ...
  - model: GCN
    ...
    protocol_note: N-Acc. (node-level accuracy) on Computer dataset
    date: Jul 19, 2025
    ...
    gap_vs_at_pub: 0.10810000000000008
  ...
  - model: ReDiSC
    ...
    is_std_outlier: false
  - model: GAT+DPM-SNC
    model_key: gat+dpm-snc
    model_plain: GAT+DPM-SNC
    value: 0.8389
    std: 0.0191
    paper_value: 0.8389
    paper_std: 0.0191
  ...
  - model: GAT+LPA
    ...
    is_std_outlier: false
  - model: GCN+DPM-SNC
    model_key: gcn+dpm-snc
    model_plain: GCN+DPM-SNC
    value: 0.8304
    std: 0.0193
    paper_value: 0.8304
    paper_std: 0.0193
...
- &id004
  ...
  - model: LGD
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: N-Acc. (node-level accuracy) on Photo dataset
    date: Jul 19, 2025
    date_display: Jul 2025
    date_iso: '2025-07-19'
    published_venue: ''
  ...
  - model: LP
    ...
    comparison_source_title: Eliciting Structural and Semantic Global Knowledge in
      Unsupervised Graph Contrastive Learning
    comparison_source_arxiv: '2202.08480'
    is_best: false
    is_std_outlier: false
  rank_metric: Accuracy
  higher_is_better: true
...
- &id008
  ...
  - model: SAGE
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Transductive node classification on heterophilic graph split
    date: Jul 19, 2025
    date_display: Jul 2025
    date_iso: '2025-07-19'
    published_venue: ''
...
- &id002
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split (Yang et al. 2016) for node-level accuracy (N-Acc.)
    date: Jul 19, 2025
    date_display: Jul 2025
    date_iso: '2025-07-19'
    published_venue: ''
    ...
    gap_vs_at_pub: 0.17779999999999996
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2023-05-10'
    value_gap_source_date_label: ICML 2023
    gap_vs_at_pub: 0.11150000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id001
  ...
  - model: GAT
    ...
    gap_vs_at_pub: 0.07950000000000002
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id009
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node-level accuracy on heterophilic graph split
    date: Jul 19, 2025
    date_display: Jul 2025
    date_iso: '2025-07-19'
    published_venue: ''
  ...
  - model: H2GCN
    ...
    value_gap_source_date_iso: '2024-04-26'
    value_gap_source_date_label: ICLR 2024
    gap_vs_at_pub: 0.5713999999999999
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: FAGCN
    ...
    value_gap_source_date_iso: '2024-04-26'
    value_gap_source_date_label: ICLR 2024
    gap_vs_at_pub: 0.37560000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GPR-GNN
    ...
    value_gap_source_date_iso: '2026-03-27'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.31709999999999994
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id003
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split (Yang et al. 2016 fixed split) for node-level accuracy
      (N-Acc.)
    date: Jul 19, 2025
    date_display: Jul 2025
    date_iso: '2025-07-19'
...
- &id007
  ...
  - model: ReDiSC
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node-level accuracy on heterophilic graphs
    date: Jul 19, 2025
    date_display: Jul 2025
    date_iso: '2025-07-19'
    published_venue: ''
...
- &id006
  ...
  - model: SAGE
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: N-Acc. on ogbn-products using standard transductive node classification
      split
    date: Jul 19, 2025
    date_display: Jul 2025
    date_iso: '2025-07-19'
...
single_proposed_model: ReDiSC
main_figure: /figures/2507.14484/main_figure.jpegoptim.jpg
---
