...
- name: Zehong Wang
  orcid: null
  s2_author_id: '2108726598'
  s2_url: null
- name: Qi Li
  orcid: null
  s2_author_id: '2146240433'
  s2_url: null
- name: Donghua Yu [2]
  orcid: null
  s2_author_id: '9185972'
  s2_url: null
- name: Xiaolong Han
  orcid: null
  s2_author_id: '2152555602'
  s2_url: null
- name: Xiao-Zhi Gao
  orcid: null
  s2_author_id: '2149395998'
  s2_url: null
- name: Shigen Shen [2]
  orcid: null
  s2_author_id: '97688457'
  s2_url: null
published_date: Oct 1, 2022
published_date_iso: '2022-10-01'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: 'Inspired by the success of Contrastive Learning (CL) in computer vision
  and natural language processing, Graph Contrastive Learning (GCL) has been developed
  to learn discriminative node representations on graph datasets. However, the development
  of GCL on Heterogeneous Information Networks (HINs) is still in the infant stage.
  For example, it is unclear how to augment the HINs without substantially altering
  the underlying semantics, and how to design the contrastive objective to fully capture
  the rich semantics. Moreover, early investigations demonstrate that CL suffers from
  sampling bias, whereas conventional debiasing techniques are empirically shown to
  be inadequate for GCL. How to mitigate the sampling bias for heterogeneous GCL is
  another important problem. To address the aforementioned challenges, we propose
  a novel Heterogeneous Graph Contrastive Multi-view Learning (HGCML) model. In particular,
  we use metapaths as the augmentation to generate multiple subgraphs as multi-views,
  and propose a contrastive objective to maximize the mutual information between any
  pairs of metapath-induced views. To alleviate the sampling bias, we further propose
  a positive sampling strategy to explicitly select positives for each node via jointly
  considering semantic and structural information preserved on each metapath view.
  Extensive experiments demonstrate HGCML consistently outperforms state-of-the-art
  baselines on five real-world benchmark datasets. To enhance the reproducibility
  of our work, we make all the code publicly available at https://github.com/Zehong-Wang/HGCML.:
  Graph contrastive learning, heterogeneous information network, self-supervised learning,
...
- &id002
  ...
  - model: GCN
    ...
    value_gap_source_date_iso: '2020-07-16'
    value_gap_source_date_label: NeurIPS 2020
    gap_vs_at_pub: 0.025899999999999923
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_title: Self-supervised Auxiliary Learning with Meta-paths for
      Heterogeneous Graphs
    value_gap_source_is_current_paper: false
    value_gap: 0.025899999999999923
    has_value_note: false
    value_note: ''
    sort_value: 0.9246
    sort_std: null
  ...
  - model: HAN
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: wang_heterogeneous_2019
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification task on ACM dataset
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.023499999999999965
    has_value_note: false
    value_note: ''
    sort_value: 0.9185
    sort_std: null
  ...
  - model: DMGI
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: park_unsupervised_2020
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification task on ACM dataset
  ...
  - model: HeCo
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: wang_self-supervised_2021
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification task on ACM dataset
  ...
  - model: DGI
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: velickovic_deep_2018
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification task on ACM dataset
  ...
  - model: Mp2vec
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: dong_metapath2vec_2017
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification task on ACM dataset
  ...
  - model: DeepWalk
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: perozzi_deepwalk_2014
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification task on ACM dataset
  ...
  - model: HERec
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: shi_heterogeneous_2019
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification task on ACM dataset
...
- &id001
  ...
  - model: HERec
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification task on DBLP
    date: Oct 1, 2022
    date_display: Oct 2022
    date_iso: '2022-10-01'
    published_venue: ''
    ...
    gap_vs_at_pub: 0.09179999999999999
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: DeepWalk
    ...
    value_gap_source_date_iso: '2019-12-19'
    value_gap_source_date_label: AAAI 2019
    gap_vs_at_pub: 0.11319999999999997
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2023-10-25'
    value_gap_source_date_label: ICML 2023
    gap_vs_at_pub: 0.008799999999999919
    worse_than_at_pub: false
    surpassed_since_pub: true
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: Mp2vec
    ...
    gap_vs_at_pub: 0.05369999999999997
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GRACE
    ...
    value_gap_source_date_iso: '2022-10-01'
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.2014999999999999
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: DGI
    ...
    value_gap_source_date_iso: '2022-10-01'
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.16379999999999995
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
- &id004
  ...
  - model: HGCML-P
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification task on FreeBase
    date: Oct 1, 2022
    date_display: Oct 2022
    date_iso: '2022-10-01'
    published_venue: ''
...
- &id003
  ...
  - model: HERec
    ...
    value_gap_source_date_iso: '2019-12-19'
    value_gap_source_date_label: AAAI 2019
    gap_vs_at_pub: 0.13419999999999993
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
main_figure: /figures/2210.00248/main_figure.jpegoptim.jpg
---
