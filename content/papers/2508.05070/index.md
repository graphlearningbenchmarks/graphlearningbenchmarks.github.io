...
- &id003
  ...
  - model: A-DGN
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: Uses the dataset's node features without external pretraining.
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_regression
    protocol_decision: standard
    protocol_note: Mean test set log10(MSE) on graph property prediction; test set
