...
published_date_iso: '2023-10-26'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: Based on the message-passing paradigm, there has been an amount of research
  proposing diverse and impressive feature propagation mechanisms to improve the performance
  of GNNs. However, less focus has been put on feature transformation, another major
  operation of the message-passing framework. In this paper, we first empirically
  investigate the performance of the feature transformation operation in several typical
  GNNs. Unexpectedly, we notice that GNNs do not completely free up the power of the
  inherent feature transformation operation. By this observation, we propose the Bi-directional
  Knowledge Transfer (BiKT), a plug-and-play approach to unleash the potential of
  the feature transformation operations without modifying the original architecture.
  Taking the feature transformation operation as a derived representation learning
  model that shares parameters with the original GNN, the direct prediction by this
  model provides a topological-agnostic knowledge feedback that can further instruct
  the learning of GNN and the feature transformations therein. On this basis, BiKT
  not only allows us to acquire knowledge from both the GNN and its derived model
  but promotes each other by injecting the knowledge into the other. In addition,
  a theoretical analysis is further provided to demonstrate that BiKT improves the
  generalization bound of the GNNs from the perspective of domain adaption. An extensive
  group of experiments on up to 7 datasets with 5 typical GNNs demonstrates that BiKT
  brings up to 0.5\
codebase_url: ''
...
- &id001
  ...
  - model: GCN
    ...
    protocol_note: Inductive node classification setting
    date: Oct 26, 2023
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Transductive node classification setting
    date: Oct 26, 2023
    date_display: Oct 2023
    date_iso: '2023-10-26'
    published_venue: ''
  ...
  - model: BiKT-GCN
    ...
    value_gap_source_date_iso: '2023-10-26'
    ...
    true_value: 0.8592
    true_std: 0.0126
    value_gap_source_arxiv: '2310.17132'
    value_gap_source_title: 'BiKT: Unleashing the potential of GNNs via Bi-directional
      Knowledge Transfer'
    ...
    is_std_outlier: false
  - model: BiKT-GCNII
    model_key: bikt-gcnii
    model_plain: BiKT-GCNII
    value: 0.854
    std: 0.0107
    paper_value: 0.854
    paper_std: 0.0107
    ...
    is_std_outlier: false
  - model: BiKT-FAGCN
    model_key: bikt-fagcn
    model_plain: BiKT-FAGCN
    value: 0.8507
    std: 0.0115
    paper_value: 0.8507
    paper_std: 0.0115
  ...
  - model: BiKT-GAT
    ...
    is_best: false
    is_std_outlier: false
  - model: BiKT-MLP_GCNII
    model_key: bikt-mlp_gcnii
    model_plain: BiKT-MLP_GCNII
    value: 0.8439
    std: 0.0091
    paper_value: 0.8439
    paper_std: 0.0091
    ...
    is_std_outlier: false
  - model: BiKT-MixHop
    model_key: bikt-mixhop
    model_plain: BiKT-MixHop
    value: 0.8358
    std: 0.0117
    paper_value: 0.8358
    paper_std: 0.0117
    ...
    is_best: false
    is_std_outlier: false
  - model: BiKT-MLP_MixHop
    model_key: bikt-mlp_mixhop
    model_plain: BiKT-MLP_MixHop
    value: 0.8296
    std: 0.0115
    paper_value: 0.8296
    paper_std: 0.0115
    ...
    is_std_outlier: false
  - model: BiKT-MLP_GAT
    model_key: bikt-mlp_gat
    model_plain: BiKT-MLP_GAT
    value: 0.8268
    std: 0.0147
    paper_value: 0.8268
    paper_std: 0.0147
    ...
    is_std_outlier: false
  - model: BiKT-MLP_GCN
    model_key: bikt-mlp_gcn
    model_plain: BiKT-MLP_GCN
    value: 0.8126
    std: 0.0174
    paper_value: 0.8126
    paper_std: 0.0174
  ...
  - model: MixHop
    ...
    is_best: false
    is_std_outlier: false
  - model: BiKT-MLP_FAGCN
    model_key: bikt-mlp_fagcn
    model_plain: BiKT-MLP_FAGCN
    value: 0.7868
    std: 0.0195
    paper_value: 0.7868
    paper_std: 0.0195
  ...
  - model: MLP_GCN
    ...
    is_std_outlier: false
  - model: MLP_MixHop
    model_key: mlp_mixhop
    model_plain: MLP_MixHop
    value: 0.713
    std: 0.0131
    paper_value: 0.713
    paper_std: 0.0131
...
- &id002
  ...
  - model: GIN
    ...
    protocol_decision: standard
    protocol_note: Average accuracy across 10-fold cross-validation as per setup prose.
    date: Oct 26, 2023
    date_display: Oct 2023
    date_iso: '2023-10-26'
    published_venue: ''
...
- &id003
  ...
  - model: GIN
    ...
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: fuzzy match to ogbg-molhiv (score=95)'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Standard OGB scaffold split for graph classification task.
    date: Oct 26, 2023
    date_display: Oct 2023
    date_iso: '2023-10-26'
    published_venue: ''
...
main_figure: /figures/2310.17132/main_figure.jpegoptim.jpg
---
