...
- &id003
  ...
  - model: GAT
    ...
    protocol_note: Inductive setting with 20% train, 30% query, 50% test split
    date: Dec 15, 2021
...
- &id004
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Original classification task on Amazon dataset
    date: Dec 15, 2021
    date_display: Dec 2021
    date_iso: '2021-12-15'
    published_venue: ''
...
- &id002
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: 20% train, 30% query, 50% test split as described in Dataset Configuration
    date: Dec 15, 2021
    date_display: Dec 2021
    date_iso: '2021-12-15'
    published_venue: ''
