...
- name: Silu He
  orcid: null
  s2_author_id: '2148909232'
  s2_url: null
- name: Qinyao Luo
  orcid: null
  s2_author_id: '2263892372'
  s2_url: null
- name: Xinsha Fu
  orcid: null
  s2_author_id: '2267226943'
  s2_url: null
- name: Ling Zhao
  orcid: null
  s2_author_id: '2264969674'
  s2_url: null
- name: Ronghua Du
  orcid: null
  s2_author_id: '2263781196'
  s2_url: null
- name: Haifeng Li
  orcid: null
  s2_author_id: '2266005002'
  s2_url: null
...
abstract: The local attention-guided message passing mechanism (LAMP) adopted in graph
  attention networks (GATs) can adaptively learn the importance of neighboring nodes
  and perform local aggregation better, thus demonstrating a stronger discrimination
  ability. However, existing GATs suffer from significant discrimination ability degradations
  in heterophilic graphs. The reason is that a high proportion of dissimilar neighbors
  can weaken the self-attention of the central node, resulting in the central node
  deviating from its similar nodes in the representation space. This type of influence
  caused by neighboring nodes is referred to as Distraction Effect (DE) in this paper.
  To estimate and weaken the DE induced by neighboring nodes, we propose a Causal
  graph Attention network for Trimming heterophilic graphs (CAT). To estimate the
  DE, since DE is generated through two paths, we adopt the total effect as the metric
  for estimating DE; To weaken the DE, we identify the neighbors with the highest
  DE (we call them Distraction Neighbors) and remove them. We adopt three representative
  GATs as the base model within the proposed CAT framework and conduct experiments
  on seven heterophilic datasets of three different sizes. Comparative experiments
  show that CAT can improve the node classification accuracies of all base GAT models.
  Ablation experiments and visualization further validate the enhanced discrimination
  ability of CATs. In addition, CAT is a plug-and-play framework and can be introduced
  to any LAMP-driven GAT because it learns a trimmed graph in the attention-learning
  stage, instead of modifying the model architecture or globally searching for new
  neighbors. The source code is available at https://github.com/GeoX-Lab/CAT.
...
- &id003
  ...
  - model: CATv3-sup
    ...
    protocol_note: Fully-supervised paradigm
    date: Dec 14, 2023
    ...
    true_value: 0.385
    true_std: 0.012
    value_gap_source_arxiv: '2312.08672'
    value_gap_source_title: 'CAT: A Causal Graph Attention Network for Trimming Heterophilic
      Graphs'
    ...
    is_best: false
    is_std_outlier: false
  - model: CATv3-unsup (100)
    model_key: catv3-unsup (100)
    model_plain: CATv3-unsup (100)
    value: 0.38
    std: 0.005
    paper_value: 0.38
    paper_std: 0.005
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Unsupervised clustering with random seed 100
    date: Dec 14, 2023
    date_display: Dec 2023
    date_iso: '2023-12-14'
    published_venue: ''
  ...
  - model: CATv3-semi
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Semi-supervised paradigm
    date: Dec 14, 2023
    date_display: Dec 2023
    date_iso: '2023-12-14'
    published_venue: ''
  ...
  - model: GATv3
    ...
    is_std_outlier: false
  - model: CAT-unsup (10)
    model_key: cat-unsup (10)
    model_plain: CAT-unsup (10)
    value: 0.337
    std: 0.006
    paper_value: 0.337
    paper_std: 0.006
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Unsupervised clustering with random seed 10
    date: Dec 14, 2023
    date_display: Dec 2023
    date_iso: '2023-12-14'
    published_venue: ''
  ...
  - model: CAT-semi
    ...
    is_best: false
    is_std_outlier: false
  - model: CATv2-unsup (10)
    model_key: catv2-unsup (10)
    model_plain: CATv2-unsup (10)
    value: 0.324
    std: 0.005
    paper_value: 0.324
    paper_std: 0.005
    ...
    is_std_outlier: false
  - model: CATv2-semi
    model_key: catv2-semi
    model_plain: CATv2-semi
    value: 0.319
    std: 0.005
    paper_value: 0.319
    paper_std: 0.005
...
- &id002
  ...
  - model: GATv3
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on Small-size Cornell dataset
    date: Dec 14, 2023
    date_display: Dec 2023
    date_iso: '2023-12-14'
    published_venue: ''
  ...
  - model: GAT
    ...
    gap_vs_at_pub: 0.20999999999999996
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id004
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on the large-size Roman-empire dataset.
    date: Dec 14, 2023
    date_display: Dec 2023
    date_iso: '2023-12-14'
    published_venue: ''
  ...
  - model: CAT-sup
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Fully-supervised variant.
    date: Dec 14, 2023
    date_display: Dec 2023
    date_iso: '2023-12-14'
    published_venue: ''
  ...
  - model: CATv2-semi
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Semi-supervised variant.
    date: Dec 14, 2023
    date_display: Dec 2023
    date_iso: '2023-12-14'
    published_venue: ''
...
- &id001
  ...
  - model: GAT
    ...
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.30100000000000005
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
main_figure: /figures/2312.08672/main_figure.jpegoptim.jpg
---
