...
- &id001
  ...
  - model: Spectral Graph Neural Networks
    model_key: spectral graph neural networks
...
- &id002
  ...
  - model: ChebNetII
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification on Penn94 dataset
    date: May 21, 2024
    date_display: May 2024
    date_iso: '2024-05-21'
    published_venue: ICML 2024
...
- scope: node-level
  ...
  - benchmark: LINKX Benchmarks
    ...
    - dataset: Penn94
      dataset_slug: penn94
single_proposed_model: Spectral Graph Neural Networks
