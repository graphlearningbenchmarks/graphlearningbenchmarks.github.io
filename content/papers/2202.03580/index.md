...
- name: Mingguo He
  orcid: null
  s2_author_id: '2116976451'
  s2_url: null
- name: Zhewei Wei
  orcid: null
  s2_author_id: '12457830'
  s2_url: null
- name: Ji-rong Wen
  orcid: null
  s2_author_id: '153693432'
  s2_url: null
...
abstract: Designing spectral convolutional networks is a challenging problem in graph
  learning. ChebNet, one of the early attempts, approximates the spectral graph convolutions
  using Chebyshev polynomials. GCN simplifies ChebNet by utilizing only the first
  two Chebyshev polynomials while still outperforming it on real-world datasets. GPR-GNN
  and BernNet demonstrate that the Monomial and Bernstein bases also outperform the
  Chebyshev basis in terms of learning the spectral graph convolutions. Such conclusions
  are counter-intuitive in the field of approximation theory, where it is established
  that the Chebyshev polynomial achieves the optimum convergent rate for approximating
  a function. In this paper, we revisit the problem of approximating the spectral
  graph convolutions with Chebyshev polynomials. We show that ChebNet's inferior performance
  is primarily due to illegal coefficients learnt by ChebNet approximating analytic
  filter functions, which leads to over-fitting. We then propose ChebNetII, a new
  GNN model based on Chebyshev interpolation, which enhances the original Chebyshev
  polynomial approximation while reducing the Runge phenomenon. We conducted an extensive
  experimental study to demonstrate that ChebNetII can learn arbitrary graph convolutions
  and achieve superior performance in both full- and semi-supervised node classification
  tasks. Most notably, we scale ChebNetII to a billion graph ogbn-papers100M, showing
  that spectral-based GNNs have superior performance. Our code is available at.
...
- &id006
  ...
  - model: BernNet
    ...
    protocol_note: full-supervised node classification with random splits
    date: Feb 4, 2022
  ...
  - model: APPNP
    ...
    gap_vs_at_pub: 0.11110000000000003
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: MLP
    ...
    gap_vs_at_pub: 0.04009999999999997
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: GPR-GNN
    ...
    value_gap_source_date_iso: '2025-05-29'
    value_gap_source_date_label: ICML 2025
    gap_vs_at_pub: 0.05970000000000003
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: TWIRLS
    ...
    value_gap_source_date_iso: '2024-03-06'
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.006999999999999951
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
...
- &id002
  ...
  - model: MLP
    ...
    is_std_outlier: false
  - model: ChebBase/k
    model_key: chebbase/k
    model_plain: ChebBase/k
    value: 0.7252
    std: 0.0029
    paper_value: 0.7252
    paper_std: 0.0029
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Semi-supervised node classification with standard fixed split (20
...
- &id005
  ...
  - model: APPNP
    ...
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.09630000000000005
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
- &id007
  ...
  - model: ChebNetII
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on large heterophilic graph Penn94
    date: Feb 4, 2022
    date_display: Feb 2022
    date_iso: '2022-02-04'
    published_venue: NeurIPS 2022
...
- &id009
  ...
  - model: ChebNetII
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: node classification on large heterophilic graph
    date: Feb 4, 2022
    date_display: Feb 2022
    date_iso: '2022-02-04'
    published_venue: NeurIPS 2022
...
- &id004
  ...
  - model: GPR-GNN
    ...
    value_gap_source_date_iso: '2025-05-29'
    value_gap_source_date_label: ICML 2025
    gap_vs_at_pub: 0.08320000000000005
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: ChebNet
    ...
    value_gap_source_date_iso: '2024-03-06'
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.07079999999999997
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: true
  ...
  - model: GCN
    ...
    gap_vs_at_pub: 0.13160000000000005
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.023599999999999954
    has_value_note: false
    value_note: ''
    sort_value: 0.7933
    sort_std: 0.0447
...
- &id008
  ...
  - model: LINKX
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Large heterophilic graph node classification task.
    date: Feb 4, 2022
    date_display: Feb 2022
    date_iso: '2022-02-04'
    published_venue: NeurIPS 2022
  ...
  - model: GCNII
    ...
    value_gap_source_date_iso: '2024-06-16'
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.0001000000000000445
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: true
...
- &id003
  ...
  - model: ChebNetII
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Full-supervised node classification on ogbn-papers100M
    date: Feb 4, 2022
    date_display: Feb 2022
    date_iso: '2022-02-04'
    published_venue: NeurIPS 2022
  ...
  - model: NDLS
    ...
    at_pub_value: 0.656
    at_pub_std: 0.003
    at_pub_source_arxiv: '2110.14377'
    at_pub_source_title: Node Dependent Local Smoothing for Scalable Graph Learning
    at_pub_source_date_iso: '2021-10-27'
    at_pub_source_date_label: NeurIPS 2021
    value_gap_source_date_iso: '2023-02-24'
    value_gap_source_date_label: ICML 2023
...
- &id010
  ...
  - model: LINKX
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Large heterophilic graph node classification
    date: Feb 4, 2022
    date_display: Feb 2022
    date_iso: '2022-02-04'
    published_venue: NeurIPS 2022
...
single_proposed_model: ChebNetII
main_figure: /figures/2202.03580/main_figure.jpegoptim.jpg
---
