...
- name: Xun Liu
  orcid: null
  s2_author_id: '2051697928'
  s2_url: null
- name: Alex Hay-Man Ng
  orcid: null
  s2_author_id: '2186741872'
  s2_url: null
- name: Fangyu Lei
  orcid: null
  s2_author_id: '2332276'
  s2_url: null
- name: Yikuan Zhang
  orcid: null
  s2_author_id: '2051693380'
  s2_url: null
- name: Zhengmin Li
  orcid: null
  s2_author_id: '2185165086'
  s2_url: null
...
abstract: 'Graph Neural Networks (GNNs) are a promising deep learning approach for
  ...
  models usually have at least one of four fundamental limitations: over-smoothing,
  over-fitting, difficult to train, and strong homophily assumption. For example,
  Simple Graph Convolution (SGC) is known to suffer from the first and fourth limitations.
  To tackle these limitations, we identify a set of key designs including (D1) dilated
  convolution, (D2) multi-channel learning, (D3) self-attention score, and (D4) sign
  factor to boost learning from different types (homophily and heterophily) and scales
  (small, medium, and large) of networks, and combine them into a graph neural network,
  GPNet, a simple and efficient one-layer model. We theoretically analyze the model
  and show that it can approximate various graph filters by adjusting the self-attention
  score and sign factor. Experiments show that GPNet consistently outperforms baselines
  in terms of average rank, average accuracy, complexity, and parameters on semi-supervised
  and full-supervised tasks, and achieves competitive performance compared to state-of-the-art
  model with inductive learning task.'
codebase_url: ''
...
- &id007
  ...
  - model: GAT
    ...
    protocol_note: Full-supervised node classification task
    date: Sep 30, 2022
...
- &id002
  ...
  - model: ARMA
    ...
    is_std_outlier: false
  - model: MixHop-learn
    model_key: mixhop-learn
    model_plain: MixHop-learn
    value: 0.714
    std: 0.008
    paper_value: 0.714
    paper_std: 0.008
...
- &id006
  ...
  - model: GGCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Full-supervised node classification on Cornell
    date: Sep 30, 2022
    date_display: Sep 2022
    date_iso: '2022-09-30'
    published_venue: ''
...
- &id003
  ...
  - model: JKNet
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split (semi-supervised)
    date: Sep 30, 2022
    date_display: Sep 2022
    date_iso: '2022-09-30'
    published_venue: ''
...
- &id008
  ...
  - model: GPNet
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Full-supervised node classification on Squirrel
    date: Sep 30, 2022
    date_display: Sep 2022
    date_iso: '2022-09-30'
    published_venue: ''
...
- &id005
  ...
  - model: GPRGNN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Full-supervised node classification on Texas
    date: Sep 30, 2022
    date_display: Sep 2022
    date_iso: '2022-09-30'
    published_venue: ''
  ...
  - model: SGC
    ...
    value_gap_source_date_iso: '2025-05-29'
    value_gap_source_date_label: ICML 2025
    gap_vs_at_pub: 0.13970000000000005
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
single_proposed_model: GPNet
main_figure: /figures/2209.15454/main_figure.jpegoptim.jpg
---
