...
- name: Wenwu Zhu
  ...
  s2_url: null
published_date: Mar 17, 2020
published_date_iso: '2020-03-17'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: Variants of Graph Neural Networks (GNNs) for representation learning have
  been proposed recently and achieved fruitful results in various fields. Among them,
  Graph Attention Network first employs a self-attention strategy to learn attention
  weights for each edge in the spatial domain. However, learning the attentions over
  edges can only focus on the local information of graphs and greatly increases the
  computational costs. In this paper, we first introduce the attention mechanism in
  the spectral domain of graphs and present Spectral Graph Attention Network that
  learns representations for different frequency components regarding weighted filters
  and graph wavelets bases. In this way, can better capture global patterns of graphs
  in an efficient manner with much fewer learned parameters than that of. Further,
  to reduce the computational cost of brought by the eigen-decomposition, we propose
  a fast approximation variant -. We thoroughly evaluate the performance of and -
  in semi-supervised node classification tasks and verify the effectiveness of the
  learned attentions in spectral domain.
codebase_url: ''
...
- &id004
  ...
  - model: APPNP
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: klicpera_predict_2019
    variant_inference_reason: 'dataset: fuzzy match to amazon-photo (score=100)'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: semi-supervised node classification
  ...
  - model: ChebyNet
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: Defferrard2016ChebNet
    variant_inference_reason: 'dataset: fuzzy match to amazon-photo (score=100)'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: semi-supervised node classification
  ...
  - model: SpGAT-Cheby-MAX
    model_key: spgat-cheby-max
    model_plain: SpGAT-Cheby-MAX
    value: 0.928
    std: 0.002
    paper_value: 0.928
    paper_std: 0.002
    ...
    is_best: false
    is_std_outlier: false
  - model: SpGAT-Cheby-MEAN
    model_key: spgat-cheby-mean
    model_plain: SpGAT-Cheby-MEAN
    value: 0.924
    std: 0.001
    paper_value: 0.924
    paper_std: 0.001
    ...
    is_std_outlier: false
  - model: SpGAT-MEAN
    model_key: spgat-mean
    model_plain: SpGAT-MEAN
    value: 0.918
    std: 0.003
    paper_value: 0.918
    paper_std: 0.003
  ...
  - model: ARMA
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: ARMAbianchi2019graph
    variant_inference_reason: 'dataset: fuzzy match to amazon-photo (score=100)'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: semi-supervised node classification
  ...
  - model: HyperGraph
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: HyperGraphbai2019hypergraph
    variant_inference_reason: 'dataset: fuzzy match to amazon-photo (score=100)'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: semi-supervised node classification
  ...
  - model: HighOrder
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: HighOrdermorris2019weisfeiler
    variant_inference_reason: 'dataset: fuzzy match to amazon-photo (score=100)'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: semi-supervised node classification
...
- &id005
  ...
  - model: GraphSAGE
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Semi-supervised node classification on Coauthor CS
    date: Mar 17, 2020
    date_display: Mar 2020
    date_iso: '2020-03-17'
    published_venue: ''
...
- &id002
  ...
  - model: ChebyNet
    ...
    at_pub_value: 0.681
    at_pub_std: 0.025
    at_pub_source_arxiv: '1811.11103'
    at_pub_source_title: Bayesian graph convolutional neural networks for semi-supervised
      classification
    at_pub_source_date_iso: '2018-11-27'
    ...
    has_value_gap: true
    comparison_type: improved
    comparison_source_title: Bayesian graph convolutional neural networks for semi-supervised
      classification
    comparison_source_arxiv: '1811.11103'
    is_best: false
    is_std_outlier: false
  - model: Planetoid
    model_key: planetoid
...
main_figure: /figures/2003.07450/main_figure.jpegoptim.jpg
---
