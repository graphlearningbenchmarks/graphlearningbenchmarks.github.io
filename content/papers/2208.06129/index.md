...
- name: Pengyang Yu
  orcid: null
  s2_author_id: '145483154'
  s2_url: null
- name: Chaofan Fu
  orcid: null
  s2_author_id: '11560076'
  s2_url: null
- name: Yanwei Yu
  orcid: null
  s2_author_id: '1949081'
  s2_url: null
- name: Chao Huang
  orcid: null
  s2_author_id: '2163057040'
  s2_url: null
- name: Zhongying Zhao
  orcid: null
  s2_author_id: '145793197'
  s2_url: null
- name: Junyu Dong
  orcid: null
  s2_author_id: '2144063462'
  s2_url: null
published_date: Aug 12, 2022
published_date_iso: '2022-08-12'
published_venue: KDD 2022
published_conference: KDD 2022
published_conference_short: KDD
published_conference_slug: kdd
abstract: Heterogeneous graph convolutional networks have gained great popularity
  in tackling various network analytical tasks on heterogeneous network data, ranging
  from link prediction to node classification. However, most existing works ignore
  the relation heterogeneity with multiplex network between multi-typed nodes and
  different importance of relations in meta-paths for node embedding, which can hardly
  capture the heterogeneous structure signals across different relations. To tackle
  this challenge, this work proposes a ultiplex eterogeneous raph onvolutional etwork
  (MHGCN) for heterogeneous network embedding. Our MHGCN can automatically learn the
  useful heterogeneous meta-path interactions of different lengths in multiplex heterogeneous
  networks through multi-layer convolution aggregation. Additionally, we effectively
  integrate both multi-relation structural signals and attribute semantics into the
  learned node embeddings with both unsupervised and semi-supervised learning paradigms.
  Extensive experiments on five real-world datasets with various network analytical
  tasks demonstrate the significant superiority of MHGCN against state-of-the-art
...
- &id002
  ...
  - model: Node2Vec
    ...
    value_gap_source_date_iso: '2022-06-25'
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.16559999999999997
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- scope: node-level
  ...
  - benchmark: Heterogeneous Graph Benchmarks
    ...
    - dataset: IMDB
      dataset_slug: imdb
single_proposed_model: MHGCN
main_figure: /figures/2208.06129/main_figure.jpegoptim.jpg
---
