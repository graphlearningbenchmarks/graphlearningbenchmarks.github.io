...
- name: Shiyin Tan
  orcid: null
  s2_author_id: '148149386'
  s2_url: null
- name: Dongyuan Li
  orcid: null
  s2_author_id: '2242195007'
  s2_url: null
- name: Renhe Jiang
  orcid: null
...
- name: Ying Zhang
  orcid: null
  s2_author_id: '2153391362'
  s2_url: null
- name: Manabu Okumura
  orcid: null
  s2_author_id: '2283854880'
  s2_url: null
...
- &id007
  ...
  - model: CI-GCL
    ...
    protocol_note: Transfer learning setting using ZINC 2M for pre-training and BACE
      for fine-tuning as per Hu et al. protocol.
    date: May 2, 2024
...
- &id008
  ...
  - model: GraphCL
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Transfer learning setting using ZINC 2M for pre-training and BBBP
      for fine-tuning.
    date: May 2, 2024
    date_display: May 2024
    date_iso: '2024-05-02'
...
- &id004
  ...
  - model: MVGRL
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Unsupervised representation learning using 10-fold cross-validation
      for TU datasets.
    date: May 2, 2024
    date_display: May 2024
    date_iso: '2024-05-02'
  ...
  - model: CI+AD-GCL
    ...
    is_std_outlier: false
  - model: CI+AutoGCL
    model_key: ci+autogcl
    model_plain: CI+AutoGCL
    value: 0.7224
    std: 0.009
    paper_value: 0.7224
    paper_std: 0.009
...
- &id009
  ...
  - model: SEGA
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Transfer learning setting with ZINC 2M pre-training and ClinTox
      fine-tuning
    date: May 2, 2024
    date_display: May 2024
    date_iso: '2024-05-02'
  ...
  - model: JOAO
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Unsupervised pre-training on whole dataset followed by downstream
      classifier with scaffold split.
    date: May 2, 2024
    date_display: May 2024
    date_iso: '2024-05-02'
    published_venue: ICML 2024
    ...
    gap_vs_at_pub: 0.031100000000000017
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id012
  ...
  - model: InfoGraph
    ...
    protocol_decision: standard
    protocol_note: Unsupervised graph regression using GIN encoder and SVM classifier.
    date: May 2, 2024
    date_display: May 2024
    date_iso: '2024-05-02'
    published_venue: ICML 2024
  ...
  - model: JOAO
    ...
    value_gap_source_date_iso: '2026-02-23'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 1.6640000000000001
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id010
  ...
  - model: SEGA
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Transfer learning setting with ZINC 2M pre-training and SIDER fine-tuning
    date: May 2, 2024
    date_display: May 2024
    date_iso: '2024-05-02'
    published_venue: ICML 2024
  ...
  - model: AD-GCL
    ...
    value_gap_source_date_iso: '2024-05-02'
    value_gap_source_date_label: ICML 2024
    gap_vs_at_pub: 0.037900000000000045
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
- &id006
  ...
  - model: JOAO
    ...
    value_gap_source_date_iso: '2022-06-02'
    value_gap_source_date_label: KDD 2022
    gap_vs_at_pub: 0.1046999999999999
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: EdgePred
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Transfer learning setting with ZINC 2M pre-training
    date: May 2, 2024
    date_display: May 2024
    date_iso: '2024-05-02'
    published_venue: ICML 2024
  ...
  - model: AD-GCL
    ...
    value_gap_source_date_iso: '2024-03-03'
    value_gap_source_date_label: ICLR 2024
    gap_vs_at_pub: 0.03280000000000005
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id011
  ...
  - model: ContextPred
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Transfer learning setting using ZINC 2M for pre-training and ToxCast
      for fine-tuning as per Hu et al. protocol.
    date: May 2, 2024
    date_display: May 2024
    date_iso: '2024-05-02'
...
single_proposed_model: CI-GCL
main_figure: /figures/2405.01350/main_figure.jpegoptim.jpg
---
