...
- name: Shuiwang Ji
  ...
  s2_url: null
published_date: Jun 4, 2022
published_date_iso: '2022-06-04'
published_venue: TMLR 2022
published_conference: TMLR 2022
published_conference_short: TMLR
published_conference_slug: tmlr
abstract: Message passing graph neural networks (GNNs) are known to have their expressiveness
  upper-bounded by 1-dimensional Weisfeiler-Leman (1-WL) algorithm. To achieve more
  powerful GNNs, existing attempts either require ad hoc features, or involve operations
  that incur high time and space complexities. In this work, we propose a general
  and provably powerful GNN framework that preserves the scalability of the message
  passing scheme. In particular, we first propose to empower 1-WL for graph isomorphism
  test by considering edges among neighbors, giving rise to NC-1-WL. The expressiveness
  of NC-1-WL is shown to be strictly above 1-WL and below 3-WL theoretically. Further,
  we propose the NC-GNN framework as a differentiable neural version of NC-1-WL. Our
  simple implementation of NC-GNN is provably as powerful as NC-1-WL. Experiments
...
- &id006
  ...
  - model: Empowering GNNs
    ...
    protocol_note: Node classification on CLUSTER dataset using 4 random runs as per
      GNN Benchmark protocol.
    date: Jun 4, 2022
...
- &id005
  ...
  - model: GIN
    ...
    comparison_source_title: Graph Homomorphism Convolution
    comparison_source_arxiv: '2005.01214'
    is_best: true
    is_std_outlier: false
  - model: GNN-AK+
    model_key: gnn-ak+
...
- &id002
  ...
  - model: GIN
    ...
    protocol_note: Table caption mentions MUTAG, PTC, and NCI1, but the dataset requested
      'synthetic dataset from Chen et al.' is not present in the provided table.
    date: Jun 4, 2022
    date_display: Jun 2022
    date_iso: '2022-06-04'
    published_venue: TMLR 2022
...
- &id007
  ...
  - model: Empowering GNNs
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on PATTERN from GNN Benchmark using 4 random
      runs.
    date: Jun 4, 2022
    date_display: Jun 2022
    date_iso: '2022-06-04'
...
- &id001
  ...
  - model: NC-GNN
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: OGB species split as per canonical protocol for ogbg-ppa.
    date: Jun 4, 2022
    date_display: Jun 2022
    date_iso: '2022-06-04'
    published_venue: TMLR 2022
  ...
  - model: GIN + 3-cycle count feature
    model_key: gin + 3-cycle count feature
