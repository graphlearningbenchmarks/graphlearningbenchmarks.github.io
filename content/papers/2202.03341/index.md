---
title: 'Neighbor2Seq: Deep Learning on Massive Graphs by Transforming Neighbors to
  Sequences'
arxiv_id: '2202.03341'
source_url: ''
authors:
...
abstract: =9pt Modern graph neural networks (GNNs) use a message passing scheme and
  have achieved great success in many fields. However, this recursive design inherently
  leads to excessive computation and memory requirements, making it not applicable
  to massive real-world graphs. In this work, we propose the Neighbor2Seq to transform
  the hierarchical neighborhood of each node into a sequence. This novel transformation
  enables the subsequent mini-batch training for general deep learning operations,
  such as convolution and attention, that are designed for grid-like data and are
  shown to be powerful in various domains. Therefore, our Neighbor2Seq naturally endows
  GNNs with the efficiency and advantages of deep learning operations on grid-like
  data by precomputing the Neighbor2Seq transformations. We evaluate our method on
  a massive graph, with more than $111$ million nodes and $1.6$ billion edges, as
  well as several medium-scale graphs. Results show that our proposed method is scalable
  to massive graphs and achieves superior performance across massive and medium-scale
  graphs. Our code is available at.
codebase_url: https://github.com/divelab/Neighbor2Seq
...
- &id001
  ...
  - model: SIGN
    ...
    is_best: false
    is_std_outlier: false
  - model: Neighbor2Seq+Conv
    model_key: neighbor2seq+conv
    model_plain: Neighbor2Seq+Conv
    value: 0.967
    std: 0.0
    paper_value: 0.967
    paper_std: 0.0
    ...
    is_best: false
    is_std_outlier: false
  - model: Neighbor2Seq+Attn
    model_key: neighbor2seq+attn
    model_plain: Neighbor2Seq+Attn
    value: 0.967
    std: 0.0
    paper_value: 0.967
    paper_std: 0.0
...
- &id003
  ...
  - model: SGC
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Transductive setting on ogbn-papers100M; test split
    date: Feb 7, 2022
    date_display: Feb 2022
    date_iso: '2022-02-07'
    published_venue: ''
...
- &id002
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Transductive node classification on ogbn-products using the standard
      OGB split (10% training/val, 90% test).
    date: Feb 7, 2022
    date_display: Feb 2022
    date_iso: '2022-02-07'
    published_venue: ''
...
main_figure: /figures/2202.03341/main_figure.jpegoptim.jpg
---
