...
- &id003
  ...
  - model: JOAOv2
    ...
    protocol_note: Semi-supervised learning with 10% label rate using 10-fold CV;
...
- &id001
  ...
  - model: GraphCL
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV, non-linear SVM classifier, Accuracy (%)
    date: Jun 10, 2021
    date_display: Jun 2021
    date_iso: '2021-06-10'
    published_venue: NeurIPS 2021
...
- &id002
  ...
  - model: AD-GCL-FIX
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV, Accuracy, PROTEINS
    date: Jun 10, 2021
    date_display: Jun 2021
    date_iso: '2021-06-10'
    published_venue: NeurIPS 2021
...
- &id004
  ...
  - model: JOAO
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 10-fold CV, semi-supervised (10% label rate), Accuracy (%)
    date: Jun 10, 2021
    date_display: Jun 2021
    date_iso: '2021-06-10'
    published_venue: NeurIPS 2021
