...
abstract: 'Leading graph contrastive learning (GCL) methods perform graph augmentations
  ...
  (i.e. distinguishing semantic nodes in graphs). On biochemical molecule and social
...
- &id005
  ...
  - model: GraphLoG
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: graph-l-o-g
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Scaffold split used for downstream evaluation after pre-training
      on Zinc-2M.
    date: Jun 16, 2022
...
- &id003
  ...
  - model: GraphCL
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Unsupervised representation learning evaluated via non-linear SVM
      classifier on TU datasets.
    date: Jun 16, 2022
    date_display: Jun 2022
    date_iso: '2022-06-16'
    published_venue: ICML 2022
...
- &id002
  ...
  - model: GraphCL
    ...
    input_feature_source: null
    feature_source_evidence: ''
    table_ref: Table unsupervised performance table
    source_ref: GraphCL
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Unsupervised representation learning evaluated with a non-linear
      SVM classifier.
    date: Jun 16, 2022
    date_display: Jun 2022
    date_iso: '2022-06-16'
...
- &id004
  ...
  - model: AD-GCL
    ...
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.04569999999999996
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
single_proposed_model: RGCL
main_figure: /figures/2206.07869/main_figure.jpegoptim.jpg
---
