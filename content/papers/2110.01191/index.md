...
- &id001
  ...
  - model: Molformer
    ...
    feature_source_evidence: The model uses 3D heterogeneous molecular graphs (HMGs)
      constructed from atom and motif nodes.
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: ROC-AUC on BACE scaffold split
    date: Oct 4, 2021
...
- &id002
  ...
  - model: Molformer
    ...
    input_feature_source: raw_features
    feature_source_evidence: The model uses 3D heterogeneous molecular graphs (HMGs)
      constructed from motifs and atoms.
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
...
- &id003
  ...
  - model: Molformer
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: The model uses HMGs constructed from motifs and atoms.
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
