...
- name: Adam Perold
  orcid: null
  s2_author_id: '2198488555'
  s2_url: null
- name: Yann LeCun
  orcid: null
  s2_author_id: '1688882'
  s2_url: null
- name: X. Bresson
  orcid: null
  s2_author_id: '2549032'
  s2_url: null
published_date: Dec 27, 2022
published_date_iso: '2022-12-27'
...
abstract: Graph Neural Networks (GNNs) have shown great potential in the field of
  ...
  The source code is available for reproducibility at:.
...
- &id005
  ...
  - model: GraphTrans-MLP-Mixer
    model_key: graphtrans-mlp-mixer
    ...
    value_gap_source_date_iso: '2022-12-27'
    ...
    true_value: 0.7396
    true_std: 0.0033
    value_gap_source_arxiv: '2212.13350'
    value_gap_source_title: A Generalization of ViT/MLP-Mixer to Graphs
  ...
  - model: GatedGCN
    ...
    gap_vs_at_pub: 0.0505000000000001
    ...
    is_best: false
    is_std_outlier: false
  - model: GatedGCN-MLP-Mixer
    model_key: gatedgcn-mlp-mixer
    model_plain: GatedGCN-MLP-Mixer
    value: 0.706
    std: 0.0022
    paper_value: 0.706
    paper_std: 0.0022
  ...
  - model: GINE-ViT
    ...
    is_best: false
    is_std_outlier: false
  - model: GINE-MLP-Mixer
    model_key: gine-mlp-mixer
    model_plain: GINE-MLP-Mixer
    value: 0.6833
    std: 0.0022
    paper_value: 0.6833
    paper_std: 0.0022
  ...
  - model: GINE
    ...
    is_std_outlier: false
  - model: GCN-MLP-Mixer
    model_key: gcn-mlp-mixer
    model_plain: GCN-MLP-Mixer
    value: 0.6111
    std: 0.0017
    paper_value: 0.6111
    paper_std: 0.0017
  ...
  - model: GCN
    ...
    gap_vs_at_pub: 0.04159999999999997
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id006
  ...
  - model: Graph ViT/MLP-Mixer
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: The model uses RWSE-8 for NodePE and RWSE-8 for PatchPE
      as shown in Table 3 and Table 5.
    table_ref: Table 5
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: 5-fold cross validation with stratified sampling for CSL task (10-class
      classification).
    date: Dec 27, 2022
    date_display: Dec 2022
    date_iso: '2022-12-27'
  ...
  - model: GCN
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: Augmented with same PE as proposed model.
    table_ref: Table 5
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: graph_classification
...
- &id004
  ...
  - model: GatedGCN
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Accuracy on MNIST graph classification task
    date: Dec 27, 2022
    date_display: Dec 2022
    date_iso: '2022-12-27'
    published_venue: ICML 2022
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.007919999999999927
    has_value_note: false
    value_note: ''
    sort_value: 0.98552
    sort_std: 0.00023
  ...
  - model: GCN
    ...
    value_gap_source_title: 'RandAlign: A Parameter-Free Method for Regularizing Graph
      Convolutional Networks'
    value_gap_source_is_current_paper: false
    value_gap: 0.013610000000000011
    has_value_note: false
    value_note: ''
    sort_value: 0.94051
    sort_std: 0.00052
...
- &id003
  ...
  - model: Graph MLP-Mixer
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: AP on standard split
    date: Dec 27, 2022
    date_display: Dec 2022
    date_iso: '2022-12-27'
    published_venue: ICML 2022
...
- &id002
  ...
  - model: GraphTrans-MLP-Mixer
    ...
    protocol_decision: standard
    protocol_note: Test MAE on standard split for Peptides-struct
    date: Dec 27, 2022
    date_display: Dec 2022
    date_iso: '2022-12-27'
    published_venue: ICML 2022
...
- &id001
  ...
  - model: GINE
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: ROC-AUC on the standard OGB MolTOX21 split
    date: Dec 27, 2022
    date_display: Dec 2022
    date_iso: '2022-12-27'
    published_venue: ICML 2022
...
- scope: graph-level
  ...
  - benchmark: GNNBenchmark
    ...
    - dataset: CSL
      dataset_slug: csl
main_figure: /figures/2212.13350/main_figure.jpegoptim.jpg
---
