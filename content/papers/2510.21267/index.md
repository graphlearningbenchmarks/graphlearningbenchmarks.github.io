...
abstract: Graph attention has demonstrated superior performance in graph learning
  ...
  large number of nodes. In this paper, we discover a new phenomenon termed over-aggregating.
  Over-aggregating arises when a large volume of messages is aggregated into a single
  node with less discrimination, leading to the dilution of the key messages and potential
  information loss. To address this, we propose Wideformer, a plug-and-play method
  for graph attention. Wideformer divides the aggregation of all nodes into parallel
  processes and guides the model to focus on specific subsets of these processes.
  The division can limit the input volume per aggregation, avoiding message dilution
  and reducing information loss. The guiding step sorts and weights the aggregation
  outputs, prioritizing the informative messages. Evaluations show that Wideformer
  can effectively mitigate over-aggregating. As a result, the backbone methods can
  focus on the informative messages, achieving superior performance compared to baseline
  methods.
...
- &id003
  ...
  - model: GCN
    ...
    protocol_note: Standard node classification on AmazonComputers
    date: Oct 24, 2025
...
- &id002
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification on AmazonPhoto
    date: Oct 24, 2025
    date_display: Oct 2025
    date_iso: '2025-10-24'
    published_venue: NeurIPS 2025
  ...
  - model: Polynormer + Entropy Reg
    model_key: polynormer + entropy reg
  ...
  - model: SGFormer + Entropy Reg
    model_key: sgformer + entropy reg
  ...
  - model: GraphGPS+Entropy Reg
    model_key: graphgps+entropy reg
...
- &id007
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Task is node classification; table caption specifies accuracy for
      amazon-ratings.
    date: Oct 24, 2025
    date_display: Oct 2025
    date_iso: '2025-10-24'
  ...
  - model: GraphGPS
    ...
    value_gap_source_date_iso: '2026-05-18'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.03370000000000001
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id005
  ...
  - model: GraphSAGE
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification on CoauthorCS
    date: Oct 24, 2025
    date_display: Oct 2025
    date_iso: '2025-10-24'
    published_venue: NeurIPS 2025
...
- &id004
  ...
  - model: GPRGNN
    ...
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: fuzzy match to coauthor-physics (score=97)'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification on CoauthorPhysics
    date: Oct 24, 2025
    date_display: Oct 2025
    date_iso: '2025-10-24'
    published_venue: NeurIPS 2025
...
- &id001
  ...
  - model: Exphormer
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification on Cora
    date: Oct 24, 2025
    date_display: Oct 2025
    date_iso: '2025-10-24'
    published_venue: NeurIPS 2025
...
- &id010
  ...
  - model: Polynormer + Wideformer
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Heterophilic dataset task measured by ROC-AUC
    date: Oct 24, 2025
    date_display: Oct 2025
    date_iso: '2025-10-24'
    published_venue: NeurIPS 2025
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2025-10-24'
    value_gap_source_date_label: NeurIPS 2025
    gap_vs_at_pub: 0.015300000000000091
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
  ...
  - model: DIFFormer
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: wu_DIFFormerScalableGraph_2023
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Heterophilic dataset task measured by ROC-AUC
  ...
  - model: NodeFormer
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: wu_NodeFormerScalableGraph_2022
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Heterophilic dataset task measured by ROC-AUC
  ...
  - model: NAGphormer
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: chen_NAGphormerTokenizedGraph_2023
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Heterophilic dataset task measured by ROC-AUC
  ...
  - model: GOAT
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: kong_GOATGlobalTransformer_2023
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Heterophilic dataset task measured by ROC-AUC
...
- &id008
  ...
  - model: GPRGNN
    ...
    at_pub_value: 0.6458
    at_pub_std: 0.012
    at_pub_source_arxiv: '2505.14033'
    at_pub_source_title: 'Partition-wise Graph Filtering: A Unified Perspective Through
      the Lens of Graph Coarsening'
    at_pub_source_date_iso: '2025-05-20'
    ...
    has_value_gap: true
    comparison_type: behind
    comparison_source_title: 'Partition-wise Graph Filtering: A Unified Perspective
      Through the Lens of Graph Coarsening'
    comparison_source_arxiv: '2505.14033'
    is_best: false
    is_std_outlier: false
  rank_metric: ROC-AUC
  higher_is_better: true
...
- &id006
  ...
  - model: GraphGPS + Wideformer
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard heterophilic node classification task on roman-empire
    date: Oct 24, 2025
    date_display: Oct 2025
    date_iso: '2025-10-24'
    published_venue: NeurIPS 2025
...
- &id009
  ...
  - model: Polynormer + Wideformer
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Heterophilic dataset task using ROC-AUC
    date: Oct 24, 2025
    date_display: Oct 2025
    date_iso: '2025-10-24'
    published_venue: NeurIPS 2025
...
- &id011
  ...
  - model: Polynormer + Wideformer
    ...
    table_ref: Table 1
    source_ref: this paper
    variant_inference_reason: 'dataset: fuzzy match to twitch-gamers (score=96)'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification task on twitch-gamer dataset.
    date: Oct 24, 2025
    date_display: Oct 2025
    date_iso: '2025-10-24'
    published_venue: NeurIPS 2025
