...
- name: Zhenhua Huang
  orcid: null
  s2_author_id: '2265944840'
  s2_url: null
- name: Kunhao Li
  orcid: null
  s2_author_id: '2256701520'
  s2_url: null
- name: Shaojie Wang
  orcid: null
  s2_author_id: '2311530166'
  s2_url: null
- name: Zhaohong Jia
  orcid: null
  s2_author_id: '2311748968'
  s2_url: null
- name: Wentao Zhu
  orcid: null
  s2_author_id: '2311578518'
  s2_url: null
- name: Sharad Mehrotra
  orcid: null
  s2_author_id: '2311501910'
  s2_url: null
...
abstract: Graph neural networks (GNNs) are widely applied in graph data modeling.
  However, existing GNNs are often trained in a task-driven manner that fails to fully
  capture the intrinsic nature of the graph structure, resulting in sub-optimal node
  and graph representations. To address this limitation, we propose a novel Graph
  structure Prompt Learning method (GPL) to enhance the training of GNNs, which is
  inspired by prompt mechanisms in natural language processing. GPL employs task-independent
  graph structure losses to encourage GNNs to learn intrinsic graph characteristics
  while simultaneously solving downstream tasks, producing higher-quality node and
  graph representations. In extensive experiments on eleven real-world datasets, after
  being trained by GPL, GNNs significantly outperform their original performance on
  node classification, graph classification, and edge prediction tasks (up to 10.28\
...
- &id004
  ...
  - model: GCN
    ...
    protocol_note: Node classification task on Computers dataset
    date: Jul 16, 2024
  ...
  - model: GAT
    ...
    is_std_outlier: false
  - model: FusedGAT+GPL
    model_key: fusedgat+gpl
    model_plain: FusedGAT+GPL
    value: 0.9161
    std: 0.0031
    paper_value: 0.9161
    paper_std: 0.0031
  ...
  - model: GraphSAGE
    ...
    gap_vs_at_pub: 0.07210000000000005
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: ChebNet
    ...
    gap_vs_at_pub: 0.08729999999999993
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GraphSage+GPL
    ...
    is_std_outlier: false
  - model: ChebNet+GPL
    model_key: chebnet+gpl
    model_plain: ChebNet+GPL
    value: 0.8573
    std: 0.0074
    paper_value: 0.8573
    paper_std: 0.0074
  ...
  - model: ARMA+GPL
    ...
    is_std_outlier: false
  - model: LightGCN+GPL
    model_key: lightgcn+gpl
    model_plain: LightGCN+GPL
    value: 0.8428
    std: 0.0005
    paper_value: 0.8428
    paper_std: 0.0005
...
- &id003
  ...
  - model: GAT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification task on Photo dataset
    date: Jul 16, 2024
    date_display: Jul 2024
    date_iso: '2024-07-16'
    published_venue: ''
    ...
    value_gap_source_date_iso: '2026-05-18'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.09909999999999997
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GraphSAGE
    ...
    gap_vs_at_pub: 0.09119999999999995
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id001
  ...
  - model: GPPT
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split node classification
    date: Jul 16, 2024
    date_display: Jul 2024
    date_iso: '2024-07-16'
    published_venue: ''
    ...
    value_gap_source_date_iso: '2024-07-16'
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.33049999999999996
    worse_than_at_pub: false
    surpassed_since_pub: false
    better_than_at_pub: true
    insignificant_improvement_at_pub: false
...
- &id008
  ...
  - model: GCN
    ...
    gap_vs_at_pub: 0.09429999999999994
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id005
  ...
  - model: ECC
    ...
    is_std_outlier: false
  - model: SortPool+GPL
    model_key: sortpool+gpl
    model_plain: SortPool+GPL
    value: 0.96
    std: 0.02
    paper_value: 0.96
    paper_std: 0.02
  ...
  - model: TopKPool
    ...
    value_gap_source_date_label: '2023'
    gap_vs_at_pub: 0.21300000000000008
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: SortPool
    ...
    is_std_outlier: false
  - model: MEWISPool+GPL
    model_key: mewispool+gpl
    model_plain: MEWISPool+GPL
    value: 0.8947
    std: 0.0333
    paper_value: 0.8947
    paper_std: 0.0333
  ...
  - model: EdgePool
    ...
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.08510000000000006
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    is_std_outlier: false
  - model: EdgePool+GPL
    model_key: edgepool+gpl
    model_plain: EdgePool+GPL
    value: 0.805
    std: 0.015
    paper_value: 0.805
    paper_std: 0.015
    ...
    is_std_outlier: false
  - model: TopKPool+GPL
    model_key: topkpool+gpl
    model_plain: TopKPool+GPL
    value: 0.805
    std: 0.0522
    paper_value: 0.805
    paper_std: 0.0522
  ...
  - model: SAGPool
    ...
    value_gap_source_date_iso: '2022-05-01'
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.11859999999999993
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    is_std_outlier: false
  - model: ASAPool+GPL
    model_key: asapool+gpl
    model_plain: ASAPool+GPL
    value: 0.795
    std: 0.035
    paper_value: 0.795
    paper_std: 0.035
  ...
  - model: ASAPool
    ...
    is_std_outlier: false
  - model: SAGPool+GPL
    model_key: sagpool+gpl
    model_plain: SAGPool+GPL
    value: 0.73
    std: 0.0871
    paper_value: 0.73
    paper_std: 0.0871
...
- &id006
  ...
  - model: DiffPool
    ...
    gap_vs_at_pub: 0.19690000000000007
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id007
  ...
  - model: TopKPool
    ...
    value_gap_source_date_label: ICLR 2020
    gap_vs_at_pub: 0.04290000000000005
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: EdgePool
    ...
    value_gap_source_date_iso: '2022-05-01'
    value_gap_source_date_label: '2022'
    gap_vs_at_pub: 0.17200000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id002
  ...
  - model: UniMP
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.046599999999999975
    has_value_note: false
    value_note: ''
    sort_value: 0.9034
    sort_std: null
...
main_figure: /figures/2407.11361/main_figure.jpegoptim.jpg
---
