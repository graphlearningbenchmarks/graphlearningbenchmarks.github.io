...
- name: Chuntao Hong
  ...
  s2_url: null
published_date: Jul 28, 2024
published_date_iso: '2024-07-28'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: 'In the graph domain, deep graph networks based on Message Passing Neural
  Networks (MPNNs) or Graph Transformers often cause over-smoothing of node features,
  limiting their expressive capacity. Many upsampling techniques involving node and
  edge manipulation have been proposed to mitigate this issue. However, these methods
  are often heuristic, resulting in extensive manual labor and suboptimal performance
  and lacking a universal integration strategy. In this study, we introduce UniGAP,
  a versal and adaptive r ph u sampling framework to mitigate over-smoothing in node
  classification tasks. Specifically, we design an adaptive graph upsampler based
  on condensed trajectory features, serving as a plug-in component for existing GNNs
  to mitigate the over-smoothing problem and enhance performance. Moreover, UniGAP
  serves as a representation-based and fully differentiable framework to inspire further
  exploration of graph upsampling methods. Through extensive experiments, UniGAP demonstrates
  significant improvements over heuristic data augmentation methods in various datasets
  and metrics. We analyze how graph structure evolves with UniGAP, identifying key
  bottlenecks where over-smoothing occurs, and providing insights into how UniGAP
  addresses this issue. Lastly, we show the potential of combining UniGAP with large
  language models (LLMs) to further improve downstream performance. Our code is available
  at: https://anonymous.4open.science/r/UniGAP.'
codebase_url: ''
...
- &id006
  ...
  - model: H2GCN + UniGAP
    ...
    protocol_note: Public split as mentioned in evaluation protocols
    date: Jul 28, 2024
...
- &id002
  ...
  - model: GPRGNN
    ...
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.09420000000000006
  ...
  - model: GAT
    ...
    gap_vs_at_pub: 0.09860000000000002
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GCN
    ...
    value_gap_source_date_iso: '2024-06-27'
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.08230000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: H2GCN
    ...
    is_std_outlier: false
  - model: GCNII + UniGAP
    model_key: gcnii + unigap
    model_plain: GCNII + UniGAP
    value: 0.737
    std: 0.004
    paper_value: 0.737
    paper_std: 0.004
  ...
  - model: DRGCN
    ...
    is_std_outlier: false
  - model: GAT + UniGAP
    model_key: gat + unigap
    model_plain: GAT + UniGAP
    value: 0.732
    std: 0.005
    paper_value: 0.732
    paper_std: 0.005
  ...
  - model: MTGCN
    ...
    is_std_outlier: false
  - model: GCNII + AdaEdge
    model_key: gcnii + adaedge
    model_plain: GCNII + AdaEdge
    value: 0.726
    std: 0.006
    paper_value: 0.726
    paper_std: 0.006
    ...
    is_best: false
    is_std_outlier: false
  - model: GCNII+DropEdge
    model_key: gcnii+dropedge
    model_plain: GCNII+DropEdge
    value: 0.7249
    std: 0.007
    paper_value: 0.7249
    paper_std: 0.007
  ...
  - model: GraphGPS
    ...
    is_std_outlier: false
  - model: GCNII + HalfHop
    model_key: gcnii + halfhop
    model_plain: GCNII + HalfHop
    value: 0.7243
    std: 0.007
    paper_value: 0.7243
    paper_std: 0.007
  ...
  - model: GCN + HalfHop
    ...
    is_best: false
    is_std_outlier: false
  - model: GPRGNN + HalfHop
    model_key: gprgnn + halfhop
    model_plain: GPRGNN + HalfHop
    value: 0.7237
    std: 0.007
    paper_value: 0.7237
    paper_std: 0.007
  ...
  - model: GraphSAGE + HalfHop
    ...
    is_best: false
    is_std_outlier: false
  - model: H2GCN + DropEdge
    model_key: h2gcn + dropedge
    model_plain: H2GCN + DropEdge
    value: 0.7195
    std: 0.009
    paper_value: 0.7195
    paper_std: 0.009
  ...
  - model: H2GCN + HalfHop
    ...
    is_std_outlier: false
  - model: GAT + HalfHop
    model_key: gat + halfhop
    model_plain: GAT + HalfHop
    value: 0.7183
    std: 0.008
    paper_value: 0.7183
    paper_std: 0.008
    ...
    is_best: false
    is_std_outlier: false
  - model: GPRGNN + DropEdge
    model_key: gprgnn + dropedge
    model_plain: GPRGNN + DropEdge
    value: 0.7174
    std: 0.008
    paper_value: 0.7174
    paper_std: 0.008
  ...
  - model: GAT +DropEdge
    ...
    is_std_outlier: false
  - model: GAT +AdaEdge
    model_key: gat +adaedge
    model_plain: GAT +AdaEdge
    value: 0.7092
    std: 0.009
    paper_value: 0.7092
    paper_std: 0.009
    ...
    is_std_outlier: false
  - model: GGCN + HalfHop
    model_key: ggcn + halfhop
    model_plain: GGCN + HalfHop
    value: 0.709
    std: 0.008
    paper_value: 0.709
    paper_std: 0.008
    ...
    is_best: false
    is_std_outlier: false
  - model: GPRGNN + AdaEdge
    model_key: gprgnn + adaedge
    model_plain: GPRGNN + AdaEdge
    value: 0.7082
    std: 0.007
    paper_value: 0.7082
    paper_std: 0.007
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split (Yang et et al. 2016 fixed split)
    date: Jul 28, 2024
    date_display: Jul 2024
    date_iso: '2024-07-28'
    published_venue: ''
    ...
    is_std_outlier: false
  - model: GGCN + DropEdge
    model_key: ggcn + dropedge
    model_plain: GGCN + DropEdge
    value: 0.708
    std: 0.005
    paper_value: 0.708
    paper_std: 0.005
    ...
    is_std_outlier: false
  - model: GGCN + AdaEdge
    model_key: ggcn + adaedge
    model_plain: GGCN + AdaEdge
    value: 0.7033
    std: 0.009
    paper_value: 0.7033
    paper_std: 0.009
...
- &id001
  ...
  - model: GGCN
    ...
    gap_vs_at_pub: 0.043099999999999916
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_title: 'From Node Interaction to Hop Interaction: New Effective
      and Scalable Graph Learning Paradigm'
    value_gap_source_is_current_paper: false
    value_gap: 0.043099999999999916
    has_value_note: false
    value_note: ''
    sort_value: 0.8795
    sort_std: 0.0105
  ...
  - model: GT
    ...
    value_gap_source_title: Language is All a Graph Needs
    value_gap_source_is_current_paper: false
    value_gap: 0.041999999999999926
    has_value_note: false
    value_note: ''
    sort_value: 0.8642
    sort_std: 0.0082
  ...
  - model: H2GCN + UniGAP
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split (Yang et et al. 2016 fixed 20-per-class train split)
    date: Jul 28, 2024
    date_display: Jul 2024
    date_iso: '2024-07-28'
    published_venue: ''
...
- &id007
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Public split as per experimental setup
    date: Jul 28, 2024
    date_display: Jul 2024
    date_iso: '2024-07-28'
    published_venue: ''
    ...
    gap_vs_at_pub: 0.18130000000000002
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id005
  ...
  - model: H2GCN + UniGAP
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Mean accuracy across twenty random seeds on the large-scale heterophilic
      dataset Squirrel.
    date: Jul 28, 2024
    date_display: Jul 2024
    date_iso: '2024-07-28'
...
- &id004
  ...
  - model: GPRGNN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Public split; mean accuracy across 20 random seeds.
    date: Jul 28, 2024
    date_display: Jul 2024
    date_iso: '2024-07-28'
    published_venue: ''
  ...
  - model: GAT
    ...
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.19540000000000002
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id003
  ...
  - model: GraphSAGE + UniGAP
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Public split, mean accuracy over 20 random seeds
    date: Jul 28, 2024
    date_display: Jul 2024
    date_iso: '2024-07-28'
    published_venue: ''
