...
- &id003
  ...
  - model: UniGAP
    ...
    protocol_note: Accuracy on Amazon-ratings using public split setting
    date: Jul 28, 2024
...
- &id004
  ...
  - model: UniGAP
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: ROC-AUC on Questions dataset using public split setting
    date: Jul 28, 2024
    date_display: Jul 2024
    date_iso: '2024-07-28'
    published_venue: ''
...
- &id002
  ...
  - model: UniGAP
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Accuracy on Squirrel using public split setting.
    date: Jul 28, 2024
    date_display: Jul 2024
    date_iso: '2024-07-28'
    published_venue: ''
...
- &id001
  ...
  - model: GraphSAGE
    ...
    uses_external_data: 0
    input_feature_source: raw_features
    feature_source_evidence: h_original indicates the use of features provided in
      PyG
    table_ref: Table 6
    source_ref: this paper
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Node classification on WikiCS using standard PyG features and split;
      Accuracy metric.
    date: Jul 28, 2024
    date_display: Jul 2024
    date_iso: '2024-07-28'
