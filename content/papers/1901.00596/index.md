...
- name: Philip S. Yu
  ...
  s2_url: null
published_date: Jan 1, 2019
published_date_iso: '2019-01-01'
published_venue: ''
published_conference: ''
published_conference_short: ''
published_conference_slug: ''
abstract: Deep learning has revolutionized many machine learning tasks in recent years,
  ranging from image classification and video processing to speech recognition and
  natural language understanding. The data in these tasks are typically represented
  in the Euclidean space. However, there is an increasing number of applications where
  data are generated from non-Euclidean do- mains and are represented as graphs with
  complex relationships and interdependency between objects. The complexity of graph
  data has imposed significant challenges on existing machine learning algorithms.
  Recently, many studies on extending deep learning approaches for graph data have
  emerged. In this survey, we provide a comprehensive overview of graph neural networks
  (GNNs) in data mining and machine learning fields. We propose a new taxonomy to
  divide the state-of-the-art graph neural networks into four categories, namely recurrent
  ...
  of graph neural networks across various domains and summarize the open source codes,
  benchmark data sets, and model evaluation of graph neural networks. Finally, we
...
- &id003
  ...
  - model: LGCN (2018)
    ...
    value_gap_source_date_iso: '2019-01-01'
    ...
    true_value: 0.73
    true_std: null
    value_gap_source_arxiv: '1901.00596'
    value_gap_source_title: A Comprehensive Survey on Graph Neural Networks
  ...
  - model: MLP
    ...
    is_std_outlier: false
  - model: DualGCN (2018)
    model_key: dualgcn (2018)
    model_plain: DualGCN (2018)
    value: 0.726
    std: null
    paper_value: 0.726
    paper_std: null
...
- &id001
  ...
  - model: StoGCN (2018)
    ...
    is_best: false
    is_std_outlier: false
  - model: Cayleynets (2017)
    model_key: cayleynets (2017)
    model_plain: Cayleynets (2017)
    value: 0.819
    std: null
    paper_value: 0.819
    paper_std: null
    ...
    is_std_outlier: false
  - model: MoNet (2017)
    model_key: monet (2017)
    model_plain: MoNet (2017)
    value: 0.8169
    std: null
    paper_value: 0.8169
    paper_std: null
...
- &id005
  ...
  - model: Cluster-GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: PPI evaluated by micro-averaged F1 score on test set using standard
...
- &id002
  ...
  - model: StoGCN (2018)
    ...
    is_best: false
    is_std_outlier: false
  - model: GeniePath (2019)
    model_key: geniepath (2019)
    model_plain: GeniePath (2019)
    value: 0.785
    std: null
    paper_value: 0.785
    paper_std: null
...
- &id004
  ...
  - model: GAAN (2018)
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Micro-averaged F1 score on Reddit test split
    date: Jan 1, 2019
    date_display: Jan 2019
    date_iso: '2019-01-01'
    published_venue: ''
  ...
  - model: Huang et al. (2018)
    ...
    is_best: false
    is_std_outlier: false
  - model: GraphSage (2017)
    model_key: graphsage (2017)
    model_plain: GraphSage (2017)
    value: 0.954
    std: null
    paper_value: 0.954
    paper_std: null
  ...
  - model: DGI (2018)
    ...
    is_std_outlier: false
  - model: FastGCN (2018)
    model_key: fastgcn (2018)
    model_plain: FastGCN (2018)
    value: 0.937
    std: null
    paper_value: 0.937
    paper_std: null
...
- scope: node-level
  ...
  - benchmark: Classic
    ...
    - dataset: PPI
      dataset_slug: ppi
main_figure: /figures/1901.00596/main_figure.jpegoptim.jpg
---
