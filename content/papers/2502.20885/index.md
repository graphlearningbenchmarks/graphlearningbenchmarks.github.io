...
source_url: ''
authors:
- name: Amadou S. Sangare
  orcid: null
  s2_author_id: '2058853046'
  s2_url: null
- name: Nicolas Dunou
  orcid: null
  s2_author_id: '2348095567'
  s2_url: null
- name: Jhony H. Giraldo
  orcid: null
  s2_author_id: '39802095'
  s2_url: null
- name: Fragkiskos D. Malliaros
  orcid: null
  s2_author_id: '2817467'
  s2_url: null
published_date: Feb 28, 2025
published_date_iso: '2025-02-28'
...
abstract: Self-supervised learning has become a key method for training deep learning
  ...
  holds great promise across various domains, the design of effective pretext tasks
  for self-supervised graph representation learning remains challenging. Contrastive
  learning, a popular approach in graph self-supervised learning, leverages positive
  and negative pairs to compute a contrastive loss function. However, current graph
  contrastive learning methods often struggle to fully use structural patterns and
  node similarities. To address these issues, we present a new method called Fused
  Gromov Wasserstein Subgraph Contrastive Learning (FOSSIL). Our model integrates
  ...
  create views for generating positive and negative pairs. Through extensive experiments
...
- &id002
  ...
  - model: PolyGCL
    ...
    protocol_note: Test set split 20% after 60/40 train/val split of development set;
      100 test seeds used.
    date: Feb 28, 2025
    ...
    gap_vs_at_pub: 0.14629999999999999
  ...
  - model: MUSE
    ...
    gap_vs_at_pub: 0.01940000000000003
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id001
  ...
  - model: FOSSIL v2
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy using logistic regression on embeddings with 100
      test seeds.
    date: Feb 28, 2025
    date_display: Feb 2025
    date_iso: '2025-02-28'
  ...
  - model: DGI
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: Velickovic2018DeepGI
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy using logistic regression on embeddings with 100
  ...
  - model: BGRL
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: Thakoor2021LargeScaleRL
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy using logistic regression on embeddings with 100
  ...
  - model: GSC
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: 10.1007/978-3-031-20056-4_6
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy using logistic regression on embeddings with 100
  ...
  - model: DSSL
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: Xiao2022DecoupledSL
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy using logistic regression on embeddings with 100
...
- scope: node-level
  ...
  - benchmark: Heterophilic Graphs
    ...
    - dataset: Actor
      dataset_slug: actor
main_figure: /figures/2502.20885/main_figure.jpegoptim.jpg
---
