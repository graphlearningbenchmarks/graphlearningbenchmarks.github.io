...
- name: Hanchen Wang
  orcid: null
  s2_author_id: '46506460'
  s2_url: null
- name: Jean Kaddour
  orcid: null
  s2_author_id: '66914903'
  s2_url: null
- name: Shengchao Liu
  orcid: null
...
abstract: 'Graph Self-Supervised Learning (GSSL) provides a robust pathway for acquiring
  embeddings without expert labelling, a capability that carries profound implications
  for molecular graphs due to the staggering number of potential molecules and the
  high cost of obtaining labels. However, GSSL methods are designed not for optimisation
  within a specific domain but rather for transferability across a variety of downstream
  tasks. This broad applicability complicates their evaluation. Addressing this challenge,
  we present "Molecular Graph Representation Evaluation", generating detailed profiles
  of molecular graph embeddings with interpretable and diversified attributes. offers
  a suite of probing tasks grouped into three categories: (i) generic graph, (ii)
  molecular substructure, and (iii) embedding space properties. By leveraging to benchmark
  existing GSSL methods against both current downstream datasets and our suite of
  tasks, we uncover significant inconsistencies between inferences drawn solely from
  existing datasets and those derived from more nuanced probing. These findings suggest
  that current evaluation methodologies fail to capture the entirety of the landscape.'
codebase_url: https://github.com/hansen7/MolGraphEval
...
- &id002
  ...
  - model: JOAO
    ...
    protocol_note: Scaffold split used for evaluation
    date: Jun 16, 2022
...
- &id003
  ...
  - model: GROVER
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Scaffold split used for molecular property prediction tasks.
    date: Jun 16, 2022
    date_display: Jun 2022
    date_iso: '2022-06-16'
    published_venue: NeurIPS 2022
  ...
  - model: GraphCL
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Scaffold split on 2M ZINC15 pre-training.
    date: Jun 16, 2022
    date_display: Jun 2022
    date_iso: '2022-06-16'
    published_venue: NeurIPS 2022
  ...
  - model: JOAO
    ...
    value_gap_source_date_iso: '2022-06-02'
    value_gap_source_date_label: KDD 2022
    gap_vs_at_pub: 0.21799999999999997
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id004
  ...
  - model: GraphMVP
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Scaffold split used as per caption and setup text.
    date: Jun 16, 2022
    date_display: Jun 2022
    date_iso: '2022-06-16'
    published_venue: NeurIPS 2022
  ...
  - model: InfoGraph
    ...
    gap_vs_at_pub: 0.16700000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id001
  ...
  - model: JOAO
    ...
    value_gap_source_date_iso: '2022-06-02'
    value_gap_source_date_label: KDD 2022
    gap_vs_at_pub: 0.1419999999999999
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: EdgePred
    ...
    value_gap_source_date_iso: '2022-06-02'
    value_gap_source_date_label: KDD 2022
    gap_vs_at_pub: 0.15599999999999992
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id006
  ...
  - model: EdgePred
    ...
    evaluation_task: graph_classification
    protocol_decision: standard
    protocol_note: Mean ROC-AUC over three random scaffold splits.
    date: Jun 16, 2022
    date_display: Jun 2022
    date_iso: '2022-06-16'
    published_venue: NeurIPS 2022
  ...
  - model: JOAO
    ...
    value_gap_source_date_iso: '2022-06-02'
    value_gap_source_date_label: KDD 2022
    gap_vs_at_pub: 0.15999999999999992
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: InfoGraph
    ...
    value_gap_source_date_iso: '2021-09-24'
    value_gap_source_date_label: AAAI 2021
    gap_vs_at_pub: 0.15899999999999992
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GraphCL
    ...
    value_gap_source_date_iso: '2022-06-02'
    value_gap_source_date_label: KDD 2022
    gap_vs_at_pub: 0.1339999999999999
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
