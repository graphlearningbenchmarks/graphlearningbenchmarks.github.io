...
- name: Julius von Rohrscheidt
  orcid: null
  s2_author_id: '2186824842'
  s2_url: null
- name: Bastian Rieck
  orcid: null
  s2_author_id: '2141029182'
  s2_url: null
...
abstract: =3em =10000 The Euler Characteristic Transform (ECT) is an efficiently-computable
  geometrical-topological invariant that characterizes the global shape of data. In
  this paper, we introduce the Local Euler Characteristic Transform ($ $), a novel
  extension of the ECT particularly designed to enhance expressivity and interpretability
  in graph representation learning. Unlike traditional graph neural networks (GNNs),
  which may lose critical local details through aggregation, the $ $ provides a lossless
  representation of local neighborhoods. This approach addresses key limitations in
  GNNs by preserving local structures while maintaining global interpretability. Moreover,
  we construct a rotation-invariant metric based on $ $s for spatial alignment of
  data spaces. Our method exhibits superior performance compared to standard GNNs
  on a variety of benchmark node-classification tasks, while also offering theoretical
  guarantees that demonstrate its effectiveness.
...
- &id007
  ...
  - model: GraphSAGE
    ...
    gap_vs_at_pub: 0.08790000000000003
  ...
  - model: H2GCN
    ...
    gap_vs_at_pub: 0.07700000000000001
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: ECT_1
    ...
    is_std_outlier: false
  - model: ECT_1+ECT_2
    model_key: ect_1+ect_2
    model_plain: ECT_1+ECT_2
    value: 0.309
    std: 0.007
    paper_value: 0.309
    paper_std: 0.007
...
- &id002
  ...
  - model: GAT
    ...
    value_gap_source_title: 'Graph Transductive Sharpening: Leveraging Unlabeled Predictions
      in Node Classification'
    value_gap_source_is_current_paper: false
    value_gap: 0.015799999999999925
    has_value_note: false
    value_note: ''
    sort_value: 0.9398
    sort_std: 0.0022
  ...
  - model: H2GCN
    ...
    gap_vs_at_pub: 0.05180000000000007
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id009
  ...
  - model: H2GCN
    ...
    gap_vs_at_pub: 0.16710000000000003
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GAT
    ...
    value_gap_source_date_iso: '2026-05-18'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.044899999999999995
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GraphSAGE
    ...
    value_gap_source_date_iso: '2024-07-28'
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.13200000000000006
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GCN
    ...
    value_gap_source_date_iso: '2026-05-18'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.11500000000000005
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GIN
    ...
    is_best: false
    is_std_outlier: false
  - model: L-ECT_1+L-ECT_2
    model_key: l-ect_1+l-ect_2
    model_plain: L-ECT_1+L-ECT_2
    value: 0.498
    std: 0.003
    paper_value: 0.498
    paper_std: 0.003
...
- &id003
  ...
  - model: GCN
    ...
    is_std_outlier: false
  - model: Diss-l-ECT
    model_key: diss-l-ect
    model_plain: Diss-l-ECT
    value: 0.961
    std: null
    paper_value: 0.961
    paper_std: null
...
- &id006
  ...
  - model: H2GCN
    ...
    value_gap_source_date_iso: '2026-03-10'
    value_gap_source_date_label: '2026'
    gap_vs_at_pub: 0.18899999999999995
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GAT
    ...
    gap_vs_at_pub: 0.37199999999999994
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GIN
    ...
    is_best: false
    is_std_outlier: false
  - model: Diss-l-ECT_1+Diss-l-ECT_2
    model_key: diss-l-ect_1+diss-l-ect_2
    model_plain: Diss-l-ECT_1+Diss-l-ECT_2
    value: 0.671
    std: 0.041
    paper_value: 0.671
    paper_std: 0.041
    ...
    is_std_outlier: false
  - model: Diss-l-ECT_2
    model_key: diss-l-ect_2
    model_plain: Diss-l-ECT_2
    value: 0.67
    std: 0.049
    paper_value: 0.67
    paper_std: 0.049
    ...
    is_std_outlier: false
  - model: Diss-l-ECT_1
    model_key: diss-l-ect_1
    model_plain: Diss-l-ECT_1
    value: 0.668
    std: 0.042
    paper_value: 0.668
    paper_std: 0.042
...
- &id008
  ...
  - model: H2GCN
    ...
    gap_vs_at_pub: 0.038899999999999935
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
    ...
    value_gap_source_is_current_paper: false
    value_gap: 0.038899999999999935
    has_value_note: false
    value_note: ''
    sort_value: 0.6809
    sort_std: 0.0029
...
- &id005
  ...
  - model: GraphSAGE
    ...
    value_gap_source_date_iso: '2023-10-18'
    value_gap_source_date_label: WWW 2023
    gap_vs_at_pub: 0.18210000000000004
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GAT
    ...
    value_gap_source_date_label: '2025'
    gap_vs_at_pub: 0.28300000000000003
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GCN
    ...
    gap_vs_at_pub: 0.31390000000000007
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
  ...
  - model: GIN
    ...
    value_gap_source_date_iso: '2024-01-26'
    value_gap_source_date_label: '2024'
    gap_vs_at_pub: 0.20399999999999996
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
main_figure: /figures/2410.02622/main_figure.jpegoptim.jpg
---
