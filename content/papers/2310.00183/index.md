...
- name: Yu Chen
  orcid: null
  s2_author_id: '40211752'
  s2_url: null
- name: Shaoliang Nie
  orcid: null
  s2_author_id: '35557488'
  s2_url: null
- name: Jingzhou Liu
  orcid: null
  s2_author_id: '2319946323'
  s2_url: null
- name: Kanika Narang
  orcid: null
  s2_author_id: '2249757531'
  s2_url: null
- name: Zahra Shakeri
  orcid: null
  s2_author_id: '2249758145'
  s2_url: null
- name: Karthik Abinav Sankararaman
  orcid: null
  s2_author_id: '2178963'
  s2_url: null
- name: Song Jiang
  orcid: null
  s2_author_id: '2249954878'
  s2_url: null
- name: Madian Khabsa
  orcid: null
  s2_author_id: '2072010'
  s2_url: null
- name: Qifan Wang
  orcid: null
  s2_author_id: '2401629789'
  s2_url: null
- name: Xia Hu
  orcid: null
...
abstract: This paper investigates the relationship between graph convolution and Mixup
  techniques. Graph convolution in a graph neural network involves aggregating features
  ...
  commonality between these techniques is their utilization of information from multiple
  samples to derive feature representation. This study aims to explore whether a connection
  exists between the two. Our investigation reveals that, under two mild modifications,
  graph convolution can be viewed as a specialized form of Mixup that is applied during
  both the training and testing phases. The two modifications are 1) Homophily Relabel
  - assigning the target node's label to all its neighbors, and 2) Test-Time Mixup
  - Mixup the feature during the test time. We establish this equivalence mathematically
  by demonstrating that graph convolution networks and simplified graph convolution
  can be expressed as a form of Mixup. We also empirically verify the equivalence
...
- &id002
  ...
  - model: GCN
    ...
    protocol_note: Planetoid CiteSeer split
    date: Sep 29, 2023
...
- &id001
  ...
  - model: GAT-alike
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid Cora split
    date: Sep 29, 2023
    date_display: Sep 2023
    date_iso: '2023-09-29'
    published_venue: TMLR 2023
...
- &id003
  ...
  - model: GCN
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid PubMed split
    date: Sep 29, 2023
    date_display: Sep 2023
    date_iso: '2023-09-29'
    published_venue: TMLR 2023
...
- scope: node-level
  ...
  - benchmark: Classic
    ...
    - dataset: PubMed
      dataset_slug: pubmed
main_figure: /figures/2310.00183/main_figure.jpegoptim.jpg
---
