...
- name: Xiaojun Guo
  orcid: null
  s2_author_id: '2265517354'
  s2_url: null
- name: Yifei Wang
  orcid: null
  s2_author_id: '2257116387'
  s2_url: null
- name: Zeming Wei
  orcid: null
  s2_author_id: '2191808925'
  s2_url: null
- name: Yisen Wang
  orcid: null
  s2_author_id: '2257103809'
  s2_url: null
published_date: Nov 5, 2023
published_date_iso: '2023-11-05'
published_venue: NeurIPS 2023
published_conference: NeurIPS 2023
published_conference_short: NeurIPS
published_conference_slug: neurips
abstract: With the prosperity of contrastive learning for visual representation learning
  (VCL), it is also adapted to the graph domain and yields promising performance.
  However, through a systematic study of various graph contrastive learning (GCL)
  methods, we observe that some common phenomena among existing GCL methods that are
  quite different from the original VCL methods, including 1) positive samples are
  not a must for GCL; 2) negative samples are not necessary for graph classification,
  neither for node classification when adopting specific normalization modules; 3)
  data augmentations have much less influence on GCL, as simple domain-agnostic augmentations
  (e.g., Gaussian noise) can also attain fairly good performance. By uncovering how
  the implicit inductive bias of GNNs works in contrastive learning, we theoretically
  provide insights into the above intriguing properties of GCL. Rather than directly
  porting existing VCL methods to GCL, we advocate for more attention toward the unique
  architecture of graph learning and consider its implicit influence when designing
  GCL methods. Code is available at.
codebase_url: https://github.com/PKU-ML/ArchitectureMattersGCL
...
- &id002
  ...
  - model: ProGCL
    ...
    protocol_note: Test accuracy on node classification using InfoNCE (Contrast) loss.
    date: Nov 5, 2023
  ...
  - model: Neighbor nodes
    model_key: neighbor nodes
    model_plain: Neighbor nodes
    value: 0.8621
    std: 0.0058
    paper_value: 0.8621
    paper_std: 0.0058
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Proposed augmentation method.
    date: Nov 5, 2023
    date_display: Nov 2023
    date_iso: '2023-11-05'
    published_venue: NeurIPS 2023
...
- &id001
  ...
  - model: GRACE
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy with GCN + CN encoder and NO Neg loss
    date: Nov 5, 2023
    date_display: Nov 2023
    date_iso: '2023-11-05'
    published_venue: NeurIPS 2023
  ...
  - model: Neighbor nodes
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Test accuracy with Neighbor nodes augmentation
    date: Nov 5, 2023
    date_display: Nov 2023
    date_iso: '2023-11-05'
    published_venue: NeurIPS 2023
...
- &id003
  ...
  - model: ECC
    ...
    is_best: false
    is_std_outlier: false
  - model: ADGCL (Contrast)
    model_key: adgcl (contrast)
    model_plain: ADGCL (Contrast)
    value: 0.9043
    std: 0.0118
    paper_value: 0.9043
    paper_std: 0.0118
    ...
    protocol_decision: standard
    protocol_note: Test accuracy on graph classification benchmark
    date: Nov 5, 2023
    date_display: Nov 2023
    date_iso: '2023-11-05'
    published_venue: NeurIPS 2023
    ...
    is_best: false
    is_std_outlier: false
  - model: InfoGraph (Contrast)
    model_key: infograph (contrast)
    model_plain: InfoGraph (Contrast)
    value: 0.8975
    std: 0.0135
    paper_value: 0.8975
    paper_std: 0.0135
    ...
    is_best: false
    is_std_outlier: false
  - model: GraphCL (NO Neg)
    model_key: graphcl (no neg)
    model_plain: GraphCL (NO Neg)
    value: 0.8873
    std: 0.0052
    paper_value: 0.8873
    paper_std: 0.0052
    ...
    is_best: false
    is_std_outlier: false
  - model: AutoGCL (NO Pos)
    model_key: autogcl (no pos)
    model_plain: AutoGCL (NO Pos)
    value: 0.8723
    std: 0.0113
    paper_value: 0.8723
    paper_std: 0.0113
    ...
    is_std_outlier: false
  - model: JOAO (Contrast)
    model_key: joao (contrast)
    model_plain: JOAO (Contrast)
    value: 0.8617
    std: 0.0155
    paper_value: 0.8617
    paper_std: 0.0155
...
- scope: graph-level
  ...
  - benchmark: TU Dortmund
    ...
    - dataset: MUTAG
      dataset_slug: mutag
main_figure: /figures/2311.02687/main_figure.jpegoptim.jpg
---
