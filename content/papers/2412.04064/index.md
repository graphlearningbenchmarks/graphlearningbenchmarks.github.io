...
- name: Arseny Skryagin
  orcid: null
  s2_author_id: '89329285'
  s2_url: null
- name: Felix Divo
  orcid: null
  s2_author_id: '2083496889'
  s2_url: null
- name: Mohammad Ali
  orcid: null
  s2_author_id: '2300248459'
  s2_url: null
- name: D. Dhami
  orcid: null
  s2_author_id: '39552485'
  s2_url: null
- name: K. Kersting
  orcid: null
  s2_author_id: '2113406566'
  s2_url: null
...
abstract: 'Graph Neural Networks (GNNs) are non-Euclidean deep learning models for
  graph-structured data. Despite their successful and diverse applications, oversmoothing
  ...
  tendency, we propose a plug-and-play module consisting of three steps: Cluster Normalize
  Activate (CNA). By applying CNA modules, GNNs search and form super nodes in each
  layer, which are normalized and activated individually. We demonstrate in node classification
  and property prediction tasks that CNA significantly improves the accuracy over
  the state-of-the-art. Particularly, CNA reaches 94.18\ It further benefits GNNs
  in regression tasks as well, reducing the mean squared error compared to all baselines.
  At the same time, GNNs with CNA require substantially fewer learnable parameters
...
- &id005
  ...
  - model: Exphormer
    ...
    feature_source_evidence: ''
    table_ref: Table 2
    source_ref: shirzadExphormerSparseTransformers2023
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification task on Computers dataset
...
- &id004
  ...
  - model: CGT
    ...
    feature_source_evidence: ''
    table_ref: Table 2
    source_ref: hoangMitigatingDegreeBiases2023
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification task on Photo dataset
...
- &id008
  ...
  - model: Trans.Conv+CNA
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: PwC Leaderboard results for Chameleon node classification.
    date: Dec 5, 2024
    date_display: Dec 2024
    date_iso: '2024-12-05'
    published_venue: NeurIPS 2024
  ...
  - model: Dir-GNN
    ...
    feature_source_evidence: ''
    table_ref: Table 2
    source_ref: beggaDiffusionJumpGNNsHomophiliation2023
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: PwC Leaderboard results for Chameleon node classification.
...
- &id003
  ...
  - model: GraphSAGE
    ...
    is_best: false
    is_std_outlier: false
  - model: ACMII-Snowball-2
    model_key: acmii-snowball-2
    model_plain: ACMII-Snowball-2
    value: 0.8207
    std: 0.0104
    paper_value: 0.8207
    paper_std: 0.0104
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: luanRevisitingHeterophilyGraph2022
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split (Yang et al. 2016 fixed split)
...
- &id001
  ...
  - model: SSP
    ...
    feature_source_evidence: ''
    table_ref: Table 2
    source_ref: izadiOptimizationGraphNeural2020
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Planetoid split (Yang et al. 2016 fixed 20-per-class train split)
  ...
  - model: GraphSAGE
    ...
    gap_vs_at_pub: 0.07190000000000007
    worse_than_at_pub: true
    surpassed_since_pub: false
    better_than_at_pub: false
    insignificant_improvement_at_pub: false
...
- &id010
  ...
  - model: CNA
    ...
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification task on DBLP split
    date: Dec 5, 2024
    date_display: Dec 2024
    date_iso: '2024-12-05'
    published_venue: NeurIPS 2024
  ...
  - model: GRACE
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: zhuDeepGraphContrastive2020
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification task on DBLP split
...
- &id002
  ...
  - model: ACM-Snowball-3
    ...
    is_best: false
    is_std_outlier: false
  - model: TransformerConv+CNA
    model_key: transformerconv+cna
    model_plain: TransformerConv+CNA
    value: 0.9016
    std: 0.0013
    paper_value: 0.9016
    paper_std: 0.0013
...
- &id009
  ...
  - model: Dir-GNN
    ...
    feature_source_evidence: ''
    table_ref: Table 2
    source_ref: rossiEdgeDirectionalityImproves2023
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
    protocol_note: Standard node classification task on Squirrel dataset.
...
- &id007
  ...
  - model: 2-HiGCN
    ...
    feature_source_evidence: ''
    table_ref: Table 1
    source_ref: huangHigherorderGraphConvolutional2024
    variant_inference_reason: 'dataset: exact match'
    evaluation_task: node_classification
    protocol_decision: standard
...
- scope: node-level
  ...
  - benchmark: Heterogeneous Graph Benchmarks
    ...
    - dataset: DBLP
      dataset_slug: dblp
main_figure: /figures/2412.04064/main_figure.jpegoptim.jpg
---
